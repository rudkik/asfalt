...
class PDF_Ab1_Page extends PDF_Page
{
    public $footerHtml = '';
    public $headerHtml = '';
    ...
    function __construct($title, $author = 'Er2003')
    {
        ...
        $this->SetMargins(PDF_MARGIN_LEFT + 5, PDF_MARGIN_TOP - 10, PDF_MARGIN_RIGHT - 7);
    }
    ...
    public function Header() {
        ...
        if(!empty($this->headerHtml)){
            ...
            $s = Func::mb_str_replace(
                '{#page#}', $this->getAliasNumPage(), mb_str_replace(
    ...
    public function Footer() {
        ...
        //$this->Cell(0, 10, $s, 0, false, 'C', 0, '', 0, false, 'T', 'M');
    }
