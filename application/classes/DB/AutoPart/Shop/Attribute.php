...
class DB_AutoPart_Shop_Attribute {
    const TABLE_NAME = 'ap_shop_attributes';
    const TABLE_ID = 430;
    const NAME = 'DB_AutoPart_Shop_Attribute';

    const SQL = array(
        'postgres' => array(
            'drop' => 'DROP TABLE IF EXISTS "public"."ap_shop_attributes";',
            'create' => '
                    -- ----------------------------
                    ...
                    COMMENT ON TABLE "public"."ap_shop_attributes" IS \'Список атрибутов\';
    ...
    const FIELDS = array(
        ...
        'shop_attribute_type_id' => array(
            'type' => DB_FieldType::FIELD_TYPE_INTEGER,
            'length' => 18,
            'decimal' => 0,
            'is_not_null' => true,
            'title' => 'ID типа атрибута',
            'table' => 'DB_AutoPart_Shop_Attribute_Type',
        ),
    );
