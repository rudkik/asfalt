...
class Controller_Sladushka_Main_ShopOperation extends Controller_Sladushka_Main_BasicSladushka {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sladushka/shopoperation/index';
    ...
    public function action_list() {
        $this->_sitePageData->url = '/sladushka/shopoperation/list';
        ...
        // получаем список
        $data = View_View::find('DB_Shop_Operation', $this->_sitePageData->shopID, "_shop/operation/list/list",
            "_shop/operation/one/list", $this->_sitePageData, $this->_driverDB,
    ...
    public function action_json() {
        $this->_sitePageData->url = '/sladushka/shopoperation/json';
        ...
        // получаем список
        $ids = Request_Request::find('DB_Shop_Operation',$this->_sitePageData->shopID,
    ...
    {
        $this->_sitePageData->url = '/sladushka/shopoperation/new';
    ...
    {
        $this->_sitePageData->url = '/sladushka/shopoperation/edit';
    ...
    {
        $this->_sitePageData->url = '/sladushka/shopoperation/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/sladushka/shopoperation/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/sladushka/shopoperation/index'
                    . URL::query(
                        array(
