...
class Controller_Sladushka_Manager_ShopPaid extends Controller_Sladushka_Manager_BasicCabinet {
	...
	public function action_index() {
		$this->_sitePageData->url = '/manager/shoppaid/index';
        ...
        View_View::find('DB_Shop_Paid', $this->_sitePageData->shopID, "_shop/paid/list/index", "_shop/paid/one/index",
			$this->_sitePageData, $this->_driverDB, array('limit_page' => 25, 'create_user_id' => $this->_sitePageData->userID), array('paid_shop_id'));
	...
	{
		$this->_sitePageData->url = '/manager/shoppaid/new';

		// задаем данные, которые будут меняться
		$this->_setGlobalDatas(
			array(
                'view::_shop/paid/one/new',
                'view::_shop/branch/one/paid',
			)
		);
        ...
        View_View::findOne('DB_Shop', $this->_sitePageData->shopID, '_shop/branch/one/paid', $this->_sitePageData, $this->_driverDB,
            array('is_error_404' => TRUE, 'id' => intval(Request_RequestParams::getParamInt('paid_shop_id')),
	...
	{
		$this->_sitePageData->url = '/manager/shoppaid/edit';
	...
	{
		$this->_sitePageData->url = '/manager/shoppaid/save';
	...
	public function action_del() {
		$this->_sitePageData->url = '/manager/shoppaid/del';
