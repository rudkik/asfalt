...
class Controller_Tax_Client_Shopuser extends Controller_Tax_Client_BasicTax {
    public function before() {
        $this->_sitePageData->shopShablonPath = 'tax/client';
        // данные о языке
        $this->_readLanguageInterface();
    }

    public function action_auth() {
        $this->_sitePageData->url = '/tax/shopuser/auth';
    ...
    public function action_registration() {
        ...
        $this->_sitePageData->url = '/tax/shopuser/registration';
        ...
        // генерируем основную часть
        $view = View::factory('tax/' . $this->_sitePageData->languageID . '/main/shopuser-registration');
        $view->data = array();
        $view->siteData = $this->_sitePageData;
        $result = Helpers_View::viewToStr($view);
        ...
        $view = View::factory('tax/' . $this->_sitePageData->languageID . '/index');
        $view->data = array();
    ...
    public function action_unlogin() {
        ...
        $this->redirect($this->_sitePageData->urlBasic . "/tax");
    }

    public function action_resetpassword() {
        $this->_sitePageData->url = '/tax/shopuser/resetpassword';
