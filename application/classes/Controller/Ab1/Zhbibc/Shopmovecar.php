...
class Controller_Ab1_ZhbiBc_ShopMoveCar extends Controller_Ab1_ZhbiBc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/zhbibc/shopmovecar/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/zhbibc/shopmovecar/history';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/shopmovecar/new';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/shopmovecar/edit';
        $this->_actionMoveCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/zhbibc/shopmovecar/save';

        $result = Api_Ab1_Shop_Move_Car::save($this->_sitePageData, $this->_driverDB, false);
