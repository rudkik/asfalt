...
class Controller_Ab1_ZhbiBc_ShopLesseeCar extends Controller_Ab1_ZhbiBc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/zhbibc/shoplesseecar/index';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/shoplesseecar/new';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/shoplesseecar/edit';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/shoplesseecar/save';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/shoplesseecar/del';
