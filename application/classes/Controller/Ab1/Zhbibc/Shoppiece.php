...
class Controller_Ab1_ZhbiBc_ShopPiece extends Controller_Ab1_ZhbiBc_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/zhbibc/shoppiece/index';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/shoppiece/new';
        $this->_actionShopPieceNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/zhbibc/shoppiece/edit';
        $this->_actionShopPieceEdit();
    }

    public function action_del()
    {
        $this->_sitePageData->url = '/zhbibc/shoppiece/del';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/shoppiece/save';
