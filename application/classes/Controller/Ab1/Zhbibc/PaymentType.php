...
class Controller_Ab1_ZhbiBc_PaymentType extends Controller_Ab1_ZhbiBc_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/zhbibc/paymenttype/index';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/paymenttype/new';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/paymenttype/edit';
    ...
    {
        $this->_sitePageData->url = '/zhbibc/paymenttype/save';
