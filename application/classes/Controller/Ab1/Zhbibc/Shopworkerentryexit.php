...
class Controller_Ab1_Zhbibc_ShopWorkerEntryExit extends Controller_Ab1_Zhbibc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/znbibc/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/znbibc/shopworkerentryexit/history';
