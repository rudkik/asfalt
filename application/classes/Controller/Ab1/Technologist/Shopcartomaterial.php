...
class Controller_Ab1_Technologist_ShopCarToMaterial extends Controller_Ab1_Technologist_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/technologist/shopcartomaterial/index';
        ...
        View_View::find('DB_Ab1_Shop_Car_To_Material', $this->_sitePageData->shopMainID,
            ...
            array(
                ...
                'technologist_operation_id' => array('name'),
    ...
    {
        $this->_sitePageData->url = '/technologist/shopcartomaterial/statistics';
        $this->_actionShopCarToMaterialStatistics();
    }

    public function action_statistics_daughter()
    {
        $this->_sitePageData->url = '/technologist/shopcartomaterial/statistics_daughter';
        $this->_actionShopCarToMaterialDaughterStatistics();
    }

    public function action_statistics_daughter_material()
    {
        $this->_sitePageData->url = '/technologist/shopcartomaterial/statistics_daughter_material';
