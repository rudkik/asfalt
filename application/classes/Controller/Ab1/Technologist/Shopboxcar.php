...
class Controller_Ab1_Technologist_ShopBoxcar extends Controller_Ab1_Technologist_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/technologist/shopboxcar/index';
    ...
    {
        $this->_sitePageData->url = '/technologist/shopboxcar/statistics';
