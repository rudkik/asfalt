...
class Controller_Ab1_Technologist_ShopMaterialMoisture extends Controller_Ab1_Technologist_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/technologist/shopmaterialmoisture/index';
    ...
    {
        $this->_sitePageData->url = '/technologist/shopmaterialmoisture/new';
        $this->_actionShopMaterialMoistureNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/technologist/shopmaterialmoisture/edit';
        $this->_actionShopMaterialMoistureEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/technologist/shopmaterialmoisture/save';
    ...
    {
        $this->_sitePageData->url = '/technologist/shopmaterialmoisture/calc_quantity';
