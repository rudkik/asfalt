...
class Controller_Ab1_Cash_ShopCar extends Controller_Ab1_Cash_BasicAb1 {
    ...
    public function action_index() {
        if($this->_sitePageData->operation->getShopTableUnitID()){
            self::redirect('/cash/shoppiece/index');
        }

        $this->_sitePageData->url = '/cash/shopcar/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/cash/shopcar/history';
    ...
    {
        $this->_sitePageData->url = '/cash/shopcar/new';
        $this->_actionShopCarNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/cash/shopcar/edit';
        $this->_actionShopCarEdit();
    }

    public function action_refusal()
    {
        $this->_sitePageData->url = '/cash/shopcar/refusal';
    ...
    {
        $this->_sitePageData->url = '/cash/shopcar/save';
    ...
    {
        $this->_sitePageData->url = '/cash/shopcar/del';
    ...
    {
        $this->_sitePageData->url = '/cash/shopcar/clone_in_move';
        ...
        $this->redirect('/cash/shopmovecar/edit?id='.$modelMoveCar->id);
    }
}
