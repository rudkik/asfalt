...
class Controller_Ab1_Cash_ShopCashbox extends Controller_Ab1_Cash_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/cash/shopcashbox/index';
        ...
        // получаем список
        View_View::find('DB_Ab1_Shop_Cashbox', $this->_sitePageData->shopID, "_shop/cashbox/list/index", "_shop/cashbox/one/index",
    ...
    {
        $this->_sitePageData->url = '/cash/shopcashbox/list';

        // получаем список
        $this->response->body(View_View::find('DB_Ab1_Shop_Cashbox', $this->_sitePageData->shopID,
    ...
    {
        $this->_sitePageData->url = '/cash/shopcashbox/new';
        ...
        $this->_sitePageData->replaceDatas['view::_shop/cashbox/one/new'] = Helpers_View::getViewObject($dataID, new Model_Ab1_Shop_Cashbox(),
            '_shop/cashbox/one/new', $this->_sitePageData, $this->_driverDB, $this->_sitePageData->shopID);
    ...
    {
        $this->_sitePageData->url = '/cash/shopcashbox/edit';
        ...
        if (!$this->dublicateObjectLanguage($model, $shopCashboxID, $this->_sitePageData->shopID, FALSE)) {
            throw new HTTP_Exception_404('Cashbox not is found!');
        }

        // получаем данные
        View_View::findOne('DB_Ab1_Shop_Cashbox', $this->_sitePageData->shopID, "_shop/cashbox/one/edit",
    ...
    {
        $this->_sitePageData->url = '/cash/shopcashbox/save';
