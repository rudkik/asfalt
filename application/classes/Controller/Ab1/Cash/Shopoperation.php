...
class Controller_Ab1_Cash_ShopOperation extends Controller_Ab1_Cash_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/cash/shopoperation/index';
        ...
        View_View::find(
            ...
            array('limit' => 1000, 'limit_page' => 25, 'shop_table_rubric_id' => Model_Ab1_Shop_Operation::RUBRIC_CASH),
            ['shop_worker_id' => ['name']]
        );
    ...
    {
        $this->_sitePageData->url = '/cash/shopoperation/new';
    ...
    {
        $this->_sitePageData->url = '/cash/shopoperation/edit';
    ...
    {
        $this->_sitePageData->url = '/cash/shopoperation/save';
