...
class Controller_Ab1_Cash_ShopWorkerEntryExit extends Controller_Ab1_Cash_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/cash/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/cash/shopworkerentryexit/history';
