...
class Controller_Ab1_Cash_ShopConsumable extends Controller_Ab1_Cash_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/cash/shopconsumable/index';
        ...
        // получаем список
        View_View::find(
            'DB_Ab1_Shop_Consumable', $this->_sitePageData->shopID,
            "_shop/consumable/list/index", "_shop/consumable/one/index",
    ...
    {
        $this->_sitePageData->url = '/cash/shopconsumable/list';
    ...
    {
        $this->_sitePageData->url = '/cash/shopconsumable/new';
    ...
    {
        $this->_sitePageData->url = '/cash/shopconsumable/edit';
    ...
    {
        $this->_sitePageData->url = '/cash/shopconsumable/save';
