...
class Controller_Ab1_Cash_ShopProductRubric extends Controller_Ab1_Cash_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/cash/shopproductrubric/index';
        ...
        // получаем список
        View_View::find('DB_Ab1_Shop_Product_Rubric',
            $this->_sitePageData->shopMainID,
            "_shop/product/rubric/list/index", "_shop/product/rubric/one/index",
            $this->_sitePageData, $this->_driverDB,
            array('limit' => 1000, 'limit_page' => 25), array('root_id' => array('name'))
        );
    ...
    {
        $this->_sitePageData->url = '/cash/shopproductrubric/list';

        // получаем список
        $this->response->body(View_View::find('DB_Ab1_Shop_Product_Rubric',
            $this->_sitePageData->shopMainID,
    ...
    {
        $this->_sitePageData->url = '/cash/shopproductrubric/new';
        $this->_actionShopProductRubricNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/cash/shopproductrubric/edit';
        $this->_actionShopProductRubricEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/cash/shopproductrubric/save';
