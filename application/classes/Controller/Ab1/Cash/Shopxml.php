...
class Controller_Ab1_Cash_ShopXML extends Controller_Ab1_Cash_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/cash/shopxml/index';
    ...
    public function action_load_asu() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/load_asu';
        ...
        self::redirect('/cash/shopxml/index');
    }
    ...
    public function action_load_act_revise() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/load_act_revise';
    ...
    public function action_loaddelivery() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/loaddelivery';
    ...
    public function action_loadproduct() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/loadproduct';
    ...
    public function action_loadclient() {
       /* set_time_limit(36000);
        ...
        $this->_sitePageData->url = '/cash/shopxml/loadclient';
    ...
    public function action_loadmoveclient() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/loadmoveclient';
    ...
    public function action_saveall() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/saveall';
    ...
    public function action_savecars() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/savecars';
    ...
    public function action_saveconsumables() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/saveconsumables';
    ...
    public function action_savepayments() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/savepayments';
    ...
    public function action_save_payment_returns() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/save_payment_returns';
    ...
    public function action_savemovecars() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/savemovecars';
    ...
    public function action_savedefectcars() {
        ...
        $this->_sitePageData->url = '/cash/shopxml/savedefectcars';
