...
class Controller_Ab1_Train_ShopOperation extends Controller_Ab1_Train_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/train/shopoperation/index';
    ...
    {
        $this->_sitePageData->url = '/train/shopoperation/new';
        $this->_actionShopOperationNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/train/shopoperation/edit';
        $this->_actionShopOperationEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/train/shopoperation/save';
