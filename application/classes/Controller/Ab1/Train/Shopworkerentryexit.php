...
class Controller_Ab1_Train_ShopWorkerEntryExit extends Controller_Ab1_Train_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/train/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/train/shopworkerentryexit/history';
