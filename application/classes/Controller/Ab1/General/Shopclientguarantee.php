...
class Controller_Ab1_General_ShopClientGuarantee extends Controller_Ab1_General_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/general/shopclientguarantee/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_index() {
        $this->_sitePageData->url = '/general/shopclientguarantee/index';
    ...
    {
        $this->_sitePageData->url = '/general/shopclientguarantee/edit';
        $this->_actionShopClientGuaranteeEdit();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/general/shopclientguarantee/new';
        $this->_actionShopClientGuaranteeNew();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/general/shopclientguarantee/save';
    ...
    {
        $this->_sitePageData->url = '/general/shopclientguarantee/del';
