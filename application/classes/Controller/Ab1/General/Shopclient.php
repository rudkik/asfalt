...
class Controller_Ab1_General_ShopClient extends Controller_Ab1_General_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/general/shopclient/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_index() {
        $this->_sitePageData->url = '/general/shopclient/index';
    ...
    {
        $this->_sitePageData->url = '/general/shopclient/edit';
        $this->_actionShopClientEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/general/shopclient/save';
    ...
    {
        $this->_sitePageData->url = '/general/shopclient/statistics';
    ...
    public function action_charity_statistics()
    {
        ...
        $this->_sitePageData->url = '/general/shopclient/charity_statistics';
