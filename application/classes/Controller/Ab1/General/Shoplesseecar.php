...
class Controller_Ab1_General_ShopLesseeCar extends Controller_Ab1_General_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/general/shoplesseecar/index';
    ...
    {
        $this->_sitePageData->url = '/general/shoplesseecar/edit';
        $this->_actionLesseeCarEdit();
    }

    public function action_statistics()
    {
        $this->_sitePageData->url = '/general/shoplesseecar/statistics';
