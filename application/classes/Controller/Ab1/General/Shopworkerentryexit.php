...
class Controller_Ab1_General_ShopWorkerEntryExit extends Controller_Ab1_General_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/general/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/general/shopworkerentryexit/history';
