...
class Controller_Ab1_General_ShopBoxcar extends Controller_Ab1_General_BasicAb1{
    ...
    {
        $this->_sitePageData->url = '/general/shopboxcar/index';
    ...
    {
        $this->_sitePageData->url = '/general/shopboxcar/edit';
        $this->_actionShopBoxcarEdit();
    }

    public function action_statistics()
    {
        $this->_sitePageData->url = '/general/shopboxcar/statistics';
