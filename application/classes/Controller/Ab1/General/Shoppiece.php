...
class Controller_Ab1_General_ShopPiece extends Controller_Ab1_General_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/general/shoppiece/index';
    ...
    {
        $this->_sitePageData->url = '/general/shoppiece/edit';
        $this->_actionShopPieceEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/general/shoppiece/save';
