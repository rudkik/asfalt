...
class Controller_Ab1_General_ShopProductStorage extends Controller_Ab1_General_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/general/shopproductstorage/index';
    ...
    {
        $this->_sitePageData->url = '/general/shopproductstorage/edit';
        $this->_actionShopProductStorageEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/general/shopproductstorage/save';
    ...
    {
        $this->_sitePageData->url = '/general/shopproductstorage/statistics';
