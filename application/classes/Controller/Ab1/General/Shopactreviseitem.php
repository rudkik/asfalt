...
class Controller_Ab1_General_ShopActReviseItem extends Controller_Ab1_General_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/general/shopactreviseitem/index';
    ...
    public function action_client() {
        $this->_sitePageData->url = '/general/shopactreviseitem/client';
        $this->_actionShopActReviseItemClient();
    }

    public function action_virtual() {
        $this->_sitePageData->url = '/general/shopactreviseitem/virtual';
