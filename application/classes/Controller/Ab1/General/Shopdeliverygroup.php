...
class Controller_Ab1_General_ShopDeliveryGroup extends Controller_Ab1_General_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/general/shopdeliverygroup/index';
    ...
    {
        $this->_sitePageData->url = '/general/shopdeliverygroup/list';
    ...
    {
        $this->_sitePageData->url = '/general/shopdeliverygroup/new';
    ...
    {
        $this->_sitePageData->url = '/general/shopdeliverygroup/edit';
    ...
    {
        $this->_sitePageData->url = '/general/shopdeliverygroup/save';
