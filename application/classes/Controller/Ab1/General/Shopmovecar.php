...
class Controller_Ab1_General_ShopMoveCar extends Controller_Ab1_General_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/general/shopmovecar/index';
    ...
    {
        $this->_sitePageData->url = '/general/shopmovecar/edit';
        $this->_actionMoveCarEdit();
    }

    public function action_statistics()
    {
        $this->_sitePageData->url = '/general/shopmovecar/statistics';
