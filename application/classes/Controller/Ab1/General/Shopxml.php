...
class Controller_Ab1_General_ShopXML extends Controller_Ab1_General_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/general/shopxml/index';
    ...
    public function action_save_invoices() {
        ...
        $this->_sitePageData->url = '/general/shopxml/save_invoices';
    ...
    public function action_save_act_services() {
        ...
        $this->_sitePageData->url = '/general/shopxml/save_act_services';
