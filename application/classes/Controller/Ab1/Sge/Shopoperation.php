...
class Controller_Ab1_Sge_ShopOperation extends Controller_Ab1_Sge_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sge/shopoperation/index';
        ...
        View_View::find(
            ...
            array('limit' => 1000, 'limit_page' => 25, 'shop_table_rubric_id' => Model_Ab1_Shop_Operation::RUBRIC_SGE),
            ['shop_worker_id' => ['name']]
        );
    ...
    {
        $this->_sitePageData->url = '/sge/shopoperation/new';
        $this->_actionShopOperationNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/sge/shopoperation/edit';
        $this->_actionShopOperationEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sge/shopoperation/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/sge/shopoperation/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/sge/shopoperation/index'
                    . URL::query(
                        array(
