...
class Controller_Ab1_Sge_ShopWorkerEntryExit extends Controller_Ab1_Sge_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sge/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/sge/shopworkerentryexit/history';
