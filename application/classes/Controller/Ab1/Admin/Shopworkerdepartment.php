...
class Controller_Ab1_Admin_ShopWorkerDepartment extends Controller_Ab1_Admin_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/ab1-admin/shopworkerdepartment/index';
    ...
    public function action_new(){
        $this->_sitePageData->url = '/ab1-admin/shopworkerdepartment/new';
    ...
    {
        $this->_sitePageData->url = '/ab1-admin/shopworkerdepartment/edit';
