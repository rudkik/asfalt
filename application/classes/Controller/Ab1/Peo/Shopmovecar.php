...
class Controller_Ab1_Peo_ShopMoveCar extends Controller_Ab1_Peo_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/peo/shopmovecar/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/peo/shopmovecar/history';
    ...
    {
        $this->_sitePageData->url = '/peo/shopmovecar/edit';
        $this->_actionMoveCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/peo/shopmovecar/save';
    ...
    {
        $this->_sitePageData->url = '/peo/shopmovecar/statistics';
