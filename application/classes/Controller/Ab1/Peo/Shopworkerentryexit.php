...
class Controller_Ab1_Peo_ShopWorkerEntryExit extends Controller_Ab1_Peo_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/peo/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/peo/shopworkerentryexit/history';
