...
class Controller_Ab1_Peo_ShopCar extends Controller_Ab1_Peo_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/peo/shopcar/index';
    ...
    public function action_asu() {
        $this->_sitePageData->url = '/peo/shopcar/asu';
        $this->_requestShopBranches(null, true);
        $this->_actionASU();
    }

    public function action_asu_cars() {
        $this->_sitePageData->url = '/peo/shopcar/asu_cars';
        $this->_actionASUCars();
    }

    public function action_history() {
        $this->_sitePageData->url = '/peo/shopcar/history';
    ...
    {
        $this->_sitePageData->url = '/peo/shopcar/edit';
        $this->_actionShopCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/peo/shopcar/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/peo/shopcar/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/peo/shopcar/index'
                    . URL::query(
                        array(
