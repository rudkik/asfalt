...
class Controller_Ab1_Lab_ShopClient extends Controller_Ab1_Lab_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/lab/shopclient/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_index() {
        $this->_sitePageData->url = '/lab/shopclient/index';
    ...
    {
        $this->_sitePageData->url = '/lab/shopclient/edit';
        $this->_actionShopClientEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/lab/shopclient/save';
    ...
    {
        $this->_sitePageData->url = '/lab/shopclient/statistics';
    ...
    public function action_charity_statistics()
    {
        ...
        $this->_sitePageData->url = '/lab/shopclient/charity_statistics';
