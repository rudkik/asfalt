...
class Controller_Ab1_Lab_ShopClientContract extends Controller_Ab1_Lab_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/lab/shopclientcontract/json';
        $this->_getJSONList(
    ...
    public function action_index() {
        $this->_sitePageData->url = '/lab/shopclientcontract/index';
    ...
    public function action_child() {
        $this->_sitePageData->url = '/lab/shopclientcontract/child';
    ...
    {
        $this->_sitePageData->url = '/lab/shopclientcontract/edit';
        $this->_actionShopClientContractEdit();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/lab/shopclientcontract/new';
        $this->_actionShopClientContractNew();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/lab/shopclientcontract/save';
    ...
    {
        $this->_sitePageData->url = '/lab/shopclientcontract/del';
    ...
    {
        $this->_sitePageData->url = '/lab/shopclientcontract/save_word';
