...
class Controller_Ab1_Lab_ShopEquipmentRepair extends Controller_Ab1_Lab_BasicAb1 {

    public function __construct(Request $request, Response $response)
    {
        $this->dbObject = 'DB_Ab1_Shop_Equipment_Repair';
        $this->controllerName = 'shopequipmentrepair';
        $this->tableID = Model_Ab1_Shop_Equipment_Repair::TABLE_ID;
        $this->tableName = Model_Ab1_Shop_Equipment_Repair::TABLE_NAME;
        $this->objectName = 'equipmentrepair';
    ...
    public function action_index() {
        $this->_sitePageData->url = '/lab/shopequipmentrepair/index';
    ...
    {
        $this->_sitePageData->url = '/lab/shopequipmentrepair/new';
    ...
    {
        $this->_sitePageData->url = '/lab/shopequipmentrepair/edit';

        // id записи
        $id = Request_RequestParams::getParamInt('id');
        $model = new Model_Ab1_Shop_Equipment_Repair();
