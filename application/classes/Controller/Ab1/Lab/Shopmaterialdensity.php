...
class Controller_Ab1_Lab_ShopMaterialDensity extends Controller_Ab1_Lab_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/lab/shopmaterialdensity/index';
    ...
    {
        $this->_sitePageData->url = '/lab/shopmaterialdensity/new';
        $this->_actionShopMaterialDensityNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/lab/shopmaterialdensity/edit';
        $this->_actionShopMaterialDensityEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/lab/shopmaterialdensity/save';
