...
class Controller_Ab1_Lab_ShopCar extends Controller_Ab1_Lab_BasicAb1{
    public function action_index() {
        $this->_sitePageData->url = '/lab/shopcar/index';
    ...
    {
        $this->_sitePageData->url = '/lab/shopcar/edit';
        $this->_actionShopCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/lab/shopcar/save';
    ...
    public function action_asu() {
        $this->_sitePageData->url = '/lab/shopcar/asu';
        $this->_requestShopBranches(null, true);
        $this->_actionASU();
    }

    public function action_asu_cars() {
        $this->_sitePageData->url = '/lab/shopcar/asu_cars';
        $this->_actionASUCars();
    }
}
