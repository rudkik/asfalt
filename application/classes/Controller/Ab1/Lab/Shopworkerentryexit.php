...
class Controller_Ab1_Lab_ShopWorkerEntryExit extends Controller_Ab1_Lab_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/lab/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/lab/shopworkerentryexit/history';
