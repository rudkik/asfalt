...
class Controller_Ab1_Lab_ShopProductStorage extends Controller_Ab1_Lab_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/lab/shopproductstorage/index';
    ...
    {
        $this->_sitePageData->url = '/lab/shopproductstorage/edit';
        $this->_actionShopProductStorageEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/lab/shopproductstorage/save';
    ...
    {
        $this->_sitePageData->url = '/lab/shopproductstorage/statistics';
