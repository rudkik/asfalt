...
class Controller_Ab1_Lab_ShopProduct extends Controller_Ab1_Lab_BasicAb1 {
    ...
    {
        $this->_sitePageData->url = '/lab/shopproduct/statistics';
        $this->_actionShopProductStatistics();
    }

    public function action_print_formula()
    {
        $this->_sitePageData->url = '/lab/shopproduct/print_formula';
