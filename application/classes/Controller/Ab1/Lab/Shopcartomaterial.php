...
class Controller_Ab1_Lab_ShopCarToMaterial extends Controller_Ab1_Lab_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/lab/shopcartomaterial/index';
    ...
    {
        $this->_sitePageData->url = '/lab/shopcartomaterial/statistics';
        $this->_actionShopCarToMaterialStatistics();
    }

    public function action_statistics_daughter()
    {
        $this->_sitePageData->url = '/lab/shopcartomaterial/statistics_daughter';
        $this->_actionShopCarToMaterialDaughterStatistics();
    }

    public function action_statistics_daughter_material()
    {
        $this->_sitePageData->url = '/lab/shopcartomaterial/statistics_daughter_material';
