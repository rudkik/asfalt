...
class Controller_Ab1_Make_ShopClientContract extends Controller_Ab1_Make_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/make/shopclientcontract/json';
        $this->_getJSONList(
    ...
    public function action_index() {
        $this->_sitePageData->url = '/make/shopclientcontract/index';
    ...
    public function action_director() {
        $this->_sitePageData->url = '/make/shopclientcontract/director';
        $this->_actionShopClientContractDirector();
    }

    public function action_child() {
        $this->_sitePageData->url = '/make/shopclientcontract/child';
    ...
    {
        $this->_sitePageData->url = '/make/shopclientcontract/edit';
        $this->_actionShopClientContractEdit();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/make/shopclientcontract/new';
        $this->_actionShopClientContractNew();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/make/shopclientcontract/save';
    ...
    {
        $this->_sitePageData->url = '/make/shopclientcontract/del';
    ...
    {
        $this->_sitePageData->url = '/make/shopclientcontract/save_word';
