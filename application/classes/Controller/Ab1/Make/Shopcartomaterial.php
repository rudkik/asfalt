...
class Controller_Ab1_Make_ShopCarToMaterial extends Controller_Ab1_Make_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/make/shopcartomaterial/index';
        ...
        $this->_requestShopClientMaterial(NULL, null, true);
    ...
    {
        $this->_sitePageData->url = '/make/shopcartomaterial/edit';
    ...
    {
        $this->_sitePageData->url = '/make/shopcartomaterial/new';
    ...
    {
        $this->_sitePageData->url = '/make/shopcartomaterial/get_images';
    ...
    {
        $this->_sitePageData->url = '/make/shopcartomaterial/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/make/shopcartomaterial/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/make/shopcartomaterial/index'
                    . URL::query(
                        array(
    ...
    {
        $this->_sitePageData->url = '/make/shopcartomaterial/send_tare';
        ...
        if (!$isError) {
            ...
            if ($model->validationFields($result)) {
                ...
                $data = Controller_Ab1_Make_Data::getDataFiles();
                $files = array(
                    0 => array(
    ...
    {
        $this->_sitePageData->url = '/make/shopcartomaterial/statistics';
        $this->_actionShopCarToMaterialStatistics();
    }

    public function action_statistics_daughter()
    {
        $this->_sitePageData->url = '/make/shopcartomaterial/statistics_daughter';
        $this->_actionShopCarToMaterialDaughterStatistics();
    }

    public function action_statistics_daughter_material()
    {
        $this->_sitePageData->url = '/make/shopcartomaterial/statistics_daughter_material';
