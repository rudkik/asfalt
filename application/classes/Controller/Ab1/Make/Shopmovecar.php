...
class Controller_Ab1_Make_ShopMoveCar extends Controller_Ab1_Make_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/make/shopmovecar/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/make/shopmovecar/history';
    ...
    {
        $this->_sitePageData->url = '/make/shopmovecar/edit';
        $this->_actionMoveCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/make/shopmovecar/save';
    ...
    {
        $this->_sitePageData->url = '/make/shopmovecar/statistics';
