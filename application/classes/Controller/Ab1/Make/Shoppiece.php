...
class Controller_Ab1_Make_ShopPiece extends Controller_Ab1_Make_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/make/shoppiece/hystory';
    ...
    {
        $this->_sitePageData->url = '/make/shoppiece/edit';
