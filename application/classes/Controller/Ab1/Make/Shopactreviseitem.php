...
class Controller_Ab1_Make_ShopActReviseItem extends Controller_Ab1_Make_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/make/shopactreviseitem/index';
    ...
    public function action_client() {
        $this->_sitePageData->url = '/make/shopactreviseitem/client';
        $this->_actionShopActReviseItemClient();
    }

    public function action_virtual() {
        $this->_sitePageData->url = '/make/shopactreviseitem/virtual';
