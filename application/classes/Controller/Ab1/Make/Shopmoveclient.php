...
class Controller_Ab1_Make_ShopMoveClient extends Controller_Ab1_Make_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/make/shopmoveclient/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_index() {
        $this->_sitePageData->url = '/make/shopmoveclient/index';
    ...
    {
        $this->_sitePageData->url = '/make/shopmoveclient/new';
    ...
    {
        $this->_sitePageData->url = '/make/shopmoveclient/edit';
    ...
    {
        $this->_sitePageData->url = '/make/shopmoveclient/save';
    ...
    {
        $this->_sitePageData->url = '/make/shopmoveclient/statistics';
