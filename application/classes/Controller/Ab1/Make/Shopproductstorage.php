...
class Controller_Ab1_Make_ShopProductStorage extends Controller_Ab1_Make_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/make/shopproductstorage/index';
    ...
    {
        $this->_sitePageData->url = '/make/shopproductstorage/edit';
        $this->_actionShopProductStorageEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/make/shopproductstorage/save';
    ...
    {
        $this->_sitePageData->url = '/make/shopproductstorage/statistics';
