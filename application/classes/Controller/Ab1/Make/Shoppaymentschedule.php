...
class Controller_Ab1_Make_ShopPaymentSchedule extends Controller_Ab1_Make_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/make/shoppaymentschedule/index';
    ...
    {
        $this->_sitePageData->url = '/make/shoppaymentschedule/new';
    ...
    {
        $this->_sitePageData->url = '/make/shoppaymentschedule/edit';
    ...
    {
        $this->_sitePageData->url = '/make/shoppaymentschedule/save';
