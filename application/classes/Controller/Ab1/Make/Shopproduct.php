...
class Controller_Ab1_Make_ShopProduct extends Controller_Ab1_Make_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/make/shopproduct/index';
    ...
    {
        $this->_sitePageData->url = '/make/shopproduct/new';
        $this->_actionShopProductNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/make/shopproduct/edit'
        ;$this->_actionShopProductEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/make/shopproduct/save';
    ...
    {
        $this->_sitePageData->url = '/make/shopproduct/statistics';
        $this->_actionShopProductStatistics();
    }

    public function action_pricelist_print() {
        $this->_sitePageData->url = '/make/shopproduct/pricelist_print';
        ...
        $this->_putInMain('/main/_shop/product/pricelist-print');
    }

    public function action_pricelist()
    {
        $this->_sitePageData->url = '/make/shopproduct/pricelist';
