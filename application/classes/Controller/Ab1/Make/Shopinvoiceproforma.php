...
class Controller_Ab1_Make_ShopInvoiceProforma extends Controller_Ab1_Make_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/make/shopinvoiceproforma/index';
    ...
    {
        $this->_sitePageData->url = '/make/shopinvoiceproforma/edit';
        $this->_actionShopInvoiceProformaEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/make/shopinvoiceproforma/save';
