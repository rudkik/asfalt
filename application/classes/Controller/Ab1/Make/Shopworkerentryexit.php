...
class Controller_Ab1_Make_ShopWorkerEntryExit extends Controller_Ab1_Make_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/make/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/make/shopworkerentryexit/history';
