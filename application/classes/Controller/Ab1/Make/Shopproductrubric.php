...
class Controller_Ab1_Make_ShopProductRubric extends Controller_Ab1_Make_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/make/shopproductrubric/index';
    ...
    {
        $this->_sitePageData->url = '/make/shopproductrubric/list';
    ...
    {
        $this->_sitePageData->url = '/make/shopproductrubric/statistics';
