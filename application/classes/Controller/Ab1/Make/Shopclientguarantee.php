...
class Controller_Ab1_Make_ShopClientGuarantee extends Controller_Ab1_Make_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/make/shopclientguarantee/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_index() {
        $this->_sitePageData->url = '/make/shopclientguarantee/index';
    ...
    {
        $this->_sitePageData->url = '/make/shopclientguarantee/edit';
