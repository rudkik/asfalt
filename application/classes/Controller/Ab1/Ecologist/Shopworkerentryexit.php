...
class Controller_Ab1_Ecologist_ShopWorkerEntryExit extends Controller_Ab1_Ecologist_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/ecologist/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/ecologist/shopworkerentryexit/history';
