...
class Controller_Ab1_Ecologist_ShopProductRubric extends Controller_Ab1_Ecologist_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/ecologist/shopproductrubric/statistics';
