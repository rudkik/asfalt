...
class Controller_Ab1_Ecologist_ShopClient extends Controller_Ab1_Ecologist_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/ecologist/shopclient/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/ecologist/shopclient/edit';
        $this->_actionShopClientEdit();
    }

        public function action_statistics()
    {
        $this->_sitePageData->url = '/ecologist/shopclient/statistics';
        $this->_actionShopClientStatistics(false);
    }

    public function action_charity_statistics()
    {
        $this->_sitePageData->url = '/ecologist/shopclient/charity_statistics';
