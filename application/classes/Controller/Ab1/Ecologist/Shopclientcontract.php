...
class Controller_Ab1_Ecologist_ShopClientContract extends Controller_Ab1_Ecologist_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/ecologist/shopclientcontract/json';
        $this->_getJSONList(
    ...
    public function action_index() {
        $this->_sitePageData->url = '/ecologist/shopclientcontract/index';
        ...
        $params = array(
            ...
            'client_contract_type_id.interface_ids_in' => [Model_Ab1_Shop_Operation::RUBRIC_ECOLOGIST],
        );
    ...
    public function action_child() {
        $this->_sitePageData->url = '/ecologist/shopclientcontract/child';
    ...
    {
        $this->_sitePageData->url = '/ecologist/shopclientcontract/edit';
        $this->_actionShopClientContractEdit();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/ecologist/shopclientcontract/new';
        $this->_actionShopClientContractNew();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/ecologist/shopclientcontract/save';
    ...
    {
        $this->_sitePageData->url = '/ecologist/shopclientcontract/del';
    ...
    {
        $this->_sitePageData->url = '/ecologist/shopclientcontract/save_word';
