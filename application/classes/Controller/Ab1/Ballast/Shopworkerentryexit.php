...
class Controller_Ab1_Ballast_ShopWorkerEntryExit extends Controller_Ab1_Ballast_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/ballast/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/ballast/shopworkerentryexit/history';
