...
class Controller_Ab1_Bookkeeping_ShopPiece extends Controller_Ab1_Bookkeeping_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shoppiece/index';
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shoppiece/edit';
        $this->_actionShopPieceEdit();
    }

    public function action_del()
    {
        $this->_sitePageData->url = '/bookkeeping/shoppiece/del';
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shoppiece/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if (Request_RequestParams::getParamBoolean('is_close') === FALSE) {
                $this->redirect('/bookkeeping/shoppiece/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/bookkeeping/shoppiece/index'
                    . URL::query(
                        array(
