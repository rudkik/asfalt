...
class Controller_Ab1_Bookkeeping_ShopWorkerEntryExit extends Controller_Ab1_Bookkeeping_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/bookkeeping/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/bookkeeping/shopworkerentryexit/history';
