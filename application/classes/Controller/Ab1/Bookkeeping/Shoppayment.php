...
class Controller_Ab1_Bookkeeping_ShopPayment extends Controller_Ab1_Bookkeeping_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shoppayment/index';
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shoppayment/list';
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shoppayment/new';
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shoppayment/edit';
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shoppayment/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if (Request_RequestParams::getParamBoolean('is_close') === FALSE) {
                $this->redirect('/bookkeeping/shoppayment/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/bookkeeping/shoppayment/index'
                    . URL::query(
                        array(
