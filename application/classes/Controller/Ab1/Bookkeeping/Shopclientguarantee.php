...
class Controller_Ab1_Bookkeeping_ShopClientGuarantee extends Controller_Ab1_Bookkeeping_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/bookkeeping/shopclientguarantee/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_index() {
        $this->_sitePageData->url = '/bookkeeping/shopclientguarantee/index';
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shopclientguarantee/edit';
        $this->_actionShopClientGuaranteeEdit();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/bookkeeping/shopclientguarantee/new';
        $this->_actionShopClientGuaranteeNew();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/bookkeeping/shopclientguarantee/save';
    ...
    {
        $this->_sitePageData->url = '/bookkeeping/shopclientguarantee/del';
