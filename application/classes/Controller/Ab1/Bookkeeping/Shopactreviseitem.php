...
class Controller_Ab1_Bookkeeping_ShopActReviseItem extends Controller_Ab1_Bookkeeping_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/bookkeeping/shopactreviseitem/index';
    ...
    public function action_client() {
        $this->_sitePageData->url = '/bookkeeping/shopactreviseitem/client';
        $this->_actionShopActReviseItemClient();
    }

    public function action_virtual() {
        $this->_sitePageData->url = '/bookkeeping/shopactreviseitem/virtual';
