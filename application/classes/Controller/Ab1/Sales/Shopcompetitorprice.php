...
class Controller_Ab1_Sales_ShopCompetitorPrice extends Controller_Ab1_Sales_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/sales/shopcompetitorprice/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shopcompetitorprice/new';
    ...
    {
        $this->_sitePageData->url = '/sales/shopcompetitorprice/edit';
    ...
    {
        $this->_sitePageData->url = '/sales/shopcompetitorprice/save';
