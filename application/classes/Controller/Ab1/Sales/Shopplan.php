...
class Controller_Ab1_Sales_ShopPlan extends Controller_Ab1_Sales_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/sales/shopplan/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shopplan/new';
    ...
    {
        $this->_sitePageData->url = '/sales/shopplan/edit';
    ...
    {
        $this->_sitePageData->url = '/sales/shopplan/save';
    ...
    {
        $this->_sitePageData->url = '/sales/shopplan/del';
