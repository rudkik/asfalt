...
class Controller_Ab1_Sales_ShopDeliveryGroup extends Controller_Ab1_Sales_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverygroup/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverygroup/list';
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverygroup/new';
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverygroup/edit';
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverygroup/save';
