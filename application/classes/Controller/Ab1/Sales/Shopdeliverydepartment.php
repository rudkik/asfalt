...
class Controller_Ab1_Sales_ShopDeliveryDepartment extends Controller_Ab1_Sales_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverydepartment/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverydepartment/list';
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverydepartment/new';
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverydepartment/edit';
    ...
    {
        $this->_sitePageData->url = '/sales/shopdeliverydepartment/save';
