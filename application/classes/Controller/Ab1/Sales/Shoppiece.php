...
class Controller_Ab1_Sales_ShopPiece extends Controller_Ab1_Sales_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/sales/shoppiece/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shoppiece/edit';
        $this->_actionShopPieceEdit();
    }

    public function action_del()
    {
        $this->_sitePageData->url = '/sales/shoppiece/del';
    ...
    {
        $this->_sitePageData->url = '/sales/shoppiece/save';
