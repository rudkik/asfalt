...
class Controller_Ab1_Sales_ShopPricelist extends Controller_Ab1_Sales_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sales/shoppricelist/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shoppricelist/new';
        $this->_actionShopPricelistNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/sales/shoppricelist/edit';
        $this->_actionShopPricelistEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sales/shoppricelist/save';
    ...
    {
        $this->_sitePageData->url = '/sales/shoppricelist/calc_balance';
        ...
        $this->redirect('/sales/shoppricelist/index?id='.$id);
    }
}
