...
class Controller_Ab1_Sales_ShopWorkerEntryExit extends Controller_Ab1_Sales_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sales/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/sales/shopworkerentryexit/history';
