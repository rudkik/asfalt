...
class Controller_Ab1_Sales_ShopProductGroup extends Controller_Ab1_Sales_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/sales/shopproductgroup/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shopproductgroup/list';
    ...
    {
        $this->_sitePageData->url = '/sales/shopproductgroup/new';
    ...
    {
        $this->_sitePageData->url = '/sales/shopproductgroup/edit';
    ...
    {
        $this->_sitePageData->url = '/sales/shopproductgroup/save';
