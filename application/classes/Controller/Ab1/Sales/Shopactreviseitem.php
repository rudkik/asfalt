...
class Controller_Ab1_Sales_ShopActReviseItem extends Controller_Ab1_Sales_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sales/shopactreviseitem/index';
    ...
    public function action_client() {
        $this->_sitePageData->url = '/sales/shopactreviseitem/client';
        $this->_actionShopActReviseItemClient();
    }

    public function action_virtual() {
        $this->_sitePageData->url = '/sales/shopactreviseitem/virtual';
