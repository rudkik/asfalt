...
class Controller_Ab1_Sales_ShopCompetitor extends Controller_Ab1_Sales_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sales/shopcompetitor/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shopcompetitor/new';
    ...
    {
        $this->_sitePageData->url = '/sales/shopcompetitor/edit';
    ...
    {
        $this->_sitePageData->url = '/sales/shopcompetitor/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/sales/shopcompetitor/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/sales/shopcompetitor/index'
                    . URL::query(
                        array(
    ...
    {
        $this->_sitePageData->url = '/sales/shopcompetitor/del';
