...
class Controller_Ab1_Sales_ShopSupplierPrice extends Controller_Ab1_Sales_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/sales/shopsupplierprice/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shopsupplierprice/new';
    ...
    {
        $this->_sitePageData->url = '/sales/shopsupplierprice/new_list';
    ...
    {
        $this->_sitePageData->url = '/sales/shopsupplierprice/edit';
    ...
    {
        $this->_sitePageData->url = '/sales/shopsupplierprice/edit_list';
    ...
    {
        $this->_sitePageData->url = '/sales/shopsupplierprice/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if (Request_RequestParams::getParamBoolean('is_close') === FALSE) {
                $this->redirect('/sales/shopsupplierprice/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/sales/shopsupplierprice/index'
                    . URL::query(
                        array(
    ...
    {
        $this->_sitePageData->url = '/sales/shopsupplierprice/save_list';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if ((Request_RequestParams::getParamBoolean('is_close') === FALSE) && ($result['id'] > 0)) {
                $this->redirect('/sales/shopsupplierprice/edit_list'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
