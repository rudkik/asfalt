...
class Controller_Ab1_Sales_ShopDefectCar extends Controller_Ab1_Sales_BasicAb1 {
    ...
    public function action_history() {
        $this->_sitePageData->url = '/sales/shopdefectcar/history';
        $this->_actionDefectCarHistory();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/sales/shopdefectcar/edit';
        $this->_actionDefectCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sales/shopdefectcar/save';
