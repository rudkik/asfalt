...
class Controller_Ab1_Sales_ShopClientGuarantee extends Controller_Ab1_Sales_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/sales/shopclientguarantee/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_index() {
        $this->_sitePageData->url = '/sales/shopclientguarantee/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shopclientguarantee/edit';
        $this->_actionShopClientGuaranteeEdit();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/sales/shopclientguarantee/new';
        $this->_actionShopClientGuaranteeNew();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sales/shopclientguarantee/save';
    ...
    {
        $this->_sitePageData->url = '/sales/shopclientguarantee/del';
