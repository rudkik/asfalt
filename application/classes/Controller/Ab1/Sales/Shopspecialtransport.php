...
class Controller_Ab1_Sales_ShopSpecialTransport extends Controller_Ab1_Sales_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sales/shopspecialtransport/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shopspecialtransport/new';
    ...
    {
        $this->_sitePageData->url = '/sales/shopspecialtransport/edit';
    ...
    {
        $this->_sitePageData->url = '/sales/shopspecialtransport/save';
