...
class Controller_Ab1_Sales_ShopPayment extends Controller_Ab1_Sales_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/sales/shoppayment/index';
    ...
    {
        $this->_sitePageData->url = '/sales/shoppayment/list';
    ...
    {
        $this->_sitePageData->url = '/sales/shoppayment/edit';
        $this->_actionShopPaymentEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sales/shoppayment/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if (Request_RequestParams::getParamBoolean('is_close') === FALSE) {
                $this->redirect('/sales/shoppayment/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/sales/shoppayment/index'
                    . URL::query(
                        array(
