...
class Controller_Ab1_Sales_ShopActService extends Controller_Ab1_Sales_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sales/shopactservice/index';
    ...
    public function action_add() {
        $this->_sitePageData->url = '/sales/shopactservice/add';
    ...
    {
        $this->_sitePageData->url = '/sales/shopactservice/edit';
    ...
    {
        $this->_sitePageData->url = '/sales/shopactservice/rebuild';
    ...
    {
        $this->_sitePageData->url = '/sales/shopactservice/save';
    ...
    public function action_virtual_index() {
        $this->_sitePageData->url = '/sales/shopactservice/virtual_index';
    ...
    public function action_virtual_show() {
        $this->_sitePageData->url = '/sales/shopactservice/virtual_show';
    ...
    public function action_virtual_edit() {
        $this->_sitePageData->url = '/sales/shopactservice/virtual_edit';
    ...
    public function action_virtual_break() {
        $this->_sitePageData->url = '/sales/shopactservice/virtual_break';
        ...
        self::redirect(
            '/sales/shopactservice/virtual_index'
            .URL::query(
                array(
                    'date_from' => $dateFrom,
                    'date_to' => $dateTo,
    ...
    {
        $this->_sitePageData->url = '/sales/shopactservice/del';
