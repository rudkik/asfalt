...
class Controller_Ab1_Atc_ShopWorkerEntryExit extends Controller_Ab1_Atc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/аtc/Shopworkerentryexit.php';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/аtc/shopworkerentryexit/history';
