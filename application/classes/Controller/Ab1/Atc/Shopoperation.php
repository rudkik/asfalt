...
class Controller_Ab1_Atc_ShopOperation extends Controller_Ab1_Atc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/atc/shopoperation/index';
        ...
        View_View::find(
            ...
            array('limit' => 1000,'limit_page' => 25, 'shop_table_rubric_id' => Model_Ab1_Shop_Operation::RUBRIC_ATC),
            ['shop_worker_id' => ['name']]
        );
    ...
    {
        $this->_sitePageData->url = '/atc/shopoperation/new';
        $this->_actionShopOperationNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/atc/shopoperation/edit';
        $this->_actionShopOperationEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/atc/shopoperation/save';
