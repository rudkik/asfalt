...
class Controller_Ab1_Nbu_ShopOperation extends Controller_Ab1_Nbu_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nbu/shopoperation/index';
        ...
        View_View::find(
            ...
            array('limit' => 1000, 'limit_page' => 25, 'shop_table_rubric_id' => Model_Ab1_Shop_Operation::RUBRIC_NBU),
            ['shop_worker_id' => ['name']]
        );
    ...
    {
        $this->_sitePageData->url = '/nbu/shopoperation/new';
        $this->_actionShopOperationNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/nbu/shopoperation/edit';
        $this->_actionShopOperationEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/nbu/shopoperation/save';
