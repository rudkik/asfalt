...
class Controller_Ab1_Owner_ShopBoxcar extends Controller_Ab1_Owner_BasicAb1{
    ...
    {
        $this->_sitePageData->url = '/owner/shopboxcar/index';
    ...
    {
        $this->_sitePageData->url = '/owner/shopboxcar/edit';
        $this->_actionShopBoxcarEdit();
    }

    public function action_statistics()
    {
        $this->_sitePageData->url = '/owner/shopboxcar/statistics';
