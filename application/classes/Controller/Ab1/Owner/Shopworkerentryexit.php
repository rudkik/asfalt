...
class Controller_Ab1_Owner_ShopWorkerEntryExit extends Controller_Ab1_Owner_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/owner/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/owner/shopworkerentryexit/history';
