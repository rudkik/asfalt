...
class Controller_Ab1_Pto_ShopCarToMaterial extends Controller_Ab1_Pto_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/pto/shopcartomaterial/index';
        ...
        if($this->_sitePageData->operation->getIsAdmin()) {
            $this->_requestShopOperations(Model_Ab1_Shop_Operation::RUBRIC_PTO);
        }
    ...
    {
        $this->_sitePageData->url = '/pto/shopcartomaterial/edit';
        $this->_actionShopCarToMaterialEdit();
    }

    public function action_get_images()
    {
        $this->_sitePageData->url = '/pto/shopcartomaterial/get_images';
    ...
    {
        $this->_sitePageData->url = '/pto/shopcartomaterial/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/pto/shopcartomaterial/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/pto/shopcartomaterial/index'
                    . URL::query(
                        array(
    ...
    {
        $this->_sitePageData->url = '/pto/shopcartomaterial/send_tare';
        ...
        if (!$isError) {
            ...
            if ($model->validationFields($result)) {
                ...
                $data = Controller_Ab1_Pto_Data::getDataFiles();
                $files = array(
                    0 => array(
    ...
    {
        $this->_sitePageData->url = '/pto/shopcartomaterial/statistics';
        $this->_actionShopCarToMaterialStatistics();
    }

    public function action_statistics_daughter()
    {
        $this->_sitePageData->url = '/pto/shopcartomaterial/statistics_daughter';
        $this->_actionShopCarToMaterialDaughterStatistics();
    }

    public function action_statistics_daughter_material()
    {
        $this->_sitePageData->url = '/pto/shopcartomaterial/statistics_daughter_material';
