...
class Controller_Ab1_Pto_ShopPayment extends Controller_Ab1_Pto_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/pto/shoppayment/index';
    ...
    {
        $this->_sitePageData->url = '/pto/shoppayment/list';
    ...
    {
        $this->_sitePageData->url = '/pto/shoppayment/edit';
        $this->_actionShopPaymentEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/pto/shoppayment/save';
