...
class Controller_Ab1_Pto_ShopDefectCar extends Controller_Ab1_Pto_BasicAb1 {
    ...
    public function action_history() {
        $this->_sitePageData->url = '/pto/shopdefectcar/history';
        $this->_actionDefectCarHistory();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/pto/shopdefectcar/edit';
        $this->_actionDefectCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/pto/shopdefectcar/save';
