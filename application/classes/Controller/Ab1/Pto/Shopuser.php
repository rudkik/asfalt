...
class Controller_Ab1_Pto_Shopuser extends Controller_Ab1_Pto_BasicAb1 {
    public function before() {
        $this->_sitePageData->shopShablonPath = 'ab1/pto';
        $this->_readLanguageInterface();
    }

    public function action_auth() {
        $this->_sitePageData->url = '/pto/shopuser/auth';
    ...
    public function action_login() {
        $this->_sitePageData->url = '/pto/shopuser/login';
        ...
        if (!$auth->login($email, $password)) {
            $this->redirect('/pto/shopuser/auth?is_main='.Request_RequestParams::getParamBoolean('is_main').'&s=1');
        } else {
            if($auth->model->getShopTableRubricID() == 0){
                $this->redirect('/pto/admin/index');
            }else {
                $this->redirect('/pto/shopcar/history');
            }
        }
    }
    ...
    public function action_unlogin() {
        ...
        $this->redirect($this->_sitePageData->urlBasic . "/pto");
    }
}
