...
class Controller_Ab1_Pto_ShopMaterial extends Controller_Ab1_Pto_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/pto/shopmaterial/index';
    ...
    {
        $this->_sitePageData->url = '/pto/shopmaterial/new';
        $this->_actionShopMaterialNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/pto/shopmaterial/edit';
        $this->_actionShopMaterialEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/pto/shopmaterial/save';
