...
class Controller_Ab1_Pto_ShopWorkerEntryExit extends Controller_Ab1_Pto_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/pto/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/pto/shopworkerentryexit/history';
