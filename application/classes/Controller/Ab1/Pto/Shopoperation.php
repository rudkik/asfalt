...
class Controller_Ab1_Pto_ShopOperation extends Controller_Ab1_Pto_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/pto/shopoperation/index';
        ...
        View_View::find(
            ...
            array('limit' => 1000, 'limit_page' => 25, 'shop_table_rubric_id' => Model_Ab1_Shop_Operation::RUBRIC_PTO),
            ['shop_worker_id' => ['name']]
        );
    ...
    {
        $this->_sitePageData->url = '/pto/shopoperation/new';
        $this->_actionShopOperationNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/pto/shopoperation/edit';
        $this->_actionShopOperationEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/pto/shopoperation/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/pto/shopoperation/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/pto/shopoperation/index'
                    . URL::query(
                        array(
