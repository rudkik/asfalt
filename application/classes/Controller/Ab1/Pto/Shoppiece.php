...
class Controller_Ab1_Pto_ShopPiece extends Controller_Ab1_Pto_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/pto/shoppiece/hystory';
    ...
    {
        $this->_sitePageData->url = '/pto/shoppiece/edit';
