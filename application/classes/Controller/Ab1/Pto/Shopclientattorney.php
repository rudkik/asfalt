...
class Controller_Ab1_Pto_ShopClientAttorney extends Controller_Ab1_Pto_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/pto/shopclientattorney/json';
    ...
    public function action_index() {
        $this->_sitePageData->url = '/pto/shopclientattorney/index';
