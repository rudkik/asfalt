...
class Controller_Ab1_Pto_ShopMoveCar extends Controller_Ab1_Pto_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/pto/shopmovecar/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/pto/shopmovecar/history';
    ...
    {
        $this->_sitePageData->url = '/pto/shopmovecar/edit';
        $this->_actionMoveCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/pto/shopmovecar/save';
    ...
    {
        $this->_sitePageData->url = '/pto/shopmovecar/statistics';
