...
class Controller_Ab1_Pto_ShopActReviseItem extends Controller_Ab1_Pto_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/pto/shopactreviseitem/index';
    ...
    public function action_client() {
        $this->_sitePageData->url = '/pto/shopactreviseitem/client';
        $this->_actionShopActReviseItemClient();
    }

    public function action_virtual() {
        $this->_sitePageData->url = '/pto/shopactreviseitem/virtual';
