...
class Controller_Ab1_Pto_ShopMaterialOther extends Controller_Ab1_Pto_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/pto/shopmaterialother/index';
    ...
    {
        $this->_sitePageData->url = '/pto/shopmaterialother/new';
    ...
    {
        $this->_sitePageData->url = '/pto/shopmaterialother/edit';
    ...
    {
        $this->_sitePageData->url = '/pto/shopmaterialother/save';
