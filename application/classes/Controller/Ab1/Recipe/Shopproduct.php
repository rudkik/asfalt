...
class Controller_Ab1_Recipe_ShopProduct extends Controller_Ab1_Recipe_BasicAb1 {
    ...
    {
        $this->_sitePageData->url = '/recipe/shopproduct/recipe';
    ...
    {
        $this->_sitePageData->url = '/recipe/shopproduct/recipes';
    ...
    {
        $this->_sitePageData->url = '/recipe/shopproduct/product_recipe';
        $this->_actionShopProductRecipe();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/recipe/shopproduct/save';

        $result = Api_Ab1_Shop_Product::save($this->_sitePageData, $this->_driverDB);
        $this->_redirectSaveResult($result, '/recipe/shopproduct/product_recipe');
    }
}
