...
class Controller_Ab1_Recipe_ShopWorkerEntryExit extends Controller_Ab1_Recipe_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/recipe/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/recipe/shopworkerentryexit/history';
