...
class Controller_Ab1_Crusher_ShopOperation extends Controller_Ab1_Crusher_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/crusher/shopoperation/index';
        ...
        View_View::find(
            ...
            array('limit' => 1000, 'limit_page' => 25, 'shop_table_rubric_id' => Model_Ab1_Shop_Operation::RUBRIC_CRUSHER),
            ['shop_worker_id' => ['name']]
        );
    ...
    {
        $this->_sitePageData->url = '/crusher/shopoperation/new';
    ...
    {
        $this->_sitePageData->url = '/crusher/shopoperation/edit';
        ...
        $this->_requestShopRaws(Arr::path($model->getAccessArray(), 'shop_raw_ids', NULL));
    ...
    {
        $this->_sitePageData->url = '/crusher/shopoperation/save';
