...
class Controller_Ab1_Crusher_ShopWorkerEntryExit extends Controller_Ab1_Crusher_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/crusher/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/crusher/shopworkerentryexit/history';
