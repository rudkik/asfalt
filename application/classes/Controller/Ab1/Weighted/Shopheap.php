...
class Controller_Ab1_Weighted_ShopHeap extends Controller_Ab1_Weighted_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/weighted/shopheap/index';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopheap/new';
        $this->_actionShopHeapNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/weighted/shopheap/edit';
        $this->_actionShopHeapEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/weighted/shopheap/save';
