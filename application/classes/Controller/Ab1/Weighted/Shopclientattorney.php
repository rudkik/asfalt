...
class Controller_Ab1_Weighted_ShopClientAttorney extends Controller_Ab1_Weighted_BasicAb1{
    ...
    public function action_json() {
        $this->_sitePageData->url = '/weighted/shopclientattorney/json';
    ...
    public function action_index() {
        $this->_sitePageData->url = '/weighted/shopclientattorney/index';
        ...
        // получаем список
        View_View::find('DB_Ab1_Shop_Client_Attorney', $this->_sitePageData->shopID, "_shop/client/attorney/list/index", "_shop/client/one/index",
