...
class Controller_Ab1_Weighted_ShopClientContract extends Controller_Ab1_Weighted_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/weighted/shopclientcontract/json';
        $this->_getJSONList(
    ...
    public function action_index() {
        $this->_sitePageData->url = '/weighted/shopclientcontract/index';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopclientcontract/edit';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopclientcontract/new';
        ...
        $this->_sitePageData->replaceDatas['view::_shop/client/contract/one/new'] = Helpers_View::getViewObject($dataID, new Model_Ab1_Shop_Client_Contract(),
            '_shop/client/contract/one/new', $this->_sitePageData, $this->_driverDB);

        $dataID = new MyArray();
        $this->_sitePageData->replaceDatas['view::_shop/client/contract/item/list/item'] = Helpers_View::getViewObjects($dataID,
            new Model_Ab1_Shop_Client_Contract_Item(), '_shop/client/contract/item/list/item',
            '_shop/client/contract/item/one/item', $this->_sitePageData, $this->_driverDB);
    ...
    {
        $this->_sitePageData->url = '/weighted/shopclientcontract/save';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopclientcontract/del';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopclientcontract/save_word';
