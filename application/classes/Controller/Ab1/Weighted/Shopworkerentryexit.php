...
class Controller_Ab1_Weighted_ShopWorkerEntryExit extends Controller_Ab1_Weighted_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/weighted/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/weighted/shopworkerentryexit/history';
