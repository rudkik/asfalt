...
class Controller_Ab1_Weighted_ShopProductStorage extends Controller_Ab1_Weighted_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/weighted/shopproductstorage/index';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopproductstorage/new';
        $this->_actionShopProductStorageNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/weighted/shopproductstorage/edit';
        $this->_actionShopProductStorageEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/weighted/shopproductstorage/save';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopproductstorage/del';
