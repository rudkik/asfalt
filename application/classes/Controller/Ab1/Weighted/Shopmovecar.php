...
class Controller_Ab1_Weighted_ShopMoveCar extends Controller_Ab1_Weighted_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/weighted/shopmovecar/index';
    ...
    public function action_entry() {
        $this->_sitePageData->url = '/weighted/shopmovecar/entry';
    ...
    public function action_exit() {
        $this->_sitePageData->url = '/weighted/shopmovecar/exit';
    ...
    public function action_exit_empty() {
        $this->_sitePageData->url = '/weighted/shopmovecar/exit_empty';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopmovecar/edit';
        ...
        $result = View_View::findOne(
            'DB_Ab1_Shop_Move_Car', $this->_sitePageData->shopID, "_shop/move/car/one/edit",
    ...
    {
        $this->_sitePageData->url = '/weighted/shopmovecar/get_images';
        ...
        // получаем данные
        $result = View_View::findOne('DB_Ab1_Shop_Car', $this->_sitePageData->shopID, "_shop/move/car/one/images",
            $this->_sitePageData, $this->_driverDB, array('id' => $shopCarID));
    ...
    {
        $this->_sitePageData->url = '/weighted/shopmovecar/get';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopmovecar/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if (!empty($url)){
                ...
                $this->redirect('/weighted/shopmovecar/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
    ...
    {
        $this->_sitePageData->url = '/weighted/shopmovecar/send_tarra';
    ...
    {
        $this->_sitePageData->url = '/weighted/shopmovecar/send_brutto';
        ...
        if (! $isError) {
            ...
            Api_Ab1_Shop_Register_Material::saveShopMoveCar($model, $this->_sitePageData, $this->_driverDB);
