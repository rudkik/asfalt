...
class Controller_Ab1_Nbc_ShopRawStorageMetering extends Controller_Ab1_Nbc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nbc/shoprawstoragemetering/index';
    ...
    {
        $this->_sitePageData->url = '/nbc/shoprawstoragemetering/new';
    ...
    {
        $this->_sitePageData->url = '/nbc/shoprawstoragemetering/edit';
        // задаем данные, которые будут меняться
        $this->_setGlobalDatas(
            array(
    ...
    {
        $this->_sitePageData->url = '/nbc/shoprawstoragemetering/save';
