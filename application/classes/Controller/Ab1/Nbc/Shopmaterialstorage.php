...
class Controller_Ab1_Nbc_ShopMaterialStorage extends Controller_Ab1_Nbc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nbc/shopmaterialstorage/index';
    ...
    public function action_total() {
        $this->_sitePageData->url = '/nbc/shopmaterialstorage/total';
    ...
    {
        $this->_sitePageData->url = '/nbc/shopmaterialstorage/new';
        $this->_actionShopMaterialStorageNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/nbc/shopmaterialstorage/edit';
        $this->_actionShopMaterialStorageEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/nbc/shopmaterialstorage/save';
