...
class Controller_Ab1_Nbc_ShopWorkerEntryExit extends Controller_Ab1_Nbc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nbc/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/nbc/shopworkerentryexit/history';
