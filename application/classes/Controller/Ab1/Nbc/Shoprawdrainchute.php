...
class Controller_Ab1_Nbc_ShopRawDrainChute extends Controller_Ab1_Nbc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nbc/shoprawdrainchute/index';
    ...
    {
        $this->_sitePageData->url = '/nbc/shoprawdrainchute/new';
        $this->_actionShopRawDrainChuteNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/nbc/shoprawdrainchute/edit';
        $this->_actionShopRawDrainChuteEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/nbc/shoprawdrainchute/save';
