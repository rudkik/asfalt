...
class Controller_Ab1_Nbc_ShopRawStorage extends Controller_Ab1_Nbc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nbc/shoprawstorage/index';
    ...
    public function action_total() {
        $this->_sitePageData->url = '/nbc/shoprawstorage/total';
    ...
    {
        $this->_sitePageData->url = '/nbc/shoprawstorage/new';
        $this->_actionShopRawStorageNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/nbc/shoprawstorage/edit';
        $this->_actionShopRawStorageEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/nbc/shoprawstorage/save';
