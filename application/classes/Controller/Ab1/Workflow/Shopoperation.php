...
class Controller_Ab1_Workflow_ShopOperation extends Controller_Ab1_Workflow_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/workflow/shopoperation/index';
    ...
    {
        $this->_sitePageData->url = '/workflow/shopoperation/new';
        $this->_actionShopOperationNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/workflow/shopoperation/edit';
        $this->_actionShopOperationEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/workflow/shopoperation/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/workflow/shopoperation/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/workflow/shopoperation/index'
                    . URL::query(
                        array(
