...
class Controller_Ab1_Control_ShopRawStorageDrain extends Controller_Ab1_Control_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/control/shoprawstoragedrain/index';
    ...
    {
        $this->_sitePageData->url = '/control/shoprawstoragedrain/add';
    ...
    {
        $this->_sitePageData->url = '/control/shoprawstoragedrain/new';
    ...
    {
        $this->_sitePageData->url = '/control/shoprawstoragedrain/edit';
        // задаем данные, которые будут меняться
        $this->_setGlobalDatas(
            array(
    ...
    {
        $this->_sitePageData->url = '/control/shoprawstoragedrain/save';
