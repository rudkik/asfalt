...
class Controller_Ab1_Control_ShopWorkerEntryExit extends Controller_Ab1_Control_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/control/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/control/shopworkerentryexit/history';
