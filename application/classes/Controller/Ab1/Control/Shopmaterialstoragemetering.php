...
class Controller_Ab1_Control_ShopMaterialStorageMetering extends Controller_Ab1_Control_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/control/shopmaterialstoragemetering/index';
    ...
    {
        $this->_sitePageData->url = '/control/shopmaterialstoragemetering/new';
    ...
    {
        $this->_sitePageData->url = '/control/shopmaterialstoragemetering/edit';
        // задаем данные, которые будут меняться
        $this->_setGlobalDatas(
            array(
    ...
    {
        $this->_sitePageData->url = '/control/shopmaterialstoragemetering/save';
