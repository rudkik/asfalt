...
class Controller_Ab1_Ogm_ShopWorkerEntryExit extends Controller_Ab1_Ogm_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/ogm/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/ogm/shopworkerentryexit/history';
