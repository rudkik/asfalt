...
class Controller_Ab1_Ogm_ShopClientContract extends Controller_Ab1_Ogm_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/ogm/shopclientcontract/json';
        $this->_getJSONList(
    ...
    public function action_index() {
        $this->_sitePageData->url = '/ogm/shopclientcontract/index';
        ...
        $params = array(
            ...
            'client_contract_type_id.interface_ids_in' => [Model_Ab1_Shop_Operation::RUBRIC_OGM],
        );
    ...
    public function action_child() {
        $this->_sitePageData->url = '/ogm/shopclientcontract/child';
    ...
    {
        $this->_sitePageData->url = '/ogm/shopclientcontract/edit';
        $this->_actionShopClientContractEdit();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/ogm/shopclientcontract/new';
        $this->_actionShopClientContractNew();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/ogm/shopclientcontract/save';
    ...
    {
        $this->_sitePageData->url = '/ogm/shopclientcontract/del';
    ...
    {
        $this->_sitePageData->url = '/ogm/shopclientcontract/save_word';
