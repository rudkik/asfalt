...
class Controller_Ab1_Ogm_ShopCarToMaterial extends Controller_Ab1_Ogm_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/ogm/shopcartomaterial/index';
        ...
        if($this->_sitePageData->operation->getIsAdmin()) {
            $this->_requestShopOperations(Model_Ab1_Shop_Operation::RUBRIC_DIRECTOR);
        }
    ...
    {
        $this->_sitePageData->url = '/ogm/shopcartomaterial/edit';
    ...
    {
        $this->_sitePageData->url = '/ogm/shopcartomaterial/get_images';
    ...
    {
        $this->_sitePageData->url = '/ogm/shopcartomaterial/save';
    ...
    {
        $this->_sitePageData->url = '/ogm/shopcartomaterial/statistics';
        $this->_actionShopCarToMaterialStatistics();
    }

    public function action_statistics_daughter()
    {
        $this->_sitePageData->url = '/ogm/shopcartomaterial/statistics_daughter';
        $this->_actionShopCarToMaterialDaughterStatistics();
    }

    public function action_statistics_daughter_material()
    {
        $this->_sitePageData->url = '/ogm/shopcartomaterial/statistics_daughter_material';
