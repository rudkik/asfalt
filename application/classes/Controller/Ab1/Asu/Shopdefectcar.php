...
class Controller_Ab1_Asu_ShopDefectCar extends Controller_Ab1_Asu_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/asu/shopdefectcar/index';
    ...
    public function action_shipment() {
        $this->_sitePageData->url = '/asu/shopdefectcar/shipment';
    ...
    public function action_shipment_json() {
        $this->_sitePageData->url = '/asu/shopdefectcar/shipment_json';
    ...
    {
        $this->_sitePageData->url = '/asu/shopdefectcar/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/asu/shopdefectcar/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/asu/shopdefectcar/index'
                    . URL::query(
                        array(
