...
class Controller_Ab1_Asu_ShopWorkerEntryExit extends Controller_Ab1_Asu_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/аsu/Shopworkerentryexit.php';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/аsu/shopworkerentryexit/history';
