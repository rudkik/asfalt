...
class Controller_Ab1_Bid_ShopPlanTransport extends Controller_Ab1_Bid_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/bid/shopplantransport/index';
    ...
    {
        $this->_sitePageData->url = '/bid/shopplantransport/new';
    ...
    {
        $this->_sitePageData->url = '/bid/shopplantransport/edit';
    ...
    {
        $this->_sitePageData->url = '/bid/shopplantransport/save';
    ...
    {
        $this->_sitePageData->url = '/bid/shopplantransport/del';
