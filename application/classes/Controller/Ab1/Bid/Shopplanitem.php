...
class Controller_Ab1_Bid_ShopPlanItem extends Controller_Ab1_Bid_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/bid/shopplanitem/table';
    ...
    {
        $this->_sitePageData->url = '/bid/shopplanitem/reason';
    ...
    {
        $this->_sitePageData->url = '/bid/shopplanitem/save';
    ...
    {
        $this->_sitePageData->url = '/bid/shopplanitem/calc_quantity_fact';
        ...
        self::redirect('/bid/shopplanitem/reason?date='.$date);
    }
}
