...
class Controller_Ab1_Bid_ShopBid extends Controller_Ab1_Bid_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/bid/shopbid/index';
    ...
    {
        $this->_sitePageData->url = '/bid/shopbid/new';
    ...
    {
        $this->_sitePageData->url = '/bid/shopbid/edit';
    ...
    {
        $this->_sitePageData->url = '/bid/shopbid/save';
    ...
    {
        $this->_sitePageData->url = '/bid/shopbid/del';
