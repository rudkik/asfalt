...
class Controller_Ab1_Device extends Controller_BasicControler {
    ...
    {
        $this->_sitePageData->url = '/device/command_z5rweb';
    ...
    public function action_z5rweb()
    {
        ...
        $result = Helpers_URL::getDataURLEmulationBrowser($this->_sitePageData->urlBasic . '/device/command_z5rweb' . URL::query(), 5, ['cmd' => $request]);
