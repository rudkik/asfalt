...
class Controller_Ab1_Cashbox_ShopWorkerEntryExit extends Controller_Ab1_Cashbox_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/cashbox/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/cashbox/shopworkerentryexit/history';
