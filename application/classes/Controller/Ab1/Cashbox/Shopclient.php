...
class Controller_Ab1_Cashbox_ShopClient extends Controller_Ab1_Cashbox_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/cashbox/shopclientattorney/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_index() {
        $this->_sitePageData->url = '/cashbox/shopclient/index';
    ...
    {
        $this->_sitePageData->url = '/cashbox/shopclient/new';
        $this->_actionShopClientNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/cashbox/shopclient/edit';
        $this->_actionShopClientEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/cashbox/shopclient/save';
    ...
    {
        $this->_sitePageData->url = '/cashbox/shopclient/del';
