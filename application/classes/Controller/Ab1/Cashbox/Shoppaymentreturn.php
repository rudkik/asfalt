...
class Controller_Ab1_Cashbox_ShopPaymentReturn extends Controller_Ab1_Cashbox_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/cashbox/shoppaymentreturn/index';
    ...
    {
        $this->_sitePageData->url = '/cashbox/shoppaymentreturn/list';
    ...
    {
        $this->_sitePageData->url = '/cashbox/shoppaymentreturn/new';
    ...
    {
        $this->_sitePageData->url = '/cashbox/shoppaymentreturn/edit';
    ...
    {
        $this->_sitePageData->url = '/cashbox/shoppaymentreturn/del';
    ...
    {
        $this->_sitePageData->url = '/cashbox/shoppaymentreturn/save';
