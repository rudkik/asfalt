...
class Controller_Ab1_Cashbox_PaymentType extends Controller_Ab1_Cashbox_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/cashbox/paymenttype/index';
    ...
    {
        $this->_sitePageData->url = '/cashbox/paymenttype/new';
    ...
    {
        $this->_sitePageData->url = '/cashbox/paymenttype/edit';
    ...
    {
        $this->_sitePageData->url = '/cashbox/paymenttype/save';
