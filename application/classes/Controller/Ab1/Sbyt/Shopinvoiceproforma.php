...
class Controller_Ab1_Sbyt_ShopInvoiceProforma extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sbyt/shopinvoiceproforma/index';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopinvoiceproforma/new';
        $this->_actionShopInvoiceProformaNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/sbyt/shopinvoiceproforma/edit';
        $this->_actionShopInvoiceProformaEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sbyt/shopinvoiceproforma/save';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopinvoiceproforma/del';
