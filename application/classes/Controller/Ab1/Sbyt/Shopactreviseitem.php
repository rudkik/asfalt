...
class Controller_Ab1_Sbyt_ShopActReviseItem extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sbyt/shopactreviseitem/index';
    ...
    public function action_client() {
        $this->_sitePageData->url = '/sbyt/shopactreviseitem/client';
        $this->_actionShopActReviseItemClient();
    }

    public function action_virtual() {
        $this->_sitePageData->url = '/sbyt/shopactreviseitem/virtual';
