...
class Controller_Ab1_Sbyt_ShopMoveCar extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sbyt/shopmovecar/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/sbyt/shopmovecar/history';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopmovecar/edit';
        $this->_actionMoveCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sbyt/shopmovecar/save';
