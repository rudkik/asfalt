...
class Controller_Ab1_Sbyt_ShopClientContract extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/sbyt/shopclientcontract/json';
        $this->_getJSONList(
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sbyt/shopclientcontract/index';
        ...
        if(Request_RequestParams::getParamBoolean('is_delete') !== false){
        ...
        View_View::find(
            ...
            array(
                ...
                'update_operation_id' => array('name'),
    ...
    public function action_child() {
        $this->_sitePageData->url = '/sbyt/shopclientcontract/child';
        ...
        $data = View_View::find(
            ...
            "_shop/client/contract/list/child", "_shop/client/contract/one/child",
            $this->_sitePageData, $this->_driverDB,
            array('is_public_ignore' => true),
            array(
                'shop_client_id' => array('name'),
                'update_operation_id' => array('name'),
                'create_user_id' => array('name'),
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientcontract/edit';
        $this->_actionShopClientContractEdit();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/sbyt/shopclientcontract/new';
        $this->_actionShopClientContractNew();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sbyt/shopclientcontract/save';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientcontract/del';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientcontract/save_word';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientcontract/save_pdf';
