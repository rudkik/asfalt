...
class Controller_Ab1_Sbyt_ShopPricelist extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sbyt/shoppricelist/index';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shoppricelist/new';
        $this->_actionShopPricelistNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/sbyt/shoppricelist/edit';
        $this->_actionShopPricelistEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sbyt/shoppricelist/save';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shoppricelist/calc_balance';
        ...
        $this->redirect('/sbyt/shoppricelist/index?id='.$id);
    }
}
