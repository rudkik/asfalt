...
class Controller_Ab1_Sbyt_ShopDeliveryGroup extends Controller_Ab1_Sbyt_BasicAb1
{
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopdeliverygroup/index';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopdeliverygroup/list';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopdeliverygroup/new';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopdeliverygroup/edit';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopdeliverygroup/save';
