...
class Controller_Ab1_Sbyt_ShopClientGuarantee extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/sbyt/shopclientguarantee/json';
        $this->_getJSONList($this->_sitePageData->shopMainID);
    }

    public function action_index() {
        $this->_sitePageData->url = '/sbyt/shopclientguarantee/index';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientguarantee/edit';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientguarantee/save';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientguarantee/del';
