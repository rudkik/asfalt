...
class Controller_Ab1_Sbyt_ShopWorkerEntryExit extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sbyt/shopworkerentryexit/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/sbyt/shopworkerentryexit/history';
