...
class Controller_Ab1_Sbyt_ShopDefectCar extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_history() {
        $this->_sitePageData->url = '/sbyt/shopdefectcar/history';
        $this->_actionDefectCarHistory();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/sbyt/shopdefectcar/edit';
        $this->_actionDefectCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sbyt/shopdefectcar/save';
