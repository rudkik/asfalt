...
class Controller_Ab1_Sbyt_ShopInvoice extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/index';
    ...
    public function action_add() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/add';
    ...
    public function action_calc_goods_price() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/calc_goods_price';
        ...
        self::redirect(
            '/sbyt/shopinvoice/virtual_show'
            . URL::query()
        );
    }

    public function action_calc_invoice_price() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/calc_invoice_price';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopinvoice/edit';
        $this->_actionShopInvoiceEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sbyt/shopinvoice/save';
    ...
    public function action_invoice_edit() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/invoice_edit';
        $this->_actionShopInvoiceModalEdit();
    }

    public function action_discount_delete() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/discount_delete';
        $this->_actionShopInvoiceDiscountDelete();
    }

    public function action_virtual_discount_delete() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/virtual_discount_delete';
    ...
    public function action_invoice_break() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/invoice_break';
    ...
    public function action_virtual_index() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/virtual_index';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopinvoice/virtual_show';
        ...
        $shopCarItemIDs = Request_Request::find('DB_Ab1_Shop_Car_Item',
            ...
            array(
                ...
                'shop_client_balance_day_id' => array('date'),
            )
        );
        ...
        $shopCarItemIDs->childsSortBy(array(Model_Basic_BasicObject::FIELD_ELEMENTS . '.shop_product_id.name', 'shop_car_id', 'shop_piece_id', 'quantity'));
    ...
    public function action_virtual_edit() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/virtual_edit';
    ...
    public function action_virtual_break() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/virtual_break';
        ...
        self::redirect(
            '/sbyt/shopinvoice/virtual_index'
            .URL::query(
                array(
                    'date_from' => $dateFrom,
                    'date_to' => $dateTo,
    ...
    public function action_client_invoice() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/client_invoice';
    ...
    public function action_set_current_price() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/set_current_price';
        ...
        if(Request_RequestParams::getParamBoolean('is_edit_invoice')){
            ...
            self::redirect('/sbyt/shopinvoice/edit' . URL::query(array('id' => $id, 'is_all' => true), false));
        }else {
            self::redirect('/sbyt/shopinvoice/virtual_show' . URL::query(array(), true));
        }
    }
    ...
    public function action_break_price_client_balance() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/break_price_client_balance';
    ...
    public function action_del_client_balance_days() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/del_client_balance_days';
    ...
    public function action_received_from_client() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/received_from_client';
        ...
        self::redirect('/sbyt/shopinvoice/index' . URL::query(array('id' => ''), true));
    }
    ...
    public function action_give_to_bookkeeping() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/give_to_bookkeeping';
    ...
    public function action_money_type() {
        $this->_sitePageData->url = '/sbyt/shopinvoice/money_type';

        $this->_actionShopInvoiceMoneyType();
    }
}
