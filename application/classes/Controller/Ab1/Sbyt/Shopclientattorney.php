...
class Controller_Ab1_Sbyt_ShopClientAttorney extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/sbyt/shopclientattorney/json';
    ...
    public function action_index() {
        $this->_sitePageData->url = '/sbyt/shopclientattorney/index';
    ...
    public function action_control() {
        $this->_sitePageData->url = '/sbyt/shopclientattorney/control';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientattorney/edit';
        $this->_actionShopClientAttorneyEdit();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/sbyt/shopclientattorney/new';
        $this->_actionShopClientAttorneyNew();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/sbyt/shopclientattorney/save';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientattorney/del';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopclientattorney/calc_balance';
        ...
        $this->redirect('/sbyt/shopclientattorney/index?id='.$shopClientAttorneyID);
    }
}
