...
class Controller_Ab1_Sbyt_ShopProduct extends Controller_Ab1_Sbyt_BasicAb1 {
    ...
    public function action_pricelist() {
        $this->_sitePageData->url = '/sbyt/shopproduct/pricelist';
    ...
    {
        $this->_sitePageData->url = '/sbyt/shopproduct/get_price';
