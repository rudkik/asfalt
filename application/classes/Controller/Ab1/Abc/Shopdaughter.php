...
class Controller_Ab1_Abc_ShopDaughter extends Controller_Ab1_Abc_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/abc/shopdaughter/index';
        ...
        // получаем список
        View_View::find('DB_Ab1_Shop_Daughter',
            $this->_sitePageData->shopMainID,
            "_shop/daughter/list/index", "_shop/daughter/one/index",
    ...
    {
        $this->_sitePageData->url = '/abc/shopdaughter/new';
        $this->_actionShopDaughterNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/abc/shopdaughter/edit';
        $this->_actionShopDaughterEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/abc/shopdaughter/save';
    ...
    public function action_json() {
        $this->_sitePageData->url = '/abc/shopdaughter/json';
