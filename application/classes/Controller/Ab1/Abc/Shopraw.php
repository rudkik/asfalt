...
class Controller_Ab1_Abc_ShopRaw extends Controller_Ab1_Abc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/abc/shopraw/index';
    ...
    {
        $this->_sitePageData->url = '/abc/shopraw/new';
        $this->_actionShopRawNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/abc/shopraw/edit';
        $this->_actionShopRawEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/abc/shopraw/save';
