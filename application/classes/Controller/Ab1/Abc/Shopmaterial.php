...
class Controller_Ab1_Abc_ShopMaterial extends Controller_Ab1_Abc_BasicAb1{
    ...
    public function action_index() {
        $this->_sitePageData->url = '/abc/shopmaterial/index';
    ...
    {
        $this->_sitePageData->url = '/abc/shopmaterial/recipe';
    ...
    {
        $this->_sitePageData->url = '/abc/shopmaterial/recipes';
        ...
        $params = Request_RequestParams::setParams(
            array(
                'limit_page' => 25,
                'id' => Arr::path($this->_sitePageData->operation->getAccessArray(), 'recipe_shop_material_ids', null),
            ),
            FALSE
        );
        View_View::find('DB_Ab1_Shop_Material',
    ...
    {
        $this->_sitePageData->url = '/abc/shopmaterial/material_recipe';
        $this->_actionShopMaterialRecipe();
    }

    public function action_new()
    {
        $this->_sitePageData->url = '/abc/shopmaterial/new';
        $this->_actionShopMaterialNew();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/abc/shopmaterial/edit';
        $this->_actionShopMaterialEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/abc/shopmaterial/save';
