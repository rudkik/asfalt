...
class Controller_Ab1_Abc_ShopWorkerEntryExit extends Controller_Ab1_Abc_BasicAb1 {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/abc/Shopworkerentryexit.php';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/abc/shopworkerentryexit/history';
