...
class Controller_Ab1_Abc_ShopDefectCar extends Controller_Ab1_Abc_BasicAb1 {
    ...
    public function action_history() {
        $this->_sitePageData->url = '/abc/shopdefectcar/history';
        $this->_actionDefectCarHistory();
    }

    public function action_edit()
    {
        $this->_sitePageData->url = '/abc/shopdefectcar/edit';
        $this->_actionDefectCarEdit();
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/abc/shopdefectcar/save';
