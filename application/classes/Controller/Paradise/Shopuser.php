...
class Controller_Paradise_Shopuser extends Controller_Paradise_BasicShop {
    ...
    public function action_index(){
        ...
        // получаем список
        View_View::find('DB_Shop_User', $this->_sitePageData->shopID,
    ...
    public function action_edit()
    {
        ...
        // получаем данные
        View_View::findOne('DB_Shop_User', $this->_sitePageData->shopID, "shopuser/edit",
    ...
    {
        $this->_sitePageData->url = '/cabinet/shopuser/del';

        // удаляем запись из базы данных
        $result = $this->_dbDeleteRecord(Request_RequestParams::getParamInt('id'),
            new Model_User());
    ...
    public function action_resetpassword() {
        ...
        if (mail(!$email, 'Reset password', 'OTO Paradise')) {
