...
class Controller_Nur_Admin_ShopTask extends Controller_Nur_Admin_BasicNur {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nur-admin/shoptask/index';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shoptask/new';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shoptask/edit';
        ...
        // получаем данные
        View_View::findOne('DB_Nur_Shop_Task', $this->_sitePageData->shopID, "_shop/task/one/edit",
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shoptask/save';
