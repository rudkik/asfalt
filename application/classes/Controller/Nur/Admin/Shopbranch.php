...
class Controller_Nur_Admin_ShopBranch extends Controller_Nur_Admin_BasicNur {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nur-admin/shopbranch/index';
    ...
    public function action_json() {
        $this->_sitePageData->url = '/nur-admin/shopbranch/json';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shopbranch/new';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shopbranch/edit';
        ...
        // получаем данные
        View_View::findOne('DB_Nur_Shop', $this->_sitePageData->shopID, "_shop/branch/one/edit",
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shopbranch/save';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shopbranch/save_requisites_pdf';
