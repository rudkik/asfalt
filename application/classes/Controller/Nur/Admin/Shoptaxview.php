...
class Controller_Nur_Admin_ShopTaxView extends Controller_Nur_Admin_BasicNur {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nur-admin/shoptaxview/index';
    ...
    public function action_json() {
        $this->_sitePageData->url = '/nur-admin/shoptaxview/json';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shoptaxview/new';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shoptaxview/edit';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shoptaxview/save';
