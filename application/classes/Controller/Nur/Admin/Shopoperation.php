...
class Controller_Nur_Admin_ShopOperation extends Controller_Nur_Admin_BasicNur {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nur-admin/shopoperation/index';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shopoperation/new';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shopoperation/edit';
    ...
    {
        $this->_sitePageData->url = '/nur-admin/shopoperation/save';
