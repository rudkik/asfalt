...
class Controller_Nur_Bookkeeping_ShopTaskCurrent extends Controller_Nur_Bookkeeping_BasicNur {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/index';
    ...
    public function action_json() {
        ...
        $this->_actionJSON(
            ...
            array(
                ...
                'shop_bookkeeper_id' => $this->_sitePageData->operationID,
            )
        );
    }

    public function action_run() {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/run';
        ...
        View_View::findBranch('DB_Nur_Shop_Task_Current',
            $this->_sitePageData->shopMainID,
    ...
    public function action_json_run() {
        $this->_sitePageData->url = '/nur-bookkeeping/shopbranch/json_run';
    ...
    {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/calendar';
    ...
    public function action_json_calendar() {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/json_calendar';
        ...
        $arr = Api_Nur_Shop_Task_Current::getCurrentTasks(
            $dateFrom, $dateTo, $this->_sitePageData, $this->_driverDB, $this->_sitePageData->operationID, TRUE
        );
        ...
        foreach ($arr as $child){
            ...
            if(!$child['status'] == 2){
                $values['url'] = '/nur-bookkeeping/shoptaskcurrent/add?id=' . $child['shop_task_id'] .'&shop_branch_id='.$child['shop_id'];
            }
    ...
    public function action_json_calendar_day() {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/json_calendar_day';
        ...
        $result = Api_Nur_Shop_Task_Current::getCurrentTasks(
            ...
            $this->_sitePageData->operationID, TRUE
        );
        ...
        foreach ($result as $child){
            ...
            if(key_exists($bookkeeper, $bookkeepers)){
                ...
                $bookkeepers[$bookkeeper] = array(
                    'shop_bookkeeper_id' => $child['shop_bookkeeper_id'],
    ...
    {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/new';
    ...
    public function action_json_new() {
        $this->_sitePageData->url = '/nur-bookkeeping/shopbranch/json_new';
        ...
        $result = Api_Nur_Shop_Task_Current::getCurrentTasks(
            $dateFrom, $dateTo, $this->_sitePageData, $this->_driverDB, $this->_sitePageData->operationID
        );
    ...
    {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/edit';
    ...
    {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/add';
        ...
        if($modelTask === NULL){
            $this->redirect('/nur-bookkeeping/shoptaskcurrent/index');
            exit();
        }
        ...
        $this->redirect('/nur-bookkeeping/shoptaskcurrent/run?id='.$model->id);
    }

    public function action_finish()
    {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/finish';
    ...
    {
        $this->_sitePageData->url = '/nur-bookkeeping/shoptaskcurrent/save';
