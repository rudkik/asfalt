...
class Controller_Nur_Bookkeeping_ShopCompanyView extends Controller_Nur_Bookkeeping_BasicNur {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/nur-bookkeeping/shopcompanyview/index';
    ...
    public function action_json() {
        $this->_sitePageData->url = '/nur-bookkeeping/shopcompanyview/json';
    ...
    {
        $this->_sitePageData->url = '/nur-bookkeeping/shopcompanyview/new';
    ...
    {
        $this->_sitePageData->url = '/nur-bookkeeping/shopcompanyview/edit';
    ...
    {
        $this->_sitePageData->url = '/nur-bookkeeping/shopcompanyview/save';
