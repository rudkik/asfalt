...
class Controller_Magazine_Bar_ShopSupplier extends Controller_Magazine_Bar_BasicMagazine {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/bar/shopsupplier/json';
    ...
    public function action_index() {
        $this->_sitePageData->url = '/bar/shopsupplier/index';
    ...
    {
        $this->_sitePageData->url = '/bar/shopsupplier/new';
    ...
    {
        $this->_sitePageData->url = '/bar/shopsupplier/edit';
    ...
    {
        $this->_sitePageData->url = '/bar/shopsupplier/save';
    ...
    {
        $this->_sitePageData->url = '/bar/shopsupplier/del';
