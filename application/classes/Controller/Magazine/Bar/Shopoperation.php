...
class Controller_Magazine_Bar_ShopOperation extends Controller_Magazine_Bar_BasicMagazine {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/bar/shopoperation/index';
        ...
        View_View::find('DB_Shop_Operation',
            ...
            $this->_sitePageData, $this->_driverDB, array('is_main_shop' => FALSE, 'limit_page' => 25,
                'shop_table_rubric_id' => Model_Magazine_Shop_Operation::RUBRIC_BAR));
    ...
    {
        $this->_sitePageData->url = '/bar/shopoperation/new';
    ...
    {
        $this->_sitePageData->url = '/bar/shopoperation/edit';
    ...
    {
        $this->_sitePageData->url = '/bar/shopoperation/save';
