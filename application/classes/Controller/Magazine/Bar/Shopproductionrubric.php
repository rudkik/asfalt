...
class Controller_Magazine_Bar_ShopProductionRubric extends Controller_Magazine_Bar_BasicMagazine
{
    ...
    {
        $this->_sitePageData->url = '/bar/shopproductionrubric/index';
    ...
    {
        $this->_sitePageData->url = '/bar/shopproductionrubric/list';
    ...
    {
        $this->_sitePageData->url = '/bar/shopproductionrubric/new';
    ...
    {
        $this->_sitePageData->url = '/bar/shopproductionrubric/edit';
    ...
    {
        $this->_sitePageData->url = '/bar/shopproductionrubric/save';
