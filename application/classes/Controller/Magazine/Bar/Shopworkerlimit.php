...
class Controller_Magazine_Bar_ShopWorkerLimit extends Controller_Magazine_Bar_BasicMagazine {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/bar/shopworkerlimit/index';
    ...
    {
        $this->_sitePageData->url = '/bar/shopworkerlimit/new';
    ...
    {
        $this->_sitePageData->url = '/bar/shopworkerlimit/edit';
    ...
    {
        $this->_sitePageData->url = '/bar/shopworkerlimit/save';
    ...
    {
        $this->_sitePageData->url = '/bar/shopworkerlimit/del';
