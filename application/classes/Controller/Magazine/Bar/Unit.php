...
class Controller_Magazine_Bar_Unit extends Controller_Magazine_Bar_BasicMagazine {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/bar/unit/index';
    ...
    {
        $this->_sitePageData->url = '/bar/unit/new';
    ...
    {
        $this->_sitePageData->url = '/bar/unit/edit';
    ...
    {
        $this->_sitePageData->url = '/bar/unit/save';
    ...
    {
        $this->_sitePageData->url = '/bar/unit/del';
