...
class Controller_Magazine_Bar_ShopWorker extends Controller_Magazine_Bar_BasicMagazine {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/bar/shopworker/json';
    ...
    public function action_index() {
        $this->_sitePageData->url = '/bar/shopworker/index';
    ...
    {
        $this->_sitePageData->url = '/bar/shopworker/new';
    ...
    {
        $this->_sitePageData->url = '/bar/shopworker/edit';
    ...
    {
        $this->_sitePageData->url = '/bar/shopworker/save';
    ...
    {
        $this->_sitePageData->url = '/bar/shopworker/del';
