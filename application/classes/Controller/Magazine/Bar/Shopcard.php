...
class Controller_Magazine_Bar_ShopCard extends Controller_Magazine_Bar_BasicMagazine {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/bar/shopcard/index';
    ...
    public function action_find_barcode() {
        $this->_sitePageData->url = '/bar/shopcard/find_barcode';
    ...
    {
        $this->_sitePageData->url = '/bar/shopcard/new';
    ...
    {
        $this->_sitePageData->url = '/bar/shopcard/edit';
    ...
    {
        $this->_sitePageData->url = '/bar/shopcard/save';
