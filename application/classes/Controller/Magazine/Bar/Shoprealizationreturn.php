...
class Controller_Magazine_Bar_ShopRealizationReturn extends Controller_Magazine_Bar_BasicMagazine {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/bar/shoprealizationreturn/index';
    ...
    {
        $this->_sitePageData->url = '/bar/shoprealizationreturn/new';
    ...
    {
        $this->_sitePageData->url = '/bar/shoprealizationreturn/edit';
    ...
    {
        $this->_sitePageData->url = '/bar/shoprealizationreturn/save';
    ...
    {
        $this->_sitePageData->url = '/bar/shoprealizationreturn/del';
