...
class Controller_Magazine_Bar_ShopReceive extends Controller_Magazine_Bar_BasicMagazine {
    ...
    public function action_index() {
        ...
        $this->_sitePageData->url = '/bar/shopreceive/index';
    ...
    {
        $this->_sitePageData->url = '/bar/shopreceive/new';
    ...
    {
        $this->_sitePageData->url = '/bar/shopreceive/edit';
    ...
    {
        $this->_sitePageData->url = '/bar/shopreceive/production';
        ...
        View_View::find('DB_Magazine_Shop_Receive_Item',
            ...
            array(
                ...
                'shop_production_id' => array('id', 'name', 'barcode', 'price', 'coefficient'),
            )
        );
    ...
    {
        $this->_sitePageData->url = '/bar/shopreceive/esf';
    ...
    {
        $this->_sitePageData->url = '/bar/shopreceive/save_esf';

        Api_Magazine_Shop_Receive::saveESF($this->_sitePageData, $this->_driverDB);
        $this->redirect('/bar/shopreceive/esf'.URL::query(array('id' => Request_RequestParams::getParamInt('id')), FALSE));
    }

    public function action_save()
    {
        $this->_sitePageData->url = '/bar/shopreceive/save';
