...
class Controller_Magazine_Accounting_ShopProductRubric extends Controller_Magazine_Accounting_BasicMagazine
{
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproductrubric/index';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproductrubric/list';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproductrubric/new';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproductrubric/edit';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproductrubric/save';
