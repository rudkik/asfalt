...
class Controller_Magazine_Accounting_ShopFinish extends Controller_Magazine_Accounting_BasicMagazine {

    public function action_index() {
        $this->_sitePageData->url = '/accounting/shopfinish/index';
