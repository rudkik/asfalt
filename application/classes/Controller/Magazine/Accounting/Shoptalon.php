...
class Controller_Magazine_Accounting_ShopTalon extends Controller_Magazine_Accounting_BasicMagazine {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/accounting/shoptalon/index';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopptalon/calc_stocks';
