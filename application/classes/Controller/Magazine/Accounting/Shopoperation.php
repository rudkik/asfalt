...
class Controller_Magazine_Accounting_ShopOperation extends Controller_Magazine_Accounting_BasicMagazine {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/accounting/shopoperation/index';
        ...
        View_View::find('DB_Shop_Operation',
            $this->_sitePageData->shopID, "_shop/operation/list/index", "_shop/operation/one/index",
            $this->_sitePageData, $this->_driverDB, array('is_main_shop' => FALSE, 'limit_page' => 25,
                'shop_table_rubric_id' => Model_Magazine_Shop_Operation::RUBRIC_BOOKKEEPING));
    ...
    {
        $this->_sitePageData->url = '/accounting/shopoperation/new';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopoperation/edit';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopoperation/save';
