...
class Controller_Magazine_Accounting_ShopRevise extends Controller_Magazine_Accounting_BasicMagazine {
    ...
    public function action_index() {
        ...
        $this->_sitePageData->url = '/accounting/shoprevise/index';
    ...
    {
        $this->_sitePageData->url = '/accounting/shoprevise/new';
    ...
    {
        $this->_sitePageData->url = '/accounting/shoprevise/edit';
    ...
    {
        $this->_sitePageData->url = '/accounting/shoprevise/save';
    ...
    {
        $this->_sitePageData->url = '/accounting/shoprevise/del';
