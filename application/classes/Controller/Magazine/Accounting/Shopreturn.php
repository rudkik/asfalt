...
class Controller_Magazine_Accounting_ShopReturn extends Controller_Magazine_Accounting_BasicMagazine {
    ...
    public function action_index() {
        ...
        $this->_sitePageData->url = '/accounting/shopreturn/index';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopreturn/new';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopreturn/edit';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopreturn/save';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopreturn/del';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopreturn/esf';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopreturn/save_esf';

        Api_Magazine_Shop_Return::saveESF($this->_sitePageData, $this->_driverDB);
        $this->redirect('/accounting/shopreturn/esf'.URL::query(array('id' => Request_RequestParams::getParamInt('id')), FALSE));
    }
}
