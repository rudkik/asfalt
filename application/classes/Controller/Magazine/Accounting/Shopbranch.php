...
class Controller_Magazine_Accounting_ShopBranch extends Controller_Magazine_Accounting_BasicMagazine {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/accounting/shopbranch/index';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopbranch/new';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopbranch/edit';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopbranch/save';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopbranch/del';
