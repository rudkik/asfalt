...
class Controller_Magazine_Accounting_ShopConsumable extends Controller_Magazine_Accounting_BasicMagazine
{
    ...
    {
        $this->_sitePageData->url = '/accounting/shopconsumable/index';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopconsumable/list';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopconsumable/new';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopconsumable/edit';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopconsumable/save';
