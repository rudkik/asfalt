...
class Controller_Magazine_Accounting_ShopWriteOffType extends Controller_Magazine_Accounting_BasicMagazine {
    ...
    public function action_json() {
        $this->_sitePageData->url = '/accounting/shopwriteofftype/json';
    ...
    public function action_index() {
        $this->_sitePageData->url = '/accounting/shopwriteofftype/index';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopwriteofftype/new';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopwriteofftype/edit';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopwriteofftype/save';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopwriteofftype/del';
