...
class Controller_Magazine_Accounting_ShopProduction extends Controller_Magazine_Accounting_BasicMagazine {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/accounting/shopproduction/index';
    ...
    public function action_history() {
        $this->_sitePageData->url = '/accounting/shopproduction/history';
    ...
    public function action_stock() {
        $this->_sitePageData->url = '/accounting/shopproduction/stock';
    ...
    public function action_find_barcode() {
        $this->_sitePageData->url = '/accounting/shopproduction/find_barcode';
        ...
        if($result['is_find']){
            ...
            // временно
            if($shopProduction->values['shop_product_id'] < 1){
                $result['values']['stock'] = 1000000;
            }
        }
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproduction/new';
        ...
        $this->_sitePageData->replaceDatas['view::_shop/production/one/new'] = Helpers_View::getViewObject(
            ...
            '_shop/production/one/new', $this->_sitePageData, $this->_driverDB, $this->_sitePageData->shopID
        );
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproduction/edit';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproduction/save_coefficient';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproduction/save';
    ...
    public function action_add_image() {
        $this->_sitePageData->url = '/accounting/shopproduction/add_image';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproduction/find_doubles';
    ...
    {
        $this->_sitePageData->url = '/accounting/shopproduction/calc_stocks';
