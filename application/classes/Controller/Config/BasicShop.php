...
class Controller_Config_BasicShop extends Controller_BasicAdmin {
    ...
    {
        // Получаем индекс страницу
        $key = $file . Helpers_DB::getURLParamDatas(array('config'));
    ...
    public function before()
    {
        ...
        $this->_sitePageData->shopShablonPath = $this->prefixView;
