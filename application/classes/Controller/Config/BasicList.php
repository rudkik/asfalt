...
class Controller_Config_BasicList extends Controller_Config_BasicShop
{
    /**
                                      ...
                                      $file = 'list', $field = 'name')
    {
        ...
        if(file_exists(VIEWPATH . 'config/_all/' . $this->_sitePageData->dataLanguageID . '/' . $view . 'list/list.php')){
            $viewPath = $view;
        }else{
            $viewPath = '_db/';
        }
        ...
        $this->_sitePageData->newShopShablonPath('config/_all');
