...
class Controller_Calendar_BasicShop extends Controller_BasicAdmin {
    ...
    public function action_select_options() {
        ...
        switch ($this->tableID) {
            case Model_Calendar_Shop_Product::TABLE_ID:
                $result = View_View::find('DB_Calendar_Shop_Product',
                    $this->_sitePageData->shopID,
                ...
                break;
            case Model_Calendar_Shop_TurnPlace::TABLE_ID:
                $result = View_View::find('DB_Calendar_Shop_TurnPlace',
                    $this->_sitePageData->shopID,
                    '_shop/'.$this->objectName.'/list/select-option',
                    '_shop/'.$this->objectName.'/one/select-option',
                    $this->_sitePageData, $this->_driverDB, array('limit_page' => 10000), array()
                ...
                break;
            case Model_Calendar_Shop_Heap::TABLE_ID:
                $result = View_View::find('DB_Calendar_Shop_Heap',
                    $this->_sitePageData->shopID,
                    '_shop/'.$this->objectName.'/list/select-option',
                    '_shop/'.$this->objectName.'/one/select-option',
                    $this->_sitePageData, $this->_driverDB, array('limit_page' => 10000), array()
                ...
                break;
            case Model_Calendar_Shop_Client_Contract::TABLE_ID:
                $result = View_View::find('DB_Calendar_Shop_Client_Contract',
                    $this->_sitePageData->shopID,
                    '_shop/'.$this->objectName.'/list/select-option',
                    '_shop/'.$this->objectName.'/one/select-option',
                    $this->_sitePageData, $this->_driverDB, array('limit_page' => 10000), array()
                ...
                break;
            case Model_Calendar_Shop_Client_Attorney::TABLE_ID:
                $result = View_View::find('DB_Calendar_Shop_Client_Attorney',
                    $this->_sitePageData->shopID,
                    '_shop/'.$this->objectName.'/list/select-option',
                    '_shop/'.$this->objectName.'/one/select-option',
                    $this->_sitePageData, $this->_driverDB, array('limit_page' => 10000), array()
