...
class Controller_Hotel_BasicList extends Controller_Hotel_BasicShop
{
    /**
    ...
    protected function _requestShopClients($currentID = NULL)
    {
        ...
        $data = View_View::find('DB_Hotel_Shop_Client', $this->_sitePageData->shopID,
    ...
    protected function _requestShopServices($currentID = NULL)
    {
        ...
        $data = View_View::find('DB_Hotel_Shop_Service', $this->_sitePageData->shopID,
    ...
    protected function _requestBillCancelStatus($currentID = NULL)
    {
        ...
        $data = View_View::find('DB_Hotel_BillCancelStatus', $this->_sitePageData->shopID,
    ...
    protected function _requestRefundTypes($currentID = NULL)
    {
        ...
        $data = View_View::find('DB_Hotel_RefundType', $this->_sitePageData->shopID,
