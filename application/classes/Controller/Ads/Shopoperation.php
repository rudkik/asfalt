...
class Controller_Ads_ShopOperation extends Controller_Ads_BasicAds {
    ...
    public function action_index() {
        $this->_sitePageData->url = '/ads/shopoperation/index';
    ...
    public function action_json() {
        $this->_sitePageData->url = '/ads/shopoperation/json';
    ...
    {
        $this->_sitePageData->url = '/ads/shopoperation/new';
    ...
    {
        $this->_sitePageData->url = '/ads/shopoperation/edit';
    ...
    {
        $this->_sitePageData->url = '/ads/shopoperation/save';
        ...
        if (Request_RequestParams::getParamBoolean('json') || $result['result']['error']) {
            ...
            if(Request_RequestParams::getParamBoolean('is_close') === FALSE){
                $this->redirect('/ads/shopoperation/edit'
                    . URL::query(
                        array(
                            'id' => $result['id'],
                        ),
                ...
                $this->redirect('/ads/shopoperation/index'
                    . URL::query(
                        array(
