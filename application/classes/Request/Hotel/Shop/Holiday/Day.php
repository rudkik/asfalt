...
class Request_Hotel_Shop_Holiday_Day extends Request_Request {
    /**
    ...
    protected static function _addWhere($dbObject, $fieldWhere, $fieldValue, array $params, Model_Driver_DBBasicSQL $sql,
        ...
        if($fieldWhere == 'period_from') {
            ...
            if(($periodFrom !== NULL) && ($periodTo !== NULL)){
                ...
                $tmp->addField('date', '', $periodFrom, '', Model_Driver_DBBasicWhere::COMPARE_TYPE_MORE_EQUALLY);
                $tmp->addField('date', '', $periodTo, '', Model_Driver_DBBasicWhere::COMPARE_TYPE_LESS_EQUALLY);
            }
