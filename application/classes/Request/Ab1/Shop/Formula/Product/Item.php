...
class Request_Ab1_Shop_Formula_Product_Item extends Request_Request {
    /**
        ...
        if($fieldWhere == 'formula_type_id') {
            ...
            if($formulaTypeID !== NULL){
                $tableJoin = self::_addJoinTable(
                    $sql,
                    Model_Ab1_Shop_Formula_Product_Item::TABLE_NAME, 'shop_formula_product_id',
                    Model_Ab1_Shop_Formula_Product::TABLE_NAME
                );
