...
class Request_Ab1_Shop_Product_Rubric extends Request_Request {
    ...
    {
        $childRubricIDs = self::findAllByRoot(
     ...
     * @return MyArray
     */
    public static function findAllByRoot($shopID, $rootID, SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver,
                                         array $params = array(), $limit = 0, $isLoadAllFields = FALSE, $elements = NULL){
        ...
        return self::find(
            'DB_Ab1_Shop_Product_Rubric', $shopID, $sitePageData, $driver, $params, $limit, $isLoadAllFields, $elements
        );
    }
}
