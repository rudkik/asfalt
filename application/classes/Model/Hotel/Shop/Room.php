...
class Model_Hotel_Shop_Room extends Model_Shop_Table_Basic_Table{
            ...
            foreach($elements as $element){
                switch($element){
                    case 'shop_building_id':
                        ...
                        break;
                    case 'shop_floor_id':
                        $this->_dbGetElement($this->getShopFloorID(), 'shop_floor_id', new Model_Hotel_Shop_Floor());
                        break;
                    case 'shop_room_type_id':
                        $this->_dbGetElement($this->getShopRoomTypeID(), 'shop_room_type_id', new Model_Hotel_Shop_Room_Type());
                        break;
                }
            }
        }
