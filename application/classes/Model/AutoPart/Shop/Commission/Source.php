...
class Model_AutoPart_Shop_Commission_Source extends Model_Shop_Table_Basic_Table{
    ...
    public function setShopCommissionSourceTypeID($value){
        $this->setValueInt('shop_commission_source_type_id', $value);
    }
    public function getShopCommissionSourceTypeID(){
        return $this->getValueInt('shop_commission_source_type_id');
    }
