...
class Model_Tax_OrganizationTaxType extends Model_Basic_Name{

    const TAX_TYPE_SIMPLIFIED = 750; // Упрощенный режим налогообложения
    const TAX_TYPE_GENERALLY = 751; // Общеустановленный режим налогообложения
