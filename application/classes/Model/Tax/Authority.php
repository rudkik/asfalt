...
class Model_Tax_Authority extends Model_Basic_Name{
    ...
    public function dbGetElements($shopID = 0, $elements = NULL){
        if(($elements === NULL) || (! is_array($elements))){
            ...
            foreach($elements as $element){
                switch($element){
                    case 'authority_location_id':
                        $this->_dbGetElement($this->getAuthorityLocationID(), 'authority_location_id', new Model_Tax_AuthorityLocation());
                        break;
                        break;
                }
            }
	...
	public function validationFields(array &$errorFields){
		...
		$validation->rule('fields_options', 'max_length', array(':value', 650000))
            ...
            ->rule('authority_location_id', 'max_length', array(':value', 11));
    ...
    public function setAuthorityLocationID($value){
        $this->setValueInt('authority_location_id', $value);
    }
    public function getAuthorityLocationID(){
        return $this->getValueInt('authority_location_id');
    }
