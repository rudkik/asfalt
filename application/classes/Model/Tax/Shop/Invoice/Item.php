...
class Model_Tax_Shop_Invoice_Item extends Model_Shop_Table_Basic_Table{

	const TABLE_NAME = 'tax_shop_invoice_items';
	const TABLE_ID = 104;
    ...
    public function validationFields(array &$errorFields)
    {
        ...
        $validation->rule('shop_contractor_id', 'max_length', array(':value', 11))
            ->rule('shop_invoice_id', 'max_length', array(':value', 11))
