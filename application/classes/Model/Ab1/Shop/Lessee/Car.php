...
class Model_Ab1_Shop_Lessee_Car extends Model_Shop_Table_Basic_Table{
    ...
    public function setValue($name, $value) {
        ...
        if ($name == 'quantity'){
            $this->setDeliveryQuantity($this->getDeliveryQuantity() - $this->basicQuantity + $this->getQuantity());
            $this->basicQuantity = $this->getQuantity();
        }
    }
