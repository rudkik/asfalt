...
class Model_Ab1_Shop_Raw_Material_Item extends Model_Shop_Basic_Options{
            ...
            foreach ($elements as $element) {
                switch ($element) {
                    ...
                    case 'shop_material_id':
                        ...
                        break;
                    case 'shop_raw_material_id':
                        $this->_dbGetElement($this->getShopRawMaterialID(), 'shop_raw_material_id', new Model_Ab1_Shop_Raw_Material(), $shopID);
                        break;
    ...
    public function validationFields(array &$errorFields)
    {
        ...
        $this->isValidationFieldInt('shop_raw_material_id', $validation);
    ...
    public function setShopRawMaterialID($value)
    {
        $this->setValueInt('shop_raw_material_id', $value);
    }
    public function getShopRawMaterialID()
    {
        return $this->getValueInt('shop_raw_material_id');
    }
