...
class Model_Ab1_Shop_Move_Car extends Model_Shop_Table_Basic_Table{
			...
			foreach($elements as $element){
				switch($element){
                    ...
                    case 'shop_storage_id':
                        ...
                        break;
					case 'shop_client_id':
						$this->_dbGetElement($this->getShopClientID(), 'shop_client_id', new Model_Ab1_Shop_Move_Client(), $shopID);
						break;
