...
class Model_Ab1_Shop_Client_Balance_Day extends Model_Shop_Basic_Object{
    ...
    public function validationFields(array &$errorFields)
    {
        ...
        $validation->rule('amount', 'max_length', array(':value', 14))
	...
	public function setAmount($value){
        ...
        $this->setBalance($this->getAmount() - $this->getBlockAmount() - $this->getBlockBalanceClient());
	}
    ...
    public function setBlockBalanceClient($value){
        $this->setValueFloat('block_balance_client', $value);
        $this->setBalance($this->getAmount() - $this->getBlockAmount() - $this->getBlockBalanceClient());
    }
    public function getBlockBalanceClient(){
        return $this->getValueFloat('block_balance_client');
    }
}
