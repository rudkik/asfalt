    ...
    public static function save(SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver)
    {
        ...
        if($id > 0) {
            if (!Helpers_DB::dublicateObjectLanguage($model, $id, $sitePageData)) {
                throw new HTTP_Exception_500('Confidant not found.');
            }
        ...
        Request_RequestParams::setParamStr('passport_number', $model);
        Request_RequestParams::setParamStr('passport_issued', $model);
        Request_RequestParams::setParamDateTime('passport_date', $model);
            ...
            if($type > 0) {
                ...
                if ($hashtags !== NULL) {
                    $model->setShopTableHashtagIDsArray(Api_Shop_Table_ObjectToObject::saveToHashtags(
                        Model_Tax_Shop_Confidant::TABLE_ID, $model->id, $model->getShopTableCatalogID(),
