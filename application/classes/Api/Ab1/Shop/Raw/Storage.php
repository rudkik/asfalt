...
class Api_Ab1_Shop_Raw_Storage  {
    ...
    public static function save(SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver)
    {
        ...
        if($id > 0) {
            if (!Helpers_DB::dublicateObjectLanguage($model, $id, $sitePageData)) {
                throw new HTTP_Exception_500('Raw storage not found.');
            }
        }
        ...
        Request_RequestParams::setParamFloat("ton_in_meter", $model);
        Request_RequestParams::setParamFloat("size_meter", $model);
        Request_RequestParams::setParamInt("shop_raw_storage_type_id", $model);
        Request_RequestParams::setParamInt("shop_raw_storage_group_id", $model);
