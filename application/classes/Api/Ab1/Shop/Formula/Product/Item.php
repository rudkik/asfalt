...
class Api_Ab1_Shop_Formula_Product_Item  {
    /**
     * удаление
    ...
    public static function delete(SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver)
    {
        ...
        if($isUnDel){
            ...
            $ids = Request_Request::find('DB_Ab1_Shop_Formula_Product_Item', $sitePageData->shopID, $sitePageData, $driver, $params);
            $driver->unDeleteObjectIDs(
                $ids->getChildArrayID(), $sitePageData->userID, Model_Ab1_Shop_Formula_Product_Item::TABLE_NAME,
     ...
     * @return bool
     */
    public static function save(Model_Ab1_Shop_Formula_Product $modelFormula, array $shopFormulaItems, bool $isSide,
                                SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver)
    {
        $model = new Model_Ab1_Shop_Formula_Product_Item();
        $model->setDBDriver($driver);
        ...
        foreach($shopFormulaItems as $shopFormulaItem){
            ...
            $shopFormulaProductItemIDs->childShiftSetModel($model);
        ...
        // удаляем лишние
        $driver->deleteObjectIDs(
            $shopFormulaProductItemIDs->getChildArrayID(), $sitePageData->userID,
            Model_Ab1_Shop_Formula_Product_Item::TABLE_NAME, array(), $sitePageData->shopID
        );
