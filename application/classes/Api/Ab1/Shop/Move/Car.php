...
class Api_Ab1_Shop_Move_Car  {
     ...
     * @return MyArray
     */
    public static function getExitShopMoveCar($dateFrom, $dateTo, SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver,
                                          $elements = NULL, $params = array(), $isAllBranch = false)
    {
        ...
        $shopCarIDs = Request_Request::find('DB_Ab1_Shop_Move_Car',
    ...
    public static function delete(SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver)
    {
        ...
        if(Request_RequestParams::getParamBoolean("is_undel") === TRUE){
            ...
            Api_Ab1_Shop_Register_Material::unDelShopMoveCar($model, $sitePageData, $driver);
        }else {
            $model->dbDelete($sitePageData->userID, 0, $sitePageData->shopID);
            Api_Ab1_Shop_Register_Material::delShopMoveCar($model, $sitePageData, $driver);
        }
    ...
    public static function save(SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver, $isWeighted = true)
    {
        ...
        if ($model->validationFields($result)) {
            ...
            Api_Ab1_Shop_Register_Material::saveShopMoveCar($model, $sitePageData, $driver);
    ...
    public static function saveXML($from, $to, SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver, $isPHPOutput = FALSE)
    {
        ...
        $carIDs = Request_Request::find('DB_Ab1_Shop_Move_Car', $sitePageData->shopID, $sitePageData, $driver,
        ...
        $modelClient = new Model_Ab1_Shop_Move_Client();
