...
class Api_Nur_Shop_Task  {
    ...
    public static function save(SitePageData $sitePageData, Model_Driver_DBBasicDriver $driver)
    {
        ...
        $date = Request_RequestParams::getParamDateTime("date_from");
        if($date !== NULL){
            $model->setDateFrom($date);
        }
        $date = Request_RequestParams::getParamDateTime("date_to");
        if($date !== NULL){
            $model->setDateTo($date);
        }
