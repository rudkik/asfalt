...
class Api_AutoPart_Shop_Bill_Delivery_Address {
    /**
     * Сохранение адреса
     * @param Model_AutoPart_Shop_Bill_Delivery_Address $model
     * @param SitePageData $sitePageData
     * @param Model_Driver_DBBasicDriver $driver
     * @throws HTTP_Exception_404
     */
    public static function saveModel(Model_AutoPart_Shop_Bill_Delivery_Address $model, SitePageData $sitePageData,
