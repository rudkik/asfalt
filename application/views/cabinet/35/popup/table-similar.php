        ...
        <div class="modal-content">
            <div class="box box-success margin-b-5">
                <div class="box-header with-border">
                    <h3 class="box-title">Выберите</h3>
                ...
                <div id="find-goods-similar-id" class="box-body no-padding padding-b-10">
            ...
            <section id="result-goods-similar" class="content padding-t-5">
