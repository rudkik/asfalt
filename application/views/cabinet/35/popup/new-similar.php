    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="box box-success margin-b-5">
                ...
                <div id="find-news-similar-id" class="box-body no-padding padding-b-10">
                    <div class="col-md-12 padding-t-5">
                        <div class="row">
                            <?php if ((Func::isShopMenu('shopnewrubric/index-all', $siteData))
                                || ((Request_RequestParams::getParamInt('type') > 0) && (Func::isShopMenu('shopnewrubric/index?type='.Request_RequestParams::getParamInt('type'), $siteData)))){ ?>
                                <div class="col-md-4">
            ...
            <section id="result-news" class="content padding-t-5">
