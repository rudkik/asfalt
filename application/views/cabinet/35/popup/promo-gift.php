<div id="find-promo-gift" class="modal fade bs-example-modal-lg in" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="box box-success margin-b-5">
                ...
                <div id="find-goods-gift-id" class="box-body no-padding padding-b-10">
                    <div class="col-md-12 padding-t-5">
                        <div class="row">
                            <?php if ((Func::isShopMenu('shopgoodcatalog/index-all', $siteData))
                                || ((Request_RequestParams::getParamInt('type') > 0) && (Func::isShopMenu('shopgoodcatalog/index?type='.Request_RequestParams::getParamInt('type'), $siteData)))){ ?>
                                <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <span for="input-name"  class="control-label">Артикул</span>
                                    <div class="input-group">
                                        <input id="input-article" class="form-control" name="article" placeholder="Артикул" value="<?php echo Arr::path($siteData->urlParams, 'article', '');?>" type="text">
            ...
            <section id="result-goods-gift" class="content padding-t-5">
