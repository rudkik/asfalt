<table data-id="0" class="table table-hover table-db margin-b-5">
    ...
    <?php
    foreach ($data['view::_shop/comment/one/similar-popup']->childs as $value){
        echo $value->str;
    }
    ?>
</table>
...
<div class="row">
    <div class="col-md-12">
        ...
        $url = 'javascript:actionFindComments(\'find-comments-similar-id\', \'result-comments-similar\', \'\', \''.$url.'\')';
