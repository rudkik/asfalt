<tr>
    ...
    <td>
        <ul class="list-inline tr-button delete">
            ...
            <li class="tr-remove"><a href="javascript:actionAddCommentPromoGift(<?php echo $data->id; ?>, <?php echo $data->values['shop_id']; ?>)" class="text-sm"><i class="fa fa-plus margin-r-5"></i> Выбрать</a></li>
        </ul>
    </td>
</tr>