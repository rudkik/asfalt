    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php if (Func::isShopMenu('shopcomment/filter?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopcomment/similar?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopcomment/seo?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li class=""><a href="#tab7" data-toggle="tab">SEO-настройки <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shopcomment/remarketing?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li class=""><a href="#tab5" data-toggle="tab">Код ремаркетинга <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shopcomment/child?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="row record-input record-tab">
                        ...
                        <div class="col-md-9">
                            <input name="name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_comment.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['name']);?>">
                        </div>
                    </div>
                    <div class="row record-input2 record-tab">
                        <?php if (((Func::isShopMenu('shopcomment/created_at?type='.Request_RequestParams::getParamInt('type'), $siteData)))){  ?>
                            ...
                            <div class="col-md-3">
                                <input name="created_at" type="datetime" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_comment.fields_title.created_at', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo $data->values['created_at'];?>">
                            </div>
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopcomment/brand?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopcomment/unit?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopcomment/select?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                    ...
                    <?php if (Func::isShopMenu('shopcomment/hashtag?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    ...
                    <?php if ((Func::isShopMenu('shopcomment/text?type='.$data->values['shop_table_catalog_id'], $siteData))
                    || (Func::isShopMenu('shopcomment/text-html?type='.$data->values['shop_table_catalog_id'], $siteData))){ ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                            ...
                            <div class="col-md-9 record-textarea">
                                <textarea name="text" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_comment.fields_title.text', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" rows="11" class="form-control"><?php echo $data->values['text'];?></textarea>
                            </div>
                        </div>
                    <?php } ?>
                </div>
...
<?php if (Func::isShopMenu('shopcomment/text-html?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
<script>
