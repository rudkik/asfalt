...
function isIgnore($name){
    ...
    switch($name){
        ...
        case 'comment_id': return TRUE; break;
        ...
        case 'sales_comment_count': return TRUE; break;
...
function writeElementName(&$data, $name, $value){
    switch($name){
        ...
        case 'comment_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.comment_select_type_id.name', ''); break;
        case 'shop_comment_unit_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.shop_comment_unit_type_id.name', ''); break;
        default:
            $result = $value;
    }
