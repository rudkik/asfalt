<form action="<?php echo Func::getFullURL($siteData, '/shoppersondiscount/savelist'); ?>" method="post">
...
<table id="edit-list" class="table table-hover table-db">
    <tr>
        ...
        <?php }?>
        <?php if(empty($editFields) || (in_array('phone', $editFields))){ ?>
    ...
    <?php
    foreach ($data['view::_shop/person-discount/one/index-edit']->childs as $value) {
        echo $value->str;
    }
    ?>
</table>
