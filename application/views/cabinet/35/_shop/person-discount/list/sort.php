<form action="<?php echo Func::getFullURL($siteData, '/shoppersondiscount/savesort');?>" method="post">
	...
	<table class="table table-hover table-db">
		<tr>
			...
			<?php } ?>
			<th class="tr-header-price"><?php echo SitePageData::setPathReplace('type.form_data.shop_person_discount.fields_title.phone', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
			...
			<?php } ?>
			<th><?php echo SitePageData::setPathReplace('type.form_data.shop_person_discount.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
			<th class="tr-header-price"><?php echo SitePageData::setPathReplace('type.form_data.shop_person_discount.fields_title.discount', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
			<th class="tr-header-buttom"></th>
		</tr>
		<tbody id="sort-record">
		<?php
		foreach ($data['view::_shop/coupon/one/sort']->childs as $value) {
			echo $value->str;
		}
		?>
		</tbody>
