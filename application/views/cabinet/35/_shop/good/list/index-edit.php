<form action="<?php echo Func::getFullURL($siteData, '/shopgood/savelist'); ?>" method="post">
...
<table id="edit-list" class="table table-hover table-db">
    <tr>
        ...
        <th class="tr-header-id">
            <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index_edit'). Func::getAddURLSortBy($siteData->urlParams, 'id'); ?>" class="link-black">ID</a>
            <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index_edit'). Func::getAddURLSortBy($siteData->urlParams, 'id'); ?>" class="link-blue">
        ...
        <th class="tr-header-article">
            <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index_edit'). Func::getAddURLSortBy($siteData->urlParams, 'article'); ?>" class="link-black"><?php echo SitePageData::setPathReplace('type.form_data.shop_good.fields_title.article', SitePageData::CASE_FIRST_LETTER_UPPER); ?></a>
            <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index_edit'). Func::getAddURLSortBy($siteData->urlParams, 'article'); ?>" class="link-blue">
        ...
        <?php }?>
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index_edit'). Func::getAddURLSortBy($siteData->urlParams, 'name'); ?>" class="link-black"><?php echo SitePageData::setPathReplace('type.form_data.shop_good.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></a>
            <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index_edit'). Func::getAddURLSortBy($siteData->urlParams, 'name'); ?>" class="link-blue">
        ...
        <th class="tr-header-price">
            <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index_edit'). Func::getAddURLSortBy($siteData->urlParams, 'price'); ?>" class="link-black"><?php echo SitePageData::setPathReplace('type.form_data.shop_good.fields_title.price', SitePageData::CASE_FIRST_LETTER_UPPER); ?></a>
            <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index_edit'). Func::getAddURLSortBy($siteData->urlParams, 'price'); ?>" class="link-blue">
    ...
    <?php
    foreach ($data['view::_shop/good/one/index-edit']->childs as $value) {
        echo $value->str;
    }
    ?>
</table>
