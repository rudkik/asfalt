...
<table class="table table-hover table-db">
    <tr>
        ...
        <?php if ((Func::isShopMenu('shopgood/table/id?type='.$type, $siteData))){ ?>
        ...
        <?php }?>
        <?php if ((Func::isShopMenu('shopgood/table/article?type='.$type, $siteData))){ ?>
        ...
        <?php }?>
        <?php if ((Func::isShopMenu('shopgood/table/image?type='.$type, $siteData))){ ?>
        ...
        <th>Модель</th>
        <?php }?>
        <?php if ((Func::isShopMenu('shopgood/table/rubric?type='.$type, $siteData))){ ?>
        ...
        <?php } ?>
        <?php if ((Func::isShopMenu('shopgood/table/stock?type='.$type, $siteData))){ ?>
        ...
        <?php } ?>
        <?php if ((Func::isShopMenu('shopgood/table/stock_rubric?type='.$type, $siteData))){ ?>
        ...
        <?php } ?>
        <?php if ((Func::isShopMenu('shopgood/table/stock_name?type='.$type, $siteData))){ ?>
            <th class="tr-header-article">
        ...
        <?php }?>
        <?php if ((Func::isShopMenu('shopgood/table/unit?type='.$type, $siteData))){ ?>
        ...
        <?php } ?>
        <?php if ((Func::isShopMenu('shopgood/table/select?type='.$type, $siteData))){ ?>
        ...
        <?php } ?>
        <?php if ((Func::isShopMenu('shopgood/table/brand?type='.$type, $siteData))){ ?>
        ...
        <?php } ?>
        <?php if ((Func::isShopMenu('shopgood/table/price?type='.$type, $siteData))){ ?>
    ...
    <?php
    foreach ($data['view::_shop/good/one/index']->childs as $value) {
        echo $value->str;
    }
    ?>
