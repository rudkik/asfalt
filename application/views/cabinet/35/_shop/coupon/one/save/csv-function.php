...
function isIgnore($name){
    ...
    switch($name){
        ...
        case 'coupon_id': return TRUE; break;
        ...
        case 'sales_coupon_count': return TRUE; break;
...
function writeElementName(&$data, $name, $value){
    switch($name){
        ...
        case 'coupon_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.coupon_select_type_id.name', ''); break;
        case 'shop_coupon_unit_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.shop_coupon_unit_type_id.name', ''); break;
        default:
            $result = $value;
    }
