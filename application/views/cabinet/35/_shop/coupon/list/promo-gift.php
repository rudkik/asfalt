<table id="panel-coupons-gift" data-id="<?php echo count($data['view::shopcoupon/promo-gift']->childs); ?>" class="table table-hover table-db margin-b-5">
    <tr>
    ...
    <?php
    foreach ($data['view::shopcoupon/promo-gift']->childs as $value){
        echo $value->str;
    }
    ?>
</table>
<?php if (count($data['view::shopcoupon/promo-gift']->childs) == 0){ ?>
