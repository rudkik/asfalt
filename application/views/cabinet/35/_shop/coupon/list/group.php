<table id="panel-group-coupons" data-id="<?php echo count($data['view::_shop/coupon/one/group']->childs); ?>" class="table table-hover table-db margin-b-5">
    <tr>
    ...
    <?php
    foreach ($data['view::_shop/coupon/one/group']->childs as $value){
        echo $value->str;
    }
    ?>
</table>
<?php if (count($data['view::_shop/coupon/one/group']->childs) == 0){ ?>
