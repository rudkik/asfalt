<form action="<?php echo Func::getFullURL($siteData, '/shopcoupon/savesort');?>" method="post">
	...
	<table class="table table-hover table-db">
		<tr>
			...
			<?php } ?>
			<th class="tr-header-price"><?php echo SitePageData::setPathReplace('type.form_data.shop_coupon.fields_title.number', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
			...
			<?php } ?>
			<th><?php echo SitePageData::setPathReplace('type.form_data.shop_coupon.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
			<th class="tr-header-price"><?php echo SitePageData::setPathReplace('type.form_data.shop_coupon.fields_title.discount', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
