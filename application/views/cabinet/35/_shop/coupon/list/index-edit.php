<form action="<?php echo Func::getFullURL($siteData, '/shopcoupon/savelist'); ?>" method="post">
...
<table id="edit-list" class="table table-hover table-db">
    <tr>
        ...
        <?php }?>
        <?php if(empty($editFields) || (in_array('number', $editFields))){ ?>
    ...
    <?php
    foreach ($data['view::_shop/coupon/one/index-edit']->childs as $value) {
        echo $value->str;
    }
    ?>
</table>
