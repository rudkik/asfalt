...
function isIgnore($name){
    ...
    switch($name){
        ...
        case 'address_id': return TRUE; break;
        ...
        case 'sales_address_count': return TRUE; break;
...
function writeElementName(&$data, $name, $value){
    switch($name){
        ...
        case 'address_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.address_select_type_id.name', ''); break;
        case 'shop_address_unit_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.shop_address_unit_type_id.name', ''); break;
        default:
            $result = $value;
    }
