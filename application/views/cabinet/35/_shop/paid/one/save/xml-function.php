...
function isIgnore($name){
    switch($name){
        ...
        case 'paid_id': return TRUE; break;
        ...
        case 'sales_paid_count': return TRUE; break;
        default:
            return FALSE;
    }
}
...
function writeElementName(&$data, $name){
    switch($name){
        ...
        case 'paid_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.paid_select_type_id.name', ''); break;
        case 'shop_paid_unit_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.shop_paid_unit_type_id.name', ''); break;
        default:
            $result = '';
    }
