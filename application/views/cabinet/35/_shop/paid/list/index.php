<table class="table table-hover table-db">
    <tr>
        <th class="tr-header-id">
            <a href="<?php echo Func::getFullURL($siteData, '/shoppaid/index'). Func::getAddURLSortBy($siteData->urlParams, 'id'); ?>" class="link-black">ID</a>
            <a href="<?php echo Func::getFullURL($siteData, '/shoppaid/index'). Func::getAddURLSortBy($siteData->urlParams, 'id'); ?>" class="link-blue">
        ...
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shoppaid/index'). Func::getAddURLSortBy($siteData->urlParams, 'name'); ?>" class="link-black"><?php echo SitePageData::setPathReplace('type.form_data.shop_paid.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></a>
            <a href="<?php echo Func::getFullURL($siteData, '/shoppaid/index'). Func::getAddURLSortBy($siteData->urlParams, 'name'); ?>" class="link-blue">
        ...
        <?php if ((Func::isShopMenu('shoppaid/shop_operation_id?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
            <th>
                <a href="<?php echo Func::getFullURL($siteData, '/shoppaid/index'). Func::getAddURLSortBy($siteData->urlParams, 'name'); ?>" class="link-black"><?php echo SitePageData::setPathReplace('type.form_data.shop_paid.fields_title.shop_operation_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></a>
                <a href="<?php echo Func::getFullURL($siteData, '/shoppaid/index'). Func::getAddURLSortBy($siteData->urlParams, 'name'); ?>" class="link-blue">
        ...
        <?php }?>
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shoppaid/index'). Func::getAddURLSortBy($siteData->urlParams, 'amount'); ?>" class="link-black">Сумма</a>
            <a href="<?php echo Func::getFullURL($siteData, '/shoppaid/index'). Func::getAddURLSortBy($siteData->urlParams, 'amount'); ?>" class="link-blue">
        ...
        <?php if ((Func::isShopMenu('shoppaid/text?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
            <th><?php echo SitePageData::setPathReplace('type.form_data.shop_paid.fields_title.text', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
        <?php }?>
        <th class="tr-header-buttom"></th>
    </tr>
    <?php
    foreach ($data['view::_shop/paid/one/index']->childs as $value) {
        echo $value->str;
    }
    ?>
