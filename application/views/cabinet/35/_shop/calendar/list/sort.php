<form action="<?php echo Func::getFullURL($siteData, '/shopcalendar/savesort');?>" method="post">
	...
	<table class="table table-hover table-db">
		<tr>
			...
			<?php if (Func::isShopMenu('shopcalendar/article?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
				<th class="tr-header-price"><?php echo SitePageData::setPathReplace('type.form_data.shop_calendar.fields_title.article', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
			<?php } ?>
			...
			<?php } ?>
			<th><?php echo SitePageData::setPathReplace('type.form_data.shop_calendar.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
            <?php if (Func::isShopMenu('shopcalendar/date_to?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                <th class="tr-header-date"><?php echo SitePageData::setPathReplace('type.form_data.shop_calendar.fields_title.date_from', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
            <?php } ?>
            <?php if (Func::isShopMenu('shopcalendar/date_to?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                <th class="tr-header-date"><?php echo SitePageData::setPathReplace('type.form_data.shop_calendar.fields_title.date_to', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
            <?php } ?>
			<th class="tr-header-buttom"></th>
		</tr>
		<tbody id="sort-record">
		<?php
		foreach ($data['view::_shop/calendar/one/sort']->childs as $value) {
			echo $value->str;
		}
		?>
		</tbody>
