...
function isIgnore($name){
    switch($name){
        ...
        case 'question_id': return TRUE; break;
        ...
        case 'sales_question_count': return TRUE; break;
        default:
            return FALSE;
    }
}
...
function writeElementName(&$data, $name){
    switch($name){
        ...
        case 'question_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.question_select_type_id.name', ''); break;
        case 'shop_question_unit_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.shop_question_unit_type_id.name', ''); break;
        default:
            $result = '';
    }
