    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php if (Func::isShopMenu('shopquestion/filter?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopquestion/similar?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopquestion/seo?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <li class=""><a href="#tab7" data-toggle="tab">SEO-настройки <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shopquestion/remarketing?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="row record-input record-tab">
                        ...
                        <div class="col-md-9">
                            <input name="name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_question.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>">
                        </div>
                    </div>
                    <div class="row record-input2 record-tab">
                        <?php if (Func::isShopMenu('shopquestion/email?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                            ...
                            <div class="col-md-3">
                                <input name="email" type="email" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_question.fields_title.email', SitePageData::CASE_FIRST_LETTER_UPPER); ?>">
                            </div>
                        <?php } ?>
                        <?php if (Func::isShopMenu('shopquestion/created_at?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                            ...
                            <div class="col-md-3">
                                <input name="created_at" type="datetime" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_question.fields_title.created_at', SitePageData::CASE_FIRST_LETTER_UPPER); ?>">
                            </div>
                        <?php } ?>
                    </div>
                    <div class="row record-input2 record-tab">
                        <?php if (((Func::isShopMenu('shopquestion/brand?type='.Request_RequestParams::getParamInt('type'), $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopquestion/unit?type='.Request_RequestParams::getParamInt('type'), $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopquestion/select?type='.Request_RequestParams::getParamInt('type'), $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                    ...
                    <?php if (Func::isShopMenu('shopquestion/hashtag?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    ...
                    <?php } ?>
                    <?php if (Func::isShopMenu('shopquestion/rubric?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                        <div class="row record-input record-tab margin-top-10px">
                            <div class="col-md-3 record-title">
                                <label>
                    ...
                    <?php if ((Func::isShopMenu('shopquestion/text?type='.Request_RequestParams::getParamInt('type'), $siteData))
                        || (Func::isShopMenu('shopquestion/text-html?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                            ...
                            <div class="col-md-9 record-textarea">
                                <textarea name="text" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_question.fields_title.text', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" rows="11" class="form-control"></textarea>
                            </div>
                        </div>
                    <?php } ?>
                    <div class="row record-input2 record-tab">
                        <?php if (Func::isShopMenu('shopquestion/answer_user_name?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                            ...
                            <div class="col-md-3">
                                <input name="answer_user_name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_question.fields_title.answer_user_name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>">
                            </div>
                        <?php } ?>
                        <?php if (Func::isShopMenu('shopquestion/answer_at?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                            ...
                            <div class="col-md-3">
                                <input name="answer_at" type="datetime" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_question.fields_title.answer_at', SitePageData::CASE_FIRST_LETTER_UPPER); ?>">
                            </div>
                        <?php } ?>
                    </div>
                    <?php if ((Func::isShopMenu('shopquestion/answer_text?type='.Request_RequestParams::getParamInt('type'), $siteData))
                        ...
                        <div class="row record-input record-tab">
                            ...
                            <div class="col-md-9 record-textarea">
                                <textarea name="answer_text" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_question.fields_title.answer_text', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" rows="11" class="form-control"></textarea>
                            </div>
                        </div>
                    <?php } ?>
                </div>
...
<?php if (Func::isShopMenu('shopquestion/text-html?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
    <script>
