<table class="table table-hover table-db">
    <tr>
        <th class="tr-header-id">
            <a href="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shopreturnitem/index<?php echo Func::getAddURLSortBy($siteData->urlParams, 'shop_good_id'); ?>" class="link-black">ID</a>
            <a href="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shopreturnitem/index<?php echo Func::getAddURLSortBy($siteData->urlParams, 'shop_good_id'); ?>" class="link-blue">
