<div class="row">
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php if (Func::isShopMenu('shopbranch/filter?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopbranch/similar?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopbranch/seo?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li class=""><a href="#tab7" data-toggle="tab">SEO-настройки <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shopbranch/remarketing?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li class=""><a href="#tab5" data-toggle="tab">Код ремаркетинга <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shopbranch/child?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li <?php if (Arr::path($data->additionDatas, 'select', 0) == $data->id){echo 'class="active"';} ?>>
                        <a href="<?php echo Func::getFullURL($siteData, '/shoptablechild/index', array('shop_root_table_object_id' => 'id', 'shop_root_table_catalog_id' => 'shop_table_catalog_id', 'is_group' => 'is_group'), array('is_public_ignore' => 1, 'root_table_id' => Model_Shop::TABLE_ID, 'type' => intval(Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS.'.shop_table_catalog_id.child_shop_table_catalog_ids.child.id', 0)), $data->values); ?>"><?php echo Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS.'.shop_table_catalog_id.child_shop_table_catalog_ids.child.name', ''); ?> <i class="fa fa-fw fa-info text-blue"></i></a>
                    </li>
                <?php } ?>
            </ul>
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="row record-input record-tab">
                        ...
                        <div class="col-md-9">
                            <input name="name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_branch.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['name']);?>">
                        </div>
                    </div>
                    ...
                    <?php } ?>
                    <?php if (((Func::isShopMenu('shopbranch/official_name?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                                    <sup><i class="fa fa-fw fa-asterisk text-red"></i></sup>
                            ...
                            <div class="col-md-9">
                                <input name="official_name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_branch.fields_title.official_name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['official_name']);?>">
                            </div>
                        </div>
                    <?php } ?>
                    <div class="row record-input2 record-tab">
                        <?php if (((Func::isShopMenu('shopbranch/sub_domain?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                            ...
                            <div class="col-md-3">
                                <input name="sub_domain" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_branch.fields_title.sub_domain', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['sub_domain']); ?>">
                            </div>
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopbranch/domain?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                            ...
                            <div class="col-md-3">
                                <input name="domain" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_branch.fields_title.domain', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['domain']);?>">
                            </div>
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopbranch/brand?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopbranch/unit?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopbranch/select?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                    ...
                    <?php if (Func::isShopMenu('shopbranch/hashtag?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    ...
                    <?php if ((Func::isShopMenu('shopbranch/text?type='.$data->values['shop_table_catalog_id'], $siteData))
                    || (Func::isShopMenu('shopbranch/text-html?type='.$data->values['shop_table_catalog_id'], $siteData))){ ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                            ...
                            <div class="col-md-9 record-textarea">
                                <textarea name="text" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_branch.fields_title.text', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" rows="11" class="form-control"><?php echo $data->values['text'];?></textarea>
                            </div>
                        </div>
                    <?php } ?>
                </div>
    ...
    <div class="col-md-3">
        <?php if (Func::isShopMenu('shopbranch/image?type='.$data->values['shop_table_catalog_id'], $siteData, TRUE)){ ?>
            <?php
...
<?php if (Func::isShopMenu('shopbranch/text-html?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
<script>
