...
function isIgnore($name){
    switch($name){
        ...
        case 'branch_id': return TRUE; break;
        ...
        case 'sales_branch_count': return TRUE; break;
        default:
            return FALSE;
    }
}
...
function writeElementName(&$data, $name){
    switch($name){
        ...
        case 'branch_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.branch_select_type_id.name', ''); break;
        case 'shop_branch_unit_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.shop_branch_unit_type_id.name', ''); break;
        default:
            $result = '';
    }
