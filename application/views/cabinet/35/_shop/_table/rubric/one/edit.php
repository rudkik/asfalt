<div class="row">
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php if (Func::isShopMenu('shoptablerubric/seo?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li class=""><a href="#tab7" data-toggle="tab">SEO-настройки <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shoptablerubric/remarketing?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="row record-input record-list">
                        <div class="col-md-3 record-title">
                            <label>
                                ...
                                <?php echo SitePageData::setPathReplace('type.form_data.shop_table_rubric.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
                                <a href="#"><i class="fa fa-fw fa-info text-blue"></i></a>
                            </label>
                        </div>
                        <div class="col-md-9">
                            <div class="input-group">
                                <input id="good-edit-name" name="name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_table_rubric.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['name']);?>">
                    ...
                    <?php if (Func::isShopMenu('shoptablerubric/root?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                        <div class="row record-input record-tab margin-top-10px">
                            <div class="col-md-3 record-title">
                                <label>
                                    <?php echo SitePageData::setPathReplace('type.form_data.shop_table_rubric.fields_title.root', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
                                    <a href="#"><i class="fa fa-fw fa-info text-blue"></i></a>
                                </label>
                            </div>
                            <div class="col-md-9">
                    ...
                    <div class="row record-input2 record-tab">
                        <?php if (((Func::isShopMenu('shoptablerubric/brand?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                                    <?php echo SitePageData::setPathReplace('type.form_data.shop_table_rubric.fields_title.brand', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
                                    <a href="#"><i class="fa fa-fw fa-info text-blue"></i></a>
                                </label>
                            </div>
                            <div class="col-md-3">
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shoptablerubric/unit?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                                    <?php echo SitePageData::setPathReplace('type.form_data.shop_table_rubric.fields_title.unit', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
                                    <a href="#"><i class="fa fa-fw fa-info text-blue"></i></a>
                                </label>
                            </div>
                            <div class="col-md-3">
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shoptablerubric/select?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                                    <?php echo SitePageData::setPathReplace('type.form_data.shop_table_rubric.fields_title.select', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
                                    <a href="#"><i class="fa fa-fw fa-info text-blue"></i></a>
                                </label>
                            </div>
                            <div class="col-md-3">
                    ...
                    <?php if ((Func::isShopMenu('shoptablerubric/text?type='.$data->values['shop_table_catalog_id'], $siteData))
                    || (Func::isShopMenu('shoptablerubric/text-html?type='.$data->values['shop_table_catalog_id'], $siteData))){ ?>
                    <div class="row record-input record-list">
                        <div class="col-md-3 record-title">
                            <label>
                                <?php echo SitePageData::setPathReplace('type.form_data.shop_table_rubric.fields_title.text', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
                                <a href="#"><i class="fa fa-fw fa-info text-blue"></i></a>
                            </label>
                        </div>
                        <div class="col-md-9 record-textarea">
                            <textarea name="text" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_table_rubric.fields_title.text', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" rows="11" class="form-control"><?php echo $data->values['text'];?></textarea>
                        </div>
                    </div>
                    <?php } ?>
                </div>
                <?php if (Func::isShopMenu('shoptablerubric/seo?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <div class="tab-pane" id="tab7">
                        ...
                        $view->data = $data;
                        $view->seoPrefix = '';
                        $view->rootSEOName = 'shop_table_catalog_id.seo.shop_table_rubric';
    ...
    <div class="col-md-3">
        ...
        $view->data = $data;
        $view->columnSize = 12;
        $view->imageTypes = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS.'.shop_table_catalog_id.image_types.shop_table_rubric', array());
        echo Helpers_View::viewToStr($view);
        ?>
    </div>
</div>
...
<?php if (Func::isShopMenu('shoptablerubric/text-html?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
    <script>
