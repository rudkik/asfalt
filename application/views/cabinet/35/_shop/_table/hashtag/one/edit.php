    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php if (Func::isShopMenu('shoptablehashtag/seo?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li class=""><a href="#tab7" data-toggle="tab">SEO-настройки <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shoptablehashtag/remarketing?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="row record-input record-list">
                        ...
                        <div class="col-md-9">
                            <input name="name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_table_hashtag.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['name']);?>">
                        </div>
                    </div>
                    ...
                    <?php if ((Func::isShopMenu('shoptablehashtag/text?type='.$data->values['shop_table_catalog_id'], $siteData))
                    || (Func::isShopMenu('shoptablehashtag/text-html?type='.$data->values['shop_table_catalog_id'], $siteData))){ ?>
                    <div class="row record-input record-list">
                        <div class="col-md-3 record-title">
                            <label>
                        ...
                        <div class="col-md-9 record-textarea">
                            <textarea name="text" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_table_hashtag.fields_title.text', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" rows="11" class="form-control"><?php echo $data->values['text'];?></textarea>
                        </div>
                    </div>
                    <?php } ?>
                </div>
...
<?php if (Func::isShopMenu('shoptablehashtag/text-html?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
    <script>
