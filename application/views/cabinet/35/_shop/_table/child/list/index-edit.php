<form action="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shoptablechild/savelist" method="post">
    ...
    <table id="edit-list" class="table table-hover table-db">
        ...
        <?php
        foreach ($data['view::_shop/_table/child/one/index-edit']->childs as $value) {
            echo $value->str;
        }
        ?>
    </table>
