                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_branch][fields_title][name_list]" type="text" class="form-control" value="филиалы"></td>
                                        </tr>
                                        <tr>
                                            <td>Один филиал</td>
                                            <td><input name="form_data[shop_branch][fields_title][name_one]" type="text" class="form-control" value="филиал"></td>
                                        </tr>
                                        <tr>
                                            <td>Название</td>
                                            <td><input name="form_data[shop_branch][fields_title][name]" type="text" class="form-control" value="Название"></td>
                                        </tr>
                                        <tr>
                                            <td>Обслуживающий менеджер</td>
                                            <td><input name="form_data[shop_branch][fields_title][shop_operation_id]" type="text" class="form-control" value="Обслуживающий менеджер"></td>
                                        </tr>
                                        <tr>
                                            <td>Баланс/td>
                                            <td><input name="form_data[shop_branch][fields_title][balance]" type="text" class="form-control" value="Баланс"></td>
                                        </tr>
                                        <tr>
                                            <td>Город</td>
                                            <td><input name="form_data[shop_branch][fields_title][city]" type="text" class="form-control" value="Город"></td>
                                        </tr>
                                        <tr>
                                            <td>Официальное название</td>
                                            <td><input name="form_data[shop_branch][fields_title][official_name]" type="text" class="form-control" value="Официальное название"></td>
                                        </tr>
                                        <tr>
                                            <td>Поддомен</td>
                                            <td><input name="form_data[shop_branch][fields_title][sub_domain]" type="text" class="form-control" value="Поддомен"></td>
                                        </tr>
                                        <tr>
                                            <td>Домен</td>
                                            <td><input name="form_data[shop_branch][fields_title][domain]" type="text" class="form-control" value="Домен"></td>
                                        </tr>
                                        <tr>
                                            <td>Единица измерения</td>
                                            <td><input name="form_data[shop_branch][fields_title][unit]" type="text" class="form-control" value="Единица измерения"></td>
                                        </tr>
                                        <tr>
                                            <td>Тип выделения</td>
                                            <td><input name="form_data[shop_branch][fields_title][select]" type="text" class="form-control" value="Тип выделения"></td>
                                        </tr>
                                        <tr>
                                            <td>Рубрика</td>
                                            <td><input name="form_data[shop_branch][fields_title][rubric]" type="text" class="form-control" value="Рубрика"></td>
                                        </tr>
                                        <tr>
                                            <td>Бренд</td>
                                            <td><input name="form_data[shop_branch][fields_title][brand]" type="text" class="form-control" value="Бренд"></td>
                                        </tr>
                                        <tr>
                                            <td>Хэштег</td>
                                            <td><input name="form_data[shop_branch][fields_title][hashtag]" type="text" class="form-control" value="Хэштег"></td>
                                        </tr>
                                        <tr>
                                            <td>Описание</td>
                                            <td><input name="form_data[shop_branch][fields_title][text]" type="text" class="form-control" value="Описание"></td>
                                        </tr>
                                        <tr>
                                            <td>Фильтры</td>
                                            <td><input name="form_data[shop_branch][fields_title][filter]" type="text" class="form-control" value="Фильтры"></td>
                                        </tr>
                                        <tr>
                                            <td>Подобные филиалы</td>
                                            <td><input name="form_data[shop_branch][fields_title][similar]" type="text" class="form-control" value="Подобные филиалы"></td>
                                        </tr>
                                        <tr>
                                            <td>Связанные филиалы</td>
                                            <td><input name="form_data[shop_branch][fields_title][group_name]" type="text" class="form-control" value="Связанные филиалы"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
