        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab1-1" data-toggle="tab">Склад оператора</a></li>
                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_good][fields_title][name_list]" type="text" class="form-control" value="склады операторов"></td>
                                        </tr>
                                        <tr>
                                            <td>Один склад оператора</td>
                                            <td><input name="form_data[shop_good][fields_title][name_one]" type="text" class="form-control" value="склад оператора"></td>
                                        </tr>
                                        <tr>
                                            <td>ФИО</td>
                                            <td><input name="form_data[shop_operation_stock][fields_title][name]" type="text" class="form-control" value="ФИО"></td>
                                        </tr>
                                        <tr>
                                            <td>Статус</td>
                                            <td><input name="form_data[shop_operation_stock][fields_title][is_close]" type="text" class="form-control" value="Закрыто"></td>
                                        </tr>
                                        <tr>
                                            <td>Менеджер</td>
                                            <td><input name="form_data[shop_operation_stock][fields_title][shop_operation_id]" type="text" class="form-control" value="Менеджер"></td>
                                        </tr>                                        
                                        <tr>
                                            <td>Дата создания</td>
                                            <td><input name="form_data[shop_operation_stock][fields_title][created_at]" type="text" class="form-control" value="Дата создания"></td>
                                        </tr>
                                        <tr>
                                            <td>Кто создал</td>
                                            <td><input name="form_data[shop_operation_stock][fields_title][create_user_id]" type="text" class="form-control" value="Кто создал"></td>
                                        </tr>
                                        <tr>
                                            <td>Стоимость</td>
                                            <td><input name="form_data[shop_operation_stock][fields_title][amount]" type="text" class="form-control" value="Стоимость"></td>
                                        </tr>
                                        <tr>
                                            <td>Пер. стоимость</td>
                                            <td><input name="form_data[shop_operation_stock][fields_title][amount_first]" type="text" class="form-control" value="Пер. стоимость"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
