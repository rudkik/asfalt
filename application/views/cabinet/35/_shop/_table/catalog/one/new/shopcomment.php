                            ...
                            <div class="active tab-pane" id="tab1-1">
                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            <td>Список комментариев</td>
                                            <td><input name="form_data[shop_comment][fields_title][name_list]" type="text" class="form-control" value="комментарии"></td>
                                        </tr>
                                        <tr>
                                            <td>Один комментарий</td>
                                            <td><input name="form_data[shop_comment][fields_title][name_one]" type="text" class="form-control" value="комментарий"></td>
                                        </tr>
                                        <tr>
                                            <td>ФИО</td>
                                            <td><input name="form_data[shop_comment][fields_title][name]" type="text" class="form-control" value="ФИО"></td>
                                        </tr>
                                        <tr>
                                            <td>Единица измерения</td>
                                            <td><input name="form_data[shop_comment][fields_title][unit]" type="text" class="form-control" value="Единица измерения"></td>
                                        </tr>
                                        <tr>
                                            <td>Тип выделения</td>
                                            <td><input name="form_data[shop_comment][fields_title][select]" type="text" class="form-control" value="Тип выделения"></td>
                                        </tr>
                                        <tr>
                                            <td>Дата создания</td>
                                            <td><input name="form_data[shop_comment][fields_title][created_at]" type="text" class="form-control" value="Дата создания"></td>
                                        </tr>
                                        <tr>
                                            <td>Рубрика</td>
                                            <td><input name="form_data[shop_comment][fields_title][rubric]" type="text" class="form-control" value="Рубрика"></td>
                                        </tr>
                                        <tr>
                                            <td>Бренд</td>
                                            <td><input name="form_data[shop_comment][fields_title][brand]" type="text" class="form-control" value="Бренд"></td>
                                        </tr>
                                        <tr>
                                            <td>Хэштег</td>
                                            <td><input name="form_data[shop_comment][fields_title][hashtag]" type="text" class="form-control" value="Хэштег"></td>
                                        </tr>
                                        <tr>
                                            <td>Описание</td>
                                            <td><input name="form_data[shop_comment][fields_title][text]" type="text" class="form-control" value="Описание"></td>
                                        </tr>
                                        <tr>
                                            <td>Фильтры</td>
                                            <td><input name="form_data[shop_comment][fields_title][filter]" type="text" class="form-control" value="Фильтры"></td>
                                        </tr>
                                        <tr>
                                            <td>Подобные комментарий</td>
                                            <td><input name="form_data[shop_comment][fields_title][similar]" type="text" class="form-control" value="Подобные комментарий"></td>
                                        </tr>
                                        <tr>
                                            <td>Связанные комментарий</td>
                                            <td><input name="form_data[shop_comment][fields_title][group_name]" type="text" class="form-control" value="Связанные комментарий"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
