                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_client][fields_title][name_list]" type="text" class="form-control" value="клиенты"></td>
                                        </tr>
                                        <tr>
                                            <td>Один клиент</td>
                                            <td><input name="form_data[shop_client][fields_title][name_one]" type="text" class="form-control" value="клиент"></td>
                                        </tr>
                                        <tr>
                                            <td>Имя</td>
                                            <td><input name="form_data[shop_client][fields_title][name]" type="text" class="form-control" value="Имя"></td>
                                        </tr>
                                        <tr>
                                            <td>Фамилия</td>
                                            <td><input name="form_data[shop_client][fields_title][last_name]" type="text" class="form-control" value="Фамилия"></td>
                                        </tr>
                                        <tr>
                                            <td>Контакты</td>
                                            <td><input name="form_data[shop_client][fields_title][contacts]" type="text" class="form-control" value="Контакты"></td>
                                        </tr>
                                        <tr>
                                            <td>Единица измерения</td>
                                            <td><input name="form_data[shop_client][fields_title][unit]" type="text" class="form-control" value="Единица измерения"></td>
                                        </tr>
                                        <tr>
                                            <td>Тип выделения</td>
                                            <td><input name="form_data[shop_client][fields_title][select]" type="text" class="form-control" value="Тип выделения"></td>
                                        </tr>
                                        <tr>
                                            <td>Рубрика</td>
                                            <td><input name="form_data[shop_client][fields_title][rubric]" type="text" class="form-control" value="Рубрика"></td>
                                        </tr>
                                        <tr>
                                            <td>Бренд</td>
                                            <td><input name="form_data[shop_client][fields_title][brand]" type="text" class="form-control" value="Бренд"></td>
                                        </tr>
                                        <tr>
                                            <td>Хэштег</td>
                                            <td><input name="form_data[shop_client][fields_title][hashtag]" type="text" class="form-control" value="Хэштег"></td>
                                        </tr>
                                        <tr>
                                            <td>Описание</td>
                                            <td><input name="form_data[shop_client][fields_title][text]" type="text" class="form-control" value="Описание"></td>
                                        </tr>
                                        <tr>
                                            <td>Фильтры</td>
                                            <td><input name="form_data[shop_client][fields_title][filter]" type="text" class="form-control" value="Фильтры"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
