                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_bill][fields_title][name_list]" type="text" class="form-control" value="заказы"></td>
                                        </tr>
                                        <tr>
                                            <td>Один заказ</td>
                                            <td><input name="form_data[shop_bill][fields_title][name_one]" type="text" class="form-control" value="заказ"></td>
                                        </tr>
                                        <tr>
                                            <td>Адрес</td>
                                            <td><input name="form_data[shop_bill][fields_title][address]" type="text" class="form-control" value="Адрес"></td>
                                        </tr>
                                        <tr>
                                            <td>ФИО</td>
                                            <td><input name="form_data[shop_bill][fields_title][name]" type="text" class="form-control" value="ФИО"></td>
                                        </tr>
                                        <tr>
                                            <td>Статус</td>
                                            <td><input name="form_data[shop_bill][fields_title][shop_bill_status_id]" type="text" class="form-control" value="Статус"></td>
                                        </tr>
                                        <tr>
                                            <td>Оплата</td>
                                            <td><input name="form_data[shop_bill][fields_title][shop_paid_type_id]" type="text" class="form-control" value="Оплата"></td>
                                        </tr>
                                        <tr>
                                            <td>Доставка</td>
                                            <td><input name="form_data[shop_bill][fields_title][shop_delivery_type_id]" type="text" class="form-control" value="Доставка"></td>
                                        </tr>
                                        <tr>
                                            <td>Магазин</td>
                                            <td><input name="form_data[shop_bill][fields_title][shop_root_id]" type="text" class="form-control" value="Магазин"></td>
                                        </tr>
                                        <tr>
                                            <td>Страна</td>
                                            <td><input name="form_data[shop_bill][fields_title][country_id]" type="text" class="form-control" value="Страна"></td>
                                        </tr>
                                        <tr>
                                            <td>Город</td>
                                            <td><input name="form_data[shop_bill][fields_title][city_id]" type="text" class="form-control" value="Город"></td>
                                        </tr>
                                        <tr>
                                            <td>Дата оплаты</td>
                                            <td><input name="form_data[shop_bill][fields_title][paid_at]" type="text" class="form-control" value="Дата оплаты "></td>
                                        </tr>
                                        <tr>
                                            <td>Дата доставки</td>
                                            <td><input name="form_data[shop_bill][fields_title][delivery_at]" type="text" class="form-control" value="Дата доставки"></td>
                                        </tr>
                                        <tr>
                                            <td>Стоимость доставки</td>
                                            <td><input name="form_data[shop_bill][fields_title][delivery_amount]" type="text" class="form-control" value="Стоимость доставки"></td>
                                        </tr>
                                        <tr>
                                            <td>Дата создания</td>
                                            <td><input name="form_data[shop_bill][fields_title][created_at]" type="text" class="form-control" value="Дата создания"></td>
                                        </tr>
                                        <tr>
                                            <td>Кто создал</td>
                                            <td><input name="form_data[shop_bill][fields_title][create_user_id]" type="text" class="form-control" value="Кто создал"></td>
                                        </tr>
                                        <tr>
                                            <td>Стоимость</td>
                                            <td><input name="form_data[shop_bill][fields_title][amount]" type="text" class="form-control" value="Стоимость"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
