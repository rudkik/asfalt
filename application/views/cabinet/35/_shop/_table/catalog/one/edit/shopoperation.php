        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab1-1" data-toggle="tab">Оператор</a></li>
                            ...
                            <div class="active tab-pane" id="tab1-1">
                                ...
                                <div class="row record-input record-list margin-t-15">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        $view->data = $data;
                                        $view->optionsChild = 'shop_operation';
                                    ...
                                    <div class="col-md-9">
                                        <table id="body_panel" class="table table-hover table-db margin-b-5">
                                            ...
                                            <tr>
                                                ...
                                                <td><input name="form_data[shop_operation][fields_title][name_list]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.name_list', 'операторы '.$data->values['name']), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Один оператор</td>
                                                <td><input name="form_data[shop_operation][fields_title][name_one]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.name_one', 'оператор '.$data->values['name']), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Кнопка добавить</td>
                                                <td><input name="form_data[shop_operation][fields_title][button_add]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.button_add', 'добавить '.$data->values['name']), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>ФИО</td>
                                                <td><input name="form_data[shop_operation][fields_title][name]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.name', 'ФИО'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>E-mail</td>
                                                <td><input name="form_data[shop_operation][fields_title][email]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.email', 'E-mail'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Пароль</td>
                                                <td><input name="form_data[shop_operation][fields_title][password]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.password', 'Пароль '), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Единица измерения</td>
                                                <td><input name="form_data[shop_operation][fields_title][unit]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.unit', 'Единица измерения'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Тип выделения</td>
                                                <td><input name="form_data[shop_operation][fields_title][select]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.select', 'Тип выделения'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Рубрика</td>
                                                <td><input name="form_data[shop_operation][fields_title][rubric]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.rubric', 'Рубрика'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Бренд</td>
                                                <td><input name="form_data[shop_operation][fields_title][brand]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.brand', 'Бренд'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Хэштег</td>
                                                <td><input name="form_data[shop_operation][fields_title][hashtag]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.hashtag', 'Хэштег'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Описание</td>
                                                <td><input name="form_data[shop_operation][fields_title][text]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.text', 'Описание'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Фильтры</td>
                                                <td><input name="form_data[shop_operation][fields_title][filter]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation.fields_title.filter', 'Фильтры'), ENT_QUOTES);?>"></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class="row record-input record-list margin-t-15">
                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            <td>Список рубрик</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][name_list]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation_rubric.fields_title.name_list', 'рубрики '.$data->values['name']), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Одна рубрика</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][name_one]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation_rubric.fields_title.name_one', 'рубрика '.$data->values['name']), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Кнопка добавления</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][button_add]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation_rubric.fields_title.button_add', 'добавить рубрику'), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Название</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][name]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation_rubric.fields_title.name', 'Название'), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Родитель</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][root]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation_rubric.fields_title.root', 'Родитель '), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Описание</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][text]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_operation_rubric.fields_title.text', 'Описание'), ENT_QUOTES);?>"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
