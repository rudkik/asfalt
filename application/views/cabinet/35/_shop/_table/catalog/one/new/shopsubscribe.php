                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_good][fields_title][name_list]" type="text" class="form-control" value="рассылки"></td>
                                        </tr>
                                        <tr>
                                            <td>Одна рассылка</td>
                                            <td><input name="form_data[shop_good][fields_title][name_one]" type="text" class="form-control" value="рассылка"></td>
                                        </tr>
                                        <tr>
                                            <td>Название</td>
