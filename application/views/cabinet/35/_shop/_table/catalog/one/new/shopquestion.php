                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_question][fields_title][name_list]" type="text" class="form-control" value="вопросы"></td>
                                        </tr>
                                        <tr>
                                            <td>Один вопрос</td>
                                            <td><input name="form_data[shop_question][fields_title][name_one]" type="text" class="form-control" value="вопрос"></td>
                                        </tr>
                                        <tr>
                                            <td>ФИО</td>
                                            <td><input name="form_data[shop_question][fields_title][name]" type="text" class="form-control" value="ФИО"></td>
                                        </tr>
                                        <tr>
                                            <td>Дата создания вопроса</td>
                                            <td><input name="form_data[shop_question][fields_title][created_at]" type="text" class="form-control" value="Дата создания вопроса"></td>
                                        </tr>
                                        <tr>
                                            <td>E-mail</td>
                                            <td><input name="form_data[shop_question][fields_title][email]" type="text" class="form-control" value="E-mail"></td>
                                        </tr>
                                        <tr>
                                            <td>Вопрос</td>
                                            <td><input name="form_data[shop_question][fields_title][text]" type="text" class="form-control" value="Вопрос"></td>
                                        </tr>
                                        <tr>
                                            <td>ФИО кто ответил</td>
                                            <td><input name="form_data[shop_question][fields_title][answer_user_name]" type="text" class="form-control" value="ФИО кто ответил"></td>
                                        </tr>
                                        <tr>
                                            <td>Дата ответа</td>
                                            <td><input name="form_data[shop_question][fields_title][answer_at]" type="text" class="form-control" value="Дата ответа"></td>
                                        </tr>
                                        <tr>
                                            <td>Ответ</td>
                                            <td><input name="form_data[shop_question][fields_title][answer_text]" type="text" class="form-control" value="Ответ"></td>
                                        </tr>
                                        <tr>
                                            <td>Единица измерения</td>
                                            <td><input name="form_data[shop_question][fields_title][unit]" type="text" class="form-control" value="Единица измерения"></td>
                                        </tr>
                                        <tr>
                                            <td>Тип выделения</td>
                                            <td><input name="form_data[shop_question][fields_title][select]" type="text" class="form-control" value="Тип выделения"></td>
                                        </tr>
                                        <tr>
                                            <td>Рубрика</td>
                                            <td><input name="form_data[shop_question][fields_title][rubric]" type="text" class="form-control" value="Рубрика"></td>
                                        </tr>
                                        <tr>
                                            <td>Бренд</td>
                                            <td><input name="form_data[shop_question][fields_title][brand]" type="text" class="form-control" value="Бренд"></td>
                                        </tr>
                                        <tr>
                                            <td>Хэштег</td>
                                            <td><input name="form_data[shop_question][fields_title][hashtag]" type="text" class="form-control" value="Хэштег"></td>
                                        </tr>
                                        <tr>
                                            <td>Фильтры</td>
                                            <td><input name="form_data[shop_question][fields_title][filter]" type="text" class="form-control" value="Фильтры"></td>
                                        </tr>
                                        <tr>
                                            <td>Подобные вопросы / услуги</td>
                                            <td><input name="form_data[shop_question][fields_title][similar]" type="text" class="form-control" value="Подобные вопросы / услуги"></td>
                                        </tr>
                                        <tr>
                                            <td>Связанные вопросы</td>
                                            <td><input name="form_data[shop_question][fields_title][group_name]" type="text" class="form-control" value="Связанные вопросы"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
