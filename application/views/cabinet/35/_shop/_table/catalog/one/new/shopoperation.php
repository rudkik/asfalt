        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab1-1" data-toggle="tab">Сотрудник</a></li>
                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_operation][fields_title][name_list]" type="text" class="form-control" value="сотрудники"></td>
                                        </tr>
                                        <tr>
                                            <td>Один сотрудник</td>
                                            <td><input name="form_data[shop_operation][fields_title][name_one]" type="text" class="form-control" value="сотрудник"></td>
                                        </tr>
                                        <tr>
                                            <td>ФИО</td>
                                            <td><input name="form_data[shop_operation][fields_title][name]" type="text" class="form-control" value="ФИО"></td>
                                        </tr>
                                        <tr>
                                            <td>E-mail</td>
                                            <td><input name="form_data[shop_operation][fields_title][email]" type="text" class="form-control" value="E-mail"></td>
                                        </tr>
                                        <tr>
                                            <td>Пароль</td>
                                            <td><input name="form_data[shop_operation][fields_title][password]" type="text" class="form-control" value="Пароль"></td>
                                        </tr>
                                        <tr>
                                            <td>Единица измерения</td>
                                            <td><input name="form_data[shop_operation][fields_title][unit]" type="text" class="form-control" value="Единица измерения"></td>
                                        </tr>
                                        <tr>
                                            <td>Тип выделения</td>
                                            <td><input name="form_data[shop_operation][fields_title][select]" type="text" class="form-control" value="Тип выделения"></td>
                                        </tr>
                                        <tr>
                                            <td>Рубрика</td>
                                            <td><input name="form_data[shop_operation][fields_title][rubric]" type="text" class="form-control" value="Рубрика"></td>
                                        </tr>
                                        <tr>
                                            <td>Бренд</td>
                                            <td><input name="form_data[shop_operation][fields_title][brand]" type="text" class="form-control" value="Бренд"></td>
                                        </tr>
                                        <tr>
                                            <td>Хэштег</td>
                                            <td><input name="form_data[shop_operation][fields_title][hashtag]" type="text" class="form-control" value="Хэштег"></td>
                                        </tr>
                                        <tr>
                                            <td>Описание</td>
                                            <td><input name="form_data[shop_operation][fields_title][text]" type="text" class="form-control" value="Описание"></td>
                                        </tr>
                                        <tr>
                                            <td>Фильтры</td>
                                            <td><input name="form_data[shop_operation][fields_title][filter]" type="text" class="form-control" value="Фильтры"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
