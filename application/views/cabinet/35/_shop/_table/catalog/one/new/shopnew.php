        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="tab1-1">
                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            <td>Список статей</td>
                                            <td><input name="form_data[shop_new][fields_title][name_list]" type="text" class="form-control" value="статьи"></td>
                                        </tr>
                                        <tr>
                                            <td>Одна статья</td>
                                            <td><input name="form_data[shop_new][fields_title][name_one]" type="text" class="form-control" value="статья"></td>
                                        </tr>
                                        <tr>
                                            <td>Кнопка добавления</td>
                                            <td><input name="form_data[shop_new][fields_title][button_add]" type="text"
                                                       class="form-control" value="Добавить"></td>></td>
                                        </tr>
                                        <tr>
                                            <td>Название</td>
                                            <td><input name="form_data[shop_new][fields_title][name]" type="text" class="form-control" value="Название"></td>
                                        </tr>
                                        <tr>
                                            <td>Артикул</td>
                                            <td><input name="form_data[shop_new][fields_title][article]" type="text" class="form-control" value="Артикул"></td>
                                        </tr>
                                        <tr>
                                            <td>Дата создания</td>
                                            <td><input name="form_data[shop_new][fields_title][created_at]" type="text" class="form-control" value="Дата создания"></td>
                                        </tr>
                                        <tr>
                                            <td>Единица измерения</td>
                                            <td><input name="form_data[shop_new][fields_title][unit]" type="text" class="form-control" value="Единица измерения"></td>
                                        </tr>
                                        <tr>
                                            <td>Тип выделения</td>
                                            <td><input name="form_data[shop_new][fields_title][select]" type="text" class="form-control" value="Тип выделения"></td>
                                        </tr>
                                        <tr>
                                            <td>Рубрика</td>
                                            <td><input name="form_data[shop_new][fields_title][rubric]" type="text" class="form-control" value="Рубрика"></td>
                                        </tr>
                                        <tr>
                                            <td>Бренд</td>
                                            <td><input name="form_data[shop_new][fields_title][brand]" type="text" class="form-control" value="Бренд"></td>
                                        </tr>
                                        <tr>
                                            <td>Хэштег</td>
                                            <td><input name="form_data[shop_new][fields_title][hashtag]" type="text" class="form-control" value="Хэштег"></td>
                                        </tr>
                                        <tr>
                                            <td>Описание</td>
                                            <td><input name="form_data[shop_new][fields_title][text]" type="text" class="form-control" value="Описание"></td>
                                        </tr>
                                        <tr>
                                            <td>Фильтры</td>
                                            <td><input name="form_data[shop_new][fields_title][filter]" type="text" class="form-control" value="Фильтры"></td>
                                        </tr>
                                        <tr>
                                            <td>Подобные статьи / новости</td>
                                            <td><input name="form_data[shop_new][fields_title][similar]" type="text" class="form-control" value="Подобные статьи / новости"></td>
                                        </tr>
                                        <tr>
                                            <td>Связанные статьи</td>
                                            <td><input name="form_data[shop_new][fields_title][group_name]" type="text" class="form-control" value="Связанные статьи"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                ...
                <div class="tab-pane" id="tab7">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab7-1" data-toggle="tab">Подстатьи доп. параметры</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="active tab-pane" id="tab7-1">
                                ...
                                <div class="row record-input record-list">
                                    ...
                                    <div class="col-md-9">
                                        <input name="child_shop_table_catalog_ids[hashtag][name]" type="text" class="form-control" placeholder="Название" value="Подстатьи">
                                    </div>
                                </div>
                                <div class="row record-input record-list margin-t-15">
                                    <div class="col-md-3 record-title">
                                    ...
                                    <div class="col-md-9">
                                        <table id="body_panel" class="table table-hover table-db margin-b-5">
                                            ...
                                            <tr>
                                                ...
                                                <td><input name="form_data[shop_table_hashtag][fields_title][name_list]" type="text" class="form-control" value="подстатьи"></td>
                                            </tr>
                                            <tr>
                                                <td>Одна подстатья</td>
                                                <td><input name="form_data[shop_table_hashtag][fields_title][name_one]" type="text" class="form-control" value="подстатья"></td>
                                            </tr>
                                            <tr>
                                                <td>Кнопка добавления</td>
                                                <td><input name="form_data[shop_table_hashtag][fields_title][button_add]" type="text" class="form-control" value="добавить подстатью"></td>
                                            </tr>
                                            <tr>
                                                <td>Название</td>
                                                <td><input name="form_data[shop_table_hashtag][fields_title][name]" type="text" class="form-control" value="Название"></td>
