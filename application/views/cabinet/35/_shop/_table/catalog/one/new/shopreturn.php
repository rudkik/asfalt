                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_good][fields_title][name_list]" type="text" class="form-control" value="возвраты"></td>
                                        </tr>
                                        <tr>
                                            <td>Один возврат</td>
                                            <td><input name="form_data[shop_good][fields_title][name_one]" type="text" class="form-control" value="возврат"></td>
                                        </tr>
                                        <tr>
                                            <td>ФИО</td>
                                            <td><input name="form_data[shop_return][fields_title][name]" type="text" class="form-control" value="ФИО"></td>
                                        </tr>
                                        <tr>
                                            <td>Страна</td>
                                            <td><input name="form_data[shop_return][fields_title][country_id]" type="text" class="form-control" value="Страна"></td>
                                        </tr>
                                        <tr>
                                            <td>Город</td>
                                            <td><input name="form_data[shop_return][fields_title][city_id]" type="text" class="form-control" value="Город"></td>
                                        </tr>
                                        <tr>
                                            <td>Дата создания</td>
                                            <td><input name="form_data[shop_return][fields_title][created_at]" type="text" class="form-control" value="Дата создания"></td>
                                        </tr>
                                        <tr>
                                            <td>Кто создал</td>
                                            <td><input name="form_data[shop_return][fields_title][create_user_id]" type="text" class="form-control" value="Кто создал"></td>
                                        </tr>
                                        <tr>
                                            <td>Стоимость</td>
                                            <td><input name="form_data[shop_return][fields_title][amount]" type="text" class="form-control" value="Стоимость"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
