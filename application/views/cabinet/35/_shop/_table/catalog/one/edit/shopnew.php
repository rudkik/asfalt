    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="#tab7" data-toggle="tab">Подстатья</a></li>
            </ul>
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab1-1" data-toggle="tab">Статья</a></li>
                                ...
                                <div class="row record-input record-list margin-t-15"">
                                    ...
                                    <div class="col-md-9">
                                        <table id="body_panel" class="table table-hover table-db margin-b-5">
                                            ...
                                            <tr>
                                                <td>Список статей</td>
                                                <td><input name="form_data[shop_new][fields_title][name_list]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.name_list', 'статьи '.$data->values['name']), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Одна статья</td>
                                                <td><input name="form_data[shop_new][fields_title][name_one]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.name_one', 'статья '.$data->values['name']), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Кнопка добавления</td>
                                                <td><input name="form_data[shop_new][fields_title][button_add]" type="text"
                                                           class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.button_add', 'добавить'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Название</td>
                                                <td><input name="form_data[shop_new][fields_title][name]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.name', 'Название'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Артикул</td>
                                                <td><input name="form_data[shop_new][fields_title][article]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.article', 'Артикул'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Дата создания</td>
                                                <td><input name="form_data[shop_new][fields_title][created_at]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.created_at', 'Дата создания'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Единица измерения</td>
                                                <td><input name="form_data[shop_new][fields_title][unit]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.unit', 'Единица измерения'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Тип выделения</td>
                                                <td><input name="form_data[shop_new][fields_title][select]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.select', 'Тип выделения'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Рубрика</td>
                                                <td><input name="form_data[shop_new][fields_title][rubric]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.rubric', 'Рубрика'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Бренд</td>
                                                <td><input name="form_data[shop_new][fields_title][brand]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.brand', 'Бренд'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Хэштег</td>
                                                <td><input name="form_data[shop_new][fields_title][hashtag]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.hashtag', 'Хэштег'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Описание</td>
                                                <td><input name="form_data[shop_new][fields_title][text]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.text', 'Описание'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Фильтры</td>
                                                <td><input name="form_data[shop_new][fields_title][filter]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.filter', 'Фильтры'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Подобные статьи / новости</td>
                                                <td><input name="form_data[shop_new][fields_title][similar]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.similar', 'Подобные статьи / новости'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Связанные статьи</td>
                                                <td><input name="form_data[shop_new][fields_title][group_name]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new.fields_title.group_name', 'Связанные статьи'), ENT_QUOTES);?>"></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class="row record-input record-list margin-t-15">
                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            <td>Список рубрик</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][name_list]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new_rubric.fields_title.name_list', 'рубрики '.$data->values['name']), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Одна рубрика</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][name_one]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new_rubric.fields_title.name_one', 'рубрика '.$data->values['name']), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Кнопка добавления</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][button_add]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new_rubric.fields_title.button_add', 'добавить рубрику'), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Название</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][name]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new_rubric.fields_title.name', 'Название'), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Родитель</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][root]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new_rubric.fields_title.root', 'Родитель '), ENT_QUOTES);?>"></td>
                                        </tr>
                                        <tr>
                                            <td>Описание</td>
                                            <td><input name="form_data[shop_table_rubric][fields_title][text]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_new_rubric.fields_title.text', 'Описание'), ENT_QUOTES);?>"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                ...
                <div class="tab-pane" id="tab7">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab7-1" data-toggle="tab">Подстатья доп. параметры</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="active tab-pane" id="tab7-1">
                                ...
                                <div class="row record-input record-list">
                                    ...
                                    <div class="col-md-9">
                                        <input name="child_shop_table_catalog_ids[child][name]" type="text" class="form-control" placeholder="Название" value="<?php echo htmlspecialchars(Arr::path($data->values['child_shop_table_catalog_ids'], 'child.name', 'Подстатьи'));?>">
                                    </div>
                                </div>
                                <div class="row record-input record-list margin-t-15">
                                    <div class="col-md-3 record-title">
                                ...
                                <div class="row record-input record-list margin-t-15">
                                    ...
                                    <div class="col-md-9">
                                        <table id="body_panel" class="table table-hover table-db margin-b-5">
                                            ...
                                            <tr>
                                                <td>Список подстатей</td>
                                                <td><input name="form_data[shop_table_child][fields_title][name_list]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_table_child.form_data.fields_title.name_list', 'подстатьи '.$data->values['name']), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Одна подстатья</td>
                                                <td><input name="form_data[shop_table_child][fields_title][name_one]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_table_child.form_data.fields_title.name_one', 'подстатья '.$data->values['name']), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Кнопка добавления</td>
                                                <td><input name="form_data[shop_table_child][fields_title][button_add]" type="text" class="form-control" value="<?php echo htmlspecialchars(Arr::path($data->values['form_data'], 'shop_table_child.form_data.fields_title.button_add', 'добавить подстатью'), ENT_QUOTES);?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Название</td>
