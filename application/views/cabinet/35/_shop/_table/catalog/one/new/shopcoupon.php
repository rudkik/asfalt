    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_coupon][fields_title][name_list]" type="text" class="form-control" value="купоны"></td>
                                        </tr>
                                        <tr>
                                            <td>Один купон</td>
                                            <td><input name="form_data[shop_coupon][fields_title][name_one]" type="text" class="form-control" value="купон"></td>
                                        </tr>
                                        <tr>
                                            <td>Название</td>
                                            <td><input name="form_data[shop_coupon][fields_title][name]" type="text" class="form-control" value="Название"></td>
                                        </tr>
                                        <tr>
                                            <td>Номер купона</td>
                                            <td><input name="form_data[shop_coupon][fields_title][number]" type="text" class="form-control" value="Номер купона"></td>
                                        </tr>
                                        <tr>
                                            <td>Скидка</td>
                                            <td><input name="form_data[shop_coupon][fields_title][discount]" type="text" class="form-control" value="Скидка"></td>
                                        </tr>
                                        <tr>
                                            <td>Единица измерения</td>
                                            <td><input name="form_data[shop_coupon][fields_title][unit]" type="text" class="form-control" value="Единица измерения"></td>
                                        </tr>
                                        <tr>
                                            <td>Тип выделения</td>
                                            <td><input name="form_data[shop_coupon][fields_title][select]" type="text" class="form-control" value="Тип выделения"></td>
                                        </tr>
                                        <tr>
                                            <td>Рубрика</td>
                                            <td><input name="form_data[shop_coupon][fields_title][rubric]" type="text" class="form-control" value="Рубрика"></td>
                                        </tr>
                                        <tr>
                                            <td>Бренд</td>
                                            <td><input name="form_data[shop_coupon][fields_title][brand]" type="text" class="form-control" value="Бренд"></td>
                                        </tr>
                                        <tr>
                                            <td>Хэштег</td>
                                            <td><input name="form_data[shop_coupon][fields_title][hashtag]" type="text" class="form-control" value="Хэштег"></td>
                                        </tr>
                                        <tr>
                                            <td>Описание</td>
                                            <td><input name="form_data[shop_coupon][fields_title][text]" type="text" class="form-control" value="Описание"></td>
                                        </tr>
                                        <tr>
                                            <td>Фильтры</td>
                                            <td><input name="form_data[shop_coupon][fields_title][filter]" type="text" class="form-control" value="Фильтры"></td>
                                        </tr>
                                        <tr>
                                            <td>Подобные купоны</td>
                                            <td><input name="form_data[shop_coupon][fields_title][similar]" type="text" class="form-control" value="Подобные купоны"></td>
                                        </tr>
                                        <tr>
                                            <td>Связанные купоны</td>
                                            <td><input name="form_data[shop_coupon][fields_title][group_name]" type="text" class="form-control" value="Связанные купоны"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
            ...
            <div class="tab-pane" id="tab7">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab7-1" data-toggle="tab">Подкупоны доп. параметры</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="active tab-pane" id="tab7-1">
                            ...
                            <div class="row record-input record-list">
                                ...
                                <div class="col-md-9">
                                    <input name="child_shop_table_catalog_ids[hashtag][name]" type="text" class="form-control" placeholder="Название" value="Подкупоны">
                                </div>
                            </div>
                            <div class="row record-input record-list margin-t-15">
                                <div class="col-md-3 record-title">
                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="form_data[shop_table_hashtag][fields_title][name_list]" type="text" class="form-control" value="подкупоны"></td>
                                        </tr>
                                        <tr>
                                            <td>Один подкупон</td>
                                            <td><input name="form_data[shop_table_hashtag][fields_title][name_one]" type="text" class="form-control" value="подкупон"></td>
                                        </tr>
                                        <tr>
                                            <td>Кнопка добавления</td>
                                            <td><input name="form_data[shop_table_hashtag][fields_title][button_add]" type="text" class="form-control" value="добавить подкупон"></td>
                                        </tr>
                                        <tr>
                                            <td>Название</td>
                                            <td><input name="form_data[shop_table_hashtag][fields_title][name]" type="text" class="form-control" value="Название"></td>
