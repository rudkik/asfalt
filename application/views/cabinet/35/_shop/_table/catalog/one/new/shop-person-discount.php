                            ...
                            <div class="active tab-pane" id="tab1-1">
                                ...
                                <div class="col-md-9">
                                    <table id="body_panel" class="table table-hover table-db margin-b-5">
                                        ...
                                        <tr>
                                            <td>Список скидок</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][name_list]" type="text" class="form-control" value="персональные скидки"></td>
                                        </tr>
                                        <tr>
                                            <td>Одна скидка</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][name_one]" type="text" class="form-control" value="персональная скидка"></td>
                                        </tr>
                                        <tr>
                                            <td>Название</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][name]" type="text" class="form-control" value="Название"></td>
                                        </tr>
                                        <tr>
                                            <td>Номер телефона</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][phone]" type="text" class="form-control" value="Номер телефона"></td>
                                        </tr>
                                        <tr>
                                            <td>Скидка</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][discount]" type="text" class="form-control" value="Скидка"></td>
                                        </tr>
                                        <tr>
                                            <td>Единица измерения</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][unit]" type="text" class="form-control" value="Единица измерения"></td>
                                        </tr>
                                        <tr>
                                            <td>Тип выделения</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][select]" type="text" class="form-control" value="Тип выделения"></td>
                                        </tr>
                                        <tr>
                                            <td>Рубрика</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][rubric]" type="text" class="form-control" value="Рубрика"></td>
                                        </tr>
                                        <tr>
                                            <td>Бренд</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][brand]" type="text" class="form-control" value="Бренд"></td>
                                        </tr>
                                        <tr>
                                            <td>Хэштег</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][hashtag]" type="text" class="form-control" value="Хэштег"></td>
                                        </tr>
                                        <tr>
                                            <td>Описание</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][text]" type="text" class="form-control" value="Описание"></td>
                                        </tr>
                                        <tr>
                                            <td>Фильтры</td>
                                            <td><input name="form_data[shop_person_discount][fields_title][filter]" type="text" class="form-control" value="Фильтры"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
