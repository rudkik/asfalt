<?php if ((Func::isShopMenu('shopgood/index?type='.$data->id, $siteData))){ ?>
    <li <?php if(!(($siteData->controllerName == 'shopgood')
        && (Request_RequestParams::getParamInt('type') == $data->id)
        && (Request_RequestParams::getParamInt('is_group') == 0))){echo 'class="menu-left"';} ?>>
        <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index', array(), array('is_public_ignore' => 1, 'type' => $data->id, 'is_group' => 0)); ?>"><i class="fa fa-circle-o text-light-blue"></i>
...
<?php if ((Func::isShopMenu('shopgood/group?type='.$data->id, $siteData))){ ?>
    <li <?php if(!(($siteData->controllerName == 'shopgood')
        ...
        <a href="<?php echo Func::getFullURL($siteData, '/shopgood/index', array(), array('is_public_ignore' => 1, 'type' => $data->id, 'is_group' => 1)); ?>"><i class="fa fa-circle-o text-light-blue"></i>
...
<?php if ((Func::isShopMenu('shoptablerubric/index?type='.$data->id, $siteData))){ ?>
    <li <?php if(!(($siteData->controllerName == 'shoptablerubric')
        && (Request_RequestParams::getParamInt('type') == $data->id)
        && (Request_RequestParams::getParamInt('table_id') == Model_Shop_Good::TABLE_ID))){echo 'class="menu-left"';} ?>>
        <a href="<?php echo Func::getFullURL($siteData, '/shoptablerubric/index', array(), array('is_public_ignore' => 1, 'type' => $data->id, 'table_id' => Model_Shop_Good::TABLE_ID)); ?>"><i class="fa fa-circle-o text-light-blue"></i>
