<?php if ((Func::isShopMenu('shopcalendar/index?type='.$data->id, $siteData))){ ?>
    <li <?php if(!(($siteData->controllerName == 'shopcalendar')
        && (Request_RequestParams::getParamInt('type') == $data->id)
        && (Request_RequestParams::getParamInt('is_group') == 0))){echo 'class="menu-left"';} ?>>
        <a href="<?php echo Func::getFullURL($siteData, '/shopcalendar/index', array(), array('is_public_ignore' => 1, 'type' => $data->id, 'is_group' => 0)); ?>"><i class="fa fa-circle-o text-light-blue"></i>
...
<?php if ((Func::isShopMenu('shopcalendar/group?type='.$data->id, $siteData))){ ?>
    <li <?php if(!(($siteData->controllerName == 'shopcalendar')
        ...
        <a href="<?php echo Func::getFullURL($siteData, '/shopcalendar/index', array(), array('is_public_ignore' => 1, 'type' => $data->id, 'is_group' => 1)); ?>"><i class="fa fa-circle-o text-light-blue"></i>
