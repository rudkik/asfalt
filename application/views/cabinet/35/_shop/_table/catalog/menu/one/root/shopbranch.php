<?php if ((Func::isShopMenu('shopbranch/index?type='.$data->id, $siteData))){ ?>
    <li <?php if(!(($siteData->controllerName == 'shopbranch')
        && (Request_RequestParams::getParamInt('type') == $data->id))){echo 'class="menu-left"';} ?>>
        <a href="<?php echo Func::getFullURL($siteData, '/shopbranch/index', array(), array('is_public_ignore' => 1, 'type' => $data->id, 'is_group' => 0), array(), FALSE, FALSE); ?>"><i class="fa fa-circle-o text-light-blue"></i>
...
<?php if ((Func::isShopMenu('shoptablerubric/index?type='.$data->id, $siteData))){ ?>
    <li <?php if(!(($siteData->controllerName == 'shoptablerubric')
        ...
        && (Request_RequestParams::getParamInt('table_id') == Model_Shop::TABLE_ID))){echo 'class="menu-left"';} ?>>
        <a href="<?php echo Func::getFullURL($siteData, '/shoptablerubric/index', array(), array('is_public_ignore' => 1, 'type' => $data->id, 'table_id' => Model_Shop::TABLE_ID)); ?>"><i class="fa fa-circle-o text-light-blue"></i>
