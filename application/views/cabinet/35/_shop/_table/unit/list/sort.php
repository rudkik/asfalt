<form action="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shoptableunit/savesort" method="post">
	...
	<table class="table table-hover table-db">
		<tr>
			...
			<?php } ?>
			<th><?php echo SitePageData::setPathReplace('type.form_data.shop_table_unit.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
			<th class="tr-header-buttom"></th>
		</tr>
		<tbody id="sort-record">
		<?php
		foreach ($data['view::_shop/_table/unit/one/sort']->childs as $value) {
			echo $value->str;
		}
		?>
		</tbody>
