<div class="row">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <?php if ((Func::isShopMenu('shopbillstatus/text', $siteData))
                        || (Func::isShopMenu('shopbillstatus/text-html', $siteData))){ ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                                    Описание
    ...
    <div class="col-md-3">
        <?php if (Func::isShopMenu('shopbillstatus/image', $siteData)){ ?>
            <?php
            $view = View::factory('cabinet/35/_addition/bills');
...
<?php if (Func::isShopMenu('shopbillstatus/text-html', $siteData)){ ?>
    <script>
