<table class="table table-hover table-db">
    <tr>
        ...
        <?php } ?>
        <?php if ((Func::isShopMenu('shopclient/name?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
            <th>
        ...
        <?php } ?>
        <?php if ((Func::isShopMenu('shopclient/contacts?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shopclient/index'). Func::getAddURLSortBy($siteData->urlParams, 'contacts'); ?>" class="link-black"><?php echo SitePageData::setPathReplace('type.form_data.shop_client.fields_title.contacts', SitePageData::CASE_FIRST_LETTER_UPPER); ?></a>
            <a href="<?php echo Func::getFullURL($siteData, '/shopclient/index'). Func::getAddURLSortBy($siteData->urlParams, 'contacts'); ?>" class="link-blue">
                <i class="fa fa-fw fa-sort-alpha-<?php if (Arr::path($siteData->urlParams, 'sort_by.contacts', '') === 'asc'){echo 'desc';}else{echo 'asc';}?>"></i>
            </a>
        </th>
        <?php } ?>
