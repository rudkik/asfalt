...
function isIgnore($name){
    switch($name){
        ...
        case 'client_id': return TRUE; break;
        ...
        case 'sales_client_count': return TRUE; break;
        default:
            return FALSE;
    }
}
...
function writeElementName(&$data, $name){
    switch($name){
        ...
        case 'client_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.client_select_type_id.name', ''); break;
        case 'shop_client_unit_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.shop_client_unit_type_id.name', ''); break;
        default:
            $result = '';
    }
