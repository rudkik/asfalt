<div class="row">
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php if (Func::isShopMenu('shopnew/filter?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopnew/similar?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopnew/seo?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li class=""><a href="#tab7" data-toggle="tab">SEO-настройки <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shopnew/remarketing?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li class=""><a href="#tab5" data-toggle="tab">Код ремаркетинга <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shopnew/child?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="row record-input record-tab">
                        ...
                        <div class="col-md-9">
                            <input name="name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_new.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['name']);?>">
                        </div>
                    </div>
                    <div class="row record-input2 record-tab">
                        <?php if (((Func::isShopMenu('shopnew/article?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            ...
                            <div class="col-md-3">
                                <input name="article" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_new.fields_title.article', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['article']); ?>">
                            </div>
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopnew/created_at?type='.Request_RequestParams::getParamInt('type'), $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                                    <?php echo SitePageData::setPathReplace('type.form_data.shop_new.fields_title.created_at', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
                                    <a href="#"><i class="fa fa-fw fa-info text-blue"></i></a>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <input name="created_at" type="datetime" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_new.fields_title.created_at', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['created_at']); ?>">
                            </div>
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopnew/brand?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopnew/unit?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                        ...
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopnew/select?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                    ...
                    <?php if (Func::isShopMenu('shopnew/hashtag?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    ...
                    <?php if ((Func::isShopMenu('shopnew/text?type='.$data->values['shop_table_catalog_id'], $siteData))
                    || (Func::isShopMenu('shopnew/text-html?type='.$data->values['shop_table_catalog_id'], $siteData))){ ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                            ...
                            <div class="col-md-9 record-textarea">
                                <textarea name="text" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_new.fields_title.text', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" rows="11" class="form-control"><?php echo $data->values['text'];?></textarea>
                            </div>
                        </div>
                    <?php } ?>
                </div>
    ...
    <div class="col-md-3">
        ...
        $view->data = $data;
        $view->columnSize = 12;
            $view->imageTypes = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS.'.shop_table_catalog_id.image_types.shop_new', array());
        echo Helpers_View::viewToStr($view);
        ?>
        <?php } ?>
    </div>
...
<?php if (Func::isShopMenu('shopnew/text-html?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
<script>
