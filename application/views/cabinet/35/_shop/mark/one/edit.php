    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php if (Func::isShopMenu('shopmark/seo', $siteData)){ ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="margin-top-10px">
                        ...
                        $view->fields = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS.'.shop_mark_id.fields_options.shop_mark', array());
                        echo Helpers_View::viewToStr($view);
                        ?>
                    </div>
                    <?php if ((Func::isShopMenu('shopmark/text', $siteData))
                    || (Func::isShopMenu('shopmark/text-html', $siteData))){ ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                                    Описание
...
<?php if (Func::isShopMenu('shopmark/text-html', $siteData)){ ?>
<script>
