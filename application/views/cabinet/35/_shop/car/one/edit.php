<div class="row">
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php if (Func::isShopMenu('shopcar/filter?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopcar/seo?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    <li class=""><a href="#tab7" data-toggle="tab">SEO-настройки <i class="fa fa-fw fa-info text-blue"></i></a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shopcar/remarketing?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="row record-input record-tab">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <input id="car-edit-name" name="name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_car.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo htmlspecialchars($data->values['name']);?>">
                                <div class="input-group-btn">
                                    <button data-id="#car-edit-name" data-action="register-sentence" type="button" class="btn btn-danger"><i class="fa fa-fw fa-text-height"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <?php if (((Func::isShopMenu('shopcar/model?type='.Request_RequestParams::getParamInt('type'), $siteData)))){  ?>
                            ...
                            <div class="col-md-3">
                                <select id="shop_model_id" class="form-control select2" style="width: 100%;" name="shop_model_id">
                                    <option data-id="0" value="0">Без значения</option>
                                    <?php echo trim($siteData->globalDatas['view::_shop/model/list/list']); ?>
                                </select>
                            </div>
                        <?php } ?>
                    ...
                    <div class="row record-input2 record-tab">
                        <?php if (((Func::isShopMenu('shopcar/price?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                            ...
                            <div class="col-md-3">
                                <input name="price" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_car.fields_title.price', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo Func::getNumberStr($data->values['price'], FALSE); ?>">
                            </div>
                        <?php } ?>
                        <?php if (((Func::isShopMenu('shopcar/price_old?type='.$data->values['shop_table_catalog_id'], $siteData)))){  ?>
                            <div class="col-md-3 record-title">
                                <label>
                            ...
                            <div class="col-md-3">
                                <input name="price_old" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_car.fields_title.price_old', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo Func::getNumberStr($data->values['price_old'], FALSE);?>">
                            </div>
                        <?php } ?>
                    ...
                    <?php if (Func::isShopMenu('shopcar/hashtag?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                    ...
                    <?php } ?>
                    <?php if (Func::isShopMenu('shopcar/rubric?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
                        <div class="row record-input record-tab margin-top-10px">
                            <div class="col-md-3 record-title">
                                <label>
                    ...
                    <?php if ((Func::isShopMenu('shopcar/text?type='.$data->values['shop_table_catalog_id'], $siteData))
                    || (Func::isShopMenu('shopcar/text-html?type='.$data->values['shop_table_catalog_id'], $siteData))){ ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                            ...
                            <div class="col-md-9 record-textarea">
                                <textarea name="text" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_car.fields_title.text', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" rows="11" class="form-control"><?php echo $data->values['text'];?></textarea>
                            </div>
                        </div>
                    <?php } ?>
                </div>
    ...
    <div class="col-md-3">
        <?php if (Func::isShopMenu('shopcar/image?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
        <?php
...
<?php if (Func::isShopMenu('shopcar/text-html?type='.$data->values['shop_table_catalog_id'], $siteData)){ ?>
<script>
