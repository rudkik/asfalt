...
function isIgnore($name){
    ...
    switch($name){
        ...
        case 'sales_car_count': return TRUE; break;
...
function writeElementName(&$data, $name, $value){
    switch($name){
        ...
        case 'car_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.car_select_type_id.name', ''); break;
