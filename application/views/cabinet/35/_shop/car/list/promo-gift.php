<table id="panel-cars-gift" data-id="<?php echo count($data['view::_shop/car/one/promo-gift']->childs); ?>" class="table table-hover table-db margin-b-5">
    <tr>
    ...
    <?php
    foreach ($data['view::_shop/car/one/promo-gift']->childs as $value){
        echo $value->str;
    }
    ?>
</table>
<?php if (count($data['view::_shop/car/one/promo-gift']->childs) == 0){ ?>
