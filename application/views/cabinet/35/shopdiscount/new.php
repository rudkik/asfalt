            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="row record-input record-tab margin-t-15">
                        ...
                        <div class="col-md-8">
                            <input name="shopgoodcatalogs_count" type="text" class="form-control" placeholder="Кол-во товаров">
                        </div>
                        <div class="col-md-1" style="padding-top: 8px;">
                            <span>шт.</span>
                        </div>
                    ...
                    <div class="row record-input record-tab">
                        ...
                        <div class="col-md-8">
                            <input name="shopgoodcatalogs_amount" type="text" class="form-control" placeholder="Общая сумма товаров / услуг">
                        </div>
                        <div class="col-md-1" style="padding-top: 8px;">
                            <span><?php echo trim(str_replace('{amount}', '', $siteData->currency->getSymbol()));?></span>
                        </div>
                ...
                <div class="tab-pane" id="tab3">
                    ...
                    <div class="row record-input record-tab margin-t-15">
                        ...
                        <div class="col-md-2">
                            <input name="shopgoods_count" type="text" class="form-control" placeholder="Кол-во товаров / услуг">
                        </div>
                        <div class="col-md-1" style="padding-top: 8px;">
                            <span>шт.</span>
                        </div>
                    ...
                    <div class="row record-input record-tab">
                        ...
                        <div class="col-md-2">
                            <input name="shopgoods_amount" type="text" class="form-control" placeholder="Общая сумма товаров / услуг">
                        </div>
                        <div class="col-md-1" style="padding-top: 8px;">
                            <span><?php echo trim(str_replace('{amount}', '', $siteData->currency->getSymbol()));?></span>
                        </div>
