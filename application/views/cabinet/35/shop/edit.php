    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php } ?>
                <?php if ((Func::isShopMenu('shop/city', $siteData)) || (Func::isShopMenu('shop/land', $siteData))){ ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <?php if ((Func::isShopMenu('shop/text', $siteData, TRUE))
                    || (Func::isShopMenu('shop/text-html', $siteData, TRUE))){ ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                                    Описание
                ...
                <div class="tab-pane" id="tab4">
                    ...
                    <?php } ?>
                    <?php if (Func::isShopMenu('shop/land', $siteData)){ ?>
                        <div class="row record-input record-tab margin-t-15">
                            <div class="col-md-3 record-title">
                                <label>
                                    Страны
                    ...
                    <?php } ?>
                    <?php if (Func::isShopMenu('shop/currency', $siteData)){ ?>
                        <div class="row record-input record-tab margin-t-15">
                            <div class="col-md-3 record-title">
                                <label>
                                    Валюты
                            ...
                            <div class="col-md-9">
                                <select name="currency_ids[]" class="form-control select2" multiple="multiple" data-placeholder="Выберите валюты" style="width: 100%;">
...
<?php if (Func::isShopMenu('shop/text-html', $siteData, TRUE)){ ?>
    <script>
