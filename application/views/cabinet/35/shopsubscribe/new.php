<div class="row">
    <div class="col-md-9">
        ...
        <div class="margin-t-15">
            ...
            $view->fields = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS.'.shop_subscribe_catalog_id.options', array());
        ...
        <div class="row record-input record-list">
            ...
            <div class="col-md-9 record-textarea">
                <textarea name="text" placeholder="Примечaние" rows="11" class="form-control"></textarea>
            </div>
        </div>
    </div>
