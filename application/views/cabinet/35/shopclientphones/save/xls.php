...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
    ...
    <Worksheet ss:Name="Лист1">
        <Table ss:ExpandedColumnCount="3" ss:ExpandedRowCount="<?php echo count($data['view::shopclientphone/save/xls']->childs) + 1; ?>" x:FullColumns="1"
               x:FullRows="1">
            ...
            <?php
            foreach ($data['view::shopclientphone/save/xls']->childs as $value) {
                echo $value->str."\r\n";
            }
            ?>
        </Table>
