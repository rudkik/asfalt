			...
			<div class="row">
				<div class="col-md-4 filter-input">
					<div class="form-group">
						<span for="name" class="col-md-4 control-label">ФИО</span>
						<div class="col-md-8">
							<div class="input-group">
								<input id="input-name" class="form-control" name="name" placeholder="ФИО" type="text">
				...
				<div class="col-md-4 filter-input">
					<div class="form-group">
						<span for="email" class="col-md-4 control-label">E-mail</span>
						<div class="col-md-8">
							<div class="input-group">
								<input id="input-name" class="form-control" name="email" placeholder="E-mail" type="text">
                                <span class="input-group-btn">
                                    <button type="submit" class="btn btn-warning btn-flat"><i class="fa fa-fw fa-search"></i></button>
                                </span>
							</div>
