<section class="content-header">
    <h1>
        <?php echo $data['view::subscribe_type']; ?>
    ...
    <ol class="breadcrumb">
        ...
        <?php } ?>
        <li><a href="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shopsubscribe/index?type=<?php echo intval(Request_RequestParams::getParamInt('type')); ?><?php if($siteData->branchID > 0){echo '&shop_branch_id='.$siteData->branchID;} ?><?php if($siteData->superUserID > 0){echo '&shop_id='.$siteData->shopID;} ?>"><i class="fa fa-dashboard"></i> <?php echo $data['view::subscribe_type']; ?></a></li>
        <li class="active"><?php echo $data['view::subscribe_type']; ?></li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form enctype="multipart/form-data" action="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shopsubscribe/save" method="post" style="padding-right: 5px;">
                        <?php echo trim($data['view::shopsubscribe/edit']); ?>
                    </form>
                </div>
            </div>
        </div>
