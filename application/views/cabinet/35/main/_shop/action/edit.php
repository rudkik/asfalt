<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <?php } ?>
        <li><a href="<?php echo Func::getFullURL($siteData, '/shopaction/index', array('type' => 'type', 'is_group' => 'is_group')); ?>"><i class="fa fa-dashboard"></i> Акции</a></li>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form enctype="multipart/form-data" action="<?php echo Func::getFullURL($siteData, '/shopaction/save'); ?>" method="post" style="padding-right: 5px;">
                        <?php echo trim($data['view::_shop/action/one/edit']); ?>
                    </form>
                </div>
            </div>
        </div>
