<section class="content-header">
	<h1>
		<?php echo SitePageData::setPathReplace('type.form_data.shop_question.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
	...
	<ol class="breadcrumb">
		...
		<?php } ?>
		<li class="active"><?php echo SitePageData::setPathReplace('type.form_data.shop_question.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?></li>
	</ol>
</section>
<section class="content padding-5">
	<div class="row">
		<div class="col-md-12">
			<?php
			$view = View::factory('cabinet/35/main/_shop/question/filter');
		...
		<div class="col-md-12">
			<div class="nav-tabs-custom" style="margin-bottom: 0px;">
                ...
                $view->siteData = $siteData;
                $view->name = 'shop_question';
                $view->tableID = Model_Shop_Question::TABLE_ID;
                $view->params = array(
                    'is_group' => 'is_group',
                );
                echo Helpers_View::viewToStr($view);
			...
			<div class="box box-primary padding-t-5">
				<div class="box-body table-responsive no-padding">
					<?php echo trim($data['view::_shop/question/list/index']); ?>
				</div>
			</div>
		</div>
	</div>
...
<?php
if ($siteData->url == '/'.$siteData->actionURLName.'/shopquestion/index_edit'){
	...
	$view->siteData = $siteData;
	$view->data = $data;
	$view->saveURL = '/cabinet/shopquestion/addimages';
	echo Helpers_View::viewToStr($view);
}
?>
