<div class="box box-success">
	...
	<form id="form-filter" class="box-body no-padding padding-b-10">
		<div class="col-md-12">
			<div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <span for="input-name"  class="control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_mark.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                        <div class="input-group">
                            <input id="input-name" class="form-control" name="name" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_mark.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>" type="text">
            ...
            <?php if ($siteData->url == '/'.$siteData->actionURLName.'/shopmark/index_edit'){ ?>
