<section class="content-header">
	<h1>
		<?php echo SitePageData::setPathReplace('type.form_data.shop_good.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
	...
	<ol class="breadcrumb">
		...
		<?php } ?>
		<li class="active"><?php echo SitePageData::setPathReplace('type.form_data.shop_good.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?></li>
	</ol>
</section>
<section class="content padding-5">
	<div class="row">
		<div class="col-md-12">
			<?php
			$view = View::factory('cabinet/35/main/_shop/good/filter');
        ...
        <div class="col-md-12">
            ...
            $view->siteData = $siteData;
            $view->name = 'shop_good';
            $view->tableID = Model_Shop_Good::TABLE_ID;
            $view->isVersion = TRUE;
            $view->params = array(
                'is_group' => 'is_group',
                'type' => 'type',
...
<?php
if ($siteData->url == '/'.$siteData->actionURLName.'/shopgood/index_edit'){
	...
	$view->siteData = $siteData;
	$view->data = $data;
	$view->saveURL = '/manager/shopgood/addimages';
	echo Helpers_View::viewToStr($view);
}
?>
