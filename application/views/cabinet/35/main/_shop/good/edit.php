<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <?php } ?>
        <li><a href="<?php echo Func::getFullURL($siteData, '/shopgood/index', array('type' => 'type', 'is_group' => 'is_group'), array('type' => Request_RequestParams::getParamInt('shop_table_catalog_id'))); ?>"><i class="fa fa-dashboard"></i> <?php echo SitePageData::setPathReplace('type.form_data.shop_good.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?></a></li>
        <li class="active"><?php echo SitePageData::setPathReplace('type.form_data.shop_good.fields_title.name_one', SitePageData::CASE_FIRST_LETTER_UPPER); ?></li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form enctype="multipart/form-data" action="<?php echo Func::getFullURL($siteData, '/shopgood/save'); ?>" method="post" style="padding-right: 5px;">
