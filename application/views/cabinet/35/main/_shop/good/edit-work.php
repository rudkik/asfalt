<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <?php } ?>
        <li><a href="<?php echo Func::getFullURL($siteData, '/shopgood/index', array('type' => 'type', 'is_group' => 'is_group')); ?>"><i class="fa fa-dashboard"></i> <?php echo SitePageData::setPathReplace('type.form_data.shop_good.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?></a></li>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form enctype="multipart/form-data" action="<?php echo Func::getFullURL($siteData, '/shopgood/save_work'); ?>" method="post" style="padding-right: 5px;">
                        <?php echo trim($data['view::_shop/good/one/edit-work']); ?>
                    </form>
                </div>
            </div>
        </div>
