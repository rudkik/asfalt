<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <?php } ?>
        <li><a href="<?php echo Func::getFullURL($siteData, '/shopgoodtooperation/index', array('type' => 'type', 'is_group' => 'is_group')); ?>"><i class="fa fa-dashboard"></i> Цены для операторов каталог</a></li>
        <li class="active">Цены товара</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form enctype="multipart/form-data" action="<?php echo Func::getFullURL($siteData, '/shopgoodtooperation/save_good'); ?>" method="post" style="padding-right: 5px;">
                        <?php echo trim($data['view::_shop/good/to/operation/one/edit/good']); ?>
                    </form>
                </div>
            </div>
        </div>
