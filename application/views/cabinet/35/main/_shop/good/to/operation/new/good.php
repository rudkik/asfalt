        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form action="<?php echo Func::getFullURL($siteData, '/shopgoodtooperation/save_good'); ?>" method="post" style="padding-right: 5px;">
                        <?php echo trim($siteData->globalDatas['view::_shop/good/to/operation/one/new/good']); ?>
                    </form>
                </div>
            </div>
        </div>
