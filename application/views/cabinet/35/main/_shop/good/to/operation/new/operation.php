<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Цены оператора</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form action="<?php echo Func::getFullURL($siteData, '/shopgoodtooperation/save_operation'); ?>" method="post" style="padding-right: 5px;">
                        <?php echo trim($siteData->globalDatas['view::_shop/good/to/operation/one/new/operation']); ?>
                    </form>
                </div>
            </div>
        </div>
