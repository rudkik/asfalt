	...
	<form id="form-filter" class="box-body no-padding padding-b-10">
		<div class="col-md-12">
			<div class="row">
				<?php if (Func::isShopMenu('shoptableselect/rubric?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
					<div class="col-md-4 filter-input">
						<div class="form-group">
							<span for="input-rubric" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_table_select.fields_title.rubric', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
							<div class="col-md-8">
				...
				<div class="col-md-4 filter-input">
					<div class="form-group">
						<span for="input-name" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_table_select.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
						<div class="col-md-8">
							<div class="input-group">
								<input id="input-name" class="form-control" name="name" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_table_select.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>" type="text">
            ...
            <?php if ($siteData->url == '/'.$siteData->actionURLName.'/shoptableselect/index_edit'){ ?>
