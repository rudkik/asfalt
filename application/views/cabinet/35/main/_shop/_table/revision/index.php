<section class="content-header">
	<h1>
		<?php echo SitePageData::setPathReplace('type.form_data.shop_table_revision.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
	...
	<ol class="breadcrumb">
		...
		<?php } ?>
		<li class="active"><?php echo SitePageData::setPathReplace('type.form_data.shop_table_revision.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?></li>
	</ol>
</section>
<section class="content padding-5">
	<div class="row">
		<div class="col-md-12">
			<?php
			$view = View::factory('cabinet/35/main/_shop/_table/revision/filter');
...
<?php
if ($siteData->url == '/'.$siteData->actionURLName.'/shoptablerevision/index_edit'){
    ...
    $view->siteData = $siteData;
    $view->data = $data;
    $view->saveURL = '/cabinet/shoptablerevision/addimages';
    echo Helpers_View::viewToStr($view);
}
?>