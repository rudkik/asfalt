<div class="box box-success">
	...
	<form id="form-filter" class="box-body no-padding padding-b-10">
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-4 filter-input">
					<div class="form-group">
						<span for="input-name" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_table_child.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
						<div class="col-md-8">
							<div class="input-group">
								<input id="input-name" class="form-control" name="name" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_table_child.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>" type="text">
            ...
            <?php if ($siteData->url == '/'.$siteData->actionURLName.'/shoptablechild/index_edit'){ ?>
			...
			<div class="row filter-search">
				...
				<div class="col-md-1">
					<div hidden>
						...
						<input name="root_table_id" value="<?php echo intval(Request_RequestParams::getParamInt('root_table_id')); ?>">
						<input name="shop_root_table_catalog_id" value="<?php echo intval(Request_RequestParams::getParamInt('shop_root_table_catalog_id')); ?>">
						<input name="shop_root_table_object_id" value="<?php echo intval(Request_RequestParams::getParamInt('shop_root_table_object_id')); ?>">
