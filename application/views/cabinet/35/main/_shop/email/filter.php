			...
			<div class="row">
                <div class="col-md-4 filter-input">
                    <div class="form-group">
                        <span for="input-rubric" class="col-md-4 control-label">Вид сообщения</span>
                        <div class="col-md-8">
                            <div class="input-group input-group-select">
                                <select id="input-rubric" name="email_type_id" class="form-control select2" style="width: 100%;">
                                    <?php $tmp = Request_RequestParams::getParamInt('email_type_id'); ?>
                                    ...
                                    <?php
                                    $tmp = 'data-id="'.$tmp.'"';
                                    echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::emailtype/list/list']));
                                    ?>
                                </select>
                            </div>
                        </div>
