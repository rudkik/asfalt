<div class="box box-success">
	...
	<form id="form-filter" class="box-body no-padding padding-b-10">
		<div class="col-md-12">
			<div class="row">
				<?php if (Func::isShopMenu('shopaddress/rubric?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
				...
				<?php if (Func::isShopMenu('shopaddress/land?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
					<div class="col-md-4 filter-input">
						<div class="form-group">
            ...
            <?php if ($siteData->url == '/'.$siteData->actionURLName.'/shopaddress/index_edit'){ ?>
