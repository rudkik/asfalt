<div class="box box-success">
	...
	<form id="form-filter" class="box-body no-padding padding-b-10">
		<div class="col-md-12">
			<div class="row">
                <?php if ((Func::isShopMenu('shopmessagechat/find/name?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
                    <div class="col-md-4">
                        <div class="form-group">
                            <span for="input-name"  class="control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_message_chat.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="input-group">
                                <input id="input-name" class="form-control" name="name" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_message_chat.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>" type="text">
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopmessagechat/find/rubric?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
					<div class="col-md-4">
						<div class="form-group">
							<span for="input-rubric" class="control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_message_chat.fields_title.rubric', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
				...
				<?php } ?>
                <?php if (Func::isShopMenu('shopmessagechat/find/brand?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
					<div class="col-md-4">
						<div class="form-group">
							<span for="input-rubric" class="control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_message_chat.fields_title.brand', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="input-group input-group-select">
				...
				<?php } ?>
                <?php if (Func::isShopMenu('shopmessagechat/find/unit?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <div class="col-md-4">
                        <div class="form-group">
                            <span for="input-rubric" class="control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_message_chat.fields_title.unit', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="input-group input-group-select">
                                <select id="input-rubric" name="shop_table_unit_id" class="form-control select2" style="width: 100%;">
                ...
                <?php } ?>
                <?php if (Func::isShopMenu('shopmessagechat/find/select?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <div class="col-md-4">
                        <div class="form-group">
                            <span for="input-rubric" class="control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_message_chat.fields_title.select', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="input-group input-group-select">
                                <select id="input-rubric" name="shop_table_select_id" class="form-control select2" style="width: 100%;">
                ...
                <?php } ?>
				<?php if (Func::isShopMenu('shopmessagechat/find/hashtag?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
					<div class="col-md-4">
						<div class="form-group">
							<span for="input-rubric" class="control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_message_chat.fields_title.hashtag', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="input-group input-group-select">
				...
				<?php } ?>
				<?php if (Func::isShopMenu('shopmessagechat/find/filter?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
					<div class="col-md-4">
						<div class="form-group">
							<span for="input-rubric" class="control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_message_chat.fields_title.filter', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="input-group input-group-select">
            ...
            <?php if ($siteData->url == '/'.$siteData->actionURLName.'/shopmessagechat/index_edit'){ ?>
