...
<section class="content padding-5">
	<div class="row">
		<div class="col-md-12">
			<?php
			$view = View::factory('cabinet/35/main/_shop/paid/filter');
		...
		<div class="col-md-12">
			<div class="nav-tabs-custom" style="margin-bottom: 0px;">
                ...
                $view->siteData = $siteData;
                $view->name = 'shop_paid';
                $view->tableID = Model_Shop_Paid::TABLE_ID;
                echo Helpers_View::viewToStr($view);
                ?>
			<div class="box box-primary padding-t-5">
				<div class="box-body table-responsive no-padding">
					<?php echo trim($data['view::_shop/paid/list/index']); ?>
				</div>
			</div>
		</div>
	</div>
...
<?php
if ($siteData->url == '/'.$siteData->actionURLName.'/shoppaid/index_edit'){
	...
	$view->siteData = $siteData;
	$view->data = $data;
	$view->saveURL = '/cabinet/shoppaid/addimages';
	echo Helpers_View::viewToStr($view);
}
?>
