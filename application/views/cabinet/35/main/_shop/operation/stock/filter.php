			...
			<div class="row">
                <div class="col-md-4 filter-input">
                    <div class="form-group">
                        <span for="input-name"  class="col-md-4 control-label">№ заявки</span>
                        <div class="col-md-8">
                            <div class="input-group">
                                <input id="input-name" class="form-control" name="id" placeholder="№ заявки" value="<?php echo Arr::path($siteData->urlParams, 'id', '');?>" type="text">
                ...
                <?php if (Func::isShopMenu('shopoperationstock/shop_operation_id?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <div class="col-md-4 filter-input">
                        <div class="form-group">
                            <span for="input-rubric" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_operation_stock.fields_title.shop_operation_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="col-md-8">
