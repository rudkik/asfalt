...
<section class="content padding-5">
	<div class="row">
		<div class="col-md-12">
			<?php
			$view = View::factory('cabinet/35/main/_shop/operation/filter');
		...
		<div class="col-md-12">
            ...
            $view->siteData = $siteData;
            $view->name = 'shop_operation';
            $view->tableID = Model_Shop_Operation::TABLE_ID;
            echo Helpers_View::viewToStr($view);
            ?>
...
if ($siteData->url == '/'.$siteData->actionURLName.'/shopoperation/index_edit'){
	...
	$view->siteData = $siteData;
	$view->data = $data;
	$view->saveURL = '/cabinet/shopoperation/addimages';
	echo Helpers_View::viewToStr($view);
}
?>
