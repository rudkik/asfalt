<section class="content-header">
	<h1>
		<?php echo SitePageData::setPathReplace('type.form_data.shop_client.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
	...
	<ol class="breadcrumb">
		...
		<?php } ?>
		<li class="active"><?php echo SitePageData::setPathReplace('type.form_data.shop_client.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?></li>
	</ol>
</section>
<section class="content padding-5">
	<div class="row">
		<div class="col-md-12">
			<?php
			$view = View::factory('cabinet/35/main/_shop/client/filter');
		...
		<div class="col-md-12">
            ...
            $view->siteData = $siteData;
            $view->name = 'shop_client';
            $view->tableID = Model_Shop_Client::TABLE_ID;
            $view->params = array(
                'is_group' => 'is_group',
            );
            echo Helpers_View::viewToStr($view);
...
<?php
if ($siteData->url == '/'.$siteData->actionURLName.'/shopclient/index_edit'){
	...
	$view->siteData = $siteData;
	$view->data = $data;
	$view->saveURL = '/cabinet/shopclient/addimages';
	echo Helpers_View::viewToStr($view);
}
?>
