			...
			<div class="row">
                <div class="col-md-4 filter-input">
                    <div class="form-group">
                        <span for="input-name"  class="col-md-4 control-label">№ заказа</span>
                        <div class="col-md-8">
                            <div class="input-group">
                                <input id="input-name" class="form-control" name="id" placeholder="№ заказа" value="<?php echo Arr::path($siteData->urlParams, 'id', '');?>" type="text">
                ...
                <?php if (Func::isShopMenu('shopbill/shop_bill_status_id?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <div class="col-md-4 filter-input">
                        <div class="form-group">
                            <span for="shop_bill_status_id" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_bill.fields_title.shop_bill_status_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="col-md-8">
                                <div class="input-group input-group-select">
                                    <select id="shop_bill_status_id" name="shop_bill_status_id" class="form-control select2" style="width: 100%;">
                ...
                <?php if (Func::isShopMenu('shopbill/shop_paid_type_id?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <div class="col-md-4 filter-input">
                        <div class="form-group">
                            <span for="shop_paid_type_id" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_bill.fields_title.shop_paid_type_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="col-md-8">
                                <div class="input-group input-group-select">
                                    <select id="shop_paid_type_id" name="shop_paid_type_id" class="form-control select2" style="width: 100%;">
                ...
                <?php if (Func::isShopMenu('shopbill/shop_delivery_type_id?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <div class="col-md-4 filter-input">
                        <div class="form-group">
                            <span for="shop_delivery_type_id" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_bill.fields_title.shop_delivery_type_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="col-md-8">
                                <div class="input-group input-group-select">
                                    <select id="shop_delivery_type_id" name="shop_delivery_type_id" class="form-control select2" style="width: 100%;">
                ...
                <?php if (Func::isShopMenu('shopbill/shop_coupon_id?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <div class="col-md-4 filter-input">
                        <div class="form-group">
                            <span for="shop_coupon_id" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_bill.fields_title.shop_coupon_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="col-md-8">
                                <div class="input-group input-group-select">
                                    <select id="shop_coupon_id" name="shop_coupon_id" class="form-control select2" style="width: 100%;">
                ...
                <?php if (Func::isShopMenu('shopbill/country_id?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <div class="col-md-4 filter-input">
                        <div class="form-group">
                            <span for="country_id" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_bill.fields_title.country_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="col-md-8">
                                <div class="input-group input-group-select">
                ...
                <?php if (Func::isShopMenu('shopbill/city_id?type='.Request_RequestParams::getParamInt('type'), $siteData)){ ?>
                    <div class="col-md-4 filter-input">
                        <div class="form-group">
                            <span for="city_id" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_bill.fields_title.city_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                            <div class="col-md-8">
                                <div class="input-group input-group-select">
