<div class="add-magazin">
                ...
                <div class="col-md-12">
                    <nav class="navbar navbar-default navbar-top" role="navigation">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="<?php echo $siteData->urlBasic;?>/superadmin/site/languages?id=<?php echo Request_RequestParams::getParamInt('id');?>&url=<?php echo Request_RequestParams::getParamStr('url');?>">Языки</a></li>
                            <li><a href="<?php echo $siteData->urlBasic;?>/superadmin/site/staticviews?id=<?php echo Request_RequestParams::getParamInt('id');?>&url=<?php echo Request_RequestParams::getParamStr('url');?>&language=<?php echo Request_RequestParams::getParamInt('language');?>">Список вьюшек index-файла</a></li>
                            <li class="active"><a href="<?php echo $siteData->urlBasic;?>/superadmin/site/staticview?id=<?php echo Request_RequestParams::getParamInt('id');?>&url=<?php echo Request_RequestParams::getParamStr('url');?>&language=<?php echo Request_RequestParams::getParamInt('language');?>&view=<?php echo Request_RequestParams::getParamInt('view');?>">Настройка вьюшки index-файла</a></li>
                    </nav>
                </div>
            </div>
        </section>
    ...
    <form class="content bg-white" method="post" action="<?php echo $siteData->urlBasic; ?>/superadmin/site/savestaticviewgroup" style="padding-top: 0px;">
        <div class="row">
            <div class="col-md-12">
                <?php echo trim($data['view::site/staticview-group']); ?>
            </div>
        </div>
    </form>
</div>