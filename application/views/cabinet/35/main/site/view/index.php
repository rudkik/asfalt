        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form action="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/site/save_views" method="post" style="padding-right: 5px;">
                        <div id="panel-insert">
                            <?php echo trim($data['view::site/view/list/index']); ?>
                        </div>
                        <div class="col-md-7">
