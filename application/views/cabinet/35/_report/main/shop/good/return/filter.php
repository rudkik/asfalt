                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="group_by[]" class="form-control select2" multiple="multiple" data-placeholder="Выберите группировки" style="width: 100%;">
                            ...
                            <?php }?>
                            <option value="shop_good_id" data-id="shop_good_id" <?php if((array_search('shop_good_id', $groupBy) !== FALSE)){echo 'selected'; }?>>Товар</option>
			...
			<div class="row filter-search">
				...
				<div class="col-md-1">
					<div hidden>
                        ...
                        <input name="shop_return[type]" value="<?php echo intval(Request_RequestParams::getParamInt('shop_return.type', array(), FALSE, NULL, TRUE)); ?>">
