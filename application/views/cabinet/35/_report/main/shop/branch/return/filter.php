	...
	<form id="form-filter" class="box-body no-padding padding-b-10">
		<div class="col-md-12">
			<div class="row">
                ...
                <div class="col-md-4 filter-input">
                    <div class="form-group">
                        <span for="input-rubric" class="col-md-4 control-label"><?php echo SitePageData::setPathReplace('type.form_data.shop_return.fields_title.create_user_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></span>
                        <div class="col-md-8">
                            <div class="input-group input-group-select">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="group_by[]" class="form-control select2" multiple="multiple" data-placeholder="Выберите группировки" style="width: 100%;">
                            ...
                            <?php if ((Func::isShopMenu('shopreturn/shop_root_id?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
                                <option value="shop_root_id" data-id="shop_root_id" <?php if((array_search('shop_root_id', $groupBy) !== FALSE)){echo 'selected'; }?>><?php echo SitePageData::setPathReplace('type.form_data.shop_return.fields_title.shop_root_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></option>
                            <?php }?>
                            <?php if ((Func::isShopMenu('shopreturn/country_id?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
                                <option value="country_id" data-id="country_id" <?php if((array_search('country_id', $groupBy) !== FALSE)){echo 'selected'; }?>><?php echo SitePageData::setPathReplace('type.form_data.shop_return.fields_title.country_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></option>
                            <?php }?>
                            <?php if ((Func::isShopMenu('shopreturn/city_id?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
                                <option value="city_id" data-id="city_id" <?php if((array_search('city_id', $groupBy) !== FALSE)){echo 'selected'; }?>><?php echo SitePageData::setPathReplace('type.form_data.shop_return.fields_title.city_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></option>
                            <?php }?>
                            <option value="create_user_id" data-id="create_user_id" <?php if((array_search('create_user_id', $groupBy) !== FALSE)){echo 'selected'; }?>><?php echo SitePageData::setPathReplace('type.form_data.shop_return.fields_title.create_user_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></option>
