                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="group_by[]" class="form-control select2" multiple="multiple" data-placeholder="Выберите группировки" style="width: 100%;">
                            ...
                            <?php if ((Func::isShopMenu('shoppaid/paid_shop_id?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
                                <option value="paid_shop_id" data-id="paid_shop_id" <?php if((array_search('paid_shop_id', $groupBy) !== FALSE)){echo 'selected'; }?>><?php echo SitePageData::setPathReplace('type.form_data.shop_paid.fields_title.paid_shop_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></option>
                            <?php }?>
                            <?php if ((Func::isShopMenu('shoppaid/shop_operation_id?type='.Request_RequestParams::getParamInt('type'), $siteData))){ ?>
                                <option value="shop_operation_id" data-id="shop_operation_id" <?php if((array_search('shop_operation_id', $groupBy) !== FALSE)){echo 'selected'; }?>><?php echo SitePageData::setPathReplace('type.form_data.shop_paid.fields_title.shop_operation_id', SitePageData::CASE_FIRST_LETTER_UPPER); ?></option>
                            <?php }?>
