<section class="content-header">
	<h1>
		<?php echo SitePageData::setPathReplace('type.form_data.shop_bill.fields_title.name_list', SitePageData::CASE_FIRST_LETTER_UPPER); ?>
...
<section class="content padding-5">
	<div class="row">
		<div class="col-md-12">
			<?php
			$view = View::factory('cabinet/35/_report/main/shop/branch/bill/filter');
		...
		<div class="col-md-12">
			<div class="nav-tabs-custom" style="margin-bottom: 0px;">
                <ul id="tab-status" class="nav nav-tabs pull-right ui-sortable-handle">
                    <li class="pull-left header">
                        <span>
                            <a href="<?php echo Func::getFullURL($siteData, '/shopreport/branch/bill_xls', array(), array(), array(), TRUE);?>" class="btn btn-success margin-b-5">
			...
			<div class="box box-primary padding-t-5">
				<div class="box-body table-responsive no-padding">
					<?php echo trim($data['view::_report/shop/bill/list/branch/bill']); ?>
				</div>
			</div>
		</div>
	</div>
