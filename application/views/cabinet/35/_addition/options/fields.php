...
<table id="body_panel_options-<?php echo $optionsChild;?>" data-id="<?php echo count($listOption); ?>" class="table table-hover table-db margin-b-5">
    <tr>
        <th>
            Заголовок
        </th>
        ...
        <tr>
            ...
            <td>
                <select name="<?php echo $optionsName.$childName;?>[<?php echo $index;?>][type]" class="form-control select2" style="width: 100%;">
                    ...
                    <option <?php if($type == Model_Shop_Basic_Options::OPTIONS_TYPE_TABLE){echo 'selected';} ?> value="<?php echo Model_Shop_Basic_Options::OPTIONS_TYPE_TABLE;?>" data-id="<?php echo Model_Shop_Basic_Options::OPTIONS_TYPE_TABLE;?>">Таблица</option>
            ...
            <td>
                <div style="display: none">
                    <?php echo Func::getURLParamsToInput(Arr::path($value, 'options', array()), $optionsName.$childName.'['.$index.'][options]');?>
                </div>
...
<div class="text-right">
    <button type="button" class="btn btn-warning" onclick="actionAddTR('body_panel_options-<?php echo $optionsChild;?>', 'tr_panel_options-<?php echo $optionsChild;?>', 'div-not-options-options-<?php echo $optionsChild;?>')"><i class="fa fa-fw fa-plus"></i> Добавить параметр</button>
</div>

<div hidden="hidden" id="tr_panel_options-<?php echo $optionsChild;?>">
    <!--
<tr>
    ...
    <td>
        <select name="<?php echo $optionsName.$childName;?>[#index#][type]" class="form-control select2" style="width: 100%;">
            ...
            <option value="<?php echo Model_Shop_Basic_Options::OPTIONS_TYPE_TABLE;?>" data-id="<?php echo Model_Shop_Basic_Options::OPTIONS_TYPE_TABLE;?>">Таблица</option>
