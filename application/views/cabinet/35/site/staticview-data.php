<h3 class="head-title">
    <a style="text-decoration: underline; color: #777;" href="<?php echo $siteData->urlBasic; ?>/superadmin/site/staticview?id=<?php echo Request_RequestParams::getParamInt('id'); ?>&url=<?php echo Request_RequestParams::getParamStr('url'); ?>&language=<?php echo Request_RequestParams::getParamInt('language'); ?>&view=<?php echo Request_RequestParams::getParamInt('view'); ?>">
        <?php echo $data->values['title_view']; ?></a>

    <?php if(key_exists('title_group', $data->values)){ ?>
        &nbsp;&nbsp;>>>>&nbsp;&nbsp;
        <a style="text-decoration: underline;" href="<?php echo $siteData->urlBasic; ?>/superadmin/site/staticviewgroup?id=<?php echo Request_RequestParams::getParamInt('id'); ?>&url=<?php echo Request_RequestParams::getParamStr('url'); ?>&language=<?php echo Request_RequestParams::getParamInt('language'); ?>&view=<?php echo Request_RequestParams::getParamInt('view'); ?>">
...
<div class="row">
    <div class="col-md-12">
        <?php if(!Func::_empty(trim($data->additionDatas['view::site/params']))){; ?>
            <div class="row top20">
                <div class="col-md-8">
                    <div class="add-magazin-options-list">
                        <span class="add-magazin-bold">Список параметров</span>
                        <ul style="margin-bottom: 0px;">
                            <?php echo $data->additionDatas['view::site/params']; ?>
                        </ul>
                    </div>
                </div>
            </div>
