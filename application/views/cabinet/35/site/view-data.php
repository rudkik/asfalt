<h3 class="head-title">
    <a style="text-decoration: underline; color: #777;" href="<?php echo $siteData->urlBasic; ?>/superadmin/site/view?id=<?php echo Request_RequestParams::getParamInt('id'); ?>&url=<?php echo Request_RequestParams::getParamStr('url'); ?>&language=<?php echo Request_RequestParams::getParamInt('language'); ?>&view=<?php echo Request_RequestParams::getParamInt('view'); ?>">
        <?php echo $data->values['title_view']; ?></a>

    <?php if(key_exists('title_group', $data->values)){ ?>
        &nbsp;&nbsp;>>>>&nbsp;&nbsp;
        <a style="text-decoration: underline;" href="<?php echo $siteData->urlBasic; ?>/superadmin/site/viewgroup?id=<?php echo Request_RequestParams::getParamInt('id'); ?>&url=<?php echo Request_RequestParams::getParamStr('url'); ?>&language=<?php echo Request_RequestParams::getParamInt('language'); ?>&view=<?php echo Request_RequestParams::getParamInt('view'); ?>">
