<section class="content-header">
    <h1>
        <a style="text-decoration: underline;" href="<?php echo $siteData->urlBasic; ?>/cabinet/site/view?id=<?php echo Request_RequestParams::getParamInt('id'); ?>&url=<?php echo Request_RequestParams::getParamStr('url'); ?>&language=<?php echo Request_RequestParams::getParamInt('language'); ?>&view=<?php echo Request_RequestParams::getParamInt('view'); ?>">
            <?php echo $data->values['title_root']; ?>
        </a>
        &nbsp;&nbsp;>>>>&nbsp;&nbsp;
        <a style="text-decoration: underline;color: #777;" href="<?php echo $siteData->urlBasic; ?>/cabinet/site/view_group?id=<?php echo Request_RequestParams::getParamInt('id'); ?>&url=<?php echo Request_RequestParams::getParamStr('url'); ?>&language=<?php echo Request_RequestParams::getParamInt('language'); ?>&view=<?php echo Request_RequestParams::getParamInt('view'); ?>">
            <?php echo $data->values['title_view']['ru']; ?>
        </a>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo Func::getFullURL($siteData, '/shop/edit'); ?>"><i class="fa fa-dashboard"></i> Главная</a></li>
        <li><a href="<?php echo $siteData->urlBasic; ?>/cabinet/site/view?id=<?php echo Request_RequestParams::getParamInt('id'); ?>&url=<?php echo Request_RequestParams::getParamStr('url'); ?>&language=<?php echo Request_RequestParams::getParamInt('language'); ?>&view=<?php echo Request_RequestParams::getParamInt('view'); ?>"><?php echo $data->values['title_root']; ?></a></li>
        <li class="active"><?php echo $data->values['title_view']['ru']; ?></li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form action="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/site/save_view_group" method="post" style="padding-right: 5px;">
