        ...
        <div class="tab-content">
            <div class="body-table">
                <div class="tab-pane active">
                    ...
                    <?php
                    $view = View::factory('ab1/owner/35/main/_shop/car/to/material/filter/statistics-subdivision');
                    $view->siteData = $siteData;
                    $view->data = $data;
                    echo Helpers_View::viewToStr($view);
                    ?>
                ...
                <div class="box-body table-responsive" style="padding-top: 0px;">
                    ...
                    <?php echo trim($data['view::_shop/car/to/material/list/statistics-subdivision']); ?>
                </div>
            </div>
        </div>
	</div>
