            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input id="input-name" class="form-control" name="name" placeholder="ФИО" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
                    </div>
                </div>
                <div class="col-md-6">
                    <div hidden>
                    ...
                    <div class="form-group pull-right">
                        ...
                        <div class="input-group" style="width: 145px;">
                            ...
                            <span class="input-group-btn">
                                <button type="submit" class="btn bg-orange btn-flat"><i class="fa fa-fw fa-search"></i> Найти</button>
                            </span>
                        </div>
                    </div>
                </div>
