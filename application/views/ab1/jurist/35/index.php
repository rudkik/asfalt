...
<head>
    ...
    <!-- Select2 -->
    <link rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/_component/select4/css/select2.min.css">
    <!-- iCheck -->
    ...
    <link rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/ab1/css/style.css?v=<?php echo Controller_Ab1_Version::VERSION;?>">
