			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label for="exampleInputEmail1">Подразделение</label>
                        <input id="input-name" class="form-control" name="name" placeholder="Подразделение" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label for="exampleInputEmail1">БИН/ИИН</label>
                        <input id="input-name" class="form-control" name="bin" placeholder="БИН/ИИН" value="<?php echo Arr::path($siteData->urlParams, 'bin', '');?>" type="text">
					</div>
				</div>
				<div class="col-md-1">
					<div hidden>
