...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input data-type="money" data-fractional-length="3" name="km" type="text" class="form-control" placeholder="Расстояние (км)" required>
    </div>
    <div class="col-md-3 record-title">
        <label>
            <sup><i class="fa fa-fw fa-asterisk text-red"></i></sup>
...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input name="min_quantity" type="text" class="form-control" placeholder="Минимальный вес при цене за вес и км">
    </div>
</div>
<div class="row">
