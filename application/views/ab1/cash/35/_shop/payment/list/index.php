<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th style="width: 116px;">
            <a href="<?php echo Func::getFullURL($siteData, '/shoppayment/index'). Func::getAddURLSortBy($siteData->urlParams, 'fiscal_check'); ?>" class="link-black">№ чека</a>
        </th>
        <th class="width-80">
            <a href="<?php echo Func::getFullURL($siteData, '/shoppayment/index'). Func::getAddURLSortBy($siteData->urlParams, 'bin'); ?>" class="link-black">№ счета</a>
        </th>
        <th>
