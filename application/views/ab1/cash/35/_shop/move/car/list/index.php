<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shopmovecar/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_client_id.name'); ?>" class="link-black">Подразделение</a>
        </th>
        <th style="width: 92px;">
