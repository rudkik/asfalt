<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th class="width-130">
            <a href="<?php echo Func::getFullURL($siteData, '/shopcar/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_client_attorney_id.number'); ?>" class="link-black">Доверенность</a>
        </th>
        <th>
        ...
        <th class="width-100">
            <a href="<?php echo Func::getFullURL($siteData, '/shopcar/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_delivery_id.name'); ?>" class="link-black">Доставка</a>
        </th>
