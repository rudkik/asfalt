            ...
            <div class="row">
                <div class="col-md-5">
                    <h4 class="text-blue">
                        ...
                        <a href="<?php echo Func::getFullURL($siteData, '/shopclient/calc_balance', array(), array('id' => Request_RequestParams::getParamInt('shop_client_id'), 'url' => '/sales/shopinvoice/virtual_show'.URL::query())); ?>" style="margin-left: 15px;font-size: 16px;" class="link-green"><i class="fa fa-calculator margin-r-5"></i> Пересчитать баланс</a>
                    </h4>
