<?php $siteData->siteTitle = 'Проверенные акты'; ?>
	...
	<div class="nav-tabs-custom nav-tabs-navy">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <?php $siteData->titleTop = 'Проверенные акты'; ?>
                <?php
                $view = View::factory('ab1/sales/35/main/_shop/act/service/filter');
                $view->siteData = $siteData;
                $view->data = $data;
                echo Helpers_View::viewToStr($view);
                ?>
            ...
            <div class="nav-tabs-custom" style="margin-bottom: 0px;">
                <ul id="tab-status" class="nav nav-tabs pull-right ui-sortable-handle">
                    <li class="pull-left">
                        <div>
                            <a href="<?php echo Func::getFullURL($siteData, '/shopreport/act_service_print_list', array(), array_merge($_POST, $_GET)); ?>" class="btn bg-info btn-flat" style="margin-left: 15px;">Сохранить в Excel для печати</a>
                        </div>
                    </li>
