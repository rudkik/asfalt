<form id="form-filter" class="box-body no-padding padding-bottom-10px">
	...
	<div class="col-md-12">
		<div class="row">
            ...
            <div class="col-md-3">
                <label class="span-checkbox" style="margin-top: 34px;">
                    <input data-not-check="1" name="is_fixed_price" data-id="1" <?php if(Request_RequestParams::getParamBoolean('is_fixed_price')){ ?>value="1" checked<?php }else{ ?> value="0"<?php } ?> type="checkbox" class="minimal">
