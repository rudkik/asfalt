		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
					<label for="name_find">Клиент</label>
                    <input id="name_find" class="form-control" name="name_find" placeholder="Клиент" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name_find', ''), ENT_QUOTES);?>" type="text">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					<label for="exampleInputEmail1">БИН/ИИН</label>
                    <input maxlength="12" id="input-name" class="form-control" name="bin" placeholder="БИН/ИИН" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'bin', ''), ENT_QUOTES);?>" type="text">
				</div>
			</div>
			<div class="col-md-1">
				<div hidden>
