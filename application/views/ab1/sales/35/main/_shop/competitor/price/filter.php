            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_competitor_id">Конкурент</label>
                        <select id="shop_competitor_id" name="shop_competitor_id" class="form-control select2" style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_competitor_id'); ?>
                            ...
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/competitor/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
