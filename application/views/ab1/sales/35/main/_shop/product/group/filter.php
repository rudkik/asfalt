			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
                        ...
                        <input id="input-name" class="form-control" name="name" placeholder="Группа" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
					</div>
				</div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Родитель</label>
                        <select id="input-group" name="root_id" class="form-control select2" style="width: 100%;">
                            ...
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/product/group/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
