    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="id">№ талона</label>
                        <input class="form-control" type="text" name="id" value="<?php echo Arr::path($siteData->urlParams, 'id', '');?>">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select id="shop_branch_id" name="shop_branch_id" class="form-control select2" style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_branch_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL){echo 'selected';} ?>></option>
                            <option value="0" data-id="0" <?php if($tmp === 0){echo 'selected';} ?>>Без значения</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
