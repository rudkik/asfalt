<div id="dialog-invoice-edit" class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form-add-car" action="<?php echo Func::getFullURL($siteData, '/shopinvoice/virtual_break'); ?>" method="get" >
                <div class="modal-body">
                    <div class="row record-input record-list">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <select data-date="<?php echo Request_RequestParams::getParamDate('date_from');?>" data-action="shop_client" data-basic-url="<?php echo $siteData->actionURLName;?>" data-action-select2="1" data-parent="#dialog-invoice-edit"
                                        ...
                                        id="modal_shop_client_id" name="shop_client_id_to" class="form-control select2" style="width: 100%">
                    ...
                    <div class="row record-input record-list">
                        ...
                        <div class="col-md-9">
                            <select data-date="<?php echo Request_RequestParams::getParamDate('date_from');?>" data-contract="#modal_shop_client_contract_id" id="modal_shop_client_attorney_id" name="shop_client_attorney_id_to"  data-parent="#dialog-invoice-edit"
                ...
                <div class="modal-footer">
                    ...
                    <input name="shop_client_id_from" value="<?php echo Request_RequestParams::getParamInt('shop_client_id'); ?>" style="display: none">
