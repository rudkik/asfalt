<table class="table table-hover table-db table-tr-line" data-action="fixed-table">
    <tr>
        ...
        <th class="text-right width-120">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientbalanceday/index'). Func::getAddURLSortBy($siteData->urlParams, 'amount'); ?>" class="link-black">Сумма</a>
        </th>
        <th class="text-right width-120">
        ...
        <th class="text-right width-120">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientbalanceday/index'). Func::getAddURLSortBy($siteData->urlParams, 'balance_amount'); ?>" class="link-black">Остаток</a>
        </th>
    </tr>
    <?php
