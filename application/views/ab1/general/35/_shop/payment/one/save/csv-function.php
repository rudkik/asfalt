...
function isIgnore($name){
    ...
    switch($name){
        ...
        case 'payment_id': return TRUE; break;
        ...
        case 'sales_payment_count': return TRUE; break;
...
function writeElementName(&$data, $name, $value){
    switch($name){
        ...
        case 'payment_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.payment_select_type_id.name', ''); break;
        case 'shop_payment_unit_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.shop_payment_unit_type_id.name', ''); break;
        default:
            $result = $value;
    }
