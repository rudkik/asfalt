		...
		<div class="row">
            <div class="col-md-2">
                <div class="form-group">
                    <label for="date_from">Номер</label>
                    <input id="old_id" class="form-control" type="text" name="old_id" value="<?php echo Request_RequestParams::getParamStr('old_id');?>">
                </div>
            </div>
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group" style="width: 100%;">
                        <div class="input-group">
                            <input id="date_from" class="form-control pull-right" type="datetime" date-type="date" name="date_from" value="<?php echo Helpers_DateTime::getDateFormatRus(Request_RequestParams::getParamDate('date_from'));?>">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <div class="input-group" style="width: 100%;">
                        <div class="input-group">
                            <input id="date_to" class="form-control pull-right" type="datetime" date-type="date" name="date_to" value="<?php echo Helpers_DateTime::getDateFormatRus(Request_RequestParams::getParamDate('date_to'));?>">
                            <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </div>
                        </div>
