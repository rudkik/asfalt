<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th style="width: 99px;">
            <a href="<?php echo Func::getFullURL($siteData, '/shoplesseecar/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_driver_id.name'); ?>" class="link-black">Водитель</a>
        </th>
        <th>
        ...
        <th class="width-75 text-right">
            <a href="<?php echo Func::getFullURL($siteData, '/shoplesseecar/index'). Func::getAddURLSortBy($siteData->urlParams, 'quantity'); ?>" class="link-black">Кол-во</a>
        </th>
        ...
        <th style="width: 131px;">
            <a href="<?php echo Func::getFullURL($siteData, '/shoplesseecar/index'). Func::getAddURLSortBy($siteData->urlParams, 'cash_operation_id.name'); ?>" class="link-black">Оператор</a>
        </th>
