...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="row record-input record-list">
            ...
            <div class="col-md-9">
                <input name="ticket" type="text" data-type="auto-number" class="form-control" required placeholder="Введите номер талона"  value="<?php echo htmlspecialchars($data->values['ticket']); ?>" >
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="row record-input record-list">
            ...
            <div class="col-md-9">
                <select id="shop_product_id" name="shop_product_id" class="form-control select2" required style="width: 100%;" <?php if(($data->values['shop_turn_id'] == Model_Ab1_Shop_Turn::TURN_EXIT) && (!$siteData->operation->getIsAdmin())){ echo 'disabled'; }?>>
...
<div class="row">
    <?php if($siteData->action != 'clone') { ?>
        ...
        <div class="modal-footer text-center">
            <a href="<?php echo Func::getFullURL($siteData, '/shopreport/talonxls', array(), array('id' => $data->values['id'])); ?>" class="btn bg-navy btn-flat pull-left"><i class="fa fa-fw fa-credit-card"></i> Талон</a>
            <?php if(($data->values['tarra'] > 0) && (($data->values['shop_turn_id'] == Model_Ab1_Shop_Turn::TURN_CASH_EXIT))){ ?>
