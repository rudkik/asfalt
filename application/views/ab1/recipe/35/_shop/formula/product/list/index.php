<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th>Продукция</th>
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shopformulaproduct/index'). Func::getAddURLSortBy($siteData->urlParams, 'formula_type_id.name'); ?>" class="link-black">Вид рецепта</a>
        </th>
        <th class="width-120">
