<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th style="min-width: 110px;">
            <a href="<?php echo Func::getFullURL($siteData, '/shopproduct/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_table_rubric_id.name'); ?>" class="link-black">Рубрика</a>
        </th>
        ...
        <th style="min-width: 107px;">
            <a href="<?php echo Func::getFullURL($siteData, '/shopproduct/index'). Func::getAddURLSortBy($siteData->urlParams, 'product_type_id.name'); ?>" class="link-black">Вид продукта</a>
        </th>
        <th>
