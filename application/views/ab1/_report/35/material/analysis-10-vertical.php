...
?>
 <Worksheet ss:Name="Лист1">
  ...
  <Table ss:ExpandedColumnCount="<?php echo $cols + 6; ?>" ss:ExpandedRowCount="<?php echo count($cars['data']) * 2 + 11; ?>" x:FullColumns="1"
   ...
   <Column ss:StyleID="s62" ss:AutoFitWidth="0" ss:Width="45" ss:Span="<?php echo $cols - 1; ?>"/>
   <Column ss:StyleID="s62" ss:AutoFitWidth="0" ss:Width="47.25"/>
   <Row ss:AutoFitHeight="0" ss:Height="24.75">
    <Cell ss:MergeAcross="<?php echo $cols + 2; ?>" ss:StyleID="s140"><Data ss:Type="String">Завоз материалов с <?php echo Helpers_DateTime::getDateFormatRus($dateFrom); ?> по <?php echo Helpers_DateTime::getDateFormatRus($dateTo); ?></Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="22.5">
    <Cell ss:StyleID="s136"><Data ss:Type="String">№ авто</Data></Cell>
    <Cell ss:StyleID="s136"><Data ss:Type="String">Рейсы/кол-во</Data></Cell>
    <?php
    $date = $dateFrom;
    while (strtotime($date) <= strtotime($dateTo)){
        ?>
    <Cell ss:StyleID="s137"><Data ss:Type="DateTime"><?php echo Helpers_DateTime::getDateFormatPHP($date); ?></Data></Cell>
    <?php
        $date = Helpers_DateTime::plusDays($date, 1);
    }
    ?>
    <Cell ss:StyleID="s134"><Data ss:Type="String">Итого</Data></Cell>
   </Row>
   <?php foreach ($cars['data'] as $car){?>
   <Row ss:AutoFitHeight="0">
    <Cell ss:MergeDown="1" ss:StyleID="s115"><Data ss:Type="String"><?php echo htmlspecialchars($car['name'], ENT_XML1); ?></Data></Cell>
    <Cell ss:StyleID="s115"><Data ss:Type="String">Рейсы</Data></Cell>
    <?php
    $date = $dateFrom;
    while (strtotime($date) <= strtotime($dateTo)){
   ...
   <Row ss:AutoFitHeight="0">
    <Cell ss:Index="2" ss:StyleID="s115"><Data ss:Type="String">Кол-во</Data></Cell>
    <?php
    $date = $dateFrom;
    while (strtotime($date) <= strtotime($dateTo)){
        $data = Arr::path($car['dates'], $date, array('quantity' => '', 'count' => ''));
   ...
   <?php } ?>
   <Row ss:AutoFitHeight="0">
    <Cell ss:MergeDown="1" ss:StyleID="s108"><Data ss:Type="String">Итого</Data></Cell>
    <Cell ss:StyleID="s115"><Data ss:Type="String">Рейсы</Data></Cell>
    <?php
    $date = $dateFrom;
    while (strtotime($date) <= strtotime($dateTo)){
