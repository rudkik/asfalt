<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th class="tr-header-date" style="width: 155px">
            <a href="<?php echo Func::getFullURL($siteData, '/shopcar/index'). Func::getAddURLSortBy($siteData->urlParams, 'exit_at'); ?>" class="link-black">Дата выезда</a>
        </th>
        ...
        <th style="width: 131px;">
            <a href="<?php echo Func::getFullURL($siteData, '/shopcar/index'). Func::getAddURLSortBy($siteData->urlParams, 'asu_operation_id.name'); ?>" class="link-black">Оператор</a>
        </th>
        <?php } ?>
    </tr>
    <?php
