...
<body data-number="<?php echo $siteData->globalDatas['view::car_count']; ?>" class="hold-transition fixed" <?php if ($siteData->url != '/asu/shopcar/shipment1'){ ?>style="font-size: 30px; font-weight: 700;"<?php } ?>>
<div class="wrapper">
...
<script>
    $(function(){
        ...
        var findCar=function(){
            jQuery.ajax({
                url: '/asu/shopcar/shipment_json',
                data: ({
                    shop_turn_place_id: (<?php echo $siteData->operation->getShopTableSelectID();?>),
                }),
                type: "GET",
