<tr>
    ...
    <td>
        <input data-type="money" data-fractional-length="0"  name="shop_plan_transport_items[<?php echo $data->id; ?>][count]" type="text" class="form-control" placeholder="Кол-во" required value="<?php echo Func::getNumberStr($data->values['count'], true); ?>">
    </td>
    <td>
