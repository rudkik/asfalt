<div class="row">
    <div class="col-md-6">
        ...
        <div class="row record-input record-list">
            ...
            <div class="col-md-9">
                <select data-client="-1" data-action="shop_client" data-basic-url="bid" data-action-select2="1" data-less-zero="false"
        ...
        <div class="row record-input record-list">
            ...
            <div class="col-md-9">
                <input name="facility" type="text" class="form-control" placeholder="Объект">
            </div>
        </div>
        <div class="row record-input record-list">
            <div class="col-md-3 record-title">
            ...
            <div class="col-md-9">
                <input name="time_from" type="datetime" date-type="time" class="form-control">
            </div>
        </div>
        <div class="row record-input record-list">
            <div class="col-md-3 record-title">
            ...
            <div class="col-md-9">
                <input name="time_to" type="datetime" date-type="time" class="form-control">
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="row record-input record-list">
            ...
            <div class="col-md-9">
                <input data-type="money" data-fractional-length="0" name="car_count" type="text" class="form-control" placeholder="Кол-во машин">
            </div>
        </div>
        <div class="row record-input record-list">
            <div class="col-md-3 record-title">
...
<script>
    $(function () {
        $('#shop_branch_id').change(function () {
            ...
            var url = '/bid/shopproduct/select_options';
            jQuery.ajax({
                url: url,
                data: ({
                    'shop_branch_id': (id),
            ...
            var url = '/bid/shopturnplace/select_options';
            jQuery.ajax({
                url: url,
                data: ({
                    'shop_branch_id': (id),
