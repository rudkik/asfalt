	...
	<div class="nav-tabs-custom nav-tabs-navy">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <?php
                $view = View::factory('ab1/technologist/35/main/_shop/boxcar/filter/index');
                $view->siteData = $siteData;
                $view->data = $data;
                echo Helpers_View::viewToStr($view);
                ?>
                ...
                <div class="nav-tabs-custom" style="margin-bottom: 0px;">
                    <ul id="tab-status" class="nav nav-tabs pull-right ui-sortable-handle">
                        ...
                        <li class="<?php if(Arr::path($siteData->urlParams, 'is_date_drain_to_empty', '') == 1){echo 'active';}?>"><a href="<?php echo Func::getFullURL($siteData, '/shopboxcar/index', array(), array('is_date_arrival_empty' => 0, 'is_date_drain_to_empty' => 1));?>">На разгрузке</a></li>
