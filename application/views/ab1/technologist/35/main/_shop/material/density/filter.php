		...
		<div class="row">
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select id="shop_material_id" name="shop_material_id" class="form-control select2" style="width: 100%;">
                        ...
                        <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите материал</option>
            ...
            <div class="col-md-1-5">
                <div class="form-group">
                    ...
                    <input class="form-control pull-right" type="datetime" date-type="date" name="date_from" value="<?php echo Helpers_DateTime::getDateFormatRus(Arr::path($siteData->urlParams, 'date_from', ''));?>">
                </div>
            </div>
            <div class="col-md-1-5">
                <div class="form-group">
                    <label for="exampleInputEmail1">Время до</label>
                    <input class="form-control pull-right" type="datetime" date-type="date" name="date_to" value="<?php echo Helpers_DateTime::getDateFormatRus(Arr::path($siteData->urlParams, 'date_to', ''));?>">
                </div>
            </div>
            <div class="col-md-5">
                <div hidden>
