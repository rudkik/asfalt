<?php $time1 = Helpers_DateTime::getDateFormatRus($siteData->replaceDatas['view::date']); ?>
            ...
            <div class="col-md-12">
                <form action="<?php echo Func::getFullURL($siteData, '/shopxml/save_invoices'); ?>" method="get" >
                    <div class="row">
                        ...
                        <?php if(!Func::_empty(Request_RequestParams::getParamDate('date_from'))){ ?>
                            <div class="col-md-8" style="padding-top: 25px;">
                                <a class="btn bg-green"  href="<?php echo Func::getFullURL($siteData, '/shopreport/invoice_save_1c', ['date_from' => 'date_from', 'date_to' => 'date_to']); ?>">Реест выгруженных накладных</a>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="row">
