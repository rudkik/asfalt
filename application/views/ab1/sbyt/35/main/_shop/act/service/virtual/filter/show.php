            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-btn">
                                <a href="<?php echo Func::getFullURL($siteData, '/shopactservice/virtual_show', array(),
                                    array(
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="shop_client_id" name="shop_client_id" class="form-control select2" style="width: 100%" disabled>
