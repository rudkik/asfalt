<form id="form-filter" class="box-body no-padding padding-bottom-10px">
	<div class="row">
		<div class="col-md-12">
			<div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <?php $checkTypeID = Request_RequestParams::getParamInt('check_type_id'); ?>
                        <select id="check_type_id" name="check_type_id" class="form-control select2" style="width: 100%;">
                            <option value="-1" data-id="-1">Все</option>
                            <option value="0" data-id="0" <?php if($checkTypeID !== null && $checkTypeID > -1 && $checkTypeID < 1){ echo 'selected';}?>>Не проверенные</option>
            ...
            <div class="row">
                <div class="col-md-2">
                    <?php $give = Request_RequestParams::getParamBoolean('empty_date_give_to_client'); ?>
                    <div class="form-group">
                        <label for="empty_date_give_to_client">Выдано клиенту</label>
                        <select id="empty_date_give_to_client" name="empty_date_give_to_client" class="form-control select2" style="width: 100%;">
                            <option value="">Все</option>
                            <option value="1" <?php if($give === true){echo 'selected';}?>>Не выдано</option>
                            <option value="0" <?php if($give === false){echo 'selected';}?>>Выдано</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
                    <?php $give = Request_RequestParams::getParamBoolean('empty_date_received_from_client'); ?>
                    <div class="form-group">
                        <label for="empty_date_received_from_client">Получено от клиента</label>
                        <select id="empty_date_received_from_client" name="empty_date_received_from_client" class="form-control select2" style="width: 100%;">
                            <option value="">Все</option>
                            <option value="1" <?php if($give === true){echo 'selected';}?>>Не получено</option>
                            <option value="0" <?php if($give === false){echo 'selected';}?>>Получено</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
                    <?php $give = Request_RequestParams::getParamBoolean('empty_date_give_to_bookkeeping'); ?>
                    <div class="form-group">
                        <label for="empty_date_give_to_bookkeeping">Сдано в бухгалтерию</label>
                        <select id="empty_date_give_to_bookkeeping" name="empty_date_give_to_bookkeeping" class="form-control select2" style="width: 100%;">
                            <option value="">Все</option>
                            <option value="1" <?php if($give === true){echo 'selected';}?>>Не сдано</option>
                            <option value="0" <?php if($give === false){echo 'selected';}?>>Сдано</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="number">№ накладной</label>
                        <input id="number" class="form-control" name="number" type="phone" value="<?php echo Request_RequestParams::getParamStr('number');?>">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="organization_type_ids">Тип организации</label>
                        <select id="organization_type_ids" name="organization_type_ids[]"  class="form-control select2" multiple  style="width: 100%;">
