		...
		<div class="row">
            <div class="col-md-4">
                <div class="form-group"  style="margin-bottom: 5px">
                    <label for="id">Клиент</label>
                    <select data-action="shop_client" data-basic-url="<?php echo $siteData->actionURLName;?>" data-action-select2="1" data-value="<?php echo Request_RequestParams::getParamInt('id');?>"
                            id="shop_client_id" name="id" class="form-control select2" style="width: 100%">
                    </select>
                </div>
            </div>
			<div class="col-md-6">
