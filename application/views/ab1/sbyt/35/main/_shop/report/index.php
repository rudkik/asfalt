...
<div class="col-md-12 padding-top-15px">
	<div class="nav-tabs-custom nav-tabs-navy">
        ...
        <div class="tab-content" style="display: inline-block; width: 100%">
            ...
            <h3>СБ12 Отчет по договорам поставки</h3>
            <div class="col-md-12">
                <form action="<?php echo Func::getFullURL($siteData, '/shopreport/contract_supply'); ?>" method="get" enctype="multipart/form-data" >
                    <div class="row">
                        <div class="col-md-1-5">
                            <div class="form-group">
                                <label for="contract_supply-date_from">Период от</label>
                                <input id="contract_supply-date_from" class="form-control" name="date_from" type="datetime" date-type="datetime" value="<?php echo $time1; ?>">
                            </div>
                        </div>
                        <div class="col-md-1-5">
                            <div class="form-group">
                                <label for="contract_supply-date_to">Период до</label>
                                <input id="contract_supply-date_to" class="form-control" name="date_to" type="datetime" date-type="datetime" value="<?php echo $time2; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="contract_supply-shop_client_id">Клиент</label>
                                <select data-action="shop_client" data-basic-url="<?php echo $siteData->actionURLName;?>" data-action-select2="1"
                                        id="contract_supply-shop_client_id" name="shop_client_id" class="form-control select2" style="width: 100%">
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <h3>СБ13 Отгружено продукции по рубрикам</h3>
            <div class="col-md-12">
                <form action="<?php echo Func::getFullURL($siteData, '/shopreport/product_rubric_departments'); ?>" method="post" enctype="multipart/form-data" >
                    <div class="row">
                        <div class="col-md-1-5">
                            <div class="form-group">
                                <label for="product_rubric_departments-created_at_from">Период от</label>
                                <input id="product_rubric_departments-created_at_from" class="form-control" name="created_at_from" type="datetime" date-type="datetime" value="<?php echo $time1; ?>">
                            </div>
                        </div>
                        <div class="col-md-1-5">
                            <div class="form-group">
                                <label for="product_rubric_departments-created_at_to">Период до</label>
                                <input id="product_rubric_departments-created_at_to" class="form-control" name="created_at_to" type="datetime" date-type="datetime" value="<?php echo $time2; ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="product_rubric_departments-shop_subdivision_id">Подразделение</label>
                                <select id="product_rubric_departments-shop_subdivision_id" name="shop_subdivision_id[]" multiple class="form-control select2" required style="width: 100%;">
            ...
            <h3>СБ14 Список невыданных накладных</h3>
            <div class="col-md-12">
                <form action="<?php echo Func::getFullURL($siteData, '/shopreport/invoice_list_not_give'); ?>" method="get" enctype="multipart/form-data" >
                    <div class="row">
                        <div class="col-md-1-5">
                            <div class="form-group">
                                <label for="invoice_list_not_give-date_from">Период от</label>
                                <input id="invoice_list_not_give-date_from" class="form-control" name="date_from" type="datetime" date-type="date" value="<?php echo Helpers_DateTime::getDateFormatRus($time1); ?>">
                            </div>
                        </div>
                        <div class="col-md-1-5">
                            <div class="form-group">
                                <label for="invoice_list_not_give-date_to">Период до</label>
                                <input id="invoice_list_notg_ive-date_to" class="form-control" name="date_to" type="datetime" date-type="date" value="<?php echo Helpers_DateTime::getDateFormatRus($time2); ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="invoice_list_not_give-organization_ids">Тип организации</label>
                                <select id="invoice_list_not_give-organization_ids" name="organization_ids[]" multiple class="form-control select2" required style="width: 100%;">
                                    <option value="0" data-id="0">Без значения</option>
