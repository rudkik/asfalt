<table class="table table-hover table-db table-tr-line" data-action="fixed-table">
    <tr>
        ...
        <th class="width-80">
            <a href="<?php echo Func::getFullURL($siteData, '/shopinvoice/index'). Func::getAddURLSortBy($siteData->urlParams, 'date_give_to_client'); ?>" class="link-black">Выдано клиенту</a>
        </th>
        <th class="width-90">
            <a href="<?php echo Func::getFullURL($siteData, '/shopinvoice/index'). Func::getAddURLSortBy($siteData->urlParams, 'date_received_from_client'); ?>" class="link-black">Получено от клиента</a>
        </th>
        <th class="width-100">
            <a href="<?php echo Func::getFullURL($siteData, '/shopinvoice/index'). Func::getAddURLSortBy($siteData->urlParams, 'date_give_to_bookkeeping'); ?>" class="link-black">Сдано в бухгалтерию</a>
        </th>
