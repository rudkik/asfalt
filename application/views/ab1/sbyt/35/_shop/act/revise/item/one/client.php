<tr>
    ...
    <td>
        <?php $title = $data->values['name'] . ' ' . $data->values['old_id'] . ' (' . Helpers_DateTime::getDateFormatRus($data->values['date']) . ')'; ?>
        <?php switch ($data->additionDatas['table_id']){
        ...
        <a target="_blank" href="<?php echo Func::getFullURL($siteData, '/'.$url.'/edit', array(), array('id' => $data->id, 'shop_branch_id' => $data->values['shop_id'])); ?>"><?php echo $title; ?></a>
        <? } ?>
    </td>
