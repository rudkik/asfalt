<table class="table table-hover table-db table-tr-line" data-action="fixed-table">
    <tr>
        ...
        <th class="text-right width-120">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientattorney/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_client_id.balance_cache'); ?>" class="link-black">Наличные</a>
        </th>
        <th class="text-right width-120">
