<tr>
    ...
    <td class="text-right">
        <a data-id="block_amount" href="<?php echo Func::getFullURL($siteData, '/shopcaritem/attorney', array(), array('shop_client_attorney_id' => $data->id), $data->values); ?>"><?php echo Func::getNumberStr($data->values['balance'], TRUE, 2, FALSE); ?></a>
    </td>
