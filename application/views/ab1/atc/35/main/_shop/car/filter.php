    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_branch_storage_id">Гараж транспорта</label>
                        <select id="shop_branch_storage_id" name="shop_transport_id/shop_branch_storage_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_transport_id/shop_branch_storage_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
