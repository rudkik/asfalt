            ...
            <div class="nav-tabs-custom" style="margin-bottom: 0px;">
                <ul id="tab-status" class="nav nav-tabs pull-right ui-sortable-handle">
                    ...
                    <li class="pull-left header padding-0">
                        <span>
                            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/new', array());?>" class="btn bg-purple btn-flat">
                    ...
                    <li class="pull-left header padding-0">
                        <span>
                            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/new', array(), ['client_contract_type_id' => Model_Ab1_ClientContract_Type::CLIENT_CONTRACT_TYPE_BUY_FUEL,'client_contract_kind_id' => Model_Ab1_ClientContract_Kind::CLIENT_CONTRACT_TYPE_BUY]);?>" class="btn bg-purple btn-flat">
                                <i class="fa fa-fw fa-plus"></i>
                                Добавить закуп ГСМ
                            </a>
                        </span>
