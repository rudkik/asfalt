            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input id="name" class="form-control" name="name" placeholder="Марка" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>" type="text">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select id="transport_view_id" name="transport_view_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('transport_view_id'); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="transport_type_1c_id">Тип транспорта 1С</label>
                        <select id="transport_type_1c_id" name="transport_view_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('transport_type_1c_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::transport/type1c/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select id="transport_work_id" name="transport_work_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('transport_work_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="transport_wage_id">Правило расчета выработки</label>
                        <select id="transport_wage_id" name="transport_wage_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('transport_wage_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::transport/wage/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
