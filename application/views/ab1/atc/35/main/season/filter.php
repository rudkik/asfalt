            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Сезон</label>
                        <input id="input-name" class="form-control" name="name" placeholder="Сезон" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>" type="text">
                    </div>
                </div>
                <div class="col-md-6">
                    <div hidden>
