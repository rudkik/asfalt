<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th class="width-80">
            <a href="<?php echo Func::getFullURL($siteData, '/shoptransportwaybill/index'). Func::getAddURLSortBy($siteData->urlParams, 'from_at'); ?>" class="link-black">Дата выезда</a>
        </th>
        <th class="width-80">
            <a href="<?php echo Func::getFullURL($siteData, '/shoptransportwaybill/index'). Func::getAddURLSortBy($siteData->urlParams, 'to_at'); ?>" class="link-black">Дата заезда</a>
        </th>
        <th>
