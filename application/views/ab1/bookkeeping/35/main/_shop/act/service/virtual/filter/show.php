        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select data-action-select2="1" id="shop_client_id" name="shop_client_id" class="form-control select2" style="width: 100%">
                            <option value="<?php echo Request_RequestParams::getParamInt('shop_client_id'); ?>" selected><?php echo Request_RequestParams::getParamStr('shop_client_name'); ?></option>
                        </select>
                        <input id="shop_client_name" name="shop_client_name" value="<?php echo Request_RequestParams::getParamStr('shop_client_name'); ?>" style="display: none">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group" style="margin-bottom: 5px">
                        <label for="shop_client_contract_id">Договор</label>
                        <select data-url="/bookkeeping/shopclientcontract/json?_fields[]=number&_fields[]=from_at"
                                id="shop_client_contract_id" name="shop_client_contract_id" class="form-control select2" style="width: 100%;">
                ...
                if($isCash !== NULL){
                    ...
                    <div class="col-md-2">
                        <div class="form-group" style="margin-bottom: 5px">
                            <label for="is_cash">Вид оплат</label>
                            <select id="is_cash" name="is_cash" class="form-control select2" style="width: 100%;">
                                <option value="0" data-id="0" <?php if(!$isCash){echo 'selected';} ?>>Наличные</option>
                                <option value="1" data-id="1" <?php if($isCash){echo 'selected';} ?>>Безналичные</option>
                            </select>
                        </div>
                    </div>
                <?php } ?>
...
<script>
    function loadShopClientAttorney (shopClientID, contract) {
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                var s = '<option value="0">Без договора</option>';
                ...
                var v = contract.val();
                contract.html(s).val(v).trigger('change');
            },
            error: function (data) {
    ...
    $('#shop_client_id').select2({
        ...
        templateSelection: function (repo) {
            loadShopClientAttorney(repo.id, $('#shop_client_contract_id'));
