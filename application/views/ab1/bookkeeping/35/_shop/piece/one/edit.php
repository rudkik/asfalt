...
<script>
    var bestPictures = new Bloodhound({
        ...
        remote: {
            url: '/bookkeeping/shopclient/json?name_bin=%QUERY&sort_by[name]=asc&limit=50&_fields[]=name&_fields[]=bin&_fields[]=balance_cache&_fields[]=balance',
            wildcard: '%QUERY'
        }
    });
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="row record-input record-list">
            ...
            <div class="col-md-9">
                <input data-type="money" data-fractional-length="3" id="delivery_km" name="delivery_km" type="text" class="form-control" value="<?php echo Func::getNumberStr($data->values['delivery_km'], true, 3); ?>" readonly>
            </div>
        </div>
        <div class="row record-input record-list">
            <div class="col-md-3 record-title">
            ...
            <div class="col-md-9">
                <input id="delivery_amount" name="delivery_amount" type="text" class="form-control" data-amount="<?php echo $data->values['delivery_amount']; ?>" value="<?php echo Func::getNumberStr($data->values['delivery_amount']); ?>" readonly>
            </div>
        </div>
        <div class="row record-input record-list">
            <div class="col-md-3 record-title">
