<div class="row record-input record-list">
    ...
    <div class="col-md-9">
        <input data-unique="true" data-field="name_full" data-href="/bookkeeping/shopmoveclient/json?id_not=<?php echo $data->id;?>" data-message="Данное название уже существует" name="name" type="text" class="form-control" placeholder="Название" required value="<?php echo htmlspecialchars(Arr::path($data->values, 'name', ''), ENT_QUOTES);?>">
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input data-unique="true" data-field="bin_full" data-href="/bookkeeping/shopmoveclient/json?id_not=<?php echo $data->id;?>" data-message="Данный БИН/ИИН уже существует" name="bin" type="text" class="form-control" placeholder="БИН/ИИН" maxlength="12" value="<?php echo htmlspecialchars(Arr::path($data->values, 'bin', ''), ENT_QUOTES);?>">
    </div>
    <div class="col-md-3 record-title">
        <label>
            Адрес
