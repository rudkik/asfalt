    ...
    <?php }?>
        <td>
            <ul class="list-inline tr-button delete">
                <li><a href="<?php echo Func::getFullURL($siteData, '/shopactservice/edit', array(), array('id' => $data->values['id']), $data->values, false, false, true); ?>" class="link-blue"><i class="fa fa-edit margin-r-5"></i> Изменить</a></li>
            </ul>
        </td>
</tr>
