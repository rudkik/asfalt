<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shopcartomaterial/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_client_id'); ?>" class="link-black">Отправитель</a>
        </th>
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shopcartomaterial/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_client_material_id'); ?>" class="link-black">Получатель</a>
        </th>
        <th style="width: 92px;">
