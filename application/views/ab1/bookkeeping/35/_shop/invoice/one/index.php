<tr>
    ...
    <td>
        <ul class="list-inline tr-button delete">
            ...
            <?php } ?>
            <li style="margin-top: 6px;"><a href="<?php echo Func::getFullURL($siteData, '/shopreport/invoice_one', array(), array('id' => $data->values['id']), $data->values, false, false, true); ?>"  class="link-green"><i class="fa fa-list-alt margin-r-5"></i> Накладная</a></li>
            <?php if(!empty($data->values['date_give_to_client'])){ ?>
                <li style="margin-top: 6px;"><a href="<?php echo Func::getFullURL($siteData, '/shopinvoice/received_from_client', array(), array('id' => $data->values['id']), array(), true, false, true); ?>"  class="link-dark-blue"><i class="fa fa-odnoklassniki margin-r-5"></i> Получено от клиента</a></li>
            <?php }?>
        </ul>
    </td>
</tr>
