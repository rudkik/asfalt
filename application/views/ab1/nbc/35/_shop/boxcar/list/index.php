<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th class="width-120">
            <a href="<?php echo Func::getFullURL($siteData, '/shopboxcar/index'). Func::getAddURLSortBy($siteData->urlParams, 'date_drain_from'); ?>" class="link-black">Начало слива</a>
        </th>
        <th class="width-130">
        ...
        <th class="width-130">
            Оператор начала слива
        </th>
        <th class="width-120">
            <a href="<?php echo Func::getFullURL($siteData, '/shopboxcar/index'). Func::getAddURLSortBy($siteData->urlParams, 'date_drain_to'); ?>" class="link-black">Окончание слива</a>
        </th>
        <th class="width-130">
        ...
        <th class="width-140">
            Оператор завершения слива
        </th>
        <th class="width-130">
            <a href="<?php echo Func::getFullURL($siteData, '/shopboxcar/index'). Func::getAddURLSortBy($siteData->urlParams, 'zhdc_shop_operation_id.name'); ?>" class="link-black">Диспетчер по ж.д документом</a>
        </th>
