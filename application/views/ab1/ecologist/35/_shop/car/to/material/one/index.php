<tr id="<?php echo $data->values['id']; ?>" data-name="<?php echo $data->values['name']; ?>" data-tarra="<?php echo $data->values['tarra']; ?>" data-quantity="<?php echo $data->values['quantity']; ?>">
    ...
    <td <?php if($data->values['is_test']){ ?>style="background: #e47365 !important;"<?php } ?>><?php echo Func::getNumberStr($data->values['tarra'], false, 3, false).' т'; ?></td>
    <td class="text-number"><?php echo Func::getNumberStr($data->values['quantity'], true, 3); ?></td>
