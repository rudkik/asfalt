			...
			<div class="row">
                ...
                <div class="col-md-1-5">
                    <div class="form-group">
                        <label for="created_at_from">Время от</label>
                ...
                <div class="col-md-1-5">
                    <div class="form-group">
                        <label for="created_at_to">Время до</label>
                        <div class="input-group" style="width: 100%;">
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                ...
                <?php } ?>
				<div class="col-md-<?php if($siteData->operation->getIsAdmin()){ echo '3';}else{echo '5';} ?>">
					<div hidden>
