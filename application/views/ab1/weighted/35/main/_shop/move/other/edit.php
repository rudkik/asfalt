    ...
    <div class="nav-tabs-custom nav-tabs-navy">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <?php $siteData->titleTop = 'Прочая машина (редактирование)'; ?>
                <form id="shopcar" action="<?php echo Func::getFullURL($siteData, '/shopmoveother/save'); ?>" method="post" style="padding-right: 5px;">
                    <?php echo trim($data['view::_shop/move/other/one/edit']); ?>
                </form>
            </div>
        </div>
    </div>
