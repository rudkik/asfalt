<form id="form-filter" class="box-body no-padding padding-bottom-10px">
	...
	<div class="col-md-12">
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
					<label for="shop_turn_type_id">Вид очереди</label>
                    <select id="shop_turn_type_id" name="shop_turn_type_id" class="form-control select2" style="width: 100%;">
                        <?php $tmp = Request_RequestParams::getParamInt('shop_turn_type_id'); ?>
                        ...
                        <?php
                        $tmp = 'data-id="'.$tmp.'"';
                        echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/turn/type/list/list']));
                        ?>
                    </select>
				</div>
			</div>
