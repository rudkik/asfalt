    ...
    <div class="nav-tabs-custom nav-tabs-navy">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                ...
                <form id="shopcartomaterial" enctype="multipart/form-data" action="<?php echo Func::getFullURL($siteData, '/shopcartomaterial/save'); ?>" method="post" style="padding-right: 5px;">
