	...
	<div class="nav-tabs-custom nav-tabs-navy">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <?php $siteData->titleTop = 'Возмещение брака'; ?>
                <?php
                $view = View::factory('ab1/weighted/35/main/_shop/defect/car/filter');
                $view->siteData = $siteData;
                $view->data = $data;
                echo Helpers_View::viewToStr($view);
                ?>
    ...
    function PrintTTN(id, pages) {
        jQuery.ajax({
            ...
            data: ({
                'action': ('print'),
                'type': ('ttn'),
                'table_id': ('<?php echo Model_Ab1_Shop_Defect_Car::TABLE_ID; ?>'),
                'pages': (pages),
                'id': (id)
            }),
            type: "GET",
    ...
    function showAutoAdd(id) {
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                jQuery.ajax({
                    url: '/weighted/shopdefectcar/clone',
                    data: ({
                        id: (id),
                        weight: (obj.weight),
                    }),
