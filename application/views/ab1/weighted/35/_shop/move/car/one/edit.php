<div id="dialog-car-edit" class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form-add-car" action="<?php echo Func::getFullURL($siteData, '/shopmovecar/save'); ?>" method="post" >
                    ...
                    <div class="row record-input record-list">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <select id="modal_shop_client_id" name="shop_client_id" class="form-control select2" required style="width: 100%;">
                ...
                <div class="modal-footer">
                    ...
                    <?php if($siteData->action == 'clone') { ?>
                        <input name="url" value="/weighted/shopmovecar/index" style="display: none">
