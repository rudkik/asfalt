<table class="table table-hover table-db table-tr-line" style="min-width1: 1560px;" data-action="fixed-table">
    <tr>
        ...
        <?php } ?>
        <?php if(Request_RequestParams::getParam('is_delete')){ ?>
            <th class="text-center width-90" style="font-size: 14px;">
                <a href="<?php echo Func::getFullURL($siteData, '/shopcartomaterial/index'). Func::getAddURLSortBy($siteData->urlParams, 'text'); ?>" class="link-black">Причина удаления</a>
            </th>
