			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
                        ...
                        <input id="input-name" class="form-control" name="name" placeholder="Поставщик" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
