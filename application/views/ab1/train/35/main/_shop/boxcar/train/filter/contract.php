		...
		<div class="row">
            <div class="col-md-1-5">
                <div class="form-group">
                    ...
                    <input id="date_from" class="form-control" name="date_from" value="<?php echo Helpers_DateTime::getDateFormatRus($dateFrom);?>" type="datetime" date-type="date">
                </div>
            </div>
            <div class="col-md-1-5">
                <div class="form-group">
                    <label for="date_to">Дата до</label>
                    <input id="date_to" class="form-control" name="date_to" value="<?php echo Helpers_DateTime::getDateFormatRus($dateTo);?>" type="datetime" date-type="date">
                </div>
            </div>
            <div class="col-md-7">
                <div hidden>
