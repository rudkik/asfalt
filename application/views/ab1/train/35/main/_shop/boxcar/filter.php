		...
		<div class="row">
			<div class="col-md-2">
                <div class="form-group">
                    <label for="number">№ вагона</label>
                    <input id="number" class="form-control" name="number" placeholder="№ вагона" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'number', ''), ENT_QUOTES);?>" type="text">
                </div>
			</div>
            <div class="col-md-8">
                <div hidden>
