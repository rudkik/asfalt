...
<div class="col-md-12 padding-top-15px">
	<div class="nav-tabs-custom nav-tabs-navy">
        ...
        <div class="tab-content" style="display: inline-block; width: 100%">
            ...
            <h3>ВГ08 Общий реестр по выгрузке</h3>
            <div class="col-md-12">
                <form action="<?php echo Func::getFullURL($siteData, '/shopreport/boxcar_cement_list'); ?>" method="get" enctype="multipart/form-data" >
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="boxcar_cement_list-date_from">Убытие от</label>
                                <input id="boxcar_cement_list-date_from" class="form-control" name="date_from" type="datetime" date-type="date" value="<?php echo $time1; ?>">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="boxcar_cement_list-date_to">Убытие до</label>
                                <input id="boxcar_cement_list-date_to" class="form-control" name="date_to" type="datetime" date-type="date" value="<?php echo $time2; ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="boxcar_cement_list-shop_raw_id">Сырье</label>
                                <select id="boxcar_cement_list-shop_raw_id" name="shop_raw_id" class="form-control select2" required style="width: 100%;">
                                    <?php echo str_replace('data-id="423463"', 'data-id="423463" selected', $siteData->replaceDatas['view::_shop/raw/list/list']); ?>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <h3>НБ02 Уведомление о приеме и сдачи хопров</h3>
            <div class="col-md-12">
                <form action="<?php echo Func::getFullURL($siteData, '/shopreport/boxcar_cement'); ?>" method="get" enctype="multipart/form-data" >
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="boxcar_drain-date_from">Дата убытия вагона от</label>
