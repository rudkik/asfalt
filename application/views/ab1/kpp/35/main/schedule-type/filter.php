            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input id="name" class="form-control" name="name" placeholder="Название" type="text" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="period">Период</label>
                        <input name="period" class="form-control" placeholder="Период" type="phone" value="<?php echo Arr::path($siteData->urlParams, 'period', '');?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div hidden>
