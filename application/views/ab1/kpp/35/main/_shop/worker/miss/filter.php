    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="miss_type_id">Вид прогула</label>
                        <select id="miss_type_id" name="miss_type_id" class="form-control select2" required style="width: 100%;">
                            ...
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::miss-type/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
                <div class="col-md-1-5">
                    <div class="form-group">
                        <label for="miss_from">Период от</label>
                        <input name="miss_from" type="datetime"  date-type="datetime" class="form-control" value="<?php echo Arr::path($siteData->urlParams, 'miss_from', '');?>">
                    </div>
                </div>
                <div class="col-md-1-5">
                    <div class="form-group">
                        <label for="miss_to">Период до</label>
                        <input name="miss_to" type="datetime" date-type="datetime"  class="form-control" value="<?php echo Arr::path($siteData->urlParams, 'miss_to', '');?>">
                    </div>
                </div>
                <div class="col-md-2">
                    <div hidden>
