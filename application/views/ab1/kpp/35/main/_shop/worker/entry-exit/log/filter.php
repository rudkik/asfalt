    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="shop_worker_entry_exit_id_empty">Распознан</label>
                        <select id="shop_worker_entry_exit_id_empty" name="shop_worker_entry_exit_id_empty" class="form-control select2" style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_worker_entry_exit_id_empty'); ?>
                            <option value="" data-id="" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <option value="0" data-id="0" <?php if($tmp == 0 && $tmp !== NULL){echo 'selected';} ?>>Распознан</option>
                            <option value="1" data-id="1" <?php if($tmp == 1){echo 'selected';} ?>>Не распознан</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
