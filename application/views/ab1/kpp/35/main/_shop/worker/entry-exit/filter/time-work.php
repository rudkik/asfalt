    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="shop_department_id">Отдел</label>
                        <select id="shop_department_id" name="shop_department_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_department_id'); ?>
                            <option value="-1" data-id="-1">Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                ...
                <div class="col-md-1-5">
                    <div class="form-group">
                        ...
                        <?php
                        $date = Arr::path($siteData->urlParams, 'date_entry_from', '');
                        if(empty($date)){
                            $date = Helpers_DateTime::getMonthBeginStr(date('m'), date('Y'));
                        }
                        ?>
                        <input name="date_entry_from" type="datetime"  date-type="datetime" class="form-control" value="<?php echo Helpers_DateTime::getDateTimeFormatRus($date);?>">
                    </div>
                </div>
                <div class="col-md-1-5">
                    <div class="form-group">
                        <label for="date_entry_to">Период до</label>
                        <input name="date_entry_to" type="datetime" date-type="datetime"  class="form-control" value="<?php echo Helpers_DateTime::getDateTimeFormatRus(Arr::path($siteData->urlParams, 'date_entry_to', ''));?>">
                    </div>
                </div>
                <div class="col-md-2">
                    <div hidden>
            ...
            <div class="row">
                <div class="col-md-12">
                    <label class="span-checkbox">
                        <input id="is_refresh" value="1" checked type="checkbox" class="minimal">
