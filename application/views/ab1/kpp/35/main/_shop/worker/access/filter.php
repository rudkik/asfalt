            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select id="shop_department_id" name="shop_worker_id/shop_department_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_worker_id/shop_department_id'); ?>
                            <option value="-1" data-id="-1">Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="shop_card_id">№ карточки</label>
                        <select id="shop_card_id" name="shop_card_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_card_id'); ?>
                            <option value="-1" data-id="-1">Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/card/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
