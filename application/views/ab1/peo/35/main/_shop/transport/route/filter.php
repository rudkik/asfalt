            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input id="name" class="form-control" name="name" placeholder="Название маршрута" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>" type="text">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_branch_from_to_id">Филиал</label>
                        <select id="shop_branch_from_to_id" name="shop_branch_from_to_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_branch_from_to_id'); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_daughter_from_to_id">Поставщик</label>
                        <select id="shop_daughter_from_to_id" name="shop_daughter_from_to_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_daughter_from_to_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <option value="0" data-id="0" <?php if($tmp == 0 && $tmp !== NULL){echo 'selected';} ?>>Без значения</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
