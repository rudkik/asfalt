            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="shop_transport_id" name="shop_transport_waybill_id/shop_transport_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_transport_waybill_id/shop_transport_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="shop_transport_work_id">Вид выработки</label>
                        <select id="shop_transport_work_id" name="shop_transport_work_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_transport_work_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                ...
                <div class="col-md-1-5">
                    <div class="form-group">
                        <label for="date_from_equally">Дата от</label>
                        <input name="shop_transport_waybill_id/date_from_equally" type="datetime"  date-type="date"  class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Arr::path($siteData->urlParams, 'shop_transport_waybill_id/date_from_equally', ''));?>">
                    </div>
                </div>
                <div class="col-md-1-5">
                    <div class="form-group">
                        <label for="date_to">Дата до</label>
                        <input name="shop_transport_waybill_id/date_to" type="datetime"  date-type="date"  class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Arr::path($siteData->urlParams, 'shop_transport_waybill_id/date_to', ''));?>">
                    </div>
                </div>
