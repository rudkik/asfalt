...
<body class="hold-transition fixed <?php if(strpos($siteData->url, 'statistics') !== false){?>body-summary<?php } ?>">
<div class="wrapper">
...
<script>
    ...
    //         $('.main-header').addClass('fixedclass');
    //     }
    //     else if ($(this).scrollTop()<50){
    //         $('.main-header').removeClass('fixedclass');
    //     }
    // });
</script>
