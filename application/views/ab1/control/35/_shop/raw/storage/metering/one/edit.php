...
<div class="row">
    ...
    <div class="modal-footer text-center">
        <button type="button" class="btn btn-primary" onclick="submitSave('shoprawstoragemetering');">Сохранить</button>
        <button type="button" class="btn btn-primary" onclick="$('#is_close').val(0); submitSave('shoprawstoragemetering');">Применить</button>
    </div>
</div>
<script>
