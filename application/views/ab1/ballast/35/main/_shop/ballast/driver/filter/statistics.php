			...
			<div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input id="date_from" type="datetime" datetype="date" class="form-control" name="date_from"  value="<?php $date = Request_RequestParams::getParamDate('date_from'); if(empty($date))($date = date('Y-m-d')); echo Helpers_DateTime::getDateFormatRus($date);?>">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="date_to">Дата до</label>
                        <input id="date_to" type="datetime" datetype="date" class="form-control" name="date_to"  value="<?php $date = Request_RequestParams::getParamDate('date_to'); if(empty($date))($date = date('Y-m-d')); echo Helpers_DateTime::getDateFormatRus($date);?>">
                    </div>
                </div>
				<div class="col-md-6">
					<div hidden>
