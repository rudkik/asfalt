...
<div class="row record-input record-list">
    ...
    <div class="col-md-9">
        <div class="input-group">
            <select id="access" name="access[shop_raw_ids][]" class="form-control select2" multiple style="width: 100%;">
...
<div class="row">
    <div hidden>
        <?php if($siteData->action != 'clone') { ?>
            ...
            <input name="shop_table_rubric_id" value="<?php echo Model_Ab1_Shop_Operation::RUBRIC_CRUSHER; ?>">
        <?php } ?>
    </div>
