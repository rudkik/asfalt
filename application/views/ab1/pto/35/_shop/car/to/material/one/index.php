<tr id="<?php echo $data->values['id']; ?>" data-name="<?php echo $data->values['name']; ?>" data-tarra="<?php echo $data->values['tarra']; ?>" data-quantity="<?php echo $data->values['quantity']; ?>">
    ...
    <td class="text-right" <?php if($data->values['is_test']){ ?>style="background: #e47365 !important;"<?php } ?>><?php echo Func::getNumberStr($data->values['tarra'] + $data->values['quantity'], false, 3, false); ?></td>
    ...
    <td class="text-right" data-id="quantity_daughter"><?php echo Func::getNumberStr($data->values['quantity_daughter'], false, 3, false); ?> т</td>
