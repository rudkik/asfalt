<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th style="width: 225px">
            <a href="<?php echo Func::getFullURL($siteData, '/shopinvoiceproforma/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_client_contract_id.number'); ?>" class="link-black">№ договора</a>
        </th>
        ...
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shopinvoiceproforma/index'). Func::getAddURLSortBy($siteData->urlParams, 'create_user_id.name'); ?>" class="link-black">Кто создал</a>
        </th>
