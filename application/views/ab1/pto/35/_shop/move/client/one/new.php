<div class="row record-input record-list">
    ...
    <div class="col-md-9">
        <input data-unique="true" data-field="name_full" data-href="/pto/shopmoveclient/json" data-message="Такое название уже есть в базе данных" name="name" type="text" class="form-control" placeholder="Название" required>
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input data-unique="true" data-field="bin_full" data-href="/pto/shopmoveclient/json" data-message="Такой БИН/ИИН уже есть в базе данных" name="bin" type="text" class="form-control" placeholder="БИН/ИИН" maxlength="12">
    </div>
    <div class="col-md-3 record-title">
        <label>
            Адрес
