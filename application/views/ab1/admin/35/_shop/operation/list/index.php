<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shopoperation/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_table_rubric_id.name'); ?>" class="link-black">Интерфейс</a>
        </th>
