            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input id="name" class="form-control" name="name" placeholder="счета" maxlength="20" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?> " type="text">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="root_id" name="root_id" class="form-control select2"  style="width: 100%;">
                            ...
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/raw/rubric/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
