            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input id="name" class="form-control" name="name" placeholder="Название банка" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>" type="text">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="bin">БИН/ИИН</label>
                        <input id="bin" class="form-control" name="bin" placeholder="БИН/ИИН" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'bin', ''), ENT_QUOTES);?>" type="text">
                    </div>
                </div>
                <div class="col-md-4">
                    <div hidden>
