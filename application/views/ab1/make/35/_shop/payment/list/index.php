<table class="table table-hover table-db table-tr-line" data-action="fixed">
    <tr>
        ...
        <th class="width-130">
            <a href="<?php echo Func::getFullURL($siteData, '/shoppayment/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_client_contract_id.number'); ?>" class="link-black">Договор</a>
        </th>
        <th class="width-110">
            <a href="<?php echo Func::getFullURL($siteData, '/shoppayment/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_cashbox_id.name'); ?>" class="link-black">Касса</a>
        </th>
