            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input id="input-name" class="form-control" name="name" placeholder="Название" maxlength="120" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
                    </div>
                </div>
                <div class="col-md-7">
                    <div hidden>
