...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input name="number" type="text" class="form-control" placeholder="Код 1С" value="<?php echo $data->values['number'];?>"  <?php if($isShow){?>disabled<?php }?>>
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input name="unit" type="text" class="form-control" placeholder="Единица измерения" value="<?php echo htmlspecialchars($data->values['unit'], ENT_QUOTES);?>"  <?php if($isShow){?>disabled<?php }?>>
    </div>
</div>
<div class="row">
    <div hidden>
