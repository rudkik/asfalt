        ...
        <div class="tab-content">
            ...
            <?php if($isExit === false){ ?>
                <div class="tab-pane active">
                    ...
                    <?php
                    $view = View::factory('ab1/_all/35/main/_shop/worker/entry-exit/filter/index');
                    $view->siteData = $siteData;
                    $view->data = $data;
                    echo Helpers_View::viewToStr($view);
                    ?>
            ...
            <div class="nav-tabs-custom" style="margin-bottom: 0px;">
                <ul id="tab-status" class="nav nav-tabs pull-right ui-sortable-handle">
                    ...
                    <li class="<?php if(Arr::path($siteData->urlParams, 'is_delete', '') != 1 && Request_RequestParams::getParamBoolean('is_exit') !== false){echo 'active';}?>"><a href="<?php echo Func::getFullURL($siteData, '/shopworkerentryexit/history', array());?>" data-id="is_public_ignore">Все <i class="fa fa-fw fa-info text-blue"></i></a></li>
