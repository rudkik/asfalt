	...
	<div class="nav-tabs-custom nav-tabs-navy">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <?php $siteData->titleTop = 'Выдача ГСМ'; ?>
                <?php
                $view = View::factory('ab1/_all/35/main/_shop/transport/waybill/fuel/expense/filter');
                $view->siteData = $siteData;
                $view->data = $data;
                echo Helpers_View::viewToStr($view);
                ?>
            ...
            <div class="body-table">
                <div class="box-body table-responsive" style="padding-top: 30px;">
                    ...
                    <?php echo trim($data['view::_shop/transport/waybill/fuel/expense/list/statistics']); ?>
                </div>
            </div>
        </div>
	</div>
