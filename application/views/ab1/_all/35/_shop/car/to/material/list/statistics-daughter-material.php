<table class="table table-hover table-db table-tr-line" style="margin-bottom: 40px;">
    ...
    <?php
    foreach ($data['view::_shop/car/to/material/one/statistics-daughter-material']->childs as $value) {
        echo $value->str;
    }
    $data = $data['view::_shop/car/to/material/one/statistics-daughter-material'];
    ?>
    <tr class="total">
        <td>Итого</td>
