...
<?php if(!$isShow){ ?>
    <div class="modal-footer">
        <button type="button" class="btn btn-danger pull-left" onclick="addContract();">Добавить продукцию</button>
    </div>
    <div id="new-product" data-index="0">
        <!--
        <tr>
            <td>
                <select data-id="product_shop_branch_id" name="shop_pricelist_items[_#index#][product_shop_branch_id]" class="form-control select2" style="width: 100%">
    ...
    <script>
        function addContract() {
            addElement('new-product', 'products', true);
        ...
        function _initDelete(elements) {
            ...
            elements.click(function () {
                ...
                var amount = 0;
                $('#products input[data-id="amount"]').each(function () {
        ...
        $(document).ready(function () {
            ...
            _initDelete($('#products [data-action="remove-tr"]'));
