<table class="table table-hover table-db table-tr-line" >
    ...
    <tr>
        <th class="tr-header-public">
            <span>
                <input name="set-is-public-all" type="checkbox" class="minimal" checked  href="<?php echo Func::getFullURL($siteData, '/shopformulamaterial/save');?>">
            </span>
        </th>
    ...
    <tbody>
    <?php
    foreach ($data['view::_shop/formula/material/one/recipe']->childs as $value) {
        echo $value->str;
    }
    ?>
    </tbody>
