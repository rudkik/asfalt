...
<tr>
    ...
    <td>
        <input data-type="money" data-fractional-length="3" name="shop_formula_items[<?php echo $data->id; ?>][norm_weight]" type="text" class="form-control" placeholder="Вес (кг)" required value="<?php echo Func::getNumberStr($data->values['norm_weight'], FALSE); ?>" <?php if($isShow){ ?>readonly<?php } ?>>
    </td>
    <?php if(!$isShow){ ?>
        <td>
