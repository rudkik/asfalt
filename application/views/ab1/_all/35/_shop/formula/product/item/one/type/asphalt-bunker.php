...
<?php if(Arr::path($data->values['options'], 'is_bitumen', '0') == 0){ ?>
    <tr>
        ...
        <td>
            <input data-type="money" data-fractional-length="2" data-id="bunker_percent" name="shop_formula_items[<?php echo $data->id; ?>][options][bunker_percent]" type="text" class="form-control text-right" required value="<?php echo Arr::path($data->values['options'], 'bunker_percent', ''); ?>" <?php if($isShow){ ?>readonly<?php } ?>>
        </td>
        <td>
