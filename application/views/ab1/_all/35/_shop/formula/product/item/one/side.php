...
<tr>
    <td>
        <select data-action="calc"  name="shop_formula_sides[<?php echo $data->id; ?>][shop_material_id]" class="form-control select2" required style="width: 100%;" <?php if($isShow){ ?>disabled<?php } ?>>
