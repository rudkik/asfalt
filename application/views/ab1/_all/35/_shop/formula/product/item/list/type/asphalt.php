...
<div class="row record-input record-list">
    ...
    <div class="col-md-9">
        <table class="table table-hover table-db table-tr-line" >
            ...
            <tbody id="materials">
            <?php
            foreach ($data['view::_shop/formula/product/item/one/type/asphalt']->childs as $value) {
                echo $value->str;
            }
            ?>
...
<div id="new-material" data-index="0">
    ...
    <tr>
        ...
        <td>
            <input data-type="money" data-fractional-length="3" data-id="norm_percent" name="shop_formula_items[_#index#][options][norm_percent]" type="text" class="form-control text-right" placeholder="Расход (%)" readonly>
        </td>
        <td>
