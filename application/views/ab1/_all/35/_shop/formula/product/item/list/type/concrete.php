...
<div class="row record-input record-list">
    ...
    <div class="col-md-9">
        <table class="table table-hover table-db table-tr-line" >
            ...
            <tbody id="materials">
            <?php
            foreach ($data['view::_shop/formula/product/item/one/type/concrete']->childs as $value) {
                echo $value->str;
            }
            ?>
...
<div id="new-material-liter" data-index="1000000">
    ...
    <tr style="background-color: rgba(97, 106, 168, 0.3);">
        ...
        <td class="text-center"> - </td>
        <td>
            <input data-action="calc-asphalt" data-id="norm_weight" name="shop_formula_items[_#index#][norm_weight]" type="text" class="form-control text-right" placeholder="Расход (л)" required>
        </td>
        <td>
            <input data-action="calc-asphalt" data-id="losses" name="shop_formula_items[_#index#][losses]" type="text" class="form-control text-right" placeholder="Потери (%)" required>
        </td>
        <td class="text-center"> - </td>
        <td>
            <input data-id="norm_industrial" name="shop_formula_items[_#index#][options][norm_industrial]" type="text" class="form-control text-right" placeholder="Производственные нормы (л)" readonly>
        </td>
        <td>
