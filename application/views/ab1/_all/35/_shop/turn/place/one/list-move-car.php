<div class="col-lg-3 col-xs-6">
    <a data-action="set-turn" href="<?php echo Func::getFullURL($siteData, '/shopmovecar/save', array(), array('id' => $data->additionDatas['shop_car_id'], 'shop_turn_place_id' => $data->id, 'shop_turn_id' => Model_Ab1_Shop_Turn::TURN_ASU), $data->values); ?>" class="small-box-footer">
        <div class="small-box #color#" style="margin-bottom: 5px;">
            <div class="inner">
                ...
                <h4><?php echo $data->additionDatas['ton'];?> т</h4>
