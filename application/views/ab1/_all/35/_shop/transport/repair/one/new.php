<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input id="date" name="date" type="datetime"  date-type="date"  class="form-control" placeholder="Дата" required value="<?php echo date('d.m.Y'); ?>">
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
    ...
    <div class="col-md-3">
        <input data-action="hours" name="from_at" type="datetime"  date-type="datetime"  class="form-control" value="<?php echo date('d.m.Y H:i:d'); ?>">
    </div>
    <div class="col-md-3 record-title">
        <label>
    ...
    <div class="col-md-3">
        <input data-action="hours" name="to_at" type="datetime"  date-type="datetime"  class="form-control">
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
    ...
    <div class="col-md-3">
        <input data-type="money" data-fractional-length="0" name="hours" type="text" class="form-control" placeholder="Часов ремонта">
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
