...
<table class="table table-hover table-db table-tr-line" data-action="fixed">
    ...
    <?php
    foreach ($data['view::_shop/transport/to/work/driver/one/index']->childs as $value) {
        echo $value->str;
    }
    ?>
    </tbody>
...
<div id="new-to-work-driver" data-index="0">
    ...
    <tr>
        <td>
            <select name="shop_transport_to_work_drivers[_#index#][shop_transport_work_id]" class="form-control select2" style="width: 100%">
