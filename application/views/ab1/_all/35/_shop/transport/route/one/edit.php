...
<div class="row record-input record-list">
    ...
    <div class="col-md-9">
        <input name="name" type="text" class="form-control" placeholder="Название маршрута" required value="<?php echo htmlspecialchars($data->values['name'], ENT_QUOTES);?>">
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
    ...
    <div class="col-md-3">
        <input data-type="money" data-fractional-length="3" name="distance" type="phone" class="form-control" placeholder="Расстояние (км)" required value="<?php echo $data->values['distance'];?>">
    </div>
    <div class="col-md-3 record-title">
        <label>
            <sup><i class="fa fa-fw fa-asterisk text-red"></i></sup>
    ...
    <div class="col-md-3">
        <input data-type="money" data-fractional-length="2" name="amount" type="phone" class="form-control" placeholder="Расценка" required value="<?php echo Func::getNumberStr($data->values['amount'], true);?>">
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
    ...
    <div class="col-md-9">
        <textarea name="formula" class="form-control" placeholder="Формула"><?php echo htmlspecialchars($data->values['formula'], ENT_QUOTES);?></textarea>
        <p>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select id="shop_branch_from_id" name="shop_branch_from_id" class="form-control select2" required style="width: 100%;">
                        ...
                        echo str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/branch/list/list']);
                        ?>
                    </select>
                </div>
            </div>
            <div class="col-md-6" id="shop_daughter_from">
                <div class="form-group">
                    ...
                    <select id="shop_daughter_from_id" name="shop_daughter_from_id" class="form-control select2" required style="width: 100%;">
                        <option value="0" data-id="0">Без значения</option>
                        <?php
                        $tmp = 'data-id="'.$data->values['shop_daughter_from_id'].'"';
                        echo str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/daughter/list/list']);
                        ?>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select id="shop_branch_to_id" name="shop_branch_to_id" class="form-control select2" required style="width: 100%;">
                        <option value="0" data-id="0">Без значения</option>
                        <?php
                        $tmp = 'data-id="'.$data->values['shop_branch_to_id'].'"';
                        echo str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/branch/list/list']);
                        ?>
                    </select>
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select id="shop_daughter_to_id" name="shop_daughter_to_id" class="form-control select2" required style="width: 100%;">
                        <option value="0" data-id="0">Без значения</option>
                        <?php
                        $tmp = 'data-id="'.$data->values['shop_daughter_to_id'].'"';
                        echo str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/daughter/list/list']);
                        ?>
                    </select>
                </div>
...
<div class="row record-input record-list" id="product">
    ...
    <div class="col-md-3">
        <select data-action="shop_client" data-basic-url="<?php echo $siteData->actionURLName;?>" data-action-select2="1" data-value="<?php echo $data->values['shop_client_to_id'];?>"
