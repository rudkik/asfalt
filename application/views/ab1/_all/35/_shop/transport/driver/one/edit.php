...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input id="name" name="name" type="text" class="form-control" placeholder="ФИО водителя" required value="<?php echo htmlspecialchars($data->values['name'], ENT_QUOTES);?>" <?php if($isShow){?>disabled<?php }?>>
    </div>
    <div class="col-md-3 record-title">
        <label>
            <sup><i class="fa fa-fw fa-asterisk text-red"></i></sup>
    ...
    <div class="col-md-3">
        <select id="shop_worker_id" name="shop_worker_id" class="form-control select2" required style="width: 100%;" <?php if($isShow){?>disabled<?php }?>>
...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <select id="shop_branch_from_id" name="shop_branch_from_id" class="form-control select2" required style="width: 100%;" <?php if($isShow){?>disabled<?php }?>>
            <option value="0" data-id="0">Без значения</option>
    ...
    <div class="col-md-3">
        <select id="shop_transport_class_id" name="shop_transport_class_id" class="form-control select2"  style="width: 100%;" <?php if($isShow){?>disabled<?php }?>>
            <option value="0" data-id="0">Без значения</option>
