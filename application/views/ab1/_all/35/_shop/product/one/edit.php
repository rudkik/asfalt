...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <textarea name="name_recipe" class="form-control" placeholder="Название по реценту"><?php echo htmlspecialchars(Arr::path($data->values, 'name_recipe', ''), ENT_QUOTES);?></textarea>
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input data-type="money" data-fractional-length="3" name="tare" type="text" class="form-control" placeholder="Вес тары" value="<?php echo Func::getNumberStr(Arr::path($data->values, 'tare', ''), FALSE);?>">
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <label class="span-checkbox">
            <input name="is_pricelist" <?php if (Arr::path($data->values, 'is_pricelist', '0') == 1) { echo ' value="1" checked'; }else{echo 'value="0"';} ?> type="checkbox" class="minimal">
    ...
    <div class="col-md-3">
        <input name="order" type="text" class="form-control" placeholder="Сортировка" value="<?php echo Arr::path($data->values, 'order', '');?>">
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title"></div>
    <div class="col-md-9">
        <label class="span-checkbox">
            <input name="options[amdor_9]" <?php if (Arr::path($data->values['options'], 'amdor_9', '0') == 1) { echo ' value="1" checked'; }else{echo 'value="0"';} ?> type="checkbox" class="minimal">
...
<div class="row record-input record-list">
    ...
    <div class="col-md-9" style="width: 900px;">
        <table class="table table-hover table-db table-tr-line" >
            ...
            <tr>
                <td>
                    <input data-type="money" data-fractional-length="3" name="options[weighted]" type="text" class="form-control" placeholder="Вес (кг)" value="<?php echo Arr::path($data->values['options'], 'weighted', '');?>">
                </td>
                <td>
                    <input data-type="money" data-fractional-length="3" name="options[volume]" type="text" class="form-control" placeholder="Объем (м3)" value="<?php echo Arr::path($data->values['options'], 'volume', '');?>">
                </td>
                <td>
                    <input data-type="money" data-fractional-length="3" name="options[length]" type="text" class="form-control" placeholder="Длина (м)" value="<?php echo Arr::path($data->values['options'], 'length', '');?>">
                </td>
                <td>
                    <input data-type="money" data-fractional-length="3" name="options[width]" type="text" class="form-control" placeholder="Ширина (м)" value="<?php echo Arr::path($data->values['options'], 'width', '');?>">
                </td>
                <td>
                    <input data-type="money" data-fractional-length="3" name="options[height]" type="text" class="form-control" placeholder="Высота (м)" value="<?php echo Arr::path($data->values['options'], 'height', '');?>">
                </td>
                <td>
                    <input data-type="money" data-fractional-length="3" name="options[area]" type="text" class="form-control" placeholder="Площадь (м2)" value="<?php echo Arr::path($data->values['options'], 'area', '');?>">
                </td>
            </tr>
            </tbody>
        </table>
...
<div class="row record-input record-list">
    ...
    <div class="col-md-9" style="max-width: 600px;">
        <?php echo trim($siteData->globalDatas['view::_shop/product/time/price/list/index']); ?>
    </div>
</div>
<div class="row">
    <div hidden>
