<tr>
    ...
    <td>
        <a href="<?php echo Func::getFullURL($siteData, '/shopboxcar/index', array(), array('shop_boxcar_train_id' => $data->values['shop_boxcar_train_id'], 'shop_client_id' => $data->values['shop_client_id'], 'is_in_transit' => true)); ?>">
