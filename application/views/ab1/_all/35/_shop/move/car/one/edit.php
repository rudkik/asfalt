...
<?php if($siteData->operation->getIsAdmin()){ ?>
    <div class="row record-input record-list">
        ...
        <div class="col-md-3">
            <input name="created_at" type="datetime" date-type="datetime" class="form-control" value="<?php echo Helpers_DateTime::getDateTimeFormatRus($data->values['created_at']); ?>" required>
        </div>
        <div class="col-md-3 record-title">
            <label>
                <sup><i class="fa fa-fw fa-asterisk text-red"></i></sup>
        ...
        <div class="col-md-3">
            <input name="exit_at" type="datetime" date-type="datetime" class="form-control" value="<?php echo Helpers_DateTime::getDateTimeFormatRus($data->values['exit_at']); ?>" required>
        </div>
    </div>
<?php } ?>
<div class="row record-input record-list">
        ...
        <div class="row">
            <div class="col-md-6">
                <label class="span-checkbox">
                    <input name="is_delivery"  <?php if (Arr::path($data->values, 'is_delivery', '') == 1) { echo ' value="1" checked'; }else{echo 'value="0"';} ?> type="checkbox" class="minimal" <?php if($isShow){ ?>disabled<?php } ?>>
                    Доставка
                </label>
            </div>
            <div class="col-md-6">
...
<?php if(!$isShow){ ?>
    <div class="row">
        ...
        <div class="modal-footer text-center">
            <a href="<?php echo Func::getFullURL($siteData, '/shopreport/move_talonxls', array(), array('id' => $data->values['id']), $data->values, false, false, true); ?>" class="btn bg-navy btn-flat pull-left"><i class="fa fa-fw fa-credit-card"></i> Талон</a>
            <a href="<?php echo Func::getFullURL($siteData, '/shopreport/move_car_ttn', array(), array('id' => $data->values['id']), $data->values, false, false, true); ?>" class="btn bg-navy btn-flat pull-left"><i class="fa fa-fw fa-credit-card"></i> ТТН</a>
