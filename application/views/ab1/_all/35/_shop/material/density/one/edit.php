...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input name="date_from" type="datetime" data-date="date" class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus($data->values['date_from']); ?>" required>
    </div>
    <div class="col-md-3 record-title">
        <label>
            <sup><i class="fa fa-fw fa-asterisk text-red"></i></sup>
    ...
    <div class="col-md-3">
        <input name="date_to" type="datetime" data-date="date" class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus($data->values['date_to']); ?>" required>
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input data-type="money" name="density" type="text" class="form-control" placeholder="Плотность" value="<?php echo htmlspecialchars(Arr::path($data->values, 'density', ''), ENT_QUOTES);?>">
    </div>
</div>
<div class="row">
    <div hidden>
