<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input name="date" type="datetime" data-date="date" class="form-control" value="<?php echo date('d.m.Y'); ?>" required>
    </div>
</div>
<div class="row record-input record-list">
    <div class="col-md-3 record-title">
...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input data-type="money" name="moisture" type="text" class="form-control" placeholder="Влажность" required>
    </div>
</div>
<div class="row">
