<tr>
    ...
    <?php if(Request_RequestParams::getParamBoolean('is_balance')){ ?>
        <td>
            <a href="<?php echo Func::getFullURL($siteData, '/shopproductrubric/compensation', array(), array('shop_client_id' => $data->values['shop_client_id'], 'shop_client_name' => $data->getElementValue('shop_client_id'), 'shop_branch_id' => Request_RequestParams::getParamInt('shop_branch_id'))); ?>">
