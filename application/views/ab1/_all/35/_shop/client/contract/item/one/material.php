...
<tr>
    <td>
        <?php if($isShow){?><input name="shop_client_contract_items[<?php echo $data->id; ?>][shop_material_id]" value="<?php echo $data->values['shop_material_id'];?>" style="display: none;"><?php }?>
        <select data-id="shop_material_id" name="shop_client_contract_items[<?php echo $data->id; ?>][shop_material_id]" class="form-control select2" style="width: 100%" <?php if($isShow){ ?>disabled<?php } ?>>
