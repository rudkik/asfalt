<table class="table table-hover table-db table-tr-line" >
    <tr>
        ...
        <th class="width-90">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'number'); ?>" class="link-black">№ осн. дог.</a>
        </th>
        <th class="width-70">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'number'); ?>" class="link-black">№ доп.</a>
        </th>
        <th class="width-90">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'created_at'); ?>" class="link-black" style="font-size: 12px;">Дата регистрации</a>
        </th>
        <th>
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'shop_client_id.name'); ?>" class="link-black">Клиент</a>
        </th>
        <th class="text-right width-120">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'amount'); ?>" class="link-black">Сумма</a>
        </th>
        <th class="width-90" style="font-size: 12px;">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'from_at'); ?>" class="link-black">Дата закл.</a>
        </th>
        <th class="width-115" style="font-size: 11px;">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'to_at'); ?>" class="link-black">Дата оконч.</a>
        </th>
        <th class="width-145">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'client_contract_type_id.name'); ?>" class="link-black">Категория договора</a>
        </th>
        <th class="width-140">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'subject'); ?>" class="link-black">Предмет договора</a>
        </th>
        <th class="width-90">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'client_contract_status_id.name'); ?>" class="link-black">Статус договора</a>
        </th>
        <th class="width-100">
            <a href="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director'). Func::getAddURLSortBy($siteData->urlParams, 'executor_shop_worker_id.name'); ?>" class="link-black">Исполнитель</a>
        </th>
        <th class="width-70">Файл</th>
        <th style="width: 115px;"></th>
    </tr>
    <form id="form-filter_" action="<?php echo Func::getFullURL($siteData, '/shopclientcontract/director', array());?>">
    ...
    <?php
    $i = 1;
    foreach ($data['view::_shop/client/contract/one/director']->childs as $value) {
