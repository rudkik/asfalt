...
<table class="table table-hover table-db table-tr-line" >
    ...
    <tbody id="contracts">
    <?php
    foreach ($data['view::_shop/client/contract/item/one/material']->childs as $value) {
        echo $value->str;
    }
    ?>
...
<div class="modal-footer">
    <button type="button" class="btn btn-danger pull-left" onclick="addContract('new-contract', 'contracts', true);">Добавить материал</button>
</div>
<div id="new-contract" data-index="0">
    <!--
    <tr>
        <td>
            <select data-id="shop_material_id" name="shop_client_contract_items[_#index#][shop_material_id]" class="form-control select2" style="width: 100%">
    ...
    function _initCalc(elements) {
        elements.on('change', function(){
            ...
            $('#contracts tr').each(function (i) {
                ...
                $(this).find('input[data-id="amount"]').valNumber(amount).attr('data-amount', sAmount);
