...
<tr>
    ...
    <td <?php if(empty(Helpers_DateTime::getDateFormatRus($data->values['from_at']))){ ?>class="tr-red"<?php } ?> ><?php echo Helpers_DateTime::getDateFormatRus($data->values['from_at']); ?></td>
    <td <?php if(empty(Helpers_DateTime::getDateFormatRus($data->values['to_at'])) && $data->values['is_perpetual'] != 1 ){ ?>class="tr-red"<?php } ?> >
