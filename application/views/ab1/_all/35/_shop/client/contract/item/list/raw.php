...
<table class="table table-hover table-db table-tr-line" >
    ...
    <tbody id="contracts">
    <?php
    foreach ($data['view::_shop/client/contract/item/one/raw']->childs as $value) {
        echo $value->str;
    }
    ?>
...
<div class="modal-footer">
    <button type="button" class="btn btn-danger pull-left" onclick="addContract('new-contract', 'contracts', true);">Добавить сырье</button>
</div>
<div id="new-contract" data-index="0">
    <!--
    <tr>
        <td>
            <select data-id="shop_raw_id" name="shop_client_contract_items[_#index#][shop_raw_id]" class="form-control select2" style="width: 100%">
