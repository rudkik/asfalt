<div id="dialog-payment" class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo Func::getFullURL($siteData, '/shoppayment/add_car'); ?>" method="post" >
                ...
                <div class="modal-footer">
                    <div style="display: none;">
                        ...
                        <input id="modal_shop_product_id" name="shop_payment_items[0][shop_product_id]" value="0">
                        <input id="modal_quantity" name="shop_payment_items[0][quantity]" value="0">
                    </div>
