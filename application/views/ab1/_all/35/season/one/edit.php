...
<div class="row record-input record-list">
    ...
    <div class="col-md-9">
        <input name="name" type="text" class="form-control" placeholder="Сезон" required value="<?php echo htmlspecialchars($data->values['name'], ENT_QUOTES);?>" <?php if($isShow){?>disabled<?php }?>>
    </div>
</div>
<div class="row">
    <div hidden>
