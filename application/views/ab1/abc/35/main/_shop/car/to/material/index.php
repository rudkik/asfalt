    ...
    <div class="nav-tabs-custom nav-tabs-navy">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <h3><?php if($isWeighted){ ?>Материалы<?php }else{ ?>Добавки<?php } ?></h3>

                <?php
                $view = View::factory('ab1/abc/35/main/_shop/car/to/material/filter');
                $view->siteData = $siteData;
                $view->data = $data;
                echo Helpers_View::viewToStr($view);
                ?>
                    ...
                    <ul id="tab-status" class="nav nav-tabs pull-right ui-sortable-handle">
                        ...
                        <?php if(!$isWeighted){ ?>
                            <li class="pull-left header">
                                <a href="<?php echo Func::getFullURL($siteData, '/shopcartomaterial/new', array(), array('is_weighted' => false));?>" class="btn bg-purple btn-flat">
