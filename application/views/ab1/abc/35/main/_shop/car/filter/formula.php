	...
	<div class="row">
		<div class="col-md-12">
			<div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" style="width: 100%;">
                            <div class="input-group">
                                ...
                                <input class="form-control pull-right" type="datetime" date-type="datetime" name="exit_at_from" value="<?php $dateFrom = Helpers_DateTime::getMonthBeginStr(date('m'), date('Y')).' 06:00:00'; echo Helpers_DateTime::getDateTimeFormatRus(Arr::path($siteData->urlParams, 'exit_at_from', $dateFrom));?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" style="width: 100%;">
                            <div class="input-group">
                                ...
                                <input class="form-control pull-right" type="datetime" date-type="datetime" name="exit_at_to" value="<?php echo Helpers_DateTime::getDateTimeFormatRus(Arr::path($siteData->urlParams, 'exit_at_to', Helpers_DateTime::plusMonth($dateFrom, 1)));?>">
                            </div>
                        </div>
                    </div>
                </div>
				<div class="col-md-3">
					<div class="form-group"  style="margin-bottom: 5px">
                        ...
                        <select data-action="shop_client" data-basic-url="abc" data-action-select2="1" data-value="<?php echo Request_RequestParams::getParamInt('shop_client_id');?>"
            ...
            <div class="row">
                ...
                <?php } ?>
				<div class="col-md-<?php if($siteData->operation->getIsAdmin()){ echo '8';}else{echo '10';} ?>">
					<div hidden>
