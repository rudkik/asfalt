			...
			<div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="shop_piece_id/name" data-type="auto-number" value="<?php echo Arr::path($siteData->urlParams, 'shop_piece_id/name', '');?>">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" style="width: 100%;">
                            <div class="input-group">
                                ...
                                <input class="form-control pull-right" type="datetime" date-type="datetime" name="shop_piece_id/created_at_from" value="<?php echo Arr::path($siteData->urlParams, 'shop_piece_id/created_at_from', '');?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" style="width: 100%;">
                            <div class="input-group">
                                ...
                                <input class="form-control pull-right" type="datetime" date-type="datetime" name="shop_piece_id/created_at_to" value="<?php echo Arr::path($siteData->urlParams, 'shop_piece_id/created_at_to', '');?>">
                            </div>
                        </div>
                    </div>
                </div>
