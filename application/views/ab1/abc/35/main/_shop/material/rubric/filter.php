			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
                        ...
                        <input id="input-name" class="form-control" name="name" placeholder="Рубрика" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
					</div>
				</div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="root_id">Родитель</label>
                        <select id="root_id" name="root_id" class="form-control select2" style="width: 100%;">
                            ...
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/material/rubric/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
