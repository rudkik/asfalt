		...
		<div class="row">
            <div class="col-md-1-5">
                <div class="form-group">
                    ...
                    <input class="form-control" type="datetime" date-type="datetime" name="date_from" value="<?php echo Helpers_DateTime::getDateTimeFormatRus($dateFrom);?>">
                </div>
            </div>
            <div class="col-md-1-5">
                <div class="form-group">
                    <label for="date_to">Период до</label>
                    <input class="form-control" type="datetime" date-type="datetime" name="date_to" value="<?php echo Helpers_DateTime::getDateTimeFormatRus($dateTo);?>">
                </div>
            </div>
            <div class="col-md-7">
                <div hidden>
