			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label for="exampleInputEmail1">Отправитель</label>
                        <input id="input-name" class="form-control" name="name" placeholder="Отправитель" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
					</div>
				</div>
				<div class="col-md-5">
					<div hidden>
