<table class="table table-hover table-db table-tr-line" style="min-width: 1373px;">
    <tr>
        ...
        <th style="width: 230px;">
            <a href="<?php echo Func::getFullURL($siteData, '/shoplesseecar/index'). Func::getAddURLSortBy($siteData->urlParams, 'shop_formula_product_id.name'); ?>" class="link-black">Рецепт</a>
        </th>
