...
<div class="row record-input record-list">
    ...
    <div class="col-md-9">
        <label class="span-checkbox">
            ...
            <input name="is_public" <?php echo $openPHP; ?> if (Arr::path($data->values, 'is_public', '1') == 1) { echo ' value="1" checked'; }else{echo 'value="0"';} <?php echo $closePHP; ?> type="checkbox" class="minimal">
            Показать
        </label>
    </div>
</div>
