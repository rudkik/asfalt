            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_transport_company_id">
                            <?php echo $field['title']; ?>

                        </label>
                        <select id="<?php echo $key; ?>" name="<?php echo $key; ?>" class="form-control select2" required style="width: 100%;">
                            <?php echo $openPHP; ?> $tmp = Request_RequestParams::getParamInt('shop_delivery_department_id'); <?php echo $closePHP; ?>
                            ...
                            <?php echo $openPHP; ?>
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/<?php echo Api_MVC::pathView($key); ?>/list/list']));
                            <?php echo $closePHP; ?>
