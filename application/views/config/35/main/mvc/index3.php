<?php $siteData->titleTop = 'Выберите поля для Edit/New';
...
<form class="form-horizontal" action="<?php echo Func::getFullURL($siteData, '/mvc/index4'); ?>" method="post" style="padding-right: 5px;">
    ...
    <div  class="form-group">
        <label class="col-md-2 control-label" style="text-align: left;">
            ...
            Заголовок при создании
        </label>
        <div class="col-md-10">
            <input name="name-new" type="text" class="form-control" placeholder="Заголовок при создании" value="">
        </div>
    </div>
    <div  class="form-group">
        <label class="col-md-2 control-label" style="text-align: left;">
            <sup><i class="fa fa-fw "></i></sup>
            Заголовок при изменении
        </label>
        <div class="col-md-10">
            <input name="name-edit" type="text" class="form-control" placeholder="Заголовок при изменении" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <label class="span-checkbox">
                <input name="updateEditNew" value="1" checked type="checkbox" class="minimal">
                Обновить Edit/New
            </label><br>
        </div>
    </div>
