...
<head>
    ...
    <link type="text/css" rel="stylesheet"
          href="<?php echo $siteData->urlBasic; ?>/css/config/vendors/jquery-ui-1.10.3.custom/css/ui-lightness/jquery-ui-1.10.3.custom.css">
    ...
    <!--Loading style-->
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/config/css/themes/style1/pink-blue.css" class="default-style">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/config/css/themes/style1/pink-blue.css" id="theme-change"
...
<body id="signin-page">
<div class="page-form">
    <form action="<?php echo $siteData->urlBasic; ?>/config/shopuser/login" class="form" method="post">
