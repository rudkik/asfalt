                ...
                <ul class="nav-right">
                    <li class="user-profile header-notification">
                        ...
                        <ul class="show-notification profile-notification">
                            <li>
                                <a href="<?php echo $siteData->urlBasic; ?>/nur-admin/shopuser/unlogin">
...
<div class="main-menu">
    <div class="main-menu-content">
        <ul class="main-navigation">
            <li class="nav-item single-item <?php if(strpos($siteData->url, '/nur-admin/shopbranch/') !== FALSE){echo 'has-class';} ?>">
                <a href="/nur-admin/shopbranch/index">
                    <i class="ti-user"></i>
                    <span data-i18n="nav.animations.main">Клиенты</span>
                </a>
            </li>
            <li class="nav-item single-item <?php if(strpos($siteData->url, '/nur-admin/shopoperation/') !== FALSE){echo 'has-class';} ?>">
                <a href="/nur-admin/shopoperation/index">
                    <i class="ti-user"></i>
                    <span data-i18n="nav.animations.main">Пользователи</span>
                </a>
            </li>
            <li class="nav-item single-item <?php if(strpos($siteData->url, '/nur-admin/shoptask/') !== FALSE){echo 'has-class';} ?>">
                <a href="/nur-admin/shoptask/index">
                    <i class="ti-user"></i>
                    <span data-i18n="nav.animations.main">Задачи</span>
                </a>
            </li>
            <li class="nav-item single-item <?php if(strpos($siteData->url, '/nur-admin/shoptaskgroup/') !== FALSE){echo 'has-class';} ?>">
                <a href="/nur-admin/shoptaskgroup/index">
                    <i class="ti-user"></i>
                    <span data-i18n="nav.animations.main">Группы задач</span>
                </a>
            </li>
            <li class="nav-item single-item <?php if(strpos($siteData->url, '/nur-admin/shopcompanyview/') !== FALSE){echo 'has-class';} ?>">
                <a href="/nur-admin/shopcompanyview/index">
                    <i class="ti-user"></i>
                    <span data-i18n="nav.animations.main">Виды деятельностей</span>
                </a>
            </li>
            <li class="nav-item single-item <?php if(strpos($siteData->url, '/nur-admin/shoptaxview/') !== FALSE){echo 'has-class';} ?>">
                <a href="/nur-admin/shoptaxview/index">
                    <i class="ti-user"></i>
                    <span data-i18n="nav.animations.main">Виды местных налогов</span>
                </a>
            </li>
            <li class="nav-item has-class">
                ...
                <ul class="tree-1">
                    <li class="nav-item single-item <?php if(strpos($siteData->url, '/nur-admin/shoptaskcurrent/run') !== FALSE){echo 'has-class';} ?>"><a href="/nur-admin/shoptaskcurrent/run" data-i18n="nav.dash.default"> Выполняются</a></li><li>
                    <li class="nav-item single-item <?php if((strpos($siteData->url, '/nur-admin/shoptaskcurrent/new') !== FALSE) && (Request_RequestParams::getParamStr('period') == 'day')){echo 'has-class';} ?>"><a href="/nur-admin/shoptaskcurrent/new?period=day" data-i18n="nav.dash.default"> Новые на три дня</a></li><li>
                    <li class="nav-item single-item <?php if((strpos($siteData->url, '/nur-admin/shoptaskcurrent/new') !== FALSE) && (Request_RequestParams::getParamStr('period') == 'week')){echo 'has-class';} ?>"><a href="/nur-admin/shoptaskcurrent/new?period=week" data-i18n="nav.dash.ecommerce"> Новые на одну неделю</a></li>
                    <li class="nav-item single-item <?php if((strpos($siteData->url, '/nur-admin/shoptaskcurrent/new') !== FALSE) && (Request_RequestParams::getParamStr('period') == 'month')){echo 'has-class';} ?>"><a href="/nur-admin/shoptaskcurrent/new?period=month" data-i18n="nav.dash.crm"> Новые на один месяц</a></li>
                    <li class="nav-item single-item <?php if(strpos($siteData->url, '/nur-admin/shoptaskcurrent/index') !== FALSE){echo 'has-class';} ?>"><a href="/nur-admin/shoptaskcurrent/index" data-i18n="nav.dash.default"> Выполненные</a></li><li>
                    <li class="nav-item single-item <?php if(strpos($siteData->url, '/nur-admin/shoptaskcurrent/calendar') !== FALSE){echo 'has-class';} ?>"><a href="/nur-admin/shoptaskcurrent/calendar" data-i18n="nav.dash.default"> Календарь</a></li><li>
                </ul>
            </li>
        </ul>
    </div>
