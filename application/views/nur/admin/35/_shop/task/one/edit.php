...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input name="date_from" id="date_from" type="datetime" data-type="date" class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Helpers_DateTime::changeDateYear($data->values['date_from'], date('Y'))); ?>">
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
            <label for="date_to" class="block">Срок действия до</label>
            <input name="date_to" id="date_to" type="datetime" data-type="date" class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Helpers_DateTime::changeDateYear($data->values['date_to'], date('Y'))); ?>">
        </div>
    </div>
</div>
<div class="text-center" style="width: 100%;">
    ...
    <a href="/nur-admin/shoptask/index" class="btn btn-danger">Отменить</a>
</div>