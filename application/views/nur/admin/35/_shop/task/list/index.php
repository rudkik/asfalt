<div class="ks-nav-body">
    <div id="task-toolbar" class="ks-datatable-toolbar">
        <div class="ks-items-block">
            ...
            <a href="<?php echo $siteData->urlBasic; ?>/nur-admin/shoptask/new" class="btn btn-primary ks-solid"><span class="ks-icon fa fa-plus"></span> <span class="ks-text">Добавить</span></a>
            <button data-action="table-delete" data-table="#task-data-table" data-url="<?php echo $siteData->urlBasic; ?>/nur-admin/shoptask/del" class="btn btn-danger ks-solid"><span class="ks-icon fa fa-remove "></span> <span class="ks-text">Удалить</span></button>
        </div>
    </div>
    ...
    <table id="task-data-table" data-action="nur-table" class="table table-striped table-bordered" width="100%"
           ...
           data-url="<?php echo $siteData->urlBasic; ?>/nur-admin/shoptask/json?is_total=1&_fields[]=date_from&_fields[]=name&_fields[]=date_to&_fields[]=id"
...
<script>
    ...
    function getEditURL(value, row) {
        return '<a href="/nur-admin/shoptask/edit?id='+ row['id']+'"><span class="ks-icon fa fa-pencil-square-o"></span> изменить</a>';
    }
</script>
