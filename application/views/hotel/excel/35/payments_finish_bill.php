...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Лист1">
   ...
   ?>
   <Table ss:ExpandedColumnCount="11" ss:ExpandedRowCount="<?php echo $row + 6; ?>" x:FullColumns="1"
   ...
   <Column ss:Width="58.75"/>
   <Row ss:Height="17.25">
    <Cell ss:MergeAcross="10" ss:StyleID="s65"><Data ss:Type="String">Отчет по завершенным броням с <?php echo Helpers_DateTime::getDateFormatRus(Request_RequestParams::getParamDateTime('period_from')); ?> по <?php echo Helpers_DateTime::getDateFormatRus(Request_RequestParams::getParamDateTime('period_to')); ?></Data></Cell>
   </Row>
   <Row ss:Index="3">
   ...
   <Row>
    ...
    <Cell ss:StyleID="s81"><Data ss:Type="String"></Data></Cell>
    <Cell ss:StyleID="s183"><Data ss:Type="DateTime"><?php echo $payment['date']; ?></Data></Cell>
   ...
   <Row ss:AutoFitHeight="1">
    ...
    <Cell ss:StyleID="s82"><Data ss:Type="String"><?php echo htmlspecialchars($room['bin'], ENT_XML1); ?></Data></Cell>
    ...
    <Cell ss:StyleID="s84"><Data ss:Type="Number"><?php echo $room['paid_amount'] - $room['amount']; ?></Data></Cell>
   </Row>
   <?php $i++; } ?>
   <?php } ?>
   <Row ss:AutoFitHeight="1">
    ...
    <Cell ss:StyleID="s84"><Data ss:Type="Number"><?php echo $payments['paid_amount'] - $payments['amount']; ?></Data></Cell>
   </Row>
  </Table>
