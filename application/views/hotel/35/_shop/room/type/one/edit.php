<div id="room-type-edit-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 750px;">
        <div class="modal-content">
            ...
            <form class="has-validation-callback" action="/hotel/shoproomtype/save">
...
<script>
    $(document).ready(function () {
        ...
        $('#room-type-edit-record form').on('submit', function(e){
            e.preventDefault();
            var $that = $(this),
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (!obj.error) {
                        $('#room-type-edit-record').modal('hide');
                        $('#room-type-data-table').bootstrapTable('updateByUniqueId', {
                                id: obj.values.id,
                                row: obj.values
                        });
