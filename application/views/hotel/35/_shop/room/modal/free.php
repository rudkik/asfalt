<link rel="stylesheet" type="text/css" href="<?php echo $siteData->urlBasic; ?>/css/hotel/assets/styles/apps/projects/grid-board.min.css">
...
<script>
    function groupItems() {
        ...
        jQuery.ajax({
            url: '/hotel/shopbill/group_items',
            data: formData,
            type: "POST",
