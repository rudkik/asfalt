<div id="holiday-new-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<script>
    $(document).ready(function () {
        ...
        $('#holiday-new-record input[type="datetime"]').datetimepicker({
            dayOfWeekStart : 1,
            lang:'ru',
            format:	'd.m.Y',
            timepicker:false,
        ...
        $('#holiday-new-record form').on('submit', function(e){
            e.preventDefault();
            var $that = $(this),
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (!obj.error) {
                        $('#holiday-new-record').modal('hide');
                        $('#holiday-data-table').bootstrapTable('insertRow', {
                            index: 0,
                            row: obj.values
                        });
