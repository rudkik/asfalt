<div id="holiday-edit-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 750px;">
        <div class="modal-content">
            ...
            <form class="has-validation-callback" action="/hotel/shopholiday/save">
...
<script>
    $(document).ready(function () {
        ...
        $('#holiday-edit-record input[type="datetime"]').datetimepicker({
            dayOfWeekStart : 1,
            lang:'ru',
            format:	'd.m.Y',
            timepicker:false,
        ...
        $('#holiday-edit-record form').on('submit', function(e){
            e.preventDefault();
            var $that = $(this),
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (!obj.error) {
                        $('#holiday-edit-record').modal('hide');
                        $('#holiday-data-table').bootstrapTable('updateByUniqueId', {
                                id: obj.values.id,
                                row: obj.values
                        });
