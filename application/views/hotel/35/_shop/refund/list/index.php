<div class="ks-nav-body">
    <div id="refund-toolbar" class="ks-datatable-toolbar">
        <div class="ks-items-block">
            ...
            <button id="refund-new" data-action="table-new" data-table="#refund-data-table" data-modal="#refund-new-record" data-url="<?php echo $siteData->urlBasic; ?>/hotel/shoprefund/new" class="btn btn-success-outline ks-solid"><span class="ks-icon fa fa-plus"></span> <span class="ks-text">Добавить</span></button>
            <?php if ($siteData->operation->getShopTableRubricID() != 2){ ?>
            <button id="refund-edit" data-action="table-edit" data-table="#refund-data-table" data-modal="#refund-edit-record" data-url="<?php echo $siteData->urlBasic; ?>/hotel/shoprefund/edit" class="btn btn-info-outline ks-solid"><span class="ks-icon fa fa-pencil-square-o"></span> <span class="ks-text">Редактировать</span></button>
            <?php } ?>
        </div>
    </div>

    <table id="refund-data-table" data-action="hotel-table" class="table table-striped table-bordered" width="100%"
           data-search="true"
           ...
           data-url="<?php echo $siteData->urlBasic; ?>/hotel/shoprefund/json?is_total=1&_fields[]=refund_type_name&_fields[]=update_user_name&_fields[]=date&_fields[]=amount&_fields[]=number&_fields[]=created_at&_fields[]=shop_client_name&_fields[]=text&_fields[]=id"
