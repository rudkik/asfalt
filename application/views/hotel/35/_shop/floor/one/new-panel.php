<div id="<?php echo $panelID; ?>" class="form-group row" style="display: none">
    <input name="is_add_floor" value="0" style="display: none">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="form-group margin-0">
                                <input name="shop_floor[name]" data-validation="length" data-validation-length="max250" maxlength="250" class="form-control" placeholder="Название" id="name" type="text">
                            </div>
                        </div>
                    </div>
                </div>
