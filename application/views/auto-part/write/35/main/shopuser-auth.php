    ...
    <div class="login-wrapepr">
        <div
            ...
            <div class="login-block">
                <form action="<?php echo $siteData->urlBasic; ?>/stock_write/shopuser/login" method="get" role="form">
                    ...
                    <div class="form-group">
                        <input type="email" name="email" class="form-control login-input" id="" placeholder="E-mail">
                    </div>
                    <div class="form-group">
