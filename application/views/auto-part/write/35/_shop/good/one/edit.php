    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input autocomplete="off" name="stock_name" type="text" class="form-control" placeholder="<?php echo SitePageData::setPathReplace('type.form_data.shop_good.fields_title.stock_name', SitePageData::CASE_FIRST_LETTER_UPPER); ?>" value="<?php echo $data->values['stock_name']; ?>">
            </div>
        </div>
    </div>
<?php } ?>
