			...
			<div class="row">
				<div class="col-md-4 filter-input">
					<div class="form-group">
						<span for="input-name"  class="col-md-4 control-label">Название / ФИО</span>
						<div class="col-md-8">
							<div class="input-group">
								<input id="input-name" class="form-control" name="name" placeholder="Название / ФИО"" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
				...
				<div class="col-md-4 filter-input">
					<div class="form-group">
						<span for="input-name"  class="col-md-4 control-label">Время купона от</span>
						<div class="col-md-8">
							<div class="input-group">
								<div class="input-group">
				...
				<div class="col-md-4 filter-input">
					<div class="form-group">
						<span for="input-name"  class="col-md-4 control-label">Время купона до</span>
						<div class="col-md-8">
							<div class="input-group">
								<div class="input-group">
									<div class="input-group-addon">
