<div class="row top20">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12" style="margin: 0px; padding: 0px; border-width: 1px; border-style: solid; border-color: #00b9f2; height: 325px;">
            <textarea  is_editor="1" name="text" id="text" placeholder="Сообщение..." rows="7" class="form-control" style="margin: 0px; height: 100%;"></textarea>
...
<div class="row top20">
    ...
    <div class="col-md-2">
        <input type="submit" value="Сохранить" class="btn btn-primary btn-block"
               onclick="actionSaveObject('<?php echo $siteData->urlBasic . '/cabinet/shopemail/save'; ?>', 0, 'edit_panel', 'table_panel', false)">
    </div>
    <div class="col-md-3">
        <input type="submit" value="Сохранить и закрыть" class="btn btn-primary btn-block"
               onclick="actionSaveObject('<?php echo $siteData->urlBasic . '/cabinet/shopemail/save'; ?>', 0, 'edit_panel', 'table_panel', true)">
    </div>
</div>