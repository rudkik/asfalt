<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
    ...
    <Worksheet ss:Name="Лист1">
        <Table ss:ExpandedColumnCount="8" ss:ExpandedRowCount="<?php echo count($data['view::shopbill/save/xls']->childs) + 1; ?>" x:FullColumns="1"
               x:FullRows="1">
            ...
            <Row>
                <Cell ss:StyleID="s21"><Data ss:Type="String">№ заказа</Data></Cell>
                <Cell ss:StyleID="s21"><Data ss:Type="String">Дата создания</Data></Cell>
                <Cell ss:StyleID="s21"><Data ss:Type="String">Дата поставки</Data></Cell>
                <Cell ss:StyleID="s21"><Data ss:Type="String">Статус</Data></Cell>
                <Cell ss:StyleID="s21"><Data ss:Type="String">Поставщик</Data></Cell>
            ...
            <?php
            foreach ($data['view::shopbill/save/xls']->childs as $value) {
                echo $value->str."\r\n";
            }
            ?>
        </Table>
