<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
    ...
    <Worksheet ss:Name="Лист1">
        <Table ss:ExpandedColumnCount="2" ss:ExpandedRowCount="<?php echo count($data['view::shopbill/save/group-by-bill-amount']->childs) + 1; ?>" x:FullColumns="1"
               x:FullRows="1">
            ...
            <?php
            foreach ($data['view::shopbill/save/group-by-bill-amount']->childs as $value) {
                echo $value->str."\r\n";
            }
            ?>
        </Table>
