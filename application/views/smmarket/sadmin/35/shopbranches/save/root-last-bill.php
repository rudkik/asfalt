<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
    ...
    <Worksheet ss:Name="Лист1">
        <Table ss:ExpandedColumnCount="4" ss:ExpandedRowCount="<?php echo count($data['view::shopbranch/save/root-last-bill']->childs) + 1; ?>" x:FullColumns="1"
               x:FullRows="1">
            ...
            <Row>
                ...
                <Cell ss:StyleID="s21"><Data ss:Type="String">Дата последнего заказа</Data></Cell>
                <Cell ss:StyleID="s21"><Data ss:Type="String">Сумма</Data></Cell>
                <Cell ss:StyleID="s21"><Data ss:Type="String">ID заказа</Data></Cell>
            </Row>
            <?php
            foreach ($data['view::shopbranch/save/root-last-bill']->childs as $value) {
                echo $value->str."\r\n";
            }
            ?>
        </Table>
