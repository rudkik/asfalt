        ...
        <div class="col-md-12">
            <div class="box box-primary padding-top-5px">
                <div class="box-body pad table-responsive">
                    <form action="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shopnew/save" method="post" style="padding-right: 5px;">
                        <?php echo trim($data['view::shopnew/edit']); ?>
                    </form>
                </div>
            </div>
        </div>
