			...
			<div class="row">
                <div class="col-md-4 filter-input">
                    <div class="form-group">
                        <span for="input-catalog"  class="col-md-4 control-label">Тип</span>
                        <div class="col-md-8">
                            <select name="shop_information_data_catalog_id" class="form-control select2" style="width: 100%;">
                                <option value="-1" data-id="-1"></option>
                                <option value="0" data-id="0">Без категории</option>
                                <?php echo trim($data['view::shopinformationdatacatalogs/list']); ?>
                            </select>
                        </div>
                    </div>
                </div>
