<div class="box box-success">
	...
	<form class="box-body no-padding padding-bottom-10px">
		<div class="col-md-12">
			<div class="row">
				<?php if ((Func::isShopMenu('shopnewrubric/index-all-root', array(), $siteData))
				|| ((Request_RequestParams::getParamInt('type') > 0) && (Func::isShopMenu('shopnewrubric/index-root?type='.Request_RequestParams::getParamInt('type'), array(), $siteData)))){ ?>
