<section class="content-header">
    <h1>
        Рубрика <?php echo trim($data['view::branch_type']); ?>
    ...
    <ol class="breadcrumb">
        ...
        <?php } ?>
        <li><a href="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shopbranchcatalog/index?type=<?php echo intval(Request_RequestParams::getParamInt('type')); ?><?php if($siteData->branchID > 0){echo '&shop_branch_id='.$siteData->branchID;} ?><?php if($siteData->superUserID > 0){echo '&shop_id='.$siteData->shopID;} ?>"><i class="fa fa-dashboard"></i> Рубрики <?php echo trim($data['view::branch_type']); ?></a></li>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-top-5px">
                <div class="box-body pad table-responsive">
                    <form action="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shopbranchcatalog/save" method="post" style="padding-right: 5px;">
                        <?php echo trim($data['view::shopbranchcatalog/edit']); ?>
                    </form>
                </div>
            </div>
        </div>
