        ...
        <div class="modal-content">
            <div class="box box-success margin-bottom-5px">
                <div class="box-header with-border">
                    <h3 class="box-title">Выберите товар / услугу</h3>
                ...
                <div id="find-goods-similar-id" class="box-body no-padding padding-bottom-10px">
            ...
            <section id="result-goods-similar" class="content padding-top-5px">
