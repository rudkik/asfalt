    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="box box-success margin-bottom-5px">
                ...
                <div id="find-goods-gift-id" class="box-body no-padding padding-bottom-10px">
                    <div class="col-md-12 padding-top-5px">
                        <div class="row">
                            <?php if ((Func::isShopMenu('shopgoodcatalog/index-all', array(), $siteData))
                                || ((Request_RequestParams::getParamInt('type') > 0) && (Func::isShopMenu('shopgoodcatalog/index?type='.Request_RequestParams::getParamInt('type'), array(), $siteData)))){ ?>
                                <div class="col-md-4">
            ...
            <section id="result-goods-gift" class="content padding-top-5px">
