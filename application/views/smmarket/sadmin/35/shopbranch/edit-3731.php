...
$view->data = $data;$view->select = 'supplier';
                    ...
                    <div class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="options[manager_address]" class="form-control" id="manager_address" rows="3" placeholder="Адрес"><?php echo htmlspecialchars(Arr::path($data->values, 'options.manager_address', ''), ENT_QUOTES); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="manager_number_plane_table" class="col-sm-2 control-label">№ планшета</label>
                                <div class="col-sm-10">
                                    <input name="options[manager_number_plane_table]" class="form-control" id="manager_number_plane_table" placeholder="№ планшета" type="text" value="<?php echo htmlspecialchars(Arr::path($data->values, 'options.manager_number_plane_table', ''), ENT_QUOTES); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="manager_date_plane_table" class="col-sm-2 control-label">Дата выдача планшета</label>
                                <div class="col-sm-10">
                                    <input name="options[manager_date_plane_table]" class="form-control" id="manager_date_plane_table" placeholder="Дата выдачи планшета" type="datetime" value="<?php echo htmlspecialchars(Arr::path($data->values, 'options.manager_date_plane_table', ''), ENT_QUOTES); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="manager_phone_plane_table" class="col-sm-2 control-label">Номер телефона на планшете</label>
                                <div class="col-sm-10">
                                    <input name="options[manager_phone_plane_table]" class="form-control" id="manager_phone_plane_table" placeholder="+7 777 777 77 77" type="text" value="<?php echo htmlspecialchars(Arr::path($data->values, 'options.manager_phone_plane_table', ''), ENT_QUOTES); ?>">
                                </div>
                            </div>
                            <div class="form-group">
