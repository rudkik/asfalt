<table id="example2_wrapper" class="table table-bordered table-hover table-striped dataTable no-footer">
    ...
    <tr>
        ...
        <th style="text-align: left; position: relative; padding: 8px;">Название</th>
    ...
    <tr>
        ...
        <td>...</td>
        <td>
            <a buttom_list="new" href="<?php echo $siteData->urlBasic.'/cabinet/shopinformationdatacatalog/new';?>?shop_id=<?php echo $siteData->shopID;?>" class="btn btn-default btn-sm checkbox-toggle">добавить</a>
        </td>
    </tr>
    <?php
    foreach ($data['view::shopinformationdatacatalog/index']->childs as $value){
        echo $value->str;
    }
    ?>
    </tbody>
