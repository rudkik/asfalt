<div class="row">
    <div class="col-md-9">
        ...
        <?php if (((Request_RequestParams::getParamInt('type') > 0) && (Func::isShopMenu('shopbranchcatalog/index-params?type='.Request_RequestParams::getParamInt('type'), array(), $siteData)))){ ?>
