		...
		<div class="col-md-12">
			<div class="row">
				<?php if ((Func::isShopMenu('shopbranchcatalog/index-all-root', array(), $siteData))
					|| ((Request_RequestParams::getParamInt('type') > 0) && (Func::isShopMenu('shopbranchcatalog/index-root?type='.Request_RequestParams::getParamInt('type'), array(), $siteData)))){ ?>
							...
							<div class="col-md-8">
								<div class="input-group">
									<select id="input-root"  name="root_id" class="form-control select2" style="width: 100%;">
										...
										<?php echo trim($data['view::shopbranchcatalogs/list']); ?>
									</select>
								</div>
							</div>
						</div>
