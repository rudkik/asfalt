<section class="content-header">
    <h1>
        Группа атрибутов <?php echo trim($data['view::good_type']); ?>
    ...
    <ol class="breadcrumb">
        ...
        <?php } ?>
        <li><a href="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shopattributegroup/index?type=<?php echo intval(Request_RequestParams::getParamInt('type')); ?><?php if($siteData->branchID > 0){echo '&shop_branch_id='.$siteData->branchID;} ?><?php if($siteData->superUserID > 0){echo '&shop_id='.$siteData->shopID;} ?>"><i class="fa fa-dashboard"></i> Группы атрибутов <?php echo trim($data['view::good_type']); ?></a></li>
        <li class="active">Группа атрибутов</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-top-5px">
                <div class="box-body pad table-responsive">
                    <?php echo trim($data['view::shopattributegroup/edit']); ?>
                </div>
            </div>
        </div>
    </div>
