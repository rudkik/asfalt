        ...
        <div class="col-md-12">
            <div class="row">
                <?php if ((Func::isShopMenu('shopattributecatalog/index-all', array(), $siteData))
                    || ((Request_RequestParams::getParamInt('type') > 0) && (Func::isShopMenu('shopattributecatalog/index?type='.Request_RequestParams::getParamInt('type'), array(), $siteData)))){ ?>
                    <div class="col-md-4 filter-input">
                        <div class="form-group">
                            <span for="input-catalog"  class="col-md-4 control-label">Рубрика</span>
                            <div class="col-md-8">
                                <div class="input-group" style="width: 100%;">
                                    <?php if ((Func::isShopMenu('shopattributecatalog/index-all', array(), $siteData))
                                    || ((Request_RequestParams::getParamInt('type') > 0) && (Func::isShopMenu('shopattributecatalog/index?type='.Request_RequestParams::getParamInt('type'), array(), $siteData)))){ ?>
                                        <select id="input-catalog"  name="shop_attribute_catalog_id" class="form-control select2" style="width: 100%;">
                                            <option value="-1" data-id="-1"></option>
                                            <option value="0" data-id="0">Без рубрики</option>
                                            <?php echo trim($siteData->globalDatas['view::shopattributecatalogs/list']); ?>
                                        </select>
                                    <?php } ?>
