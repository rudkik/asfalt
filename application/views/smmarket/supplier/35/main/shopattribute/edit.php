<section class="content-header">
    <h1>
        Атрибут <?php echo trim($data['view::good_type']); ?>
        ...
        <div class="col-md-12">
            <div class="box box-primary padding-top-5px">
                <div class="box-body pad table-responsive">
                    <?php echo trim($data['view::shopattribute/edit']); ?>
                </div>
            </div>
        </div>
    </div>
