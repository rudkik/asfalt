<div class="box box-success">
	...
	<form id="form-filter" class="box-body no-padding padding-bottom-10px">
		<div class="col-md-12">
			<div class="row">
                <?php if ((Func::isShopMenu('shopgoodcatalog/index-all-root', array(), $siteData))
                || ((Request_RequestParams::getParamInt('type') > 0) && (Func::isShopMenu('shopgoodcatalog/index-root?type='.Request_RequestParams::getParamInt('type'), array(), $siteData)))){ ?>
                    <div class="col-md-4 filter-input">
                        <div class="form-group">
                            <span for="input-root"  class="col-md-4 control-label">Рубрика</span>
                            <div class="col-md-8">
                                <div class="input-group">
                                    <select id="input-root"  name="root_id" class="form-control select2" style="width: 100%;">
                                        <option value="-1" data-id="-1"></option>
                                        <option value="0" data-id="0">Категории верхнего уровня</option>
                                        <?php echo trim($data['view::shopgoodcatalogs/list']); ?>
                                    </select>
                                </div>
                            </div>
                        </div>
