<table id="example2" class="table table-bordered table-hover table-striped dataTable no-footer">
    ...
    <tr>
        ...
        echo ' href="' . $siteData->urlBasic . '/cabinet/shop/index' . Func::getAddURLParams($siteData->urlParams, array('sort_by' => array('name' => $sort), 'is_table' => '1')) . '"';
        ?>>Название
        </th>
        <th<?php
        ...
        echo ' href="' . $siteData->urlBasic . '/cabinet/shop/index' . Func::getAddURLParams($siteData->urlParams, array('sort_by' => array('domain' => $sort), 'is_table' => '1')) . '"';
        ?>>Домен</th>
        <th<?php
        ...
        echo ' href="' . $siteData->urlBasic . '/cabinet/shop/index' . Func::getAddURLParams($siteData->urlParams, array('sort_by' => array('sub_domain' => $sort), 'is_table' => '1')) . '"';
        ?>>Субдомен</th>
        ...
        echo ' href="' . $siteData->urlBasic . '/cabinet/shop/index' . Func::getAddURLParams($siteData->urlParams, array('sort_by' => array('to_pay_at' => $sort), 'is_table' => '1')) . '"';
        ?>>Оплачен до
        </th>
    ...
    <tr>
        ...
        <td>...</td>
        <td>
            <a buttom_list="new" href="<?php echo $siteData->urlBasic . '/cabinet/site/index'; ?>"
