<div class="row">
    <div class="col-md-9">
        ...
        <?php if ((Func::isShopMenu('shopattributecatalog/index-all-root', array(), $siteData))
            || (($data->values['shop_table_catalog_id'] > 0) && (Func::isShopMenu('shopgoodcatalog/index-root?type='.$data->values['shop_table_catalog_id'], array(), $siteData)))){ ?>
            <div class="row record-input record-list">
                <div class="col-md-3 record-title">
                <span>
                    <sup><i class="fa fa-fw fa-asterisk text-red"></i></sup>
        ...
        <?php if (($data->values['shop_table_catalog_id'] > 0) && (Func::isShopMenu('shopgoodcatalog/index-params?type='.$data->values['shop_table_catalog_id'], array(), $siteData))){ ?>
