    ...
    <div class="form-horizontal box-partner-goods-edit">
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <label>
                        <input name="good_select_type_id" value="3723" <?php if ($data->values['good_select_type_id'] == 3723) { echo ' value="3723" checked'; }else{echo 'value="0"';} ?> data-id="3723" type="checkbox" class="minimal">
                        Новинка
                    </label>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="options[price_a]" class="form-control" id="price_a" placeholder="Цена - А" type="text" value="<?php echo Arr::path($data->values, 'options.price_a', '');?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="price_b" class="col-sm-2 control-label">Цена - B</label>
                        <div class="col-sm-10">
                            <input name="options[price_b]" class="form-control" id="price_b" placeholder="Цена - B" type="text" value="<?php echo Arr::path($data->values, 'options.price_b', '');?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="price_b_plus" class="col-sm-2 control-label">Цена - B+</label>
                        <div class="col-sm-10">
                            <input name="options[price_b_plus]" class="form-control" id="price_b_plus" placeholder="Цена - B+" type="text" value="<?php echo Arr::path($data->values, 'options.price_b_plus', '');?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="options[price_c]" class="form-control" id="price_c" placeholder="Цена - C" type="text" value="<?php echo Arr::path($data->values, 'options.price_c', '');?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="price_market" class="col-sm-2 control-label">Цена - рынки и базары</label>
                        <div class="col-sm-10">
                            <input name="options[price_market]" class="form-control" id="price_market" placeholder="Цена - рынки и базары" type="text" value="<?php echo Arr::path($data->values, 'options.price_market', '');?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="price_horeca" class="col-sm-2 control-label">Цена - Horeca</label>
                        <div class="col-sm-10">
                            <input name="options[price_horeca]" class="form-control" id="price_horeca" placeholder="Цена - Horeca" type="text" value="<?php echo Arr::path($data->values, 'options.price_horeca', '');?>">
                        </div>
                    </div>
                </div>
            </div>
