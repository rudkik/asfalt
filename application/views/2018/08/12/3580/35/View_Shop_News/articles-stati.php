    ...
    <nav class="listar-pagination">
        <ul>
            <?php if($siteData->pages > 0) {
                ...
                // предыдущая страница
                $previous_active = '<li class="listar-prevpage"><a href="$url$"><i class="fa fa-angle-left"></i></a></li>';
                $previous_not_active = '';

                // следующая страница
                $next_active = '<li class="listar-nextpage"><a href="$url$"><i class="fa fa-angle-right"></i></a></li>';
                $next_not_active = '';
