...
<section class="tz-introduce-univesity">
    ...
    <?php } ?>
    <?php if (Arr::path($data->values['options'], 'is_info', '0') == 1){ ?>
...
<section class="tz-cources">
    <span class="tz-images-check"><img src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/images/check-01-home1.png" alt="Images"></span>
        ...
        <section class="tz-portfolio-wrapper">
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                <div class="tz-gallary">
                    ...
                    <div class="tz-gallery-images" style="margin: 0 auto">
