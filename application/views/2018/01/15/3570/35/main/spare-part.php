<div class="header-title">
    <h3>Каталог автозапчастей. Всего позиций в наличии <?php echo trim($siteData->globalDatas['view::View_Shop_Goods\kolichestvo-zapchastei']); ?></h3>
</div>
...
<div class="header-cars">
    <div class="goods-info">
        <?php echo trim($siteData->globalDatas['view::View_Shop_Good\spare-part-zapchast']); ?>
    </div>
</div>
</div>
</div>
