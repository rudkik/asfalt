            ...
            <div class="header-top-car">
                <img class="" src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/background/car-1.png">
                <h2>Наша разборка специализируется <br>на продаже б/у запчастей</h2>
            </div>
        </div>
		<?php echo trim($siteData->globalDatas['view::View_Shop_News\preimushchestva-nashei-razborki']); ?>
        <?php echo trim($siteData->globalDatas['view::View_Shop_News\katalog-avtozapchastei']); ?>
            <div data-action="scroll-line" data-id="4" class="header-box-top">
                <img src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/arrow_bottom.png">
                <p>ДОСТАВКИ И ОПЛАТА</p>
            </div>
        <?php echo trim($siteData->globalDatas['view::View_Shop_News\usloviya-dostavki-i-oplata']); ?>
