        ...
        <div class="text_block">
            ...
            <div class="sitemap">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us" title="عن الشركة">عن الشركة</a>
                        <ul>
                            <li class="first">
                    ...
                    <li>
                        <a href="<?php echo $siteData->urlBasicLanguage; ?>/events/events-and-exhibitions" title=" المعارض"> المعارض</a>
                        <ul>
                    ...
                    <li class="last">
                        <a href="<?php echo $siteData->urlBasicLanguage; ?>/contact-us" title="الإتصال بنا" >الإتصال بنا</a>
                    </li>
                </ul>
            </div>
        </div>
