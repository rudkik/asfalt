<header class="header-bread-crumbs">
    <div class="container">
        ...
        <div class="box-bread-crumbs">
            ...
            <span>الإتصال بنا</span>
        </div>
    </div>
</header>
<header class="header-contact-list">
    <div class="container">
        <h1 itemprop="name">الإتصال بنا</h1>
        <div class="row">
            <div class="col-md-8">
            ...
            <div class="col-md-4">
                ...
                <div id="respond">
                    <form id="form-send" class="ajax_form" method="post" action="/command/message_add" enctype="multipart/form-data">
                        ...
                        <p>
                            <label accesskey="s" for="title">الموضوع</label><br>
                        ...
                        <div id="otherField">
                            <label> تحميل صورة للرقم التسلسلي</label><br>
                            <label for="file" class="btn btn-block btn-danger btn-lg btn-file"> إختيار</label>
