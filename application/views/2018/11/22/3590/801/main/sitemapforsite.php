        ...
        <div class="text_block">
            ...
            <div class="sitemap">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us" title="O nas">O nas</a>
                        <ul>
                            <li class="first">
                    ...
                    <li>
                        <a href="<?php echo $siteData->urlBasicLanguage; ?>/events/events-and-exhibitions" title="Targi">Targi</a>
                        <ul>
                    ...
                    <li class="last">
                        <a href="<?php echo $siteData->urlBasicLanguage; ?>/contact-us" title="Kontakt" >Kontakt</a>
                    </li>
                </ul>
            </div>
        </div>
