...
<body class="polish" itemscope="itemscope" itemtype="http://schema.org/WebPage">
<!-- !@@&body&@@! -->
<div class="body">
        ...
        <div class="container">
            ...
            <div class="pull-right">
                <div class="box-about">
                    ...
                    <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/news">Nowości</a>
                </div>
                <div class="box-find">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav box-main-menu">
                            ...
                            <li class="one-line"><a href="<?php echo $siteData->urlBasicLanguage; ?>/contact-us">Kontakt</a></li>
...
<footer>
        ...
        <div class="container">
            <div class="row group-menu">
                <div class="col-md-3">
                    <ul class="box-menu">
                        <li>
                            <h3><a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us">O nas</a></h3>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/history">Historia</a>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/events/events-and-exhibitions">Targi</a>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/news">Nowości</a>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/brands">Brands</a>
                        </li>
                        <li>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            <div class="copyright">
                UNI-TECH 2004 - <?php echo date('Y');?> © WSZELKIE PRAWA ZASTRZEŻONE
            </div>
        </div>
    </div>
</footer>
                ...
                <div class="modal-fields">
                    ...
                    <div class="background-body">
                        <div class="row my-menu">
                            ...
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/news">Nowości</a>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/job-positions">Kariera</a>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/contact-us">Kontakt
                            </a>
                        </div>
                    </div>
                </div>
