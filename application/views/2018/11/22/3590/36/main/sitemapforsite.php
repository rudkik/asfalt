        ...
        <div class="text_block">
            ...
            <div class="sitemap">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us" title="About us">About us</a>
                        <ul>
                            <li class="first">
                    ...
                    <li>
                        <a href="<?php echo $siteData->urlBasicLanguage; ?>/events/events-and-exhibitions" title="Exhibitions">Exhibitions</a>
                        <ul>
                    ...
                    <li class="last">
                        <a href="<?php echo $siteData->urlBasicLanguage; ?>/contact-us" title="Contact us" >Contact us</a>
                    </li>
                </ul>
            </div>
        </div>
