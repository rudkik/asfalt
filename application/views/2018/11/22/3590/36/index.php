                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav box-main-menu">
                            ...
                            <li class="one-line"><a href="<?php echo $siteData->urlBasicLanguage; ?>/contact-us">Contact us</a></li>
        ...
        <div class="container">
            <div class="row group-menu">
                <div class="col-md-3">
                    <ul class="box-menu">
                        <li>
                            <h3><a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us">About us</a></h3>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/history">History</a>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/events/events-and-exhibitions">Exhibitions</a>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/news">News</a>
                        </li>
                        ...
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/job-positions">Career</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-9">
                ...
                <div class="modal-fields">
                    ...
                    <div class="background-body">
                        <div class="row my-menu">
                            ...
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/news">News</a>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/job-positions">Career</a>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/contact-us">Contact us
                            </a>
                        </div>
                    </div>
                </div>
