...
<div class="form-group">
    ...
    <select class="form-control select2" name="options[country]" style="width: 100%">
...
<style>
    ...
    .select2-container--default:focus, .select2-selection--single:focus, .select2-container--default:hover, .select2-selection--single:hover {
        border-color: #cd0000;
    }
</style>