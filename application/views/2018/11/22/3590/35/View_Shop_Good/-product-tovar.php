        ...
        <div class="row">
            <div class="col-md-7 box-good-name">
                ...
                <div class="buttons">
                    ...
                    <a href="#" data-toggle="modal" data-target="#show-send" class="btn btn-info btn-flat btn-red">Запросить решение</a>
                </div>
            ...
            <div class="modal-body">
                <div id="respond" style="display: inline-block; width: 100%;">
                    <form id="form-send" class="ajax_form" method="post" action="/command/message_add" enctype="multipart/form-data">
                        <h2 class="text-red">Запросить решение</h2>
                        <?php
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-block btn-danger btn-lg btn-send pull-right" data-dismiss="modal">Закрыть</button>
            </div>
        </div>
    </div>
</div>