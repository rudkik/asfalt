...
<header class="header-article">
    <div class="container">
        ...
        <ul class="box-pagination">
            <?php echo trim($siteData->globalDatas['view::View_Shop_News\-events-archive-show-predydushchaya-statya']); ?>
            <?php echo trim($siteData->globalDatas['view::View_Shop_News\-events-archive-show-sledushchaya-statya']); ?>
        </ul>
    </div>
</header>