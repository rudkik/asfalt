...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/css/style.css?cache=44">
        ...
        <div class="container">
            ...
            <div class="pull-right">
                <div class="box-about">
                    ...
                    <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/news">Новости</a>
                </div>
                <div class="box-find">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav box-main-menu">
                            ...
                            <li class="one-line"><a href="<?php echo $siteData->urlBasicLanguage; ?>/contact-us">Контакты</a></li>
        ...
        <div class="container">
            <div class="row group-menu">
                <div class="col-md-3">
                    <ul class="box-menu">
                        <li>
                            <h3><a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us">О Компании</a></h3>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/history">История компании</a>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/events/events-and-exhibitions">Выставки</a>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/news">Новости</a>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/brands">Бренды</a>
                        </li>
                        <li>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/job-positions">Вакансии</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-9">
                ...
                <div class="modal-fields">
                    ...
                    <div class="background-body">
                        <div class="row my-menu">
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/brands">Бренды</a>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/news">Новости</a>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/about-us/job-positions">Работа в компании</a>
                            <a href="<?php echo $siteData->urlBasicLanguage; ?>/contact-us">Контакты</a>
                        </div>
                    </div>
                </div>
            </div>
...
<a target="_blank" href="https://t.me/uni_tech_group_bot" class="telegram-bot"><img src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/telegram.png"></a>
<?php if(!key_exists('CookieApply', $_COOKIE)){?>
    <div class="cookie-bar">
        <div class="cookie-bar__left">
            Продолжая использовать сайт UNI-TECH GROUP, вы даете согласие на обработку файлов cookie, которые обеспечивают правильную работу сайта. Пожалуйста ознакомьтесь с нашей Политикой Cookies, чтобы узнать почему мы их используем и как вы можете их удалить. Продолжая работу с сайтом, вы соглашаетесь с использованием cookies.
        </div>
        <div class="cookie-bar__right">
            <a class="cookie__cta" href="#" onclick="setCookie('3')">Принять</a>
...
<script>
    $(document).ready(function() {
        ...
        $('#sliders:not([data-sliders="1"])').slick({
            arrows:         true,
            dots:           false,
            infinite:       true,
            slidesToShow:   1,
