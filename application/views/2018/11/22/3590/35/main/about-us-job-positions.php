...
<header class="header-jobs">
    <div class="container">
        <h1 itemprop="headline">Вакансии</h1>
        <div class="line-red"></div>
        <div class="row">
            <div class="col-md-9">
                <ul class="nav nav-tabs">
                    <?php echo trim($siteData->globalDatas['view::View_Shop_News\-about-us-job-positions-vakansii-zagolovki']); ?>
                </ul>
                <div class="tab-content">
                    <?php echo trim($siteData->globalDatas['view::View_Shop_News\-about-us-job-positions-vakansii']); ?>
                </div>
            </div>
            <div class="col-md-3">
                <div id="respond">
                    <form id="form-send" class="ajax_form" method="post" action="/command/message_add" enctype="multipart/form-data">
                        <?php
                        $view = View::factory('2018/11/22/3590/35/country');
                        $view->siteData = $siteData;
                        echo Helpers_View::viewToStr($view);
                        ?>
                        <p>
                            <label for="name">Имя <span color="red">*</span></label><br>
                        ...
                        <p>
                            <label for="phone">Телефон<span color="red">*</span></label><br>
                        ...
                        <div id="otherField">
                            <label>Файл:</label><br>
                            <label for="file" class="btn btn-block btn-danger btn-lg btn-file">Выбрать</label>
                        ...
                        <p>
                            <label for="text">Сообщение<font color="red">*</font></label><br>
                        ...
                        <div class="form-group box-captcha">
                            ...
                            <div id="reload-captcha" class="btn btn-block btn-danger btn-lg btn-send"><i class="glyphicon glyphicon-refresh"></i> Обновить</div>
                            <script src="<?php echo $siteData->urlBasic; ?>/css/_component/captcha/captcha.js"></script>
                        </div>
                        <div class="form-group">
                            <label id="label-captcha" for="image_captcha" class="control-label">Пожалуйста, введите указанный на изображении код:</label>
                        ...
                        <button id="button-send" class="btn btn-block btn-danger btn-lg btn-send" type="button">Отправить</button>
                    </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-block btn-danger btn-send pull-right" data-dismiss="modal">Закрыть</button>
            </div>
        </div>
    </div>
</div>