<div class="col-md-4 goods">
    <div class="block-goods">
        <a href="<?php echo $siteData->urlBasicLanguage; ?>/sector-goods?id=<?php echo $data->values['id']; ?>&sector=<?php echo $data->values['shop_id']; ?>">
        ...
        <div class="goods-info">
            <h3>
                <a href="<?php echo $siteData->urlBasicLanguage; ?>/sector-goods?id=<?php echo $data->values['id']; ?>&sector=<?php echo $data->values['shop_id']; ?>"><?php echo $data->values['name']; ?></a>
            </h3>
        </div>
    </div>
</div>