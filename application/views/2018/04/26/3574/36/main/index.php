    ...
    <div class="col-md-12">
        <div class="box-menu">
            ...
            <div class="menus">
                ...
                <div class="menu">
                    <a href="<?php echo $siteData->urlBasicLanguage;?>/articles">Статьи</a>
                </div>
                <div class="menu">
        ...
        <div class="box-body">
            <?php echo trim($siteData->globalDatas['view::View_Shop_Gallerys\-slaider-na-glavnoi']); ?>
            <div class="list-directions" style="padding-top: 45px;">
                <?php echo trim($siteData->globalDatas['view::View_Shops\sectors-acticles-napravleniya']); ?>
            </div>
			<?php echo trim($siteData->globalDatas['view::View_Shop_News\-statya-na-glavnoi']); ?>
        </div>
    </div>
</header>