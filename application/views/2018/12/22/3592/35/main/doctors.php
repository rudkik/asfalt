<header class="header-bread-crumbs">
    <div class="container">
        ...
        <ul itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement" data-qaid="breadcrumbs" class="bread-crumbs">
            ...
            <li>
                <span typeof="v:Breadcrumb">Специалисты</span>
            </li>
        </ul>
    </div>
</header>
<header class="header-body box-bg-dom">
    <div class="container">
        ...
        <div class="col-sm-9">
            <h1 itemprop="headline">Специалисты</h1>
            ...
            <div class="box-doctors">
                <?php echo trim($siteData->globalDatas['view::View_Shop_News\-doctors-spetcialisty']); ?>
            </div>
        </div>
    </div>
</header>
