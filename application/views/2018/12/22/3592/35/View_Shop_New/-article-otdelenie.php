...
<header class="header-bread-crumbs">
    <div class="container">
        ...
        <ul itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement" data-qaid="breadcrumbs" class="bread-crumbs">
            ...
            <li>
                <span typeof="v:Breadcrumb"><a rel="v:url" property="v:title" <a href="<?php echo $siteData->urlBasicLanguage; ?>/articles">Статьи</a></span> /
            </li>
            <li>
    ...
    <div class="container">
        <div class="col-sm-3">
            <div class="row">
                <div class="box-menu">
                    <ul>
                        <?php echo trim($siteData->globalDatas['view::View_Shop_News\-articles-rubrikatciya']); ?>
                    </ul>
                </div>
            </div>
        </div>
