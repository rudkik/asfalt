...
<body <?php if (!empty($font)){echo 'class="font-'.$font.' impaired"';} ?> itemscope="itemscope" itemtype="http://schema.org/WebPage"><!-- !@@&body&@@! --><div class="body">
    <header class="header-top">
        <div class="container box-main-top <?php if (!empty($font)){echo 'font';} ?>">
            <a href="<?php echo $siteData->urlBasicLanguage.$siteData->url.URL::query(array('font' => 'huge'));?>" class="vision"><span class="glyphicon glyphicon-eye-close"></span> Арнайы нұсқа</a>
            ...
            <div class="pull-right">
                ...
                <a href="<?php echo $siteData->urlBasic. $siteData->url . $siteData->urlSEO . URL::query($arr, FALSE);?>" class="blog-main" style="font-weight: 700;">Русский</a>
            ...
            <div class="box-right">
                <div class="row" itemscope itemtype="http://schema.org/LocalBusiness">
                    ...
                    <div class="col-sm-4 clock">
                        ...
                        <div class="media-body">
                            <div class="box-text">
                                <div class="title">Жұмыс уақыты</div>
                    ...
                    <div class="col-sm-4 phone">
                        ...
                        <div class="media-body">
                            <div class="box-text">
                                <div class="title">Байланыс телефондары</div>
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    <li <?php if ($siteData->url == '/about'){echo 'class="active"';}?>>
                                        <a class="nav-link" href="<?php echo $siteData->urlBasicLanguage;?>/about">Орталық туралы</a>
                                    </li>
                                    <li <?php if (($siteData->url == '/departments') || ($siteData->url == '/department')){echo 'class="active"';}?>>
                                        <a class="nav-link" href="<?php echo $siteData->urlBasicLanguage;?>/departments">Бөлімдер</a>
                                    </li>
                                    <li <?php if (($siteData->url == '/doctors') || ($siteData->url == '/doctor')){echo 'class="active"';}?>>
                                        <a class="nav-link" href="<?php echo $siteData->urlBasicLanguage;?>/doctors">Мамандар</a>
                                    </li>
                                    <li <?php if ($siteData->url == '/fo-patients'){echo 'class="active"';}?>>
                                        <a class="nav-link" href="<?php echo $siteData->urlBasicLanguage;?>/fo-patients">Пациенттерге арналған</a>
                                    </li>
                                    <li <?php if ($siteData->url == '/documents'){echo 'class="active"';}?>>
                                        <a class="nav-link" href="<?php echo $siteData->urlBasicLanguage;?>/documents">Құжаттар</a>
                                    </li>
                                    <li <?php if ($siteData->url == '/contacts'){echo 'class="active"';}?>>
                                        <a class="nav-link" href="<?php echo $siteData->urlBasicLanguage;?>/contacts">Байланыс ақпараттары</a>
                                    </li>
                                </ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title">Қабылдауға жазылу</h2>
