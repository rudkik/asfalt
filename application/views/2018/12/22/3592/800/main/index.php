...
<header class="header-comments">
    <div class="container">
        <h2>Тұтынушыларымыздың пікірлері</h2>
        <img class="img-line" src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/line.png">
...
<header class="header-sales box-sales">
    <div class="container">
        <h2>Акциялар мен жеңілдіктер</h2>
        <img class="img-line" src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/line.png">
...
<header class="header-benefit">
    <div class="container">
        <h2>Пайдалы ақпарат</h2>
        <img class="img-line" src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/line.png">

        <div class="text-center">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#panel1">Мақалалар</a></li>
                <li><a data-toggle="tab" href="#panel2">Ұсыныстар</a></li>
            </ul>
        </div>
