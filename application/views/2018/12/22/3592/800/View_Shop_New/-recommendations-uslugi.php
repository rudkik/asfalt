<div class="col-md-6">
    <div class="article">
        ...
        <div class="box-text">
            <p class="title"><a href="<?php echo $siteData->urlBasicLanguage; ?>/recommendations<?php echo $data->values['name_url']; ?>"><?php echo $data->values['name']; ?></a></p>
            <p class="info"><?php echo Arr::path($data->values['options'], 'info', ''); ?></p>
            <a class="next" href="<?php echo $siteData->urlBasicLanguage; ?>/recommendations<?php echo $data->values['name_url']; ?>">Подробнее &gt;</a>
        </div>
    </div>
</div>