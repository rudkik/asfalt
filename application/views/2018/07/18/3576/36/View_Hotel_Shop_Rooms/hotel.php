...
?>
<div class="col-sm-12"><h4>Ground Floor</h4></div>
<div class="col-sm-6">
    <div class="box-room">
        <div class="room no-active">
            <p class="number">Café/Shop</p>
        </div>
    </div>
    <?php
...
<div class="col-sm-6">
    <div class="box-room">
        <div class="room no-active">
            <p class="number">Café/Reception</p>
        </div>
    </div>
    <div class="box-room">
        <div class="room no-active">
            <p class="number">Staff Only</p>
        </div>
    </div>
    <?php
...
<div class="col-sm-12"><h4>First Floor</h4></div>
<div class="col-sm-6">
    <div class="box-room">
        <div class="room no-active">
            <p class="number">Billiard</p>
        </div>
    </div>
    <?php
