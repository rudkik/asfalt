<div class="item">
    <div class="slider" style="background: url('<?php echo Helpers_Image::getPhotoPath($data->values['image_path'], 1920, 800); ?>') no-repeat scroll center bottom transparent;">
        <a class="title-company" href="<?php echo $siteData->urlBasicLanguage;?>" ><span>Kara Dala Resort</span><!--<img src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/logo-t.png"> --></a>
        ...
        <?php }elseif (($siteData->url == '/') || ($siteData->url == '')){ ?>
            <h1>Chundzha Hot Springs in Kazakhstan</h1>
