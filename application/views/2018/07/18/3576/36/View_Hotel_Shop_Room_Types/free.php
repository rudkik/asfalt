...
<div id="<?php echo $panelID; ?>" class="row" data-block="box-rooms">
    <div class="col-sm-12">
        <?php if (FALSE && (Arr::path($additionDatas, 'is_min_amount', '') === TRUE)){ ?>
            <h3 class="text-left">Option 1 “Budget”</h3>
        <?php }elseif (FALSE && (Arr::path($additionDatas, 'is_min_room', '') === TRUE)){ ?>
            <h3 class="text-left">Option 2 “Alternative”</h3>
        <?php } ?>
        <form action="<?php echo $siteData->urlBasic;?>/hotel/room/add_bill_room_type?data_language_id=<?php echo $siteData->dataLanguageID; ?>" method="get" style="margin: 30px 0px 40px;">
            <div class="box">
            ...
            <div class="row box-button-rooms">
                <div class="col-sm-6 text-left">
                    <button class="btn btn-flat btn-blue" data-action="edit-room-type" type="button" onclick="editTable<?php echo $rand; ?>()">Change Booking</button>
                    <button style="display: none" class="btn btn-flat btn-blue" data-action="add-room-type" type="button" onclick="addTr<?php echo $rand; ?>('#from-<?php echo $panelID; ?>', '#to-<?php echo $panelID; ?>')">Add a Room</button>
                </div>
