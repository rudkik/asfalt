    ...
    <header class="header-reserve">
        <div class="container">
            ...
            <div class="row box-pays">
                <div class="col-sm-4">
                    ...
                    <div class="btn-pay">
                        <form action="<?php echo $siteData->urlBasicLanguage;?>/bill/pay/online" method="get">
                            ...
                            <button type="submit" class="btn btn-flat btn-blue-un" style="margin-top: 7px;" type="submit">Next</button>
                        </form>
                    </div>
                </div>
                <!--
                <div class="col-sm-4">
                    <h3>Through Halyk Bank Branch </h3>
                ...
                <div class="col-sm-4">
                    <h3>Through any Bank of Kazakhstan</h3>
