<div class="box-room">
    <div class="room standard<?php if($data->additionDatas['is_free'] != 1){echo ' busy';} ?>">
        ...
        <div class="price"><?php echo Func::getPriceStr($siteData->currency, $data->values['price']); ?></div>
        <img class="pull-right" src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/room/<?php echo $data->values['human']; ?>.png">
