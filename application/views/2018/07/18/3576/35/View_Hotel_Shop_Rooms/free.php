...
<div class="row">
    <div class="col-sm-12" id="<?php echo $panelID; ?>">
        <h3 class="text-left">Номера <span style="color: rgb(0, 51, 142);"><?php echo Helpers_DateTime::getDateFormatRus($additionDatas['date_from']) .' - '. Helpers_DateTime::getDateFormatRus($additionDatas['date_to']); ?></span></h3>
        <form action="<?php echo $siteData->urlBasicLanguage;?>/hotel/room/add_bill_room" method="get" style="margin: 30px 0px 40px;">
            <div class="box">
            ...
            <div class="row box-button-rooms">
                <div class="col-sm-6 text-left">
                    <button class="btn btn-flat btn-blue" data-action="edit-room" type="button" onclick="editTable<?php echo $rand; ?>()">Изменить вариант</button>
                    <button style="display: none" class="btn btn-flat btn-blue" data-action="add-room" type="button" onclick="addTr<?php echo $rand; ?>('#from-<?php echo $panelID; ?>', '#to-<?php echo $panelID; ?>')">Добавить номер</button>
                </div>
