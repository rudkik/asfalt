...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/css/style.css?cache=4">
...
<body itemscope="itemscope" itemtype="http://schema.org/WebPage"><!-- !@@&body&@@! --><header class="header-menu" style="z-index: 1000">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li>
                                    <a class="nav-link<?php if($siteData->url == '/reserv/check'){echo ' active';} ?>" href="<?php echo $siteData->urlBasicLanguage;?>/reserv/check">Проверить бронь</a>
                                </li>
                                <li>
                                    <a class="nav-link<?php if($siteData->url == '/about'){echo ' active';} ?>" href="<?php echo $siteData->urlBasicLanguage;?>/about">О Нас</a>
                                </li>
                                <li>
                                    <a class="nav-link<?php if($siteData->url == '/water'){echo ' active';} ?>" href="<?php echo $siteData->urlBasicLanguage;?>/water">Вода и Бассейны</a>
                                </li>
                                <li>
                                    <a class="nav-link<?php if($siteData->url == '/habitation'){echo ' active';} ?>" href="<?php echo $siteData->urlBasicLanguage;?>/habitation">Проживание</a>
                                </li>
                                <li>
                                    <a class="nav-link<?php if($siteData->url == '/kitchen'){echo ' active';} ?>" href="<?php echo $siteData->urlBasicLanguage;?>/kitchen">Кухня</a>
                                </li>
                                <li>
                                    <a class="nav-link<?php if($siteData->url == '/faq'){echo ' active';} ?>" href="<?php echo $siteData->urlBasicLanguage;?>/faq">Вопросы</a>
                                <li>
                                <li>
                                    <a class="nav-link<?php if($siteData->url == '/scheme'){echo ' active';} ?>" href="<?php echo $siteData->urlBasicLanguage;?>/scheme">Карта </a>
                                <li>
                                <li>
                                    <a class="nav-link<?php if($siteData->url == '/contacts'){echo ' active';} ?>" href="<?php echo $siteData->urlBasicLanguage;?>/contacts">Контакты</a>
                                </li>
                            </ul>
                        </div>
                    </div>
