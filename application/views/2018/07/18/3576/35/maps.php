<header class="header-map-img">
    <div class="container">
        <h2>Выбор номера на интерактивной карте Кара Далы</h2>
        <img src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/line.png">
        <img id="map-zone" class="img-responsive img-map" src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/map.png">
    </div>
</header>
...
<div id="reserv-hotel" class="modal fade modal-reserve" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-full">
        ...
        <div class="modal-content">
            <form data-get-url="<?php echo $siteData->urlBasicLanguage;?>/rooms/hotel"  enctype="multipart/form-data" action="<?php echo $siteData->urlBasic;?>/free/rooms" method="get">
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="submit" class="btn btn-blue">Забронировать</button>
                        </div>
                    </div>
                </div>
            </form>
...
<script>
    ...
    jQuery( document ).ready(function( $ ) {
        ...
        $("#map-zone").tooltip({
            trigger: 'manual',
            title: 'Кликнув на это здание Вы сможете сделать заказ'
        }).click(function(e) {
