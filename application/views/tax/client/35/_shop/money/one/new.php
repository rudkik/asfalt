...
<div id="money<?php echo $key; ?>-new-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="form-group row">
                        <label for="money<?php echo $key; ?>-new-shop_contractor_id" class="col-3 col-form-label">Контрагент</label>
                        <div class="col-9">
                            <div class="form-group margin-0">
                                <div class="input-group">
                                    <select name="shop_contractor_id" id="money<?php echo $key; ?>-new-shop_contractor_id" class="form-control ks-select" data-parent="#money<?php echo $key; ?>-new-record" data-parent="#money<?php echo $key; ?>-new-record" style="width: 100%">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-primary" type="button" data-select="#money<?php echo $key; ?>-new-shop_contractor_id" data-action="add-new-panel">Добавить</button>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    $view->data = $data;
                    $view->panelID = 'money'.$key.'-new-contractor';
                    $view->selectID = 'money'.$key.'-new-shop_contractor_id';
                    echo Helpers_View::viewToStr($view);
                    ?>
                    <div class="form-group row">
                        <label for="money<?php echo $key; ?>-new-shop_contract_id" class="col-3 col-form-label">Договор</label>
                        <div class="col-9">
                            <div class="form-group margin-0">
                                <div class="input-group">
                                    <select name="shop_contract_id" id="money<?php echo $key; ?>-new-shop_contract_id" class="form-control ks-select" data-parent="#money<?php echo $key; ?>-new-record" style="width: 100%">
                                        <option value="0" data-id="0">Без договора</option>
                                        <option value="-1" data-id="-1">Новый договор</option>
                                    </select>
                                    <span class="input-group-btn">
                                        <button class="btn btn-primary" type="button" data-select="#money<?php echo $key; ?>-new-shop_contract_id" data-action="add-new-panel">Добавить</button>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    $view->siteData = $siteData;
                    $view->data = $data;
                    $view->panelID = 'money'.$key.'-new-contract';
                    $view->selectID = 'money'.$key.'-new-shop_contract_id';
                    echo Helpers_View::viewToStr($view);
                    ?>
                    <div class="form-group row">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#money<?php echo $key; ?>-new-record input[type="datetime"]').datetimepicker({
                dayOfWeekStart : 1,
                lang:'ru',
                format:	'd.m.Y',
                timepicker:false,
            ...
            $('#money<?php echo $key; ?>-new-record form').on('submit', function(e){
                e.preventDefault();
                var $that = $(this),
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (!obj.error) {
                            $('#money<?php echo $key; ?>-new-record').modal('hide');
            ...
            $('#money<?php echo $key; ?>-new-record form select[name="shop_contractor_id"]').change(function () {
                var id = $(this).val();
                ...
                if (id > 0) {
                    jQuery.ajax({
                        ...
                        type: "POST",
                        success: function (data) {
                            var tmp = $('#money<?php echo $key; ?>-new-record form select[name="shop_contract_id"]');
                            var s = tmp.val();
                ...
                if(id < 0){
                    var tmp = $('#money<?php echo $key; ?>-new-contractor');
            ...
            $('#money<?php echo $key; ?>-new-record form select[name="shop_contract_id"]').change(function () {
                var id = $(this).val();

                if(id < 0){
                    var tmp = $('#money<?php echo $key; ?>-new-contract');
                    tmp.css('display', 'block');
