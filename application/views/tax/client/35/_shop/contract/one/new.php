<div id="contract-new-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="form-group row">
                        <label for="name" class="col-3 col-form-label">Номер</label>
                        <div class="col-9">
                            <div class="form-group margin-0">
                                <input name="number" data-validation="length" data-validation-length="max50" maxlength="50" class="form-control" placeholder="Номер" id="number" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="form-group margin-0">
                                <select name="shop_contractor_id" id="sshop_contractor_id" class="form-control ks-select" data-parent="#contract-new-record" style="width: 100%">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="form-group margin-0">
                                <input name="view" data-validation="length" data-validation-length="max250" maxlength="250" class="form-control valid" placeholder="на оказание услуг" id="view" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#contract-new-record input[type="datetime"]').datetimepicker({
                dayOfWeekStart : 1,
                lang:'ru',
                format:	'd.m.Y',
                timepicker:false,
            ...
            $('#contract-new-record form').on('submit', function(e){
                e.preventDefault();
                var $that = $(this),
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (!obj.error) {
                            $('#contract-new-record').modal('hide');
                            $('#contract-data-table').bootstrapTable('insertRow', {
                                index: 0,
                                row: obj.values
                            });
