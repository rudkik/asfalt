<div id="product-edit-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Редактирование товар/услугу</h5>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-form-label" style="text-align: left;">
                                ...
                                <label class="ks-checkbox-slider ks-on-off ks-primary">
                                    <input name="is_service" type="checkbox" value="1" <?php if($data->values['is_service'] == 1) {echo 'checked';}?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="form-group margin-0">
                                    <input class="form-control money-format" placeholder="Цена" name="price" type="text" value="<?php echo Func::getNumberStr($data->values['price'], FALSE);?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="form-group margin-0">
                                    <input class="form-control units typeahead" placeholder="Единица измерения" name="unit_name" type="text" value="<?php echo htmlspecialchars(Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS.'.unit_id.name', $data->values['unit_name']), ENT_QUOTES);?>">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#product-edit-record form').on('submit', function(e){
                e.preventDefault();
                var $that = $(this),
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (!obj.error) {
                            $('#product-edit-record').modal('hide');
                            $('#product-data-table').bootstrapTable('updateByUniqueId', {
                                id: obj.values.id,
                                row: obj.values
                            });
