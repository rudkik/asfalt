<div id="bank-account-edit-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Редактирование банковского счета</h5>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-form-label" style="text-align: left;">
                                ...
                                <label class="ks-checkbox-slider ks-on-off ks-primary" style="margin-top: 10px;">
                                    <input name="is_public" type="checkbox" value="1" <?php if($data->values['is_public'] == 1) {echo 'checked';}?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="form-group margin-0">
                                    <select name="bank_id" id="bank-account-edit-bank_id" class="form-control ks-select" data-parent="#bank-account-edit-record" style="width: 100%">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#bank-account-edit-record form').on('submit', function(e){
                e.preventDefault();
                var $that = $(this),
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (!obj.error) {
                            $('#bank-account-edit-record').modal('hide');
                            $('#bank-account-data-table').bootstrapTable('updateByUniqueId', {
                                id: obj.values.id,
                                row: obj.values
                            });
