<div id="worker-wage-month-new-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Добавление зарплат</h5>
                            ...
                            <div class="row">
                                <div class="col-5">
                                    <div class="form-group margin-0">
                                        ...
                                        <select name="month" id="worker-wage-month-new-month" class="form-control ks-select" data-parent="#worker-wage-month-new-record" style="width: 100%">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#worker-wage-month-new-record form').on('submit', function(e){
                e.preventDefault();
                var $that = $(this),
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (!obj.error) {
                            $('#worker-wage-month-new-record').modal('hide');
                            $('#worker-wage-month-data-table').bootstrapTable('insertRow', {
                                index: 0,
                                row: obj.values
                            });
