...
<div id="bill-edit-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="form-group margin-0">
                                    <select name="shop_contractor_id" id="shop_contractor_id" class="form-control ks-select" data-parent="#bill-edit-record" style="width: 100%" <?php if ($isRead){ echo 'disabled';} ?>>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#bill-edit-record input[type="datetime"]').datetimepicker({
                dayOfWeekStart : 1,
                lang:'ru',
                format:	'd.m.Y',
                timepicker:false,
