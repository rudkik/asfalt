...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <input name="shop_operation[email]" type="email" class="form-control" placeholder="E-mail" value="<?php echo htmlspecialchars(Arr::path($data->values['options'], 'shop_operation.email', ''), ENT_QUOTES);?>" required>
    </div>
    <div class="col-md-3 record-title">
        <label>
            Пароль
    ...
    <div class="col-md-3">
        <input name="shop_operation[password]" type="password" class="form-control" placeholder="Пароль">
    </div>
</div>
<div class="row">
    <div hidden>
