...
<div class="row record-input record-list">
    ...
    <div class="col-md-3">
        <div class="input-group">
            <input name="norm_waste" type="text" class="form-control" placeholder="Норма естественного убыли" required value="<?php echo htmlspecialchars(Arr::path($data->values, 'norm_waste', ''), ENT_QUOTES);?>">
