        ...
        <?php }else{?>
            <ul class="list-inline tr-button <?php if ($data->values['is_delete'] == 1) { echo ' un-'; } ?>delete">
                ...
                <?php if($siteData->operation->getIsAdmin()){ ?>
                    <li><a data-action="set-special" data-id="<?php echo $data->id; ?>" data-special="<?php echo Model_Magazine_Shop_Realization::SPECIAL_TYPE_BASIC;?>" href="<?php echo Func::getFullURL($siteData, '/shoprealization/edit_type', array('id' => 'id'), array('is_special' => Model_Magazine_Shop_Realization::SPECIAL_TYPE_BASIC), $data->values); ?>" class="link-red"><i class="fa fa-edit margin-r-5"></i> Перенести в реализацию</a></li>
                <?php }?>
            </ul>
        <?php }?>
    </td>
