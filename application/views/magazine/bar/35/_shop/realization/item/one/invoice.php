<tr <?php if($siteData->url == '/bar/shopinvoice/edit' && $data->values['quantity'] != $data->values['esf_receive_quantity']){ ?> class="b-red"<?php }?>>
    ...
    <td class="text-right"><?php echo Func::getNumberStr($data->values['esf_receive_quantity'], TRUE, 3, FALSE); ?></td>
