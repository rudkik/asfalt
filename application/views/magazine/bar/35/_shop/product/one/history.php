<tr>
    ...
    <td>
        ...
        switch ($data->additionDatas['type']){
            case 'receive':
                echo '<a target="_black"  href="/bar/shopreceive/edit?id='.$data->values['shop_receive_id'].'">Приход</a>';
                break;
            case 'realization':
                ...
                echo '<a target="_black"  href="/bar/shoprealization/edit?id='.$data->values['shop_realization_id'].'">'.$s.'</a>';
                break;
            case 'move':
                echo '<a target="_black" href="/bar/shopmove/edit?id='.$data->values['shop_move_id'].'&shop_branch_id='.$data->values['shop_id'].'">Перемещение</a>';
                break;
            case 'realization_return':
                echo '<a target="_black" href="/accounting/shoprealizationreturn/edit?id='.$data->values['shop_realization_return_id'].'">Возврат реализации</a>';
                break;
        }
        ?>
    </td>
