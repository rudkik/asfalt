    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select data-type="select2" id="input-rubric" name="shop_product_rubric_id" class="form-control select2" style="width: 100%;">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_supplier_id">Остатки у поставщика</label>
                        <select data-type="select2" id="shop_supplier_id" name="shop_supplier_id" class="form-control select2" style="width: 100%;">
                            ...
                            <option value="-1" data-id="-1" <?php if($tmp === NULL){echo 'selected';} ?>>Выберите поставщика</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
