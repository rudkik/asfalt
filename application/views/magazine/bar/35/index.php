                                ...
                                <ul class="dropdown-menu" style="top: 82px;">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-right">
                                            <a href="<?php echo $siteData->urlBasic; ?>/bar/shopuser/unlogin" class="btn btn-default btn-flat">Выход</a>
                                        </div>
                                    </li>
                                </ul>
                            <?php } ?>
...
<script src="<?php echo $siteData->urlBasic; ?>/css/magazine/js/main.js?cache=8"></script>
</body>
</html>
