...
<head>
    ...
    <title>Кабинет</title>
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scasocialle=no" name="viewport">
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="<?php echo $siteData->urlBasic; ?>/social/shopuser/login" method="post">
