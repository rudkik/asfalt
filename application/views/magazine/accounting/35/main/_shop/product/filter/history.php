            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input id="created_at_from_equally" class="form-control" name="created_at_from_equally" value="<?php echo Helpers_DateTime::getDateTimeFormatRus(Request_RequestParams::getParamDateTime('created_at_from_equally'));?>" type="datetime" date-type="date">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="created_at_to_day">Период до</label>
                        <input id="created_at_to_day" class="form-control" name="created_at_to_day" value="<?php echo Helpers_DateTime::getDateTimeFormatRus(Request_RequestParams::getParamDateTime('created_at_to_day'));?>" type="datetime" date-type="date">
                    </div>
                </div>
                <div class="col-md-1">
                    <div hidden>
