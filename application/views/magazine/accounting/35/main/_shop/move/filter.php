            ...
            <div class="row">
                <div class="col-xs-3">
                    <div class="form-group">
                        <label for="shop_supplier_id">Куда</label>
                        <select data-type="select2" id="branch_move_id" name="branch_move_id" class="form-control select2" style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('branch_move_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL){echo 'selected';} ?>>Выберите</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
