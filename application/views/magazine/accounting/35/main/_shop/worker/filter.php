			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
                        ...
                        <input id="name" class="form-control" name="name" placeholder="ФИО" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
					</div>
				</div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_branch_id">Филиал</label>
                        <select data-type="select2" id="shop_branch_id" name="shop_branch_id_" class="form-control select2" style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_branch_id_'); ?>
