        ...
        <div class="tab-content">
            ...
            <div class="nav-tabs-custom" style="margin-bottom: 0px;">
                <ul id="tab-status" class="nav nav-tabs pull-right ui-sortable-handle">
                    ...
                    <li class="<?php if(($siteData->url == '/'.$siteData->actionURLName.'/shopinvoice/days')){echo 'active';}?>"><a href="<?php echo Func::getFullURL($siteData, '/shopinvoice/days', array(), array());?>"  data-id="is_public_ignore">Pаспределенные по дням</a></li>
            ...
            <div class="body-table">
                <div class="box-body table-responsive" style="padding-top: 0px;">
                    <?php echo trim($data['view::_shop/invoice/list/days']); ?>
                </div>
            </div>
        </div>
	</div>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo Func::getFullURL($siteData, '/shopinvoice/new'); ?>" method="get" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <input id="esf_type_id" name="esf_type_id" value="" style="display: none">
