            ...
            <div class="row">
                <div class="col-xs-2">
                    <div class="form-group">
                        ...
                        <input id="date_from" class="form-control" name="date_from" type="datetime" date-type="date" value="<?php echo Helpers_DateTime::getDateTimeFormatRus(Request_RequestParams::getParamDate('date_from')); ?>">
                    </div>
                </div>
                <div class="col-xs-2">
                    <div class="form-group">
