            ...
            <div class="row">
                <div class="col-xs-3">
                    <div class="form-group">
                        <label for="shop_write_off_type_id">Виды списания</label>
                        <select data-type="select2" id="shop_write_off_type_id" name="shop_write_off_type_id" class="form-control select2" style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_write_off_type_id'); ?>
                            ...
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/write-off/type/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
