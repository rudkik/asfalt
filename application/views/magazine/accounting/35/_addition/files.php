...
<div class="row box-images" id="sort-images<?php echo $postfix; ?>" data-id="<?php echo count(Arr::path($data->values, 'files', array())) + 1; ?>" column="<?php echo $columnSize; ?>" style="display: grid;">
            ...
            <div class="box box-image box-danger">
                ...
                <div class="box-body no-padding">
                    <ul class="users-list clearfix">
                        <li name="image-file">
                            <?php if((intval(Arr::path($file, 'w', '0')) > 0) && (Arr::path($file, 'h', '0') * 1 > 0)){ ?>
                            <div class="img-size">
