...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/magazine/css/style.css">
...
<div class="wrapper">
    <div class="content-wrapper" style="margin-left: 0px;">
        <header class="main-header" style="position: relative;">
            <a href="<?php echo $siteData->urlBasic; ?>/bar" class="logo">
                <?php if($siteData->shopID > 0){ ?>
                                ...
                                <ul class="dropdown-menu" style="top: 82px;">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-right">
                                            <a href="<?php echo $siteData->urlBasic; ?>/accounting/shopuser/unlogin" class="btn btn-default btn-flat">Выход</a>
                                        </div>
                                    </li>
                                </ul>
                            <?php } ?>
...
<script src="<?php echo $siteData->urlBasic; ?>/css/magazine/js/main.js?cache=6"></script>
</body>
</html>
