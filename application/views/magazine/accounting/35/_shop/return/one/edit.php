<div class="inline-block">
    <h3 class="pull-left">Возврат продуктов поставщику <small style="margin-right: 10px;">редактирование</small></h3>
    <button type="button" class="btn bg-orange btn-flat pull-right" onclick="submitReturn('shopreturn');">Сохранить</button>
    <a href="<?php echo Func::getFullURL($siteData, '/shopreport/return_one', array(), array('shop_return_id' => $data->id)); ?>" class="btn bg-info btn-flat pull-right" style="margin-right: 10px">Сохранить в Excel</a>
</div>
        ...
        <div class="col-xs-3 box-filter-right">
            ...
            <div class="form-group" style="margin-top: 10px">
                ...
                <div class="input-group">
                    <input data-is-unique="true" data-action="find-barcode" data-url="/accounting/shopproduct/find_barcode" name="barcode" type="tel" class="form-control" placeholder="Штрих-код">
