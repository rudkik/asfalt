...
<div class="inline-block">
    ...
    <button type="button" class="btn bg-orange btn-flat pull-right margin-l-10" onclick="submitReceive('shopreturn');">Сохранить</button>
...
<form id="shopreturn" action="<?php echo Func::getFullURL($siteData, '/shopreturn/save_esf'); ?>" method="post" style="padding-right: 5px;">
    <div class="row">
        <div class="col-md-2">
    ...
    <div class="row">
        ...
        ?>
        <div class="col-xs-<?php if($esf->getProducts()->isEmpty()){echo 12;}else{echo 8;} ?> box-body-goods">
            <table class="table-input table table-hover table-db table-tr-line" data-action="table-select">
                ...
                <tbody id="products">
                <?php echo $siteData->globalDatas['view::_shop/return/item/list/esf'];?>
                <?php
                $esf = new Helpers_ESF_Unload_Invoice();
                $arr = json_decode($data->values['esf'], TRUE);
                if(is_array($arr)) {
        ...
        <?php if($esf->getProducts()->isNotProcessed()){ ?>
...
<div id="dialog-load-esf" class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo Func::getFullURL($siteData, '/shopreturn/load_esf'); ?>" method="post" enctype="multipart/form-data">
