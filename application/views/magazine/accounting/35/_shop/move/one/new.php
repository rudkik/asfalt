    ...
    <div class="row">
        <div class="col-xs-3 box-filter-right">
            ...
            <div class="form-group" style="margin-top: 10px">
                ...
                <input data-is-unique="true" data-action="find-barcode" data-url="/accounting/shopproduction/find_barcode" name="barcode" type="tel" class="form-control" placeholder="Штрих-код">
            </div>
