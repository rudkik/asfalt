...
<table class="table-input table table-hover table-db table-tr-line" data-action="table-select" style="position: inherit;">
    ...
    <?php
    $i = 0;
    foreach ($data['view::_shop/realization/return/item/one/index']->childs as $value) {
        $i++;
...
<div id="new-product" data-index="0">
    ...
    <tr data-barcode="#barcode#" data-action="tr">
        ...
        <td>
            <span data-id="shop_product_name">Продукт</span><br>
            <input data-id="shop_product_id" name="shop_realization_return_items[_#index#][shop_production_id]" value="0" hidden>
            <span class="link-red">Остаток:</span> <label data-id="stock" class="link-red"></label>
        </td>
        <td class="text-center">
            <div class="box-quantity">
                <input data-round="1" data-keywords="virtual" data-id="quantity" data-keywords="virtual" data-action="tr-multiply" data-total="#total" data-parent-count="3" name="shop_realization_return_items[_#index#][quantity]" type="tel" class="form-control text-center" placeholder="Кол-во" required value="1">
            </div>
            <div class="box-price">
                <label data-id="price" data-action="tr-multiply" class="text-right"></label>
            </div>
        </td>
