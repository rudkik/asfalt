...
<div class="inline-block">
    <h3 class="pull-left">Возврат реализации <small style="margin-right: 10px;"><?php if(!$isShow){ ?>редактирование<?php }else{?>просмотр<?php }?></small></h3>
    ...
    <div class="row">
        <div class="col-xs-3 box-filter-right">
            ...
            <div class="form-group" style="margin-top: 10px">
                ...
                <input data-is-unique="true" data-keywords="virtual" data-action="find-barcode" data-url="/accounting/shopproduction/find_barcode" type="tel" class="form-control" placeholder="Штрих-код" <?php if($isShow){ ?>readonly<?php }?>>
            </div>
            <?php if(!$isShow){ ?>
            <div class="keyboard">
