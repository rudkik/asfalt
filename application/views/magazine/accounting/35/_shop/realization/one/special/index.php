    ...
    <td>
        <?php if($data->values['is_fiscal_check'] < 1){ ?>
            <ul class="list-inline tr-button <?php if ($data->values['is_delete'] == 1) { echo ' un-'; } ?>delete">
                ...
                <?php }?>
                <li><a data-acton="fiscal-print" data-acton="fiscal-print" href="<?php echo Func::getFullURL($siteData, '/shoprealization/print', array('id' => 'id'), array('token_not' => true), $data->values); ?>" class="link-blue text-sm"><i class="fa fa-reply margin-r-5"></i> Печать чека</a></li>
