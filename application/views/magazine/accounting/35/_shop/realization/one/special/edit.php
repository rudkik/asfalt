    ...
    <div class="row">
        <div class="col-xs-3 box-filter-right b-green">
            ...
            <div class="form-group" style="margin-top: 10px">
                ...
                <input data-is-unique="true" data-keywords="virtual" data-action="find-barcode" data-url="/accounting/shopproduction/find_barcode?is_special=1" type="tel" class="form-control" placeholder="Штрих-код">
            </div>
