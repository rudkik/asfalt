    ...
    <div class="row">
        <div class="col-xs-3 box-filter-right b-green">
            ...
            <div class="form-group" style="margin-top: 10px">
                ...
                <input data-is-unique="true" data-keywords="virtual" data-action="find-barcode" data-url="/accounting/shopproduction/find_barcode?is_special=1" name="barcode" type="tel" class="form-control" placeholder="Штрих-код">
            </div>
            <div class="form-group">
                ...
                <input data-keywords="virtual" data-type="card-number" data-action="find-card-number" data-url="/accounting/shopcard/find_barcode" type="tel" class="form-control" placeholder="Номер карты" required>
            </div>
            <div class="form-group">
