    ...
    <div class="row">
        <div class="col-xs-3 box-filter-right b-purple">
            ...
            <div class="form-group" style="margin-top: 10px">
                ...
                <input data-is-unique="true" data-keywords="virtual" data-action="find-barcode" data-url="/accounting/shopproduction/find_barcode" type="tel" class="form-control" placeholder="Штрих-код">
            </div>
            ...
            <div class="form-group">
                ...
                <input name="created_at" type="datetime" date-type="date" class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus($data->values['created_at']); ?>">
            </div>
            <div class="keyboard">
