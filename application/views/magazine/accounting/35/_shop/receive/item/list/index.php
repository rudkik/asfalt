<table class="table-input table table-hover table-db table-tr-line" data-action="table-select">
    <tr class="bg-light-blue-active">
        ...
        <th>Продукт</th>
        <th class="width-50 text-right">НДС</th>
        <th class="tr-quantity-price text-center">Кол-во / Цена</th>
        <th class="width-90 text-right">Сумма</th>
...
<div id="new-product" data-index="0">
    ...
    <tr data-barcode="#barcode#" data-action="tr">
        ...
        <td>
            <a target="_blank" href="/accounting/shopproduction/index?shop_product_id=#shop_product_id#">
        ...
        <td class="text-right">
            <input data-id="total" data-action="tr-edit-total" data-total="#total" data-parent-count="3" class="form-control text-right" name="shop_receive_items[_#index#][amount]" type="tel" placeholder="Сумма" required>
        </td>
