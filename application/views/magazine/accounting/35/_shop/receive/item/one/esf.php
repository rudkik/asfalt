...
<tr data-hash="<?php echo $esf->getHash(); ?>" data-quantity="<?php echo round($data->values['quantity'], 4); ?>" data-price="<?php echo $data->values['price']; ?>">
    <td>
        ...
        <input data-id="shop_receive_item_id" name="shop_receive_items[<?php echo $data->id; ?>][shop_receive_item_id]" value="<?php echo $data->values['id']; ?>" hidden>
        <input data-id="hash_esf" name="shop_receive_items[<?php echo $data->id; ?>][hash_esf]" value="<?php echo $esf->getHash(); ?>" hidden>
    </td>
