<div class="header header-breakpoint" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement" data-qaid="breadcrumbs">
    <div class="container">
        ...
        <span typeof="v:Breadcrumb" class="active"><a rel="v:url" property="v:title" href="<?php echo $siteData->urlBasic; ?>/trade/bonus">Бонусы</a></span>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 box-text">
                <?php echo trim($data['view::_shop/article/bonus/list/index']); ?>
            </div>
        </div>
    </div>
</div>
