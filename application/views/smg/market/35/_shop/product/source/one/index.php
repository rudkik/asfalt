...
<tr>
    <td>
        ...
        <?php }else{ ?>
            <img src="<?php echo $data->values['image_url']; ?>" style="max-width: 68px; max-height: 52px;">
        <?php } ?>
    </td>
    ...
    <td>
        <a target="_blank" href="<?php echo $data->values['url']; ?>" class="text-blue text-sm">Ссылка</a><br>
    </td>
    <td class="text-right">
