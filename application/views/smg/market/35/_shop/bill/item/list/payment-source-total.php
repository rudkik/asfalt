<table class="table table-striped table-bordered table-hover">
    ...
    <tr>
        ...
        <th rowspan="2" class="text-right width-110">Доход</th>
    </tr>
    <tr>
    ...
    <tr class="bg-blue">
        ...
        <td class="text-right"><?php echo Func::getNumberStr($data->values['amount_bill_items'] - $data->values['commission_source'], true, 2, false); ?></td>
    </tr>
    <?php echo trim($siteData->globalDatas['view::_shop/bill/item/list/payment-source']); ?>
    <tr class="bg-blue">
        <td colspan="4" class="text-right">Итого:</td>
        <td class="text-right"><?php echo Func::getNumberStr($data->values['quantity_bill_items'], true); ?></td>
        <td class="text-right">x</td>
