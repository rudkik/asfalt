<tr>
    <td><a data-action="accept-transfer" href="<?php echo Func::getFullURL($siteData, '/shopbillitem/accept_transfer', array('id' => 'id'), array(''), $child->values); ?>" class="btn btn-blue">Принять</a></td>
