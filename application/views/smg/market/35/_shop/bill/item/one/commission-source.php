<?php
if($data->values['payment_shop_commission_source_id'] == Request_RequestParams::getParamInt('id')){
    $commission = $data->values['commission_source_payment'];
}else{
    $commission = $data->values['commission_source_service'];
}
?>
<tr>
    ...
    <td class="text-right"><?php echo Func::getNumberStr($commission, true, 2); ?></td>
    <td class="text-right"><?php echo Func::getNumberStr(round($data->values['amount'] / 100 * $commission, 2), true, 2, false); ?></td>
</tr>