            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input name="date" type="datetime"  date-type="date"  class="form-control" placeholder=" Дата документа" value="<?php  echo Arr::path($siteData->urlParams, 'date', '');?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="shop_courier_id" name="shop_courier_id" class="form-control select2" required style="width: 100%;">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input id="number" class="form-control" name="number" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'number', ''), ENT_QUOTES);?>" type="text">
                    </div>
                </div>
                <div class="col-md-0">
                    <div hidden>
