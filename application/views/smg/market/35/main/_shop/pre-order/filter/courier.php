            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input name="date" type="datetime" date-type="date"  class="form-control" value="<?php $date = Request_RequestParams::getParamDate('date'); if(empty($date)){ $date = Helpers_DateTime::getCurrentDatePHP(); } echo Helpers_DateTime::getDateFormatRus($date);?>">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                ...
                <?php } ?>
                <div class="col-md-3" <?php if($siteData->operation->getShopPositionID() == 0){ ?>style="display: none"<?php } ?>>
                    <div hidden>
