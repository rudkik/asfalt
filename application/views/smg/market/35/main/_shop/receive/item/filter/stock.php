            ...
            <div class="row">
                <div class="col-md-1-5">
                    <div class="form-group">
                        ...
                        <input name="date" type="datetime" date-type="date"  class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Arr::path($siteData->urlParams, 'shop_receive_id/date', ''));?>">
                    </div>
                </div>
                <div class="col-md-1-5">
                    <div class="form-group">
                        ...
                        <input id="number" class="form-control" name="number" placeholder="№ документа" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'shop_receive_id/number', ''), ENT_QUOTES);?>" type="text">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_supplier_id">
                            Поставщик
                        </label>
                        <select data-type="select2" id="shop_supplier_id" name="shop_receive_id/shop_supplier_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_receive_id/shop_supplier_id'); ?>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="is_store">На складе</label>
                        <select data-type="select2" id="is_store" name="is_store" class="form-control select2" style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamBoolean('is_receive'); ?>
                            <option value="" data-id="">Выберите значение</option>
                            <option value="1" data-id="1" <?php if($tmp === true){echo 'selected';} ?>>На складе</option>
                            <option value="0" data-id="0" <?php if($tmp === false){echo 'selected';} ?>>Не на складе</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
