            ...
            <div class="row">
                <div class="col-md-1-5">
                    <div class="form-group">
                        <label for="date_from_equally">
                            Дата доставки от
                        </label>
                        <input name="shop_receive_id/date_from_equally" type="datetime"  date-type="date"  class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Request_RequestParams::getParamDate('shop_receive_id/date_from_equally'));?>">
                    </div>
                </div>
                <div class="col-md-1-5">
                    <div class="form-group">
                        ...
                        <input name="shop_receive_id/date_to" type="datetime"  date-type="date"  class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Request_RequestParams::getParamDate('shop_receive_id/date_to'));?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="shop_product_id/name" placeholder="Название товара" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'shop_product_id/name', ''), ENT_QUOTES);?>" type="text">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="name">
                            Название товара источника
                        </label>
                        <input class="form-control" name="name" placeholder="Название товара источника" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'name', ''), ENT_QUOTES);?>" type="text">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="is_receive">Накладные</label>
                        <select data-type="select2" id="is_receive" name="is_receive" class="form-control select2" style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamBoolean('is_receive'); ?>
                            <option value="" data-id="">Выберите значение</option>
                            <option value="1" data-id="1" <?php if($tmp === true){echo 'selected';} ?>>С накладными</option>
                            <option value="0" data-id="0" <?php if($tmp === false){echo 'selected';} ?>>Без накладных</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
