            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input id="number" class="form-control" name="number" placeholder="№ документа" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'number', ''), ENT_QUOTES);?>" type="text">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input name="esf_date" type="datetime" date-type="date"  class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Arr::path($siteData->urlParams, 'esf_date', ''));?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="esf_number">
                            № ЭСФ
                        </label>
                        <input id="esf_number" class="form-control" name="esf_number" placeholder="№ ЭСФ" value="<?php echo htmlspecialchars(Arr::path($siteData->urlParams, 'esf_number', ''), ENT_QUOTES);?>" type="text">
                    </div>
                </div>
                <div class="col-md-6">
                    <div hidden>
