                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="shop_investor_id" name="shop_investor_id" class="form-control select2" required style="width: 100%;">
                            ...
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/investor/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
