<div class="tab-content">
    <div class="tab-pane active">
        <?php $siteData->titleTop = 'Список складов';?>
        <?php $view = View::factory('smg/market/35/main/_shop/product/storage/filter');
        ...
        <div class="nav-tabs-custom" style="margin-bottom: 0px;">
            <ul id="tab-status" class="nav nav-tabs pull-right ui-sortable-handle">
                ...
                <li class="pull-left header">
                    <span>
                        <a href="<?php echo Func::getFullURL($siteData, '/shopproductstorage/new', array()); ?>" class="btn btn-violet">
    ...
    <div class="body-table">
        <div class="box-body table-responsive" style="padding-top: 0px;">
            <?php echo trim($data['view::_shop/product/storage/list/index']); ?>        </div>
    </div>
</div>
