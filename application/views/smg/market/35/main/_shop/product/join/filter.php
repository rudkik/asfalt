    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_operation_id">Оператор</label>
                        <select data-type="select2" id="shop_operation_id" name="shop_operation_id" class="form-control select2" required style="width: 100%;">
