            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input id="article" class="form-control" name="article" placeholder="Артикул" value="<?php echo Arr::path($siteData->urlParams, 'article', '');?>" type="text">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="name">Название</label>
                        <input id="name" class="form-control" name="name" placeholder="Название" value="<?php echo Arr::path($siteData->urlParams, 'name', '');?>" type="text">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select data-type="select2" id="shop_brand_id" name="shop_brand_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_brand_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_rubric_id">Рубрика</label>
                        <select data-type="select2" id="shop_rubric_id" name="shop_rubric_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_rubric_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_product_status_id">Статус</label>
                        <select data-type="select2" id="shop_product_status_id" name="shop_product_status_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_product_status_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/product/status/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
                <div class="col-md-4">
                    <div hidden>
                        ...
                        <?php if(Arr::path($siteData->urlParams, 'is_public_ignore', '') == 1){?>
                            <input id="input-status" name="is_public_ignore" value="1">
                        <?php }elseif(Arr::path($siteData->urlParams, 'is_public', '') == 1){?>
