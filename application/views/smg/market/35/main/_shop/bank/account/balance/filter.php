            ...
            <div class="row">
                <div class="col-md-1-5">
                    <div class="form-group">
                        ...
                        <input name="date_from_equally" type="datetime"  date-type="date"  class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Request_RequestParams::getParamDate('date_from_equally'));?>">
                    </div>
                </div>
                <div class="col-md-1-5">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="shop_bank_account_id" name="shop_bank_account_id" class="form-control select2" required style="width: 100%;">
