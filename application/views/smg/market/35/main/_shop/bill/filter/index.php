            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input id="old_id" class="form-control" name="old_id" placeholder="Номер" value="<?php echo Request_RequestParams::getParamStr('old_id');?>" type="text">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="shop_bill_status_source_id">Статус источника</label>
                        <select data-type="select2" id="shop_bill_status_source_id" name="shop_bill_status_source_id" class="form-control select2" required style="width: 100%;">
                            <?php $tmp = Request_RequestParams::getParamInt('shop_bill_status_source_id'); ?>
                            <option value="-1" data-id="-1" <?php if($tmp === NULL || $tmp < 0){echo 'selected';} ?>>Выберите значение</option>
                            <?php
                            $tmp = 'data-id="'.$tmp.'"';
                            echo trim(str_replace($tmp, $tmp.' selected', $siteData->replaceDatas['view::_shop/bill/status/source/list/list']));
                            ?>
                        </select>
                    </div>
                </div>
