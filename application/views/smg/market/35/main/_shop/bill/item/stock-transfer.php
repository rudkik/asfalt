<div class="tab-pane active">
    <?php $siteData->titleTop = 'Необходимо принять товары'; ?>
    <?php
    $view = View::factory('smg/market/35/main/_shop/bill/item/filter/stock-transfer');
...
<div class="body-table dataTables_wrapper ">
    <div class="box-body table-responsive" style="padding-top: 0px;">
        <?php echo trim($data['view::_shop/bill/item/list/stock-transfer']); ?>
    </div>
</div>
