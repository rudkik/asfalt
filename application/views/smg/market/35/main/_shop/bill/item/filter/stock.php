            ...
            <div class="row">
                <div class="col-md-1-5">
                    <div class="form-group">
                        ...
                        <input name="buy_at_from_equally" type="datetime"  date-type="date"  class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Request_RequestParams::getParamDate('buy_at_from_equally'));?>">
                    </div>
                </div>
                <div class="col-md-1-5">
                    <div class="form-group">
                        ...
                        <input name="buy_at_to" type="datetime"  date-type="date"  class="form-control" value="<?php echo Helpers_DateTime::getDateFormatRus(Request_RequestParams::getParamDate('buy_at_to'));?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
