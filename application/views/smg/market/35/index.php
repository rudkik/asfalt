...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/jquery-ui-1.10.4.custom/css/ui-lightness/jquery-ui-1.10.4.custom.min.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/font-awesome/css/font-awesome.min.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/bootstrap/css/bootstrap.min.css">
    <!--LOADING STYLESHEET FOR PAGE-->
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/intro.js/introjs.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/calendar/zabuto_calendar.min.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/sco.message/sco.message.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/intro.js/introjs.css">
    <!--Loading style vendors-->
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/animate.css/animate.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/jquery-pace/pace.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/iCheck/skins/all.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/jquery-notific8/jquery.notific8.min.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/bootstrap-daterangepicker/daterangepicker-bs3.css">
    <!--Loading style-->
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/css/themes/style1/orange-blue.css" class="default-style">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/css/themes/style1/orange-blue.css" id="theme-change" class="style-change color-change">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/css/style-responsive.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/DataTables/media/css/jquery.dataTables.css">
    <link rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/_component/bootstrap/v3.3/plugins/iCheck/all.css">
    <link rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/css/morris.css">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/smg/css/style.css?v=8">

    <script src="<?php echo $siteData->urlBasic; ?>/css/_component/bootstrap/v3.3/plugins/jQuery/jQuery-2.1.4.min.js"></script>

    <script src="<?php echo $siteData->urlBasic; ?>/css/smg/js/jquery-1.10.2.min.js"></script>
    <script src="<?php echo $siteData->urlBasic; ?>/css/smg/js/jquery-migrate-1.2.1.min.js"></script>


    <script src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
    <script src="<?php echo $siteData->urlBasic; ?>/css/smg/js/morris.js"></script>
    <!-- jQuery UI 1.11.4 -->
    <script src="<?php echo $siteData->urlBasic; ?>/css/_component/admin-panel/server/jquery-ui.min.js"></script>
    <!--loading bootstrap js-->
    <script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/bootstrap/js/bootstrap.min.js"></script>
    <!--<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/bootstrap-hover-dropdown/bootstrap-hover-dropdown.js1"></script>-->
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown topbar-user">
                        ...
                        <ul class="dropdown-menu dropdown-user pull-right">
                            <li><a href="<?php echo $siteData->urlBasic; ?>/market/shopoperation/edit?id=<?php echo $siteData->operationID; ?>"><i class="fa fa-user"></i>Сменя пароля</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo $siteData->urlBasic; ?>/market/shopuser/unlogin"><i class="fa fa-key"></i>Выход</a></li>
                        </ul>
                    </li>
                    <?php } ?>
                </ul>
        ...
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    <li></li>
                    <?php
                    $view = View::factory('smg/market/35/main/menu');
...
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/metisMenu/jquery.metisMenu.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/slimScroll/jquery.slimscroll.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/jquery-cookie/jquery.cookie.js"></script>
...
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/jquery-notific8/jquery.notific8.min.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/jquery-highcharts/highcharts.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/js/jquery.menu.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/jquery-pace/pace.min.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/holder/holder.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/responsive-tabs/responsive-tabs.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/jquery-news-ticker/jquery.newsTicker.min.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/moment/moment.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/bootstrap-daterangepicker/daterangepicker.js"></script>

<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/intro.js/intro.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/flot-chart/jquery.flot.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/flot-chart/jquery.flot.categories.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/flot-chart/jquery.flot.pie.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/flot-chart/jquery.flot.tooltip.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/flot-chart/jquery.flot.resize.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/flot-chart/jquery.flot.fillbetween.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/flot-chart/jquery.flot.stack.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/flot-chart/jquery.flot.spline.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/calendar/zabuto_calendar.min.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/sco.message/sco.message.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/vendors/intro.js/intro.js"></script>
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/js/index.js"></script>
...
<script src="<?php echo $siteData->urlBasic; ?>/css/smg/main.js?3"></script>

<script>
    $('[data-toggle="collapse"]').trigger('click').trigger('click');
</script>
</body>
</html>