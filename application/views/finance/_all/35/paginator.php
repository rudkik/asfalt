...
<div class="row">
    <div class="col-md-5">
        <div class="dataTables_length">
            <label>Показаны с <?php if($siteData->countRecord > 0){echo ($siteData->page - 1) * $siteData->limitPage + 1;}else{echo 0;} ?> по <?php $tmp = (($siteData->page) * $siteData->limitPage); if($siteData->countRecord < $tmp){$tmp = $siteData->countRecord;}  echo $tmp; ?> из <?php echo Func::getCountElementStrRus($siteData->countRecord, 'записей', 'запись', 'записи'); ?></label>
        </div>
    </div>
