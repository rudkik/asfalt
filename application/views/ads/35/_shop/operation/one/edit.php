<div id="operation-edit-record" class="modal fade bd-example-modal-lg modal-edit" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="has-validation-callback" action="/ads/shopoperation/save">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="form-group margin-0">
                                    <select name="shop_table_rubric_id" id="operation-new-shop_table_rubric_id" class="form-control ks-select" data-parent="#operation-edit-record" style="width: 100%">
                                        <option value="1" data-id="1" <?php if($data->values['shop_table_rubric_id'] == 1) {echo 'selected';}?>>Администратор</option>
                                        <option value="2" data-id="2" <?php if($data->values['shop_table_rubric_id'] == 2) {echo 'selected';}?>>Управление посылками</option>
                                        <option value="3" data-id="3" <?php if($data->values['shop_table_rubric_id'] == 3) {echo 'selected';}?>>Управление оплатами</option>
                                    </select>
                                </div>
                            </div>
                        </div>
