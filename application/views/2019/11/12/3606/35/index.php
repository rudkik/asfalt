    ...
    <div class="content">
        ...
        <header class="header-top">
            <div class="container">
                ...
                <div class="box-basket" style="margin-right: 10px; padding: 21px 20.5px;">
                    <a class="" href="#user-modal" data-toggle="modal"><img src="<?php echo $siteData->urlBasic;?>/css/<?php echo $siteData->shopShablonPath;?>/img/user-b.png"></a>
                </div>
            </div>
        </header>
...
<div class="modal fade" id="user-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="top: 61px; max-width: 450px;">
        <form action="<?php echo $siteData->urlBasic;?>/user/login" method="post" class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <a href="<?php echo $siteData->urlBasic;?>/my/registration" class="btn btn-default btn-white pull-left">Регистрация</a>
                <button type="submit" class="btn btn-primary btn-red">Войти</button>
            </div>
        </form>
    </div>
</div>
