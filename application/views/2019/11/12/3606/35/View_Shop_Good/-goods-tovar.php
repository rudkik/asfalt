        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="box-images">
                    ...
                    <div class="box-image" id="goods-img-<?php echo $data->values['id']; ?>">
            ...
            <div class="col-sm-7">
                ...
                <div class="row btn-buy">
                    <div class="col-xs-6">
                        <a href="#" class="btn btn-flat btn-white btn-img btn-basket" data-cart-action="add-good" data-id="<?php echo $data->values['id']; ?>" data-child="0" data-shop="<?php echo $data->values['shop_id']; ?>">В корзину</a>
                    </div>
                </div>
            </div>
        </div>
