...
function isIgnore($name){
    ...
    switch($name){
        ...
        case 'operation_id': return TRUE; break;
        ...
        case 'sales_operation_count': return TRUE; break;
...
function writeElementName(&$data, $name, $value){
    switch($name){
        ...
        case 'operation_select_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.operation_select_type_id.name', ''); break;
        case 'shop_operation_unit_type_id': $result = Arr::path($data->values, Model_Basic_BasicObject::FIELD_ELEMENTS. '.shop_operation_unit_type_id.name', ''); break;
        default:
            $result = $value;
    }
