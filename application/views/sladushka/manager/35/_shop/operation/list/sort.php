<form action="<?php echo Func::getFullURL($siteData, '/shopoperation/savesort');?>" method="post">
	...
	<table class="table table-hover table-db">
		<tr>
			...
			<?php } ?>
			<th><?php echo SitePageData::setPathReplace('type.form_data.shop_operation.fields_title.name', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
			<th><?php echo SitePageData::setPathReplace('type.form_data.shop_operation.fields_title.email', SitePageData::CASE_FIRST_LETTER_UPPER); ?></th>
			<th class="tr-header-buttom"></th>
		</tr>
		<tbody id="sort-record">
		<?php
		foreach ($data['view::_shop/operation/one/sort']->childs as $value) {
			echo $value->str;
		}
		?>
		</tbody>
