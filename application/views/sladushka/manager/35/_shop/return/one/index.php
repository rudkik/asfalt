<li class="item">
    <div class="box-product">
        ...
        <div class="product-info">
            ...
            <a href="<?php echo $siteData->urlBasic; ?>/manager/shopreturn/edit?id=<?php echo $data->id; ?>" class="btn btn-danger btn-flat pull-right btn-cart">Просмотр</a>
            <a href="<?php echo Func::getFullURL($siteData, '/shoppaid/new', array(), array('paid_shop_id'=>$data->values['shop_id'], 'type'=>51666)); ?>" class="btn btn-info btn-flat pull-right btn-cart">Оплата</a>
