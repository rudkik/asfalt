...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/manager/css/style.css">
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="<?php echo $siteData->urlBasic; ?>/manager/shopuser/login" method="post">
