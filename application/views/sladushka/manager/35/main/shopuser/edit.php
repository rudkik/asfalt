        ...
        <div class="col-md-12">
            <div class="box box-primary padding-t-5">
                <div class="box-body pad table-responsive">
                    <form action="<?php echo $siteData->urlBasic; ?>/<?php echo $siteData->actionURLName; ?>/shopuser/save" method="post" style="padding-right: 5px;">
                        <?php echo trim($data['view::shopuser/edit']); ?>
                    </form>
                </div>
            </div>
        </div>
