    ...
    <div class="col-md-9">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <?php if (Func::isShopMenu('shop/work_time', $siteData)){ ?>
                <li><a href="#tab2" data-toggle="tab">Режим работы</a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shop/requisites', $siteData)){ ?>
                <li><a href="#tab3" data-toggle="tab">Реквизиты</a></li>
                <?php } ?>
                <?php if (Func::isShopMenu('shop/city', $siteData)){ ?>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="row record-input2 record-tab">
                        <?php if (Func::isShopMenu('shop/sub_domain', $siteData)){ ?>
                            <div class="col-md-3 record-title">
                                <label>
                                    <sup><i class="fa fa-fw fa-asterisk text-red"></i></sup>
                                    Поддомен (*.*.*)
                            ...
                            <div class="col-md-3">
                                <input unique-current-id="<?php echo $data->id;?>" unique-error="Поддомен с таким именем уже существует" unique="1" href="<?php echo $siteData->urlBasic; ?>/manager/shop/isunique" name="sub_domain" type="text" class="form-control" id="sub_name" placeholder="Поддомен" value="<?php echo htmlspecialchars($data->values['sub_domain']); ?>">
                            </div>
                        <?php } ?>
                        <?php if (Func::isShopMenu('shop/domain', $siteData)){ ?>
                        <div class="col-md-3 record-title">
                            <label>
                                Домен
                                <a href="#"><i class="fa fa-fw fa-info text-blue"></i></a>
                        ...
                        <div class="col-md-3">
                            <input unique-current-id="<?php echo $data->id;?>" unique-error="Домен с таким именем уже существует"  unique="1" href="<?php echo $siteData->urlBasic; ?>/manager/shop/isunique" name="domain" type="text" class="form-control" rows="5" placeholder="Название" value="<?php echo htmlspecialchars($data->values['domain']);?>">
                        </div>
                        <?php } ?>
                    </div>
                    <?php if ((Func::isShopMenu('shop/text', $siteData))
                    || (Func::isShopMenu('shop/text-html', $siteData))){ ?>
                        <div class="row record-input record-tab">
                            <div class="col-md-3 record-title">
                                <label>
                                    Описание
                ...
                <div class="tab-pane" id="tab4">
                    <?php if (Func::isShopMenu('shop/city', $siteData)){ ?>
                        <div class="row record-input record-tab margin-t-15">
                            ...
                            <div class="col-md-9">
                                <select name="city_ids[]" class="form-control select2" multiple="multiple" data-placeholder="Выберите города" style="width: 100%;">
...
<?php if (Func::isShopMenu('shop/text-html', $siteData)){ ?>
    <script>
