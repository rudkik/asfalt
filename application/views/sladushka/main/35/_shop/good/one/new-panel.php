<div id="<?php echo $panelID; ?>" class="form-group row" style="display: none">
    <input name="is_add_good" value="0" style="display: none">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="form-group margin-0">
                                <input name="shop_good[number]" data-validation="length" data-validation-length="max50" maxlength="50" class="form-control valid" placeholder="Номер" id="number" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="form-group margin-0">
                                <input name="shop_good[name]" data-validation="length" data-validation-length="max250" maxlength="250" class="form-control valid" placeholder="ФИО на кого выписана" id="name" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="row">
                                <div class="col-5">
                                    <div class="form-group margin-0">
                                        <input name="shop_good[date_from]" class="form-control" placeholder="Дата начала" id="date_from" type="datetime">
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <div class="form-group margin-0">
                                                <input name="shop_good[date_to]" class="form-control" placeholder="Дата окончания" id="date_to" type="datetime">
                                            </div>
                                        </div>
                                    </div>
                                </div>
