...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $siteData->urlBasic; ?>/css/pyramid/css/style.css">
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="<?php echo $siteData->urlBasic; ?>/pyramid/shopuser/login" method="post">
