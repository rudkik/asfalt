<div class="ks-nav-body">
    ...
    <table id="bill-item-relax-data-table" data-action="pyramid-table" class="table table-striped table-bordered" width="100%"
           data-search="true"
           ...
           data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shopbillitem/json_relax?is_total=1&_fields[]=shop_bill_id&_fields[]=shop_room_name&_fields[]=shop_client_name&_fields[]=date_from&_fields[]=date_to&_fields[]=shop_bill_is_finish&_fields[]=shop_bill_finish_date&_fields[]=id"
