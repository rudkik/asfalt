<div class="ks-nav-body">
    <div id="bill-cancel-toolbar" class="ks-datatable-toolbar">
        <div class="ks-items-block">
            ...
            <button data-action="table-delete" data-table="#bill-cancel-data-table" data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shopbill/un_cancel" class="btn btn-danger-outline ks-solid"><span class="ks-icon fa fa-remove "></span> <span class="ks-text">Восстановить</span></button>
            <div class="btn-group">
                <a data-action="table-download" data-table="#bill-cancel-data-table" data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shopexcel/act_service" href="#" type="button" class="btn btn-info-outline ks-solid">Печать</a>
                ...
                <div class="dropdown-menu">
                    <a data-action="table-download" data-table="#bill-cancel-data-table" class="dropdown-item" data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shopbill/save_pdf" href="#">Бронь</a>
                    <a data-action="table-download" data-table="#bill-cancel-data-table" class="dropdown-item" data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shopbill/save_halyk_pdf" href="#">Оплата через Народный Банк</a>
                    <a data-action="table-download" data-table="#bill-cancel-data-table" class="dropdown-item" data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shopbill/save_bank_pdf" href="#">Оплата через Любой банк</a>
                    <a data-action="table-download" data-table="#bill-cancel-data-table" class="dropdown-item" data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shopbill/save_bank_and_halyk_pdf" href="#">Оплата через Любой банк и Народный Банк</a>
                    <a data-action="table-download" data-table="#bill-cancel-data-table" class="dropdown-item" data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shopexcel/act_service" href="#">Акт выполненных работ</a>
                </div>
            </div>
        </div>
    </div>

    <table id="bill-cancel-data-table" data-action="pyramid-table" class="table table-striped table-bordered" width="100%"
           data-search="true"
           ...
           data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shopbill/json?is_total=1&is_public=0&_fields[]=text&_fields[]=bill_cancel_status_name&_fields[]=update_user_name&_fields[]=residual_amount&_fields[]=created_at&_fields[]=amount&_fields[]=paid_amount&_fields[]=shop_client_name&_fields[]=shop_client_phone&_fields[]=date_from&_fields[]=date_to&_fields[]=id"
