                    ...
                    <div class="pull-left">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button data-url="/pyramid/shoppayment/add?shop_bill_id=<?php echo $data->id; ?>&shop_paid_type_id=899&is_paid=1" data-action="add-payment" type="button" class="btn btn-primary">Оплатить</button>
                                    <a style="display: none" id="bill-edit-pko" data-url="/pyramid/shopexcel/pko?id=" target="_blank" href="#" class="btn btn-primary">ПКО</a>
                                </span>
                            </div>
                        </div>
                    </div>
