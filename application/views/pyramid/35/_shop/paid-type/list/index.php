<div class="ks-nav-body">
    <div id="paid-type-toolbar" class="ks-datatable-toolbar">
        <div class="ks-items-block">
            ...
            <button id="paid-type-edit" data-action="table-edit" data-table="#paid-type-data-table" data-modal="#paid-type-edit-record" data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shoppaidtype/edit" class="btn btn-info-outline ks-solid"><span class="ks-icon fa fa-pencil-square-o"></span> <span class="ks-text">Редактировать</span></button>
        </div>
    </div>

    <table id="paid-type-data-table" data-action="pyramid-table" class="table table-striped table-bordered" width="100%"
           data-search="true"
           ...
           data-url="<?php echo $siteData->urlBasic; ?>/pyramid/shoppaidtype/json?is_total=1&_fields[]=options_reserve_time&_fields[]=name&_fields[]=id"
